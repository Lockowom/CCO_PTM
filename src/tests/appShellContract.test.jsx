...
import { ROUTE_META, getRouteMeta, getBreadcrumb, getNavGroups, SEARCHABLE_ROUTES } from '../constants/routeMeta';
...
describe('PR-013 · routeMeta SSOT', () => {
  ...
  it('getRouteMeta normaliza query y trailing slash', () => {
    expect(getRouteMeta('/inventory/conteo?tab=sesiones')?.path).toBe('/inventory/conteo?tab=sesiones');
