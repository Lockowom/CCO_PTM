  ...
  return (
    <div ref={container} className="p-6 bg-slate-950 min-h-screen text-slate-300">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-white tracking-wide">Reportes y BI</h1>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {reports.map((report, i) => (
          <div key={i} className={`report-card bg-slate-900/80 border ${report.border} rounded-2xl p-6 backdrop-blur-xl hover:shadow-[0_0_20px_rgba(0,0,0,0.5)] transition-all group`}>
