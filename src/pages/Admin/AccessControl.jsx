...
const TABS = [
  ...
  },
  {
    ...
    label: 'Accesos',
    icon: LogIn,
    path: '/admin/roles?vista=accesos',
    soloAdmin: true
  },
  {
    id: 'auditoria',
        ...
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-xl sm:text-3xl font-black text-slate-900 tracking-tight">
              Identidad y <span className="text-orange-600">Seguridad</span>
            </h1>
            <p className="text-xs sm:text-sm text-slate-500">
              Control de accesos: usuarios, roles, permisos, ámbitos, sesiones, auditoría, políticas
              y delegaciones
            </p>
          </div>
        </div>
