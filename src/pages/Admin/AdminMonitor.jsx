        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3 sm:p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="min-w-0">
              <p className="text-[10px] sm:text-xs text-slate-500 uppercase tracking-wider font-semibold truncate">
                Conectados
              </p>
          ...
          <div className="flex flex-wrap gap-3">
            {Object.entries(moduleGroups)
              ...
              .map(([mod, usersInMod]) => (
                <div
                  key={mod}
                  className="bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 flex items-center gap-2"
                >
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-500 uppercase text-xs">
              <tr>
                ...
                <th className="px-2 sm:px-5 py-3 sm:py-4 font-bold tracking-wider">
                  Módulo Actual
                </th>
              ...
              {filteredUsers.length === 0 && !isLoading && (
                <tr>
                  <td colSpan="5" className="px-5 py-10 text-center text-slate-400">
                    ...
                    <p>
                      No hay usuarios{' '}
                      {filter === 'online' ? 'activos' : filter === 'offline' ? 'offline' : ''} en
                      este momento
                    </p>
                  </td>
                </tr>
