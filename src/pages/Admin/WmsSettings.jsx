          ...
          <div className="space-y-8 animate-in fade-in">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                ...
                <div className="space-y-4">
                  <label className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200 cursor-pointer hover:border-indigo-300 transition-colors">
                    <span className="text-sm font-medium text-slate-700">Permitir Recepción Ciega</span>
                    <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                      ...
                      />
                      <span className="block bg-slate-300 w-full h-full rounded-full peer-checked:bg-indigo-600 transition-all duration-300"></span>
                      <span className="absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-all duration-300 peer-checked:translate-x-6"></span>
                    </div>
                  </label>

                  <label className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200 cursor-pointer hover:border-indigo-300 transition-colors">
                    <span className="text-sm font-medium text-slate-700">Requerir Control Calidad (QC)</span>
                    <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                      <input 
                        type="checkbox" 
                        name="require_qc"
                        ...
                        className="peer absolute opacity-0 w-0 h-0"
                      />
                      <span className="block bg-slate-300 w-full h-full rounded-full peer-checked:bg-emerald-500 transition-all duration-300"></span>
                      <span className="absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-all duration-300 peer-checked:translate-x-6"></span>
                    </div>
                  </label>
                </div>
          ...
          <div className="space-y-8 animate-in fade-in">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="space-y-6">
                 ...
                 <div className="space-y-4">
                    <label className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200 cursor-pointer hover:border-indigo-300 transition-colors">
                      <span className="text-sm font-medium text-slate-700">Permitir Picking Parcial</span>
                      <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                        <input 
                          type="checkbox" 
                    ...
                    <p className="text-xs text-slate-400 px-2">Si se habilita, el sistema permitirá cerrar órdenes con faltantes.</p>
                 </div>
               </div>
             </div>
          </div>
