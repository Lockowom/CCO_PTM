          ...
          <div className="p-4 grid grid-cols-2 gap-3">
            {WIDGET_TYPES.map((wt) => (
              <button
                ...
                className="text-left p-4 rounded-xl border border-gray-200 hover:border-[#f57c00] hover:bg-orange-50/50 transition-all"
              >
          ...
          <div className="p-4 space-y-2">
            ...
            {DATA_SOURCES.map((ds) => (
              <button
                ...
                className="w-full text-left p-3 rounded-xl border border-gray-200 hover:border-[#f57c00] hover:bg-orange-50/50 transition-all"
              >
