// Todas las pantallas del Panel PTM ya están portadas de forma nativa.
// (Auditoría se fusionó dentro de Configuración, que es solo para admin.)
...
export { default as PanelConfig } from './config/PanelConfigReal';
