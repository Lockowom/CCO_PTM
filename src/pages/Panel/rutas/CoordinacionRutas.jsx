      ...
      <div className="cr-map-layout">
        <div className="cr-card cr-map-card">
          ...
          <div className="cr-map-note">
            <CircleDot size={14} /> Los puntos sin latitud histórica se muestran temporalmente en el
            centro de su comuna.
          </div>
        </div>
        ...
        <aside className="cr-card cr-sector-card">
          ...
          {sectorCounts.map((item) => (
            ...
            >
              <span className="cr-sector__dot" style={{ background: SECTOR_COLORS[item.name] }} />
              <div>
        ...
        <div className="cr-card">
          ...
          {showPickup && (
            <form className="cr-pickup-form" onSubmit={createPickup}>
              ...
              <button className="cr-button cr-button--orange" disabled={busy === 'create-pickup'}>
          ...
          <div className="cr-plan-tabs">
            ...
            {data.planes.map((plan) => (
              ...
              >
                ...
                <Badge tone={plan.estado === 'BORRADOR' ? 'orange' : 'green'}>{plan.estado}</Badge>
              </button>
            ))}
          </div>
        </div>
            ...
            {shippingSantiago
              ...
              .map((item) => (
                <article className="cr-dispatch" key={stopKey(item)}>
                  <div className="cr-stop-index" style={{ background: SECTOR_COLORS[item.sector] }}>
                    <Navigation size={15} />
                  </div>
                  ...
                  <button
                    ...
                    onClick={() =>
                      run(
                        'confirm',
                        () =>
                          routeCoordinationService.changePlanStatus(selectedPlan.id, 'CONFIRMADA'),
                        'Ruta confirmada.'
                      )
                    }
                  >
                  ...
                  <article className="cr-stop" key={stop.id}>
                    ...
                    <div>
                      <div>
                        ...
                        <Badge tone={stop.tipo === 'RETIRO' ? 'green' : 'slate'}>{stop.tipo}</Badge>
