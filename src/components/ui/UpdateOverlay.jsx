          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[11px] text-slate-400">
                Versión {updateInfo.version} · {pct}%
              </p>
            </div>
            <span className="text-[15px] font-black text-amber-400 tabular-nums shrink-0">
              {pct}%
            </span>
          </div>
          <div className="h-1.5 w-full bg-white/5 overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-orange-500 to-amber-400 transition-all duration-500 ease-out relative"
              style={{ width: `${pct}%` }}
            >
      ...
      <div className="anim-scale-in relative w-full max-w-sm rounded-[2rem] border border-white/10 bg-gradient-to-b from-white/[0.07] to-white/[0.02] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.7)] overflow-hidden">
        ...
        <div className="px-8 pt-7 pb-8 text-center">
          <div className="flex items-center justify-center gap-2 mb-7">
            ...
            <span className="px-1.5 py-0.5 bg-orange-500 text-white text-[9px] font-black rounded-md tracking-[0.2em] uppercase">
              System
            </span>
          </div>
