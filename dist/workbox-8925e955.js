  ...
  function O(t) {
    return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
      ...
      : function (e, ...s) {
          ...
          return (I.set(n, e.sort ? e.sort() : [e]), B(n));
        };
  }
  function k(t) {
    ...
    async F(t, e) {
      ...
      if (!this.K) throw new s('missing-precache-entry', { cacheName: this.cacheName, url: t.url });
      {
        ...
        ((n = await e.fetch(new Request(t, { integrity: 'no-cors' !== t.mode ? i || s : void 0 }))),
          s && a && 'no-cors' !== t.mode && (this.$(), await e.cachePut(t, n.clone())));
      }
      return n;
    }
    async A(t, e) {
    ...
    $() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== Z.copyRedirectedCacheableResponsesPlugin &&
          (n === Z.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
      0 === e
  ...
  ((t.CacheableResponsePlugin = class {
    ...
    (t.NavigationRoute = class extends r {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        (super((t) => this.nt(t), t), (this.rt = e), (this.it = s));
      }
      nt({ url: t, request: e }) {
        if (e && 'navigate' !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.it) if (t.test(s)) return !1;
        return !!this.rt.some((t) => t.test(s));
      }
    }),
    (t.NetworkFirst = class extends v {
      constructor(t = {}) {
        (super(t),
          this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(H),
      ...
      async U(t, e) {
        ...
        const a = this.ht({ timeoutId: i, request: t, logs: n, handler: e });
        r.push(a);
    ...
    (t.NetworkOnly = class extends v {
      constructor(t = {}) {
        (super(t), (this.ot = t.networkTimeoutSeconds || 0));
      }
      async U(t, e) {
        let n, r;
        try {
          const s = [e.fetch(t)];
          if (this.ot) {
            const t = u(1e3 * this.ot);
            s.push(t);
          }
          if (((r = await Promise.race(s)), !r))
            throw new Error(`Timed out the network response after ${this.ot} seconds.`);
        } catch (t) {
          t instanceof Error && (n = t);
        }
    ...
    (t.StaleWhileRevalidate = class extends v {
      constructor(t = {}) {
        (super(t), this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(H));
      }
      async U(t, e) {
    ...
    (t.createHandlerBoundToURL = function (t) {
      return et().createHandlerBoundToURL(t);
    }),
