define(['exports'], function (t) {
  ...
  function x(t) {
    return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
      ? (
        ...
        ? function (...e) {
            return (t.apply(E(this), e), L(R.get(this)));
          }
        : function (...e) {
            return L(t.apply(E(this), e));
          }
      : function (e, ...s) {
          const n = t.call(E(this), e, ...s);
          return (b.set(n, e.sort ? e.sort() : [e]), L(n));
        };
  }
  function I(t) {
    return 'function' == typeof t
      ...
      : (t instanceof IDBTransaction &&
        ...
        (e = t),
        (m || (m = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(
          (t) => e instanceof t
        )
          ? new Proxy(t, U)
          : t);
  ...
  function L(t) {
    ...
    const e = I(t);
    return (e !== t && (q.set(t, e), D.set(e, t)), e);
  }
  const E = (t) => D.get(t);
  ...
  function k(t, e) {
    ...
    const s = e.replace(/FromIndex$/, ''),
      n = e !== s,
      i = N.includes(s);
    if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || (!i && !C.includes(s))) return;
  ...
  class P {
    ...
    l(t) {
      const e = t.createObjectStore(B, { keyPath: 'id' });
      ...
      (this.l(t),
        this.u &&
          (function (t, { blocked: e } = {}) {
            ...
            (e && s.addEventListener('blocked', (t) => e(t.oldVersion, t)), L(s).then(() => {}));
          })(this.u));
    }
    async setTimestamp(t, e) {
      const s = { url: (t = T(t)), timestamp: e, cacheName: this.u, id: this.m(t) },
            ...
            return (
              n &&
                a.addEventListener('upgradeneeded', (t) => {
                  n(L(a.result), t.oldVersion, t.newVersion, L(a.transaction), t);
                }),
  ...
  class M {
    constructor(t, e = {}) {
      ((this.R = !1),
        (this.v = !1),
        (this.q = e.maxEntries),
        (this.D = e.maxAgeSeconds),
        (this.U = e.matchOptions),
        (this.u = t),
        (this._ = new P(t)));
    }
    async expireEntries() {
      if (this.R) return void (this.v = !0);
      this.R = !0;
      ...
      ((this.R = !1), this.v && ((this.v = !1), d(this.expireEntries())));
    }
    ...
    async delete() {
      ((this.v = !1), await this._.expireEntries(1 / 0));
    }
  }
  try {
  ...
  class W {
    ...
    isResponseCacheable(t) {
      ...
      return (
        ...
        this.L && e && (e = Object.keys(this.L).some((e) => t.headers.get(e) === this.L[e])),
        e
      );
    }
  }
  ...
  class F {
    constructor(t, e) {
      ((this.C = {}),
        ...
        (this.B = [...t.plugins]),
        (this.T = new Map()));
      for (const t of this.B) this.T.set(t, {});
      this.event.waitUntil(this.O.promise);
    }
    async fetch(t) {
      const { event: e } = this;
      let n = A(t);
      ...
      try {
        let t;
        t = await fetch(n, 'navigate' === n.mode ? void 0 : this.N.fetchOptions);
    ...
    async cacheMatch(t) {
      const e = A(t);
      let s;
      const { cacheName: n, matchOptions: i } = this.N,
    ...
    async cachePut(t, e) {
      ...
      if (!o) return !1;
      const { cacheName: c, matchOptions: h } = this.N,
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                a = await t.keys(e, r);
              for (const e of a) if (i === S(e.url, s)) return t.match(e, n);
    ...
    async getCacheKey(t, e) {
      ...
      if (!this.C[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = A(await t({ mode: e, request: n, event: this.event, params: this.params }));
        this.C[s] = n;
      }
      return this.C[s];
    }
    hasCallback(t) {
      for (const e of this.N.plugins) if (t in e) return !0;
      return !1;
    }
  ...
  class H {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new F(this, { event: e, request: s, params: n }),
        r = this.M(i, s, e);
      return [r, this.W(r, i, s, e)];
    }
    async M(t, e, n) {
      let i;
      await t.runCallbacks('handlerWillStart', { event: n, request: e });
      try {
        if (((i = await this.j(e, t)), !i || 'error' === i.type))
  ...
  ((t.CacheableResponsePlugin = class {
    ...
    (t.ExpirationPlugin = class {
      ...
      Z(t) {
        ...
        let e = this.et.get(t);
        return (e || ((e = new M(t, this.tt)), this.et.set(t, e)), e);
      }
      Y(t) {
        if (!this.D) return !0;
        const e = this.st(t);
    ...
    (t.NavigationRoute = class extends i {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        (super((t) => this.nt(t), t), (this.it = e), (this.rt = s));
      }
      nt({ url: t, request: e }) {
        if (e && 'navigate' !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.rt) if (t.test(s)) return !1;
        return !!this.it.some((t) => t.test(s));
      }
    }),
    (t.NetworkFirst = class extends H {
      constructor(t = {}) {
        (super(t),
          ...
          (this.ot = t.networkTimeoutSeconds || 0));
      }
      async j(t, e) {
        const n = [],
          i = [];
        let r;
        if (this.ot) {
          const { id: s, promise: a } = this.ct({ request: t, logs: n, handler: e });
          ((r = s), i.push(a));
        }
        const a = this.ht({ timeoutId: r, request: t, logs: n, handler: e });
        i.push(a);
      ...
      async ht({ timeoutId: t, request: e, logs: s, handler: n }) {
        let i, r;
        try {
    ...
    (t.StaleWhileRevalidate = class extends H {
      constructor(t = {}) {
        (super(t), this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(j));
      }
      async j(t, e) {
    ...
    (t.createHandlerBoundToURL = function (t) {
      return tt().createHandlerBoundToURL(t);
    }),
