...
import {
  ...
  d as ne,
  a as te
} from './exportRendicion-CNX71Jjr.js';
...
function oe({ token: h, reportId: g, viewToken: v }) {
          ...
          e.jsx('div', {
            ...
            children: e.jsxs('table', {
              ...
              children: [
                ...
                e.jsx('tbody', {
                  children: p.items.map((t) =>
                    e.jsxs(
                      'tr',
                      {
                        children: [
                          e.jsx('td', { children: t.orden }),
                          e.jsx('td', {
                            children: new Date(`${t.fecha}T12:00:00`).toLocaleDateString('es-CL')
                          }),
                          e.jsx('td', { children: t.numero_documento || '—' }),
                          e.jsxs('td', {
                            children: [
                              t.descripcion,
                              e.jsxs('small', {
                                children: [t.subcategoria_nombre, ' · ', t.tipo_documento]
                              })
                            ]
                          }),
                          e.jsx('td', { children: n.centro_costo_codigo }),
                          e.jsx('td', { children: t.categoria_nombre }),
                          e.jsxs('td', {
                            className: 'money',
                            children: ['$ ', Number(t.monto).toLocaleString('es-CL')]
                          })
                        ]
                      },
                      t.id
              ...
              children: p.fotos.map((t) =>
                e.jsxs(
                  'a',
                  {
                    ...
                    rel: 'noreferrer',
                    children: [
                      e.jsx('img', { src: t.url, alt: 'Comprobante' }),
...
function ue() {
    ...
    ((document.title = 'Rendición de gastos · PTM'),
      ...
      g ||
        S.bootstrap(h)
          .then((s) => {
            var a;
            (E(s.catalogs), t(((a = s.link) == null ? void 0 : a.nombre) || 'Rendición de gastos'));
          })
          .catch((s) => V(s.message)));
  }, [h, g]);
  const B = d.useMemo(() => {
      const s = Object.fromEntries(
        ((o == null ? void 0 : o.subcategorias) || []).map((a) => [a.codigo, a])
      );
      return ((o == null ? void 0 : o.relaciones) || []).reduce((a, r) => {
        var i;
        return ((a[(i = r.categoria_codigo)] || (a[i] = [])).push(s[r.subcategoria_codigo]), a);
      }, {});
    }, [o]),
    T = d.useMemo(() => {
      var s;
      return (
        ((s = o == null ? void 0 : o.tecnicos) == null
          ? void 0
          : s.find((a) => a.id === c.solicitante_tecnico_id)) || null
      );
    }, [o, c.solicitante_tecnico_id]);
  if (g && v) return e.jsx(oe, { token: h, reportId: g, viewToken: v });
  if (L)
    return e.jsx('main', {
      className: 'rp-shell',
      children: e.jsxs('section', {
  ...
  const m = (s, a, r) =>
      _((i) => ({
        ...i,
        items: i.items.map((l, u) =>
          u === s
            ? { ...l, [a]: r, ...(a === 'categoria_codigo' ? { subcategoria_codigo: '' } : {}) }
            : l
        )
      })),
    q = (s) => _((a) => ({ ...a, items: a.items.filter((r, i) => i !== s) })),
    H = async (s, a) => {
      const r = c.items.reduce((l, u) => l + u.photos.length, 0),
        i = Math.min(3 - c.items[s].photos.length, 10 - r);
      if (i <= 0) return b.error('Máximo 3 fotos por gasto y 10 por rendición.');
      try {
        const l = [];
        for (const u of [...a].slice(0, i)) l.push(await re(u));
    ...
    W = async (s) => {
      ...
      z(!0);
      try {
        const i = await S.submit(h, a, N.current, k);
        if (i.ignored) return;
        const l = Object.fromEntries(i.report.items.map((x) => [x.client_id, x.id])),
          u = c.items.flatMap((x) => x.photos.map((K) => ({ photo: K, itemId: l[x.client_id] })));
        let y = 0;
        for (const x of u)
          try {
            await S.upload(h, i.view_token, i.report.id, x.itemId, x.photo);
          } catch {
            y += 1;
          }
        ...
        (R({
          folio: i.report.folio,
          total: i.report.total,
          viewPath: `${J}/ver/${i.report.id}/${i.view_token}`,
          failed: y
        }),
                          ...
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsx('input', {
                                ...
                                value: s.fecha,
                                onChange: (r) => m(a, 'fecha', r.target.value)
                              }),
                              j(`items.${a}.fecha`)
                            ]
                          }),
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsxs('select', {
                                ...
                                onChange: (r) => m(a, 'categoria_codigo', r.target.value),
                                children: [
                                  e.jsx('option', { value: '', children: 'Seleccionar…' }),
                                  o.categorias.map((r) =>
                                    e.jsx(
                                      'option',
                                      { value: r.codigo, children: r.nombre },
                                      r.codigo
                                    )
                                  )
                                ]
                          ...
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsxs('select', {
                                ...
                                onChange: (r) => m(a, 'subcategoria_codigo', r.target.value),
                                children: [
                                  e.jsx('option', { value: '', children: 'Seleccionar…' }),
                                  (B[s.categoria_codigo] || [])
                                    .filter(Boolean)
                                    .map((r) =>
                                      e.jsx(
                                        'option',
                          ...
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsx('input', {
                                ...
                                placeholder: '$ 0',
                                value: s.monto,
                                onChange: (r) => m(a, 'monto', r.target.value)
                              }),
                              j(`items.${a}.monto`)
                            ]
                          }),
                          e.jsxs('label', {
                            ...
                            children: [
                              ...
                              e.jsx('textarea', {
                                ...
                                value: s.descripcion,
                                onChange: (r) => m(a, 'descripcion', r.target.value)
                              }),
                          ...
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsxs('select', {
                                ...
                                onChange: (r) => m(a, 'tipo_documento', r.target.value),
                                children: [
                                  e.jsx('option', { value: '', children: 'Seleccionar…' }),
                                  ae.map((r) => e.jsx('option', { children: r }, r))
                                ]
                              }),
                          ...
                          e.jsxs('label', {
                            children: [
                              ...
                              e.jsx('input', {
                                ...
                                onChange: (r) => m(a, 'numero_documento', r.target.value)
                              }),
                          ...
                          e.jsxs('label', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                ...
                                multiple: !0,
                                onChange: (r) => {
                                  (H(a, r.target.files), (r.target.value = ''));
                                }
                              }),
                              e.jsxs('b', {
