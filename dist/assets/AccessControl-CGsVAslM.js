import { u as Ns, d as Oe, c as ze, j as e } from './query-vendor-CojWQiBV.js';
import { s as Q, y as ws, A as He, z as as, u as Ue } from './index-BU_ov3s4.js';
import { r as n, R as Se, e as Ms, u as Ls } from './react-vendor-CA7EHQ1X.js';
import {
  u as qs,
  K as X,
  R as le,
...
import {
  ...
  J as cs,
  K as Ja
} from './iamService-Cu-kfHP4.js';
import './supabase-vendor-jY4wIOEF.js';
const ds = { background: '#1e293b', border: '1px solid #10b981', color: '#f8fafc' },
  xs = { background: '#1e293b', border: '1px solid #ef4444', color: '#f8fafc' },
  ms = (l) => {
    if (!l) return 'Nunca';
    const c = new Date(l);
    if (isNaN(c.getTime())) return '—';
    const x = Math.floor((Date.now() - c.getTime()) / 6e4);
    if (x < 1) return 'Ahora';
    if (x < 60) return `hace ${x} min`;
    const m = Math.floor(x / 60);
    if (m < 24) return `hace ${m} h`;
    const t = Math.floor(m / 24);
    return t < 30 ? `hace ${t} d` : c.toLocaleDateString('es-CL');
  },
  Qa = ({ embedded: l = !1 }) => {
    const c = Ns(),
      x = n.useRef(null),
    ...
    const { data: j = [], isLoading: $ } = Oe({
        queryKey: ['roles_catalogo'],
        queryFn: async () => {
          const { data: s, error: v } = await Q.from('tms_roles')
      ...
      O = Se.useMemo(() => Object.fromEntries(j.map((s) => [s.id, s])), [j]),
      { data: I = [], isLoading: ve } = Oe({
        queryKey: ['admin_users'],
        queryFn: async () => {
          const { data: s, error: v } = await Q.from('tms_usuarios')
            .select(
    ...
    Se.useEffect(() => {
      let s = {};
      const v = (_) => {
          (s[_] && clearTimeout(s[_]),
            (s[_] = setTimeout(() => c.invalidateQueries({ queryKey: [_] }), 800)));
        },
        A = Q.channel('admin_users_realtime')
          ...
          .subscribe((_, E) => {
            E && console.error('Realtime subscription error:', E);
          });
      return () => {
        (Object.values(s).forEach((_) => clearTimeout(_)), Q.removeChannel(A));
      };
    }, [c]);
    const H = ze({
        mutationFn: async (s) => {
          ...
          const v = {
              ...
              rol: s.rol,
              activo: s.activo,
              es_admin_delegado: s.es_admin_delegado,
              password: ((E = s.password) == null ? void 0 : E.trim()) || null
            },
            { data: A, error: _ } = await Q.rpc('guardar_usuario', { p: v });
          if (_) throw _;
          if (A && A.ok === !1) throw new Error(A.error || 'No se pudo guardar');
          return A;
        },
        onSuccess: () => {
          (c.invalidateQueries({ queryKey: ['admin_users'] }),
            g.success(`Usuario ${b ? 'actualizado' : 'creado'} exitosamente`, { style: ds }),
            L(!1));
        },
        onError: (s) => g.error('Error al guardar usuario: ' + s.message, { style: xs })
      }),
      Ae = ze({
        mutationFn: async (s) => {
          const { error: v } = await Q.rpc('eliminar_usuario_completo', { p_id: s });
          if (v) throw v;
        },
        onSuccess: () => {
          (c.invalidateQueries({ queryKey: ['admin_users'] }),
            g.success('Usuario eliminado (cuenta, accesos y rastros anonimizados)'));
        },
        onError: (s) => g.error('Error al eliminar: ' + s.message)
      }),
      B = ze({
        mutationFn: async ({ ids: s, accion: v, valor: A = null }) => {
          const { data: _, error: E } = await Q.rpc('usuarios_bulk', {
            p_ids: s,
            p_accion: v,
            p_valor: A
          });
        ...
        onSuccess: (s, v) => {
          ...
          const A =
            ...
            }[v.accion] || 'actualizado(s)';
          (g.success(`${(s == null ? void 0 : s.n) ?? v.ids.length} usuario(s) ${A}`, {
            style: ds
          }),
            v.accion !== '__toggle' && (D(new Set()), y('')));
        },
        onError: (s) => g.error('Error en la acción: ' + s.message, { style: xs })
      }),
      de = (s = null) => {
        (T(s),
          f(!1),
          k({
            nombre: (s == null ? void 0 : s.nombre) || '',
            email: (s == null ? void 0 : s.email) || '',
            password: '',
            rol: (s == null ? void 0 : s.rol) || '',
            activo: s ? s.activo : !0,
            es_admin_delegado: (s == null ? void 0 : s.es_admin_delegado) || !1
          }),
          L(!0));
      },
      Ge = (s) => {
        if ((s.preventDefault(), !o.nombre || !o.email || !o.rol)) {
          g.error('Completa los campos requeridos');
          return;
        }
        H.mutate(o);
      },
      fe = (s) => {
        window.confirm('¿Eliminar este usuario permanentemente?') && Ae.mutate(s);
      },
      Ne = (s, v) => {
        (v == null || v.stopPropagation(),
          B.mutate({ ids: [s.id], accion: s.activo ? 'desactivar' : 'activar' }));
      },
      we = (s, v) => {
        (v == null || v.stopPropagation(),
          D((A) => {
      ...
      V = Se.useMemo(() => {
        const s = I.filter((_) => {
            ...
            const E =
                !t ||
                ((a = _.nombre) == null ? void 0 : a.toLowerCase().includes(t.toLowerCase())) ||
                ((u = _.email) == null ? void 0 : u.toLowerCase().includes(t.toLowerCase())),
              U = !w || _.rol === w,
              ue = !h || (h === 'active' ? _.activo : !_.activo);
            return E && U && ue;
          }),
          v = (_) => {
            var E;
            return ((E = O[_.rol]) == null ? void 0 : E.nombre) || _.rol || '';
          },
          A =
            {
              recientes: (_, E) => new Date(E.created_at) - new Date(_.created_at),
              nombre: (_, E) => (_.nombre || '').localeCompare(E.nombre || ''),
              rol: (_, E) => v(_).localeCompare(v(E)),
              ultimo: (_, E) => new Date(E.last_seen || 0) - new Date(_.last_seen || 0),
              estado: (_, E) => Number(E.activo) - Number(_.activo)
            }[S] || (() => 0);
        return [...s].sort(A);
      }, [I, t, w, h, S, O]),
      K = V.map((s) => s.id),
      ye = K.length > 0 && K.every((s) => C.has(s)),
      Ee = () => {
        D((s) => {
          const v = new Set(s);
          return (ye ? K.forEach((A) => v.delete(A)) : K.forEach((A) => v.add(A)), v);
        });
      },
      xe = (s, v = null) => {
        const A = [...C];
        A.length !== 0 &&
          ((s === 'eliminar' &&
            !window.confirm(
              `¿Eliminar ${A.length} usuario(s) permanentemente? Esta acción no se puede deshacer.`
            )) ||
            B.mutate({ ids: A, accion: s, valor: v }));
      },
      me = Se.useMemo(
        () => ({
          total: I.length,
          active: I.filter((s) => s.activo).length,
          admins: I.filter((s) => {
            var v;
            return (
              ((v = s.rol) == null ? void 0 : v.toUpperCase()) === 'ADMIN' || s.es_admin_delegado
            );
          }).length,
          supervisors: I.filter((s) => {
            var v;
            return ((v = s.rol) == null ? void 0 : v.toUpperCase()) === 'SUPERVISOR';
          }).length
        }),
        [I]
      ),
      _e = (s) => {
        switch (s == null ? void 0 : s.toUpperCase()) {
          case 'ADMIN':
      ...
      Re = (s) => {
        switch (s == null ? void 0 : s.toUpperCase()) {
          case 'ADMIN':
            return e.jsx(ke, { size: 14 });
          case 'SUPERVISOR':
            return e.jsx(Be, { size: 14 });
          case 'OPERADOR':
            return e.jsx(Js, { size: 14 });
          default:
            return e.jsx(X, { size: 14 });
        }
      },
      pe = ({ icon: s, label: v, value: A, glowColor: _ }) =>
        e.jsxs('div', {
          className:
            'bg-white backdrop-blur-xl rounded-2xl p-3 sm:p-5 border border-slate-200 relative overflow-hidden group',
          children: [
            e.jsx('div', {
              className: `absolute top-0 right-0 w-24 h-24 bg-${_}-500/10 rounded-full blur-2xl group-hover:bg-${_}-500/20 transition-all`
            }),
            e.jsxs('div', {
              className: 'flex items-center gap-2 sm:gap-4 relative z-10',
              children: [
                e.jsx('div', {
                  className: `p-2 sm:p-4 rounded-xl bg-slate-50 border border-slate-200 text-${_}-400 shadow-sm`,
                  children: s
                }),
                e.jsxs('div', {
                  className: 'min-w-0',
    ...
    return e.jsxs('div', {
      ...
      children: [
                  ...
                  e.jsxs('h1', {
                    ...
                    children: [
                      e.jsx('div', {
                        ...
                        children: e.jsx(X, { className: 'text-orange-400', size: 28 })
                      }),
                      'Control de ',
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsx('button', {
                  ...
                  children: e.jsx(le, {
                    size: 20,
                    className: ve ? 'animate-spin text-orange-400' : ''
                  })
                }),
                e.jsxs('button', {
                  onClick: () => de(),
                  ...
                  children: [e.jsx(Us, { size: 20 }), ' Nuevo Usuario']
                })
              ]
            })
          ]
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsx(pe, {
              icon: e.jsx(X, { size: 24 }),
              label: 'Total Usuarios',
              value: me.total,
              glowColor: 'orange'
            }),
            e.jsx(pe, {
              icon: e.jsx(ys, { size: 24 }),
              label: 'Activos',
              value: me.active,
              glowColor: 'emerald'
            }),
            e.jsx(pe, {
              icon: e.jsx(ke, { size: 24 }),
              label: 'Admins',
              value: me.admins,
              glowColor: 'rose'
            }),
            e.jsx(pe, {
              icon: e.jsx(Be, { size: 24 }),
              label: 'Supervisores',
              value: me.supervisors,
              glowColor: 'amber'
            })
          ]
        }),
              ...
              children: [
                e.jsxs('select', {
                  ...
                  children: [
                    ...
                    j.map((s) => e.jsx('option', { value: s.id, children: s.nombre }, s.id))
                  ]
                }),
                e.jsxs('select', {
                  className:
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsx('button', {
                      onClick: () => p('cards'),
                      title: 'Tarjetas',
                      className: `p-2 rounded-lg transition-colors ${N === 'cards' ? 'bg-orange-600 text-white' : 'text-slate-400 hover:text-slate-700'}`,
                      children: e.jsx(Fs, { size: 18 })
                    }),
                    e.jsx('button', {
                      onClick: () => p('table'),
                      title: 'Tabla',
                      className: `p-2 rounded-lg transition-colors ${N === 'table' ? 'bg-orange-600 text-white' : 'text-slate-400 hover:text-slate-700'}`,
                      children: e.jsx(Gs, { size: 18 })
                    })
                  ]
                })
              ]
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('span', {
                ...
                children: [C.size, ' seleccionado(s)']
              }),
              e.jsx('button', {
                onClick: M,
              ...
              e.jsxs('button', {
                ...
                children: [e.jsx(_s, { size: 14 }), ' Activar']
              }),
              e.jsxs('button', {
                onClick: () => xe('desactivar'),
                disabled: B.isPending,
                className:
                ...
                children: [e.jsx(ks, { size: 14 }), ' Desactivar']
              }),
              e.jsx('div', {
                ...
                children: e.jsxs('select', {
                  ...
                  children: [
                    ...
                    j.map((s) =>
                      e.jsx(
                        'option',
                        { value: s.id, className: 'text-slate-900', children: s.nombre },
                        s.id
                      )
                    )
                  ]
              ...
              e.jsxs('button', {
                ...
                children: [e.jsx(te, { size: 14 }), ' Eliminar']
              }),
              B.isPending && e.jsx(je, { size: 16, className: 'animate-spin' })
            ]
          }),
        e.jsxs('div', {
          className:
          ...
          children: [
            e.jsxs('span', { children: [V.length, ' de ', I.length, ' usuarios'] }),
            V.length > 0 &&
              e.jsxs('button', {
                onClick: Ee,
                className:
                ...
                children: [
                  ye ? e.jsx($e, { size: 15 }) : e.jsx(Pe, { size: 15 }),
                  ' Seleccionar todos'
                ]
              })
          ]
                ...
                ? e.jsxs('div', {
                    ...
                    children: [
                      e.jsx('div', {
                        ...
                        children: e.jsx(Te, { size: 48, className: 'text-slate-500' })
                      }),
                      e.jsx('h3', {
                                ...
                                children: [
                                  e.jsx('th', {
                                    ...
                                    children: e.jsx('button', {
                                      onClick: Ee,
                                      children: ye
                                        ? e.jsx($e, { size: 16, className: 'text-orange-600' })
                                        : e.jsx(Pe, { size: 16, className: 'text-slate-300' })
                                    })
                                  }),
                            ...
                            e.jsx('tbody', {
                              children: V.map((s) => {
                                ...
                                return e.jsxs(
                                  'tr',
                                  {
                                    className: `border-b border-slate-100 last:border-0 transition-colors ${v ? 'bg-orange-50/60' : 'hover:bg-slate-50'}`,
                                    children: [
                                      e.jsx('td', {
                                        className: 'p-3',
                                        children: e.jsx('button', {
                                      ...
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('div', {
                                          ...
                                          children: [
                                            e.jsx('div', {
                                              className: `w-8 h-8 rounded-lg flex items-center justify-center font-black text-xs shrink-0 ${_e(s.rol)}`,
                                              children:
                                                (A = s.nombre) == null
                                                  ? void 0
                                            ...
                                            e.jsxs('div', {
                                              ...
                                              children: [
                                                e.jsxs('div', {
                                                  ...
                                                  children: [
                                                    s.nombre,
                                                    (s.rol === 'ADMIN' || s.es_admin_delegado) &&
                                                      e.jsx(ke, {
                                                        size: 12,
                                      ...
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('span', {
                                          className: `inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border text-xs font-bold ${_e(s.rol)}`,
                                          children: [
                                            Re(s.rol),
                                            ((_ = O[s.rol]) == null ? void 0 : _.nombre) || s.rol
                                          ]
                                        })
                                      }),
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('button', {
                                          ...
                                          className: `inline-flex items-center gap-1.5 px-2 py-1 rounded-lg text-[11px] font-black border transition-colors ${s.activo ? 'bg-emerald-50 text-emerald-600 border-emerald-200 hover:bg-emerald-100' : 'bg-slate-100 text-slate-400 border-slate-200 hover:bg-slate-200'}`,
                                          children: [
                                            e.jsx('span', {
                                              className: `w-1.5 h-1.5 rounded-full ${s.activo ? 'bg-emerald-500' : 'bg-slate-400'}`
                                            }),
                                      ...
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('span', {
                                          ...
                                          children: [
                                            e.jsx(Me, { size: 12, className: 'text-slate-300' }),
                                            ms(s.last_seen)
                                          ]
                                        })
                                      }),
                  ...
                  : e.jsx('div', {
                      ...
                      children: V.map((s) => {
                        ...
                        return e.jsxs(
                          'div',
                          {
                            className: `group bg-white backdrop-blur-md rounded-3xl border shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden relative ${v ? 'border-orange-400 ring-2 ring-orange-200' : 'border-slate-200 hover:border-slate-600'}`,
                            children: [
                              e.jsx('div', {
                                className: `h-24 w-full absolute top-0 left-0 transition-colors ${s.activo ? 'bg-gradient-to-b from-orange-500/10 to-transparent' : 'bg-slate-100'}`
                              }),
                              e.jsx('button', {
                                onClick: (E) => we(s.id, E),
                                className:
                                ...
                                children: v
                                  ? e.jsx($e, { size: 18, className: 'text-orange-600' })
                                  : e.jsx(Pe, { size: 18, className: 'text-slate-300' })
                              }),
                              e.jsxs('div', {
                      ...
                      ${s.rol === 'ADMIN' ? 'bg-rose-500/20 border-rose-500/30 text-rose-400' : s.rol === 'SUPERVISOR' ? 'bg-amber-500/20 border-amber-500/30 text-amber-400' : 'bg-orange-500/20 border-orange-500/30 text-orange-400'}`,
                                        children:
                                          (A = s.nombre) == null
                                            ? void 0
                                            : A.charAt(0).toUpperCase()
                                      ...
                                      e.jsxs('div', {
                                        ...
                                        children: [
                                          e.jsx('button', {
                                            onClick: (E) => Ne(s, E),
                                            title: s.activo ? 'Desactivar' : 'Activar',
                                            className: `px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border transition-colors ${s.activo ? 'bg-emerald-50 text-emerald-600 border-emerald-200 hover:bg-emerald-100' : 'bg-slate-100 text-slate-500 border-slate-200 hover:bg-slate-200'}`,
                                            children: s.activo ? 'Activo' : 'Inactivo'
                                          }),
                                          (s.rol === 'ADMIN' || s.es_admin_delegado) &&
                                            e.jsx('span', {
                                              className: `p-1.5 rounded-lg border ${s.es_admin_delegado ? 'bg-amber-500/10 border-amber-500/20 text-amber-400' : 'bg-rose-500/10 border-rose-500/20 text-rose-400'}`,
                                              title: s.es_admin_delegado
                                  ...
                                  e.jsx('div', {
                                    ...
                                    children: e.jsxs('div', {
                                      className: `flex-1 flex items-center gap-2 px-3 py-2 rounded-xl border ${_e(s.rol)}`,
                                      children: [
                                        Re(s.rol),
                                        e.jsx('span', {
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Le, { size: 16 }), ' Editar']
                                      }),
                                      e.jsx('button', {
                                        onClick: () => fe(s.id),
                                        className:
                    ...
                    e.jsxs('div', {
                      children: [
                        e.jsx('h2', {
                          ...
                          children: b ? 'Editar Perfil' : 'Nuevo Usuario'
                        }),
                        e.jsx('p', {
                      ...
                      children: [
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: o.nombre,
                                  onChange: (s) => k({ ...o, nombre: s.target.value })
                                })
                              ]
                            })
                          ]
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: o.email,
                                  onChange: (s) => k({ ...o, email: s.target.value })
                                })
                              ]
                            })
                          ]
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            e.jsx('label', {
                              className:
                                'block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2',
                              children: b ? 'Nueva Contraseña (Opcional)' : 'Contraseña Inicial'
                            }),
                            e.jsxs('div', {
                              className: 'relative',
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: o.password,
                                  onChange: (s) => k({ ...o, password: s.target.value }),
                                  placeholder: b ? '••••••••' : 'Mínimo 6 caracteres'
                                }),
                                e.jsx('button', {
                                  type: 'button',
                                  onClick: () => f(!R),
                                  ...
                                  children: R ? e.jsx(Bs, { size: 20 }) : e.jsx(Ks, { size: 20 })
                                })
                              ]
                            })
                          ]
                          ...
                          children: [
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    e.jsxs('select', {
                                      ...
                                      value: o.rol,
                                      onChange: (s) => k({ ...o, rol: s.target.value }),
                                      children: [
                                        e.jsx('option', {
                                          value: '',
                                          disabled: !0,
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsxs('div', {
                                  onClick: () => k({ ...o, activo: !o.activo }),
                                  className: `h-[52px] w-full rounded-xl flex items-center px-4 cursor-pointer transition-all border ${o.activo ? 'bg-emerald-50 border-emerald-200' : 'bg-slate-50 border-slate-200'}`,
                                  children: [
                                    e.jsx('div', {
                                      className: `w-12 h-6 rounded-full relative transition-colors ${o.activo ? 'bg-emerald-500' : 'bg-slate-200'}`,
                                      children: e.jsx('div', {
                                        className: `absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform shadow-sm ${o.activo ? 'translate-x-6' : 'translate-x-0'}`
                                      })
                                    }),
                                    e.jsx('span', {
                                      className: `ml-3 font-bold text-sm ${o.activo ? 'text-emerald-600' : 'text-slate-500'}`,
                                      children: o.activo ? 'Activo' : 'Inactivo'
                                    })
                                  ]
                                })
                              ]
                        ...
                        o.rol &&
                          (() => {
                            ...
                            const s = O[o.rol];
                            if (!s) return null;
                            const v = s.permisos_json || [],
                              { modulos: A } = ws(v),
                              _ =
                                ((E = He.find((U) => U.value === s.landing_page)) == null
                                  ? void 0
                                  : E.label) || s.landing_page;
                            return e.jsxs('div', {
                              className:
                                  ...
                                  children: [
                                    A.map((U) =>
                                      e.jsxs(
                                        'span',
                                        {
                                          title: U.rutas.map((ue) => ue.label).join(`
`),
                                          className: `px-2 py-0.5 rounded-md border font-bold ${U.soloAdmin ? 'bg-orange-50 text-orange-600 border-orange-200' : 'bg-white text-orange-700 border-orange-200'}`,
                                          children: [U.label, ' · ', U.rutas.length]
                                        },
                                        U.id
                                      )
                                    ),
                                ...
                                _ &&
                                  e.jsxs('div', {
                                    ...
                                    children: ['Página de inicio: ', e.jsx('b', { children: _ })]
                                  }),
                                A.some((U) => U.soloAdmin) &&
                                  e.jsx('div', {
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('div', {
                                      ...
                                      className: `w-10 h-5 rounded-full relative cursor-pointer transition-colors ${o.es_admin_delegado ? 'bg-amber-500' : 'bg-slate-200'}`,
                                      children: e.jsx('div', {
                                        className: `absolute top-0.5 left-0.5 bg-white w-4 h-4 rounded-full transition-transform shadow-sm ${o.es_admin_delegado ? 'translate-x-5' : 'translate-x-0'}`
                                      })
                                    })
                                  ]
                                }),
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsxs('button', {
                          ...
                          children: [
                            H.isPending
                              ? e.jsx(je, { className: 'animate-spin', size: 20 })
                              : e.jsx(Cs, { size: 20 }),
                            H.isPending ? 'Guardando...' : 'Confirmar Cambios'
                          ]
                        })
                      ]
                    })
  ...
  Z = (l) => {
    var c, x;
    return (
      ((x = (c = as.find((m) => m.id === l)) == null ? void 0 : c.permissions) == null
        ? void 0
        : x.map((m) => m.id)) || []
    );
  },
  ee = (l) => Array.from(new Set(l)),
  Wa = ee(as.flatMap((l) => l.permissions.map((c) => c.id))),
  Ha = [
  ...
  et = Object.fromEntries(Za.map((l) => [l.id, l]));
function Ke(l) {
  return et[l] || null;
}
(Z('inventario'),
  ...
  Z('admin'));
const st = {
    dashboard: e.jsx(sa, { size: 16 }),
    tms: e.jsx(ea, { size: 16 }),
    inbound: e.jsx(Zs, { size: 16 }),
    outbound: e.jsx(Xs, { size: 16 }),
    queries: e.jsx(Te, { size: 16 }),
    analytics: e.jsx(Ys, { size: 16 }),
    quality: e.jsx(Fe, { size: 16 }),
    admin: e.jsx(Hs, { size: 16 })
  },
  ps = as.map((l) => ({ ...l, icon: st[l.id] || e.jsx(ie, { size: 16 }) })),
  re = ({ embedded: l = !1 }) => {
    const { refreshPermissions: c } = Ue(),
      x = Ns(),
      m = Se.useRef(),
      [t, d] = n.useState(null),
      [w, i] = n.useState(!1),
      [h, z] = n.useState(!1),
      { data: S = [], isLoading: r } = Oe({
        queryKey: ['admin_roles'],
        queryFn: async () => {
          const { data: o, error: k } = await Q.from('tms_roles').select('*').order('nombre');
          if (k) throw k;
          const { data: R } = await Q.from('tms_usuarios').select('rol'),
            f = {};
          return (
            (R || []).forEach((j) => {
              f[j.rol] = (f[j.rol] || 0) + 1;
            }),
            o.map((j) => ({ ...j, usuarios: f[j.id] || 0, permisos: j.permisos_json || [] }))
          );
        }
      }),
      N = ze({
        mutationFn: async (o) => {
          const k = h ? o.nombre.toUpperCase().replace(/\s+/g, '_') : o.id,
            R = o.id === 'ADMIN' ? 'Administrador' : o.nombre,
            { error: f } = await Q.from('tms_roles').upsert(
              {
                id: k,
                nombre: R,
                descripcion: o.descripcion,
                landing_page: o.landing_page || null,
                permisos_json: o.permisos || []
              },
              { onConflict: 'id' }
            );
          if (f) throw f;
        ...
        onSuccess: async () => {
          (await x.invalidateQueries({ queryKey: ['admin_roles'] }),
            await c(),
            g.success('Rol guardado exitosamente'),
            i(!1),
            z(!1));
        },
        onError: (o) => {
          g.error(`Error al guardar: ${o.message}`);
        }
      }),
      p = ze({
        mutationFn: async (o) => {
          const { error: k } = await Q.from('tms_roles').delete().eq('id', o);
          if (k) throw k;
        },
        onSuccess: async () => {
          (await x.invalidateQueries({ queryKey: ['admin_roles'] }),
            await c(),
            g.success('Rol eliminado'),
            d(null));
        },
        onError: (o) => {
          g.error(`Error al eliminar: ${o.message}`);
        }
      }),
      { data: C = [] } = Oe({
        queryKey: ['rol_usuarios', (t == null ? void 0 : t.id) || ''],
        enabled: !!(t != null && t.id),
        queryFn: async () => {
          const { data: o } = await Q.from('tms_usuarios')
      ...
      P = () => {
        ...
        o &&
          ...
          g.success(`Plantilla oficial cargada para ${o.id}`));
      },
      L = (o) => {
        confirm('¿Eliminar este rol?') && p.mutate(o);
      },
      b = (o) => {
        w &&
          d((k) => {
            const R = k.permisos || [],
              f = R.includes(o) ? R.filter((j) => j !== o) : [...R, o];
            return { ...k, permisos: f };
          });
      },
      T = (o) => {
        if (!w) return;
        const R = ps.find((f) => f.id === o).permissions.map((f) => f.id);
        d((f) => {
          const j = f.permisos || [],
            O = R.every((I) => j.includes(I))
              ? j.filter((I) => !R.includes(I))
              : [...new Set([...j, ...R])];
          return { ...f, permisos: O };
        });
      };
    return r
      ? e.jsx('div', {
          ...
          children: e.jsx(je, { className: 'animate-spin text-emerald-500', size: 40 })
        })
      : e.jsxs('div', {
          ref: m,
          className: l
                ...
                children: [
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        ...
                        children: [
                          e.jsx(ie, { size: 24, className: 'sm:hidden', strokeWidth: 2.5 }),
                          e.jsx(ie, { size: 32, className: 'hidden sm:block', strokeWidth: 2.5 })
                        ]
                      }),
                      e.jsxs('div', {
                        className: 'min-w-0',
                  ...
                  !t &&
                    ...
                    e.jsxs('button', {
                      ...
                      children: [e.jsx(Y, { size: 24 }), ' Nuevo Rol']
                    })
                ]
              }),
            e.jsx('div', {
                            ...
                            'div',
                            {
                              ...
                              children: [
                                e.jsx('div', {
                                  ...
                                  children: e.jsx(ie, { size: 80, className: 'text-emerald-600' })
                                }),
                                e.jsxs('div', {
                                  className: 'flex justify-between items-start mb-6 relative z-10',
                                  children: [
                                    e.jsx('div', {
                                      className: `w-14 h-14 rounded-2xl flex items-center justify-center ${o.id === 'ADMIN' ? 'bg-orange-50 text-orange-600 border border-orange-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'}`,
                                      children:
                                        o.id === 'ADMIN'
                                          ? e.jsx(Ye, { size: 28 })
                                          : e.jsx(X, { size: 28 })
                                ...
                                e.jsx('p', {
                                  ...
                                  children: o.descripcion || 'Sin descripción'
                                }),
                                e.jsxs('div', {
                                  className:
                                  ...
                                  children: [
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        e.jsx(ie, { size: 16, className: 'text-emerald-500/50' }),
                                        ((k = o.permisos) == null ? void 0 : k.length) || 0,
                                        ' permisos'
                                      ]
                                    }),
                                    e.jsxs('span', {
                                      ...
                                      children: ['Editar ', e.jsx(Le, { size: 16 })]
                                    })
                                  ]
                                })
                              ]
                        ...
                        e.jsxs('button', {
                          ...
                          children: [
                            e.jsx('div', {
                              ...
                              children: e.jsx(Y, { size: 40, strokeWidth: 3 })
                            }),
                            e.jsx('span', {
                                        ...
                                        children: [
                                          ...
                                          e.jsxs('div', {
                                            ...
                                            children: [
                                              ...
                                              e.jsx('input', {
                                                ...
                                                value: t.descripcion || '',
                                                onChange: (o) =>
                                                  d({ ...t, descripcion: o.target.value }),
                                                className:
                                          ...
                                          e.jsxs('div', {
                                            ...
                                            children: [
                                              ...
                                              e.jsxs('select', {
                                                value: t.landing_page || '',
                                                onChange: (o) =>
                                                  d({ ...t, landing_page: o.target.value }),
                                                className:
                                              ...
                                              h &&
                                                ...
                                                e.jsxs('p', {
                                                  ...
                                                  children: [
                                                    'ID del rol: ',
                                                    t.nombre.toUpperCase().replace(/\s+/g, '_')
                                                  ]
                                                })
                                            ]
                                          })
                                            ...
                                            children: [
                                              ...
                                              t.id === 'ADMIN' &&
                                                e.jsxs('span', {
                                                  ...
                                                  children: [
                                                    e.jsx(Ye, { size: 12, strokeWidth: 3 }),
                                                    ' Sistema'
                                                  ]
                                                })
                                            ]
                              ...
                              children: w
                                    ...
                                    children: [
                                      Ke(t == null ? void 0 : t.id) &&
                                        e.jsxs('button', {
                                          ...
                                          children: [e.jsx(Xe, { size: 20 }), ' Cargar Plantilla']
                                        }),
                                      e.jsx('button', {
                                        onClick: () => {
                                          (i(!1), z(!1), h && d(null));
                                      ...
                                      e.jsxs('button', {
                                        ...
                                        children: [
                                          N.isPending
                                            ? e.jsx(je, { className: 'animate-spin', size: 20 })
                                            : e.jsx(Cs, { size: 20 }),
                                          N.isPending ? 'Guardando...' : 'Guardar Cambios'
                                        ]
                                      })
                                    ]
                                  })
                                : e.jsxs(e.Fragment, {
                                    children: [
                                      e.jsx('button', {
                                        onClick: () => L(t.id),
                                        disabled: t.id === 'ADMIN' || t.usuarios > 0,
                                        className:
                                      ...
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Le, { size: 20 }), ' Editar Permisos']
                                      })
                                    ]
                                  })
                            })
                        ...
                        e.jsx('div', {
                          ...
                          children: e.jsxs('div', {
                            ...
                            children: [
                              (() => {
                                var R;
                                const { modulos: o } = ws(t.permisos || []),
                                  k =
                                    (R = He.find((f) => f.value === t.landing_page)) == null
                                      ? void 0
                                      : R.label;
                                return e.jsxs('div', {
                                          ...
                                          children: [
                                            o.map((f) =>
                                              e.jsxs(
                                                'span',
                                                {
                                                  title: f.rutas.map((j) => j.label).join(`
`),
                                    ...
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        e.jsxs('h4', {
                                          className:
                                            'text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3',
                                          children: ['Usuarios con este rol (', C.length, ')']
                                        }),
                                        e.jsxs('div', {
                                          className:
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('h3', {
                                    ...
                                    children: [
                                      e.jsx(ie, { size: 20, className: 'text-emerald-500' }),
                              ...
                              e.jsx('div', {
                                ...
                                children: ps.map((o) => {
                                  const k = o.permissions.map(($) => $.id),
                                    R = k.filter(($) => {
                                      var O;
                                      return (O = t.permisos) == null ? void 0 : O.includes($);
                                    }).length,
                                    f = R === k.length,
                                    j = R === 0;
                                  return e.jsxs(
                                    'div',
                                    {
                                      ...
                                      children: [
                                        e.jsxs('div', {
                                          ...
                                          children: [
                                            e.jsxs('div', {
                                              ...
                                              children: [
                                                e.jsx('div', {
                                                  className: `p-3 rounded-2xl transition-all ${f ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20' : j ? 'bg-white text-slate-300 border border-slate-100' : 'bg-orange-50 text-orange-500 border border-orange-100'}`,
                                                  children: o.icon
                                                }),
                                                e.jsxs('div', {
                                                  children: [
                                                    ...
                                                    !w &&
                                                      e.jsxs('span', {
                                                        ...
                                                        children: [R, ' de ', k.length, ' activos']
                                                      })
                                                  ]
                                                })
                                              ]
                                        ...
                                        e.jsx('div', {
                                          ...
                                          children: o.permissions.map(($) => {
                                            var I;
                                            const O =
                                              (I = t.permisos) == null ? void 0 : I.includes($.id);
                                            return e.jsxs(
                                              'div',
                                              {
                                                role: 'checkbox',
                                                ...
                                                children: [
                                                  e.jsx('div', {
                                                    className: `mt-0.5 w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${O ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'bg-white border-slate-200'}`,
                                                    children:
                                                      O && e.jsx(Fe, { size: 14, strokeWidth: 4 })
                                                  }),
                                                  e.jsx('div', {
                                                    children: e.jsx('span', {
                                                      className: `text-sm block leading-tight tracking-tight ${O ? 'text-slate-900 font-black' : 'text-slate-500 font-bold'}`,
                                                      children: $.label
                                                    })
                                                  })
                                                ]
...
function ne({ filas: l = 5 }) {
  return e.jsx('div', {
    className: 'divide-y divide-slate-100',
    'aria-busy': 'true',
    'aria-label': 'Cargando',
    children: Array.from({ length: l }).map((c, x) =>
      e.jsxs(
        'div',
        {
...
function ce({ mensaje: l, onRetry: c }) {
  return e.jsxs('div', {
    className: 'py-12 text-center px-4',
    children: [
      e.jsx(Ss, { size: 28, className: 'mx-auto text-red-400 mb-2' }),
      ...
      c &&
        e.jsxs('button', {
          ...
          children: [e.jsx(le, { size: 14 }), ' Reintentar']
        })
    ]
  });
}
function W({ children: l }) {
  return e.jsxs('div', {
    className: 'py-12 text-center text-slate-400 text-sm px-4 flex flex-col items-center gap-2',
    children: [e.jsx(aa, { size: 26, className: 'text-slate-300' }), e.jsx('span', { children: l })]
  });
}
const us = [
  ...
  Ce = 'text-[11px] font-bold text-slate-500 uppercase tracking-wide';
function at() {
  const { hasPermission: l, user: c } = Ue(),
    x =
      l('manage_roles') ||
      (c == null ? void 0 : c.rol) === 'ADMIN' ||
      (c == null ? void 0 : c.es_admin_delegado),
    [m, t] = n.useState({ usuarios: [], roles: [], centros_costo: [] }),
    [d, w] = n.useState([]),
    [i, h] = n.useState(!0),
    [z, S] = n.useState(null),
    [r, N] = n.useState({
    ...
    D = n.useCallback(async () => {
      (h(!0), S(null));
      try {
        const [b, T] = await Promise.all([rs(), ba()]);
        (t(b), w(T));
      } catch (b) {
        S(b.message || 'No se pudo cargar');
      } finally {
        h(!1);
      }
    }, []);
  ...
  const q = n.useMemo(
      () => (r.scopeType === 'centro_costo' ? m.centros_costo || [] : []),
      [r.scopeType, m.centros_costo]
    ),
    y = async () => {
      if (!r.userId || !r.role || !r.scopeCode) {
        g.error('Usuario, rol y código de ámbito son obligatorios');
        return;
      }
      C(!0);
      const b = await ga(r.userId, r.role, r.scopeType, r.scopeCode, r.expires || null);
      (C(!1),
        b != null && b.ok
          ? (g.success(b.accion === 'actualizado' ? 'Asignación actualizada' : 'Ámbito asignado'),
            N({ ...r, scopeCode: '', expires: '' }),
            D())
          : g.error((b == null ? void 0 : b.error) || 'Error al asignar'));
    },
    P = async (b) => {
      if (!window.confirm('¿Revocar esta asignación con ámbito?')) return;
      const T = await ha(b);
      T != null && T.ok
        ? (g.success('Revocada'), w((o) => o.filter((k) => k.id !== b)))
        : g.error((T == null ? void 0 : T.error) || 'Error');
    },
    L = (b) => {
      var T;
      return ((T = us.find((o) => o.id === b)) == null ? void 0 : T.label) || b;
    };
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsx(ta, { size: 18, className: 'text-sky-500 shrink-0 mt-0.5' }),
          e.jsxs('p', {
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                e.jsx(Y, { size: 15, className: 'text-orange-500' }),
                e.jsx('h3', {
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('label', {
                  className: 'block',
                  children: [
                    e.jsx('span', { className: Ce, children: 'Usuario' }),
                    e.jsxs('select', {
                      value: r.userId,
                      onChange: (b) => N({ ...r, userId: b.target.value }),
                      className: `${be} mt-1`,
                      children: [
                        ...
                        m.usuarios.map((b) =>
                          e.jsxs(
                            'option',
                            { value: b.id, children: [b.nombre, ' · ', b.correo] },
                            b.id
                          )
                        )
                      ]
                ...
                e.jsxs('label', {
                  className: 'block',
                  children: [
                    e.jsx('span', { className: Ce, children: 'Rol' }),
                    e.jsxs('select', {
                      value: r.role,
                      onChange: (b) => N({ ...r, role: b.target.value }),
                      className: `${be} mt-1`,
                      children: [
                        e.jsx('option', { value: '', children: '—' }),
                        m.roles.map((b) =>
                          e.jsxs(
                            'option',
                            { value: b.codigo, children: [b.codigo, ' · ', b.nombre] },
                            b.codigo
                          )
                        )
                      ]
                ...
                e.jsxs('label', {
                  className: 'block',
                  children: [
                    e.jsx('span', { className: Ce, children: 'Eje' }),
                    e.jsx('select', {
                      value: r.scopeType,
                      onChange: (b) => N({ ...r, scopeType: b.target.value, scopeCode: '' }),
                      className: `${be} mt-1`,
                      children: us.map((b) =>
                        e.jsx('option', { value: b.id, children: b.label }, b.id)
                      )
                    })
                  ]
                }),
                e.jsxs('label', {
                  className: 'block',
                  children: [
                    e.jsx('span', { className: Ce, children: 'Código de ámbito' }),
                    q.length > 0
                      ? e.jsxs('select', {
                          value: r.scopeCode,
                          onChange: (b) => N({ ...r, scopeCode: b.target.value }),
                          className: `${be} mt-1`,
                          children: [
                            e.jsx('option', { value: '', children: '—' }),
                            q.map((b) => e.jsx('option', { value: b, children: b }, b))
                          ]
                        })
                      : e.jsx('input', {
                          value: r.scopeCode,
                          onChange: (b) => N({ ...r, scopeCode: b.target.value.trim() }),
                          placeholder: 'código',
                          className: `${be} mt-1`
                        })
                  ]
                ...
                e.jsxs('label', {
                  className: 'block',
                  children: [
                    e.jsx('span', { className: Ce, children: 'Expira (opcional)' }),
                    e.jsx('input', {
                      type: 'date',
                      value: r.expires,
                      onChange: (b) => N({ ...r, expires: b.target.value }),
                      className: `${be} mt-1`
                    })
                  ]
                })
            ...
            e.jsx('div', {
              ...
              children: e.jsxs('button', {
                ...
                children: [e.jsx(Y, { size: 16 }), ' ', p ? 'Asignando…' : 'Asignar ámbito']
              })
            })
          ]
        }),
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [e.jsx(Xe, { size: 12 }), ' Asignaciones con ámbito (', d.length, ')']
          }),
          i
            ? e.jsx(ne, {})
            : z
              ? e.jsx(ce, { mensaje: z, onRetry: D })
              : d.length === 0
                ? e.jsx(W, {
                    ...
                    children: d.map((b) =>
                      e.jsxs(
                        'div',
                        {
                          ...
                          children: [
                            e.jsx(zs, { size: 15, className: 'text-slate-300 shrink-0' }),
                            e.jsxs('div', {
                              className: 'min-w-0',
                              children: [
                                e.jsx('div', {
                            ...
                            e.jsxs('span', {
                              ...
                              children: [
                                e.jsx(qe, { size: 11, className: 'text-orange-500' }),
                                b.role
                              ]
                            }),
                            e.jsxs('span', {
                              ...
                              children: [
                                ...
                                L(b.scope_type),
                                ': ',
                                e.jsx('span', { className: 'font-mono', children: b.scope_code })
                              ]
                            }),
                            bs(b.expires_at) &&
                              e.jsxs('span', {
                                ...
                                children: [e.jsx(Me, { size: 10 }), ' expira ', bs(b.expires_at)]
                              }),
                            x &&
                              e.jsx('button', {
                                onClick: () => P(b.id),
...
const tt = (l) => {
  ...
  lt = (l = '') => /Android|iPhone|iPad|Mobile|CCO|Capacitor/i.test(l),
  rt = (l = '') =>
    /Android/i.test(l)
      ? 'Android'
      : /iPhone|iPad/i.test(l)
        ? 'iOS'
        : /Edg/i.test(l)
          ? 'Edge'
          : /Chrome/i.test(l)
...
function ot() {
  ...
  const z = async (r) => {
      if (
        !window.confirm(
          `¿Forzar el cierre de sesión de ${r.nombre}? Se revocarán sus sesiones activas.`
        )
      )
        return;
      i(r.auth_uid);
      const N = await va(r.auth_uid);
      (i(null),
        N != null && N.ok
          ? (g.success(`Sesión revocada (${N.revocadas || 0})`), h())
          : g.error((N == null ? void 0 : N.error) || 'Error'));
    },
    S = (r) => r.estado === 'online' || r.estado === 'conectado';
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [e.jsx(le, { size: 14 }), ' Actualizar']
          })
        ]
      }),
      e.jsx('div', {
        ...
        children: x
          ? e.jsx(ne, {})
          : t
            ? e.jsx(ce, { mensaje: t, onRetry: h })
            : l.length === 0
              ? e.jsx(W, { children: 'No hay sesiones activas.' })
              : e.jsx('div', {
                  className: 'divide-y divide-slate-100',
                  children: l.map((r) =>
                    e.jsxs(
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('div', {
                                ...
                                children: lt(r.user_agent)
                                  ? e.jsx(la, { size: 17 })
                                  : e.jsx(ra, { size: 17 })
                              }),
                              e.jsx(Es, {
                                size: 9,
                                className: `absolute -bottom-0.5 -right-0.5 rounded-full ${S(r) ? 'text-emerald-500 fill-emerald-500' : 'text-slate-300 fill-slate-300'}`
                              })
                            ]
                          }),
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  ' · visto',
                                  ' ',
                                  tt(r.refreshed_at || r.created_at)
                                ]
                              })
                            ]
                          }),
...
function ct(l, c) {
  const x = l || {},
    m = c || {},
    t = Array.from(new Set([...Object.keys(x), ...Object.keys(m)])).sort(),
    d = [];
  for (const w of t) {
    const i = x[w],
      h = m[w],
      z = i === void 0 ? void 0 : JSON.stringify(i),
      S = h === void 0 ? void 0 : JSON.stringify(h);
    z !== S &&
      d.push({
        k: w,
        tipo: z === void 0 ? 'add' : S === void 0 ? 'del' : 'mod',
        antes: z,
        despues: S
      });
  }
...
function dt({ r: l }) {
  const [c, x] = n.useState(!1),
    m = n.useMemo(() => (l.antes || l.despues ? ct(l.antes, l.despues) : []), [l]),
    t = nt[l.accion] || 'text-slate-600 bg-slate-50 border-slate-200';
  return e.jsxs('div', {
    className: 'text-[13px]',
    children: [
      e.jsxs('button', {
        ...
        children: [
          m.length > 0
            ? c
              ? e.jsx(Rs, { size: 14, className: 'text-slate-400 shrink-0' })
              : e.jsx($s, { size: 14, className: 'text-slate-400 shrink-0' })
            : e.jsx('span', { className: 'w-3.5 shrink-0' }),
          e.jsx('span', {
            className: `text-[10px] font-black rounded px-1.5 py-0.5 border shrink-0 ${t}`,
            children: l.accion
          }),
          e.jsx('span', {
          ...
          e.jsxs('span', {
            ...
            children: [
              'reg. ',
              e.jsx('span', { className: 'font-mono text-[11px]', children: l.registro_id || '—' })
            ]
          }),
          e.jsxs('span', {
            className: 'ml-auto text-slate-500 shrink-0 truncate max-w-[160px]',
            children: [l.actor, l.actor_rol ? ` · ${l.actor_rol}` : '']
          }),
          e.jsx('span', {
            ...
            children: m.map((d) =>
              e.jsxs(
                'div',
                {
                  ...
                  children: [
                    d.tipo === 'add'
                      ? e.jsx(Y, { size: 12, className: 'text-emerald-500 mt-0.5 shrink-0' })
                      : d.tipo === 'del'
                        ? e.jsx(ia, { size: 12, className: 'text-red-500 mt-0.5 shrink-0' })
                        : e.jsx(Ps, { size: 11, className: 'text-amber-500 mt-0.5 shrink-0' }),
                    e.jsx('span', {
                    ...
                    e.jsxs('span', {
                      ...
                      children: [
                        ...
                        d.despues !== void 0 &&
                          e.jsx('span', { className: 'text-emerald-600', children: d.despues })
                      ]
                    })
                  ]
                },
...
function xt() {
  const [l, c] = n.useState([]),
    [x, m] = n.useState({ tablas: [], acciones: [], total: 0 }),
    [t, d] = n.useState({ tabla: '', accion: '', desde: '', hasta: '' }),
    [w, i] = n.useState(!0),
    [h, z] = n.useState(null),
    S = n.useCallback(async () => {
      ...
      try {
        c(
          await fa({ tabla: t.tabla, accion: t.accion, desde: t.desde, hasta: t.hasta, limit: 300 })
        );
      } catch (r) {
        z(r.message || 'No autorizado');
      } finally {
        i(!1);
      }
    }, [t]);
      ...
      children: [
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('select', {
              value: t.tabla,
              onChange: (r) => d({ ...t, tabla: r.target.value }),
              className: Ie,
              children: [
                e.jsx('option', { value: '', children: 'Todas las tablas' }),
                x.tablas.map((r) => e.jsx('option', { value: r, children: r }, r))
              ]
            }),
            e.jsxs('select', {
              value: t.accion,
              onChange: (r) => d({ ...t, accion: r.target.value }),
              className: Ie,
              children: [
                e.jsx('option', { value: '', children: 'Toda acción' }),
                x.acciones.map((r) => e.jsx('option', { value: r, children: r }, r))
              ]
            }),
            e.jsx('input', {
              type: 'date',
              value: t.desde,
              onChange: (r) => d({ ...t, desde: r.target.value }),
              className: Ie
            }),
            e.jsx('input', {
              type: 'date',
              value: t.hasta,
              onChange: (r) => d({ ...t, hasta: r.target.value }),
              className: Ie
            }),
            e.jsxs('button', {
              onClick: S,
              className:
                'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 bg-white text-sm font-bold text-slate-600 hover:bg-slate-50',
              children: [e.jsx(le, { size: 14 }), ' Aplicar']
            }),
            e.jsxs('span', {
              className: 'ml-auto text-[11px] text-slate-400 inline-flex items-center gap-1.5',
              children: [e.jsx(ls, { size: 13 }), ' ', x.total, ' eventos registrados']
            })
          ]
        }),
        e.jsx('div', {
          ...
          children: w
            ? e.jsx(ne, {})
            : h
              ? e.jsx(ce, { mensaje: h, onRetry: S })
              : l.length === 0
                ? e.jsx(W, { children: 'Sin registros para el filtro.' })
                : e.jsx('div', {
                    className: 'divide-y divide-slate-100',
                    children: l.map((r) => e.jsx(dt, { r }, r.id))
                  })
        }),
        e.jsx('p', {
...
`)) {
    const m = x.trim();
    if (!m) continue;
    const t = m.split(/[,\t;]/).map((z) => z.trim()),
      [d, w, i, h] = t;
    (!d && !w) || c.push({ nombre: d || '', email: w || '', rol: i || '', password: h || void 0 });
  }
  return c;
}
function pt() {
  ...
  const [l, c] = n.useState({}),
    ...
    S = n.useCallback(async () => {
      try {
        ...
        g.error(y.message || 'No autorizado');
      }
    }, []);
  n.useEffect(() => {
    S();
  }, [S]);
  const r = n.useMemo(() => mt(t), [t]),
    N = async () => {
      m(!0);
      const y = await ya();
      (m(!1),
        y != null && y.ok
          ? (g.success(`Permisos recalculados (${y.filas} filas)`), S())
          : g.error((y == null ? void 0 : y.error) || 'Error'));
    },
    p = async () => {
      var P;
      if (r.length === 0) {
        g.error('Pega al menos una fila (nombre, email, rol)');
        return;
      }
      if (
        !window.confirm(`¿Cargar ${r.length} usuario(s)? Se crearán identidades reales de acceso.`)
      )
        return;
      (i(!0), z(null));
      const y = await _a(r);
      (i(!1),
        y != null && y.ok
          ? (z(y),
            g.success(
              `${y.creados} creados · ${y.actualizados} actualizados${(P = y.errores) != null && P.length ? ` · ${y.errores.length} con error` : ''}`
            ),
            S())
          : g.error((y == null ? void 0 : y.error) || 'Error en la carga'));
    },
    C = () => {
      var P;
      const y = ((h == null ? void 0 : h.detalle) || [])
        .filter((L) => L.password)
        .map((L) => `${L.email}	${L.password}`).join(`
`);
      if (!y) {
        g.info('No hay contraseñas generadas');
        return;
      }
      ((P = navigator.clipboard) == null || P.writeText(y), g.success('Credenciales copiadas'));
    };
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('div', {
                className: 'flex items-center gap-2',
                children: [
                  e.jsx(Is, { size: 16, className: 'text-orange-500' }),
                  e.jsx('h3', {
                    className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
              ...
              e.jsxs('button', {
                ...
                children: [
                  x ? e.jsx(je, { size: 14, className: 'animate-spin' }) : e.jsx(le, { size: 14 }),
                  ' ',
                  'Recalcular ahora'
                ]
              })
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx(oe, { label: 'Usuarios', value: l.usuarios }),
              e.jsx(oe, { label: 'Roles', value: l.roles }),
              e.jsx(oe, { label: 'Permisos', value: l.permisos }),
              e.jsx(oe, { label: 'Asignaciones', value: l.asignaciones }),
              e.jsx(oe, { label: 'Con ámbito', value: l.con_ambito }),
              e.jsx(oe, { label: 'Filas MV', value: l.filas_mv }),
              e.jsx(oe, { label: 'Pares efect.', value: l.pares_efectivos })
            ]
          }),
          e.jsxs('p', {
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              e.jsx(X, { size: 16, className: 'text-orange-500' }),
              e.jsx('h3', {
                className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('span', {
                ...
                children: [r.length, ' fila(s) detectada(s)']
              }),
              e.jsxs('button', {
                onClick: p,
                ...
                children: [
                  w ? e.jsx(je, { size: 16, className: 'animate-spin' }) : e.jsx(ca, { size: 16 }),
                  ' ',
                  'Cargar usuarios'
                ]
              })
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsxs('span', {
                      ...
                      children: [e.jsx(Fe, { size: 14 }), ' ', h.creados, ' creados']
                    }),
                    e.jsxs('span', {
                      className: 'inline-flex items-center gap-1 text-sky-600',
                      children: [e.jsx(le, { size: 13 }), ' ', h.actualizados, ' actualizados']
                    }),
                    ((D = h.errores) == null ? void 0 : D.length) > 0 &&
                      e.jsxs('span', {
                        className: 'inline-flex items-center gap-1 text-red-500',
                        children: [e.jsx(Ss, { size: 13 }), ' ', h.errores.length, ' error(es)']
                      }),
                    (h.detalle || []).some((y) => y.password) &&
                      e.jsxs('button', {
                        onClick: C,
                        className:
                          'ml-auto inline-flex items-center gap-1 text-[12px] font-bold text-orange-600 hover:text-orange-700',
                        children: [e.jsx(da, { size: 12 }), ' Copiar credenciales']
                      })
                  ]
                }),
                ((q = h.errores) == null ? void 0 : q.length) > 0 &&
                  e.jsx('ul', {
                    className: 'text-[12px] text-red-500 space-y-0.5',
                    children: h.errores.map((y, P) =>
                      e.jsxs(
                        'li',
                        { className: 'font-mono', children: [y.email, ': ', y.error] },
                        P
                      )
                    )
                  }),
                (h.detalle || []).filter((y) => y.password).length > 0 &&
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('ul', {
                        ...
                        children: h.detalle
                          .filter((y) => y.password)
                          .map((y, P) =>
                            e.jsxs('li', { children: [y.email, ' → ', y.password] }, P)
                          )
                      })
                    ]
                  })
...
function bt({ data: l, onClose: c, onSave: x }) {
  const m = !!l.codigo,
    [t, d] = n.useState({
      codigo: l.codigo || '',
      recurso: l.recurso || 'nv',
      accion: l.accion || 'editar',
      descripcion: l.descripcion || '',
      activo: l.activo !== !1,
      condicion: JSON.stringify(l.condicion || {}, null, 2)
    }),
    w = () => {
      let i;
      try {
        i = JSON.parse(t.condicion || '{}');
      } catch {
        g.error('La condición no es JSON válido');
        return;
      }
      if (!t.codigo || !t.recurso || !t.accion) {
        g.error('Código, recurso y acción son obligatorios');
        return;
      }
      x({ ...t, condicion: i });
    };
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx('h3', {
                ...
                children: m ? `Editar política ${l.codigo}` : 'Nueva política'
              }),
              e.jsx('button', {
                onClick: c,
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('label', {
                    ...
                    children: [
                      e.jsx('span', { className: ae, children: 'Recurso' }),
                      e.jsx('input', {
                        value: t.recurso,
                        onChange: (i) => d({ ...t, recurso: i.target.value.trim() }),
                        className: `${se} mt-1`
                      })
                    ]
                  }),
                  e.jsxs('label', {
                    className: 'block col-span-1',
                    children: [
                      e.jsx('span', { className: ae, children: 'Acción' }),
                      e.jsx('input', {
                        value: t.accion,
                        onChange: (i) => d({ ...t, accion: i.target.value.trim() }),
                        className: `${se} mt-1`
                      })
                    ]
                  }),
                  e.jsxs('label', {
                    className: 'block col-span-1',
                    children: [
                      e.jsx('span', { className: ae, children: 'Activa' }),
                      e.jsxs('select', {
                        value: t.activo ? '1' : '0',
                        onChange: (i) => d({ ...t, activo: i.target.value === '1' }),
                        className: `${se} mt-1`,
                        children: [
              ...
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: ae, children: 'Código' }),
                  e.jsx('input', {
                    disabled: m,
                    value: t.codigo,
                    onChange: (i) => d({ ...t, codigo: i.target.value.trim() }),
                    placeholder: 'nv_editar_ambito',
                    className: `${se} mt-1 ${m ? 'bg-slate-50 text-slate-400' : ''}`
                  })
                ]
              }),
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: ae, children: 'Descripción' }),
                  e.jsx('input', {
                    value: t.descripcion,
                    onChange: (i) => d({ ...t, descripcion: i.target.value }),
                    className: `${se} mt-1`
                  })
                ]
              }),
              e.jsxs('label', {
                ...
                children: [
                  e.jsxs('div', {
                    className: 'flex items-center justify-between',
                    children: [
                      e.jsx('span', { className: ae, children: 'Condición (JSON DSL)' }),
                      e.jsx('button', {
                        onClick: () => d({ ...t, condicion: ut }),
                  ...
                  e.jsx('textarea', {
                    value: t.condicion,
                    onChange: (i) => d({ ...t, condicion: i.target.value }),
                    rows: 10,
                    className: `${se} mt-1 font-mono text-[12px] resize-y`
                  })
                ]
              }),
              e.jsxs('p', {
...
function gt({ p: l, onToggle: c, onEdit: x }) {
    ...
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsx('button', {
            onClick: () => t((d) => !d),
            'aria-label': m ? 'Contraer condición' : 'Ver condición',
            'aria-expanded': m,
            className: 'text-slate-400 shrink-0',
            children: m ? e.jsx(Rs, { size: 15 }) : e.jsx($s, { size: 15 })
          }),
          e.jsx('span', {
            className: `w-2 h-2 rounded-full shrink-0 ${l.activo ? 'bg-emerald-500' : 'bg-slate-300'}`
          }),
          e.jsxs('div', {
            className: 'min-w-0 flex-1',
            children: [
              e.jsxs('div', {
                className: 'flex items-center gap-2',
                children: [
                  e.jsx('span', { className: 'font-black text-slate-800', children: l.codigo }),
                  e.jsxs('span', {
                    className:
                      'text-[10px] font-mono text-slate-400 bg-slate-100 rounded px-1.5 py-0.5',
                    children: [l.recurso, '·', l.accion]
                  }),
                  l.es_sistema &&
                    e.jsx('span', {
                      className:
          ...
          e.jsx('button', {
            ...
            className: `w-8 h-8 rounded-lg grid place-items-center shrink-0 ${l.activo ? 'text-emerald-500 hover:bg-emerald-50' : 'text-slate-400 hover:bg-slate-100'}`,
            children: l.activo ? e.jsx(_s, { size: 15 }) : e.jsx(ks, { size: 15 })
          }),
          e.jsx('button', {
            onClick: () => x(l),
            className:
      ...
      m &&
        e.jsx('pre', {
          ...
          children: JSON.stringify(l.condicion, null, 2)
        })
    ]
  });
}
function ht() {
  ...
  const L = async (j) => {
      const $ = await Ca(j);
      $ != null && $.ok
        ? (g.success('Política guardada'), i(null), P())
        : g.error(($ == null ? void 0 : $.error) || 'Error');
    },
    b = async (j) => {
      const $ = await Sa(j.id, !j.activo);
      $ != null && $.ok
        ? c((O) => O.map((I) => (I.id === j.id ? { ...I, activo: !j.activo } : I)))
        : g.error(($ == null ? void 0 : $.error) || 'Error');
    },
    T = async () => {
      if (!h) {
        g.error('Ingresa el ID de una N.V. (tms_operaciones.id)');
        return;
      }
      (y(!0), D(null));
      try {
        D(await za(Number(h), S || null));
      } catch (j) {
        g.error(j.message || 'Error');
      } finally {
        y(!1);
      }
    },
    o = C == null ? void 0 : C.contexto;
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          ...
          x
            ? e.jsx(ne, {})
            : t
              ? e.jsx(ce, { mensaje: t, onRetry: P })
              : l.length === 0
                ? e.jsx(W, { children: 'Sin políticas.' })
                : e.jsx('div', {
                    className: 'divide-y divide-slate-100',
                    children: l.map((j) =>
                      e.jsx(gt, { p: j, onToggle: b, onEdit: ($) => i($) }, j.id)
                    )
                  })
        ]
      }),
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              e.jsx(Ze, { size: 16, className: 'text-orange-500' }),
              e.jsx('h3', {
                className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: ae, children: 'ID de N.V. (tms_operaciones.id)' }),
                  e.jsx('input', {
                    value: h,
                    onChange: (j) => z(j.target.value.replace(/\D/g, '')),
                    inputMode: 'numeric',
                    placeholder: '1234',
                    className: `${se} mt-1 w-40`
                  })
                ]
              }),
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: ae, children: 'Como usuario' }),
                  e.jsxs('select', {
                    value: S,
                    onChange: (j) => r(j.target.value),
                    className: `${se} mt-1 w-56`,
                    children: [
                      e.jsx('option', { value: '', children: '— yo (admin) —' }),
                      N.map((j) => e.jsx('option', { value: j.id, children: j.nombre }, j.id))
                    ]
                  })
                ]
              }),
              e.jsxs('button', {
                ...
                children: [e.jsx(Ze, { size: 15 }), ' ', q ? 'Evaluando…' : 'Evaluar']
              })
            ]
          }),
          C &&
            (C.error
              ...
              : e.jsxs('div', {
                  className: `rounded-xl border p-3 ${C.permitida ? 'border-emerald-200 bg-emerald-50/60' : 'border-red-200 bg-red-50/60'}`,
                  children: [
                    e.jsx('div', {
                      className: 'flex items-center gap-2 font-black text-[14px] mb-2',
                      children: C.permitida
                        ? e.jsxs(e.Fragment, {
                            children: [
                              e.jsx(Fe, { size: 17, className: 'text-emerald-600' }),
                              e.jsx('span', {
                        ...
                        : e.jsxs(e.Fragment, {
                            children: [
                              e.jsx(Ye, { size: 16, className: 'text-red-500' }),
                                ...
                                e.jsxs('li', {
                                  children: [
                                    ...
                                    e.jsx('b', {
                                      className: 'font-mono',
                                      children:
                                        ((k = C.nv) == null ? void 0 : k.centro_costo) || '—'
                                    })
                                  ]
                                }),
                                e.jsxs('li', {
                                  children: [
                                    'Estado: ',
                                    e.jsx('b', {
                                      children: ((R = C.nv) == null ? void 0 : R.estado) || '—'
                                    })
                                  ]
                                }),
                                e.jsxs('li', {
                            ...
                            e.jsxs('ul', {
                              ...
                              children: [
                                e.jsxs('li', {
                                  children: [
                                    'Rol: ',
                                    e.jsx('b', { children: (o == null ? void 0 : o.rol) || '—' }),
                                    (o == null ? void 0 : o.es_admin) &&
                                      e.jsx('span', {
                                ...
                                e.jsxs('li', {
                                  children: [
                                    ...
                                    e.jsx('b', {
                                      children: o != null && o.sin_limite_centro ? 'sí' : 'no'
                                    })
                                  ]
                                }),
                                e.jsxs('li', {
                                  children: [
                                    ...
                                    e.jsx('span', {
                                      className: 'font-mono',
                                      children:
                                        ((o == null ? void 0 : o.centros_costo) || []).join(', ') ||
                                        '(ninguno)'
                                    })
                                  ]
                                })
      ...
      w && e.jsx(bt, { data: w, onClose: () => i(null), onSave: L })
    ]
  });
}
const gs = (l) => {
  ...
  ge =
    'w-full border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-orange-400 bg-white',
  he = 'text-[11px] font-bold text-slate-500 uppercase tracking-wide';
function jt({ usuarios: l, roles: c, onClose: x, onSave: m }) {
  const [t, d] = n.useState({
    ...
    w = () => {
      if (!t.delegador || !t.delegado || !t.hasta) {
        g.error('Delegador, cobertura y fecha de término son obligatorios');
        return;
      }
      if (t.delegador === t.delegado) {
        g.error('El delegador y la cobertura deben ser distintos');
        return;
      }
      m({
        delegador: t.delegador,
        delegado: t.delegado,
        role: t.role || null,
        motivo: t.motivo || null,
        desde: t.desde ? new Date(t.desde).toISOString() : null,
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: he, children: 'Delegador (presta permisos)' }),
                  e.jsxs('select', {
                    value: t.delegador,
                    onChange: (i) => d({ ...t, delegador: i.target.value }),
                    className: `${ge} mt-1`,
                    children: [
                      e.jsx('option', { value: '', children: '—' }),
                      l.map((i) => e.jsx('option', { value: i.id, children: i.nombre }, i.id))
                    ]
                  })
                ]
              }),
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: he, children: 'Cobertura (recibe permisos)' }),
                  e.jsxs('select', {
                    value: t.delegado,
                    onChange: (i) => d({ ...t, delegado: i.target.value }),
                    className: `${ge} mt-1`,
                    children: [
                      e.jsx('option', { value: '', children: '—' }),
                      l.map((i) => e.jsx('option', { value: i.id, children: i.nombre }, i.id))
              ...
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: he, children: 'Rol específico (opcional)' }),
                  e.jsxs('select', {
                    value: t.role,
                    onChange: (i) => d({ ...t, role: i.target.value }),
                    className: `${ge} mt-1`,
                    children: [
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('label', {
                    className: 'block',
                    children: [
                      e.jsx('span', { className: he, children: 'Desde' }),
                      e.jsx('input', {
                        type: 'date',
                        value: t.desde,
                        onChange: (i) => d({ ...t, desde: i.target.value }),
                        className: `${ge} mt-1`
                      })
                    ]
                  }),
                  e.jsxs('label', {
                    className: 'block',
                    children: [
                      e.jsx('span', { className: he, children: 'Hasta' }),
                      e.jsx('input', {
                        type: 'date',
                        value: t.hasta,
                        onChange: (i) => d({ ...t, hasta: i.target.value }),
                        className: `${ge} mt-1`
                      })
                    ]
                  })
              ...
              e.jsxs('label', {
                className: 'block',
                children: [
                  e.jsx('span', { className: he, children: 'Motivo' }),
                  e.jsx('input', {
                    value: t.motivo,
                    onChange: (i) => d({ ...t, motivo: i.target.value }),
...
function vt() {
  ...
  const r = async (p) => {
      const C = await Ea(p);
      C != null && C.ok
        ? (g.success('Delegación creada'), z(!1), S())
        : g.error((C == null ? void 0 : C.error) || 'Error');
    },
    N = async (p) => {
      if (
  ...
  return e.jsxs('div', {
    ...
    children: [
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [e.jsx(Y, { size: 16 }), ' Nueva']
          })
        ]
      }),
      e.jsx('div', {
        ...
        children: t
          ? e.jsx(ne, {})
          : w
            ? e.jsx(ce, { mensaje: w, onRetry: S })
            : l.length === 0
              ? e.jsx(W, { children: 'Sin delegaciones.' })
              : e.jsx('div', {
                  className: 'divide-y divide-slate-100',
                  children: l.map((p) =>
                    e.jsxs(
                      'div',
                      {
                        ...
                        children: [
                          e.jsx(Es, {
                            size: 9,
                            className: `shrink-0 rounded-full ${p.vigente ? 'text-emerald-500 fill-emerald-500' : 'text-slate-300 fill-slate-300'}`
                          }),
                          e.jsxs('div', {
                            className: 'min-w-0 flex-1',
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx('span', {
                                    className: 'truncate',
                                    children: p.delegador_nombre
                                  }),
                                  e.jsx(xa, { size: 12, className: 'text-slate-300' }),
                                  e.jsx('span', {
                                    className: 'truncate',
                                    children: p.delegado_nombre
                                  }),
                                  p.role &&
                                    e.jsx('span', {
                                      className:
      ...
      h && e.jsx(jt, { usuarios: x.usuarios, roles: x.roles, onClose: () => z(!1), onSave: r })
    ]
  });
}
const Je =
  ...
  hs = (l) => {
    if (!l) return '';
    const c = Math.floor((Date.now() - new Date(l).getTime()) / 1e3);
    return c < 60
      ? 'hace instantes'
      : c < 3600
...
function Nt() {
  const [l, c] = n.useState([]),
    [x, m] = n.useState({}),
    [t, d] = n.useState({ desde: '', hasta: '', q: '' }),
    [w, i] = n.useState(!0),
    [h, z] = n.useState(null),
    S = n.useCallback(async () => {
      (i(!0), z(null));
      try {
        c(await $a({ desde: t.desde, hasta: t.hasta, q: t.q, limit: 400 }));
      } catch (N) {
        z(N.message || 'No autorizado');
      } finally {
        i(!1);
      }
    }, [t]);
  ...
  const r = (N) => (N || '?').charAt(0).toUpperCase();
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsx(De, { label: 'Ingresos totales', value: x.total }),
          e.jsx(De, { label: 'Usuarios', value: x.usuarios }),
          e.jsx(De, { label: 'Hoy', value: x.hoy }),
          e.jsx(De, { label: 'Últimos 7 días', value: x.semana })
        ]
      }),
      e.jsxs('div', {
        className: 'flex items-center gap-2 flex-wrap',
        children: [
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsx('input', {
                value: t.q,
                onChange: (N) => d({ ...t, q: N.target.value }),
                placeholder: 'Nombre, email o rol',
                className: `${Je} pl-8 w-56`
              })
            ]
          }),
          e.jsx('input', {
            type: 'date',
            value: t.desde,
            onChange: (N) => d({ ...t, desde: N.target.value }),
            className: Je
          }),
          e.jsx('input', {
            type: 'date',
            value: t.hasta,
            onChange: (N) => d({ ...t, hasta: N.target.value }),
            className: Je
          }),
          e.jsxs('button', {
            onClick: S,
          ...
          x.ultimo &&
            e.jsxs('span', {
              className: 'ml-auto text-[11px] text-slate-400 inline-flex items-center gap-1.5',
              children: [e.jsx(Me, { size: 12 }), ' último ingreso ', hs(x.ultimo)]
            })
        ]
      }),
      e.jsx('div', {
        ...
        children: w
          ...
          : h
            ? e.jsx(ce, { mensaje: h, onRetry: S })
            : l.length === 0
              ? e.jsx(W, { children: 'Sin ingresos para el filtro.' })
              : e.jsx('div', {
                  className: 'divide-y divide-slate-100',
                  children: l.map((N) =>
                    e.jsxs(
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx(Os, { size: 12, className: 'text-emerald-500' }),
                                  ' ',
                                  ft(N.fecha)
                                ]
                              }),
...
const G =
    'w-full border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-orange-400 bg-white',
  J = 'text-[11px] font-bold text-slate-500 uppercase tracking-wide',
  Qe = { id: '', codigo: '', nombre: '', departamento_id: '', activo: !0 },
  We = {
    id: '',
    codigo: '',
    nombre: '',
...
function js({ active: l, icon: c, label: x, onClick: m }) {
  return e.jsxs('button', {
    onClick: m,
    className: `px-3.5 py-2 rounded-xl text-xs sm:text-sm font-black border flex items-center gap-1.5 transition-colors ${l ? 'bg-orange-600 text-white border-orange-600' : 'bg-white text-slate-600 border-slate-200 hover:bg-slate-50'}`,
    children: [e.jsx(c, { size: 15 }), ' ', x]
  });
}
function vs({ rows: l, onRemove: c, dynamic: x = !1 }) {
  return l.length
    ? e.jsx('div', {
        className: 'divide-y divide-slate-100',
        children: l.map((m) =>
          e.jsxs(
            'div',
            {
              className: 'flex items-center gap-3 px-4 py-2.5 text-[13px]',
              children: [
                e.jsx(ss, { size: 15, className: 'text-slate-300 shrink-0' }),
                e.jsxs('div', {
                  className: 'min-w-0',
                  children: [
                    e.jsx('div', {
                ...
                x &&
                  ...
                  e.jsxs('span', {
                    ...
                    children: [e.jsx(ma, { size: 11 }), ' dinámico']
                  }),
                c &&
                  (!x || !m.dinamico) &&
                  e.jsx('button', {
    ...
    : e.jsx(W, { children: 'Sin miembros asignados.' });
}
function fs({ rows: l, roles: c, form: x, setForm: m, onAssign: t, onRemove: d, canEdit: w }) {
  return e.jsxs('div', {
    className: 'rounded-2xl border border-slate-200 bg-white overflow-hidden',
    children: [
      e.jsxs('div', {
        className:
          'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
        children: [e.jsx(qe, { size: 12 }), ' Roles heredables']
      }),
      w &&
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('label', {
              className: 'block',
              children: [
                e.jsx('span', { className: J, children: 'Rol' }),
                e.jsxs('select', {
                  value: x.role,
                  onChange: (i) => m((h) => ({ ...h, role: i.target.value })),
                  className: `${G} mt-1`,
                  children: [
                    e.jsx('option', { value: '', children: '—' }),
                    c.map((i) =>
            ...
            e.jsxs('label', {
              className: 'block',
              children: [
                e.jsx('span', { className: J, children: 'Ámbito' }),
                e.jsxs('select', {
                  value: x.scopeType,
                  onChange: (i) => m((h) => ({ ...h, scopeType: i.target.value, scopeCode: '' })),
                  className: `${G} mt-1`,
                  children: [
            ...
            e.jsxs('label', {
              className: 'block',
              children: [
                e.jsx('span', { className: J, children: 'Código ámbito' }),
                e.jsx('input', {
                  value: x.scopeCode,
                  disabled: x.scopeType === 'global',
                  onChange: (i) => m((h) => ({ ...h, scopeCode: i.target.value.trim() })),
                  className: `${G} mt-1 disabled:bg-slate-50`,
                  placeholder: x.scopeType === 'global' ? 'No aplica' : 'código'
                })
              ]
            }),
            e.jsx('div', {
              ...
              children: e.jsxs('button', {
                ...
                children: [e.jsx(Y, { size: 16 }), ' Asignar rol']
              })
            })
          ]
        }),
      l.length
                ...
                'div',
                {
                  ...
                  children: [
                    e.jsxs('span', {
                      className:
                        'inline-flex items-center gap-1 text-[11px] font-bold text-slate-600 bg-slate-50 border border-slate-200 rounded-lg px-2 py-1 shrink-0',
                      children: [e.jsx(qe, { size: 11, className: 'text-orange-500' }), i.role]
                    }),
                    e.jsx('span', {
        ...
        : e.jsx(W, { children: 'Sin roles heredables asignados.' })
    ]
  });
}
function wt() {
  ...
  const { hasPermission: l, user: c } = Ue(),
    x =
      ...
      (c == null ? void 0 : c.rol) === 'ADMIN' ||
      (c == null ? void 0 : c.es_admin_delegado),
    [m, t] = n.useState('teams'),
    [d, w] = n.useState({ usuarios: [], roles: [], departamentos: [] }),
    [i, h] = n.useState([]),
    [z, S] = n.useState([]),
    [r, N] = n.useState(null),
    [p, C] = n.useState(null),
    ...
    [$, O] = n.useState(''),
    [I, ve] = n.useState(''),
    [H, Ae] = n.useState({ role: '', scopeType: 'global', scopeCode: '' }),
    [B, de] = n.useState({ role: '', scopeType: 'global', scopeCode: '' }),
    [Ge, fe] = n.useState(!0),
    [Ne, we] = n.useState(null),
    M = n.useCallback(async () => {
      (fe(!0), we(null));
      try {
        const [a, u, F] = await Promise.all([Ia(), Da(), Oa()]);
        (w(a), h(u), S(F), !r && u[0] && N(u[0]), !p && F[0] && C(F[0]));
      } catch (a) {
        we(a.message || 'No se pudo cargar la administración organizacional');
      } finally {
        fe(!1);
      }
    }, [p, r]),
    V = n.useCallback(async (a) => {
      if (a)
        try {
          const [u, F] = await Promise.all([Ta(a.id), is('team', a.id)]);
          (q(u),
            b(F),
            R({
              id: a.id,
          ...
          g.error(u.message || 'No se pudo cargar el detalle del equipo');
        }
    }, []),
    K = n.useCallback(async (a) => {
      var u, F, os;
      if (a)
        try {
          const [Ve, Ts] = await Promise.all([Ma(a.id), is('group', a.id)]);
          (P(Ve),
            o(Ts),
            j({
              id: a.id,
              ...
              activo: a.activo !== !1,
              regla: {
                user_ids: ((u = a.regla) == null ? void 0 : u.user_ids) || [],
                team_ids: ((F = a.regla) == null ? void 0 : F.team_ids) || [],
                department_ids: ((os = a.regla) == null ? void 0 : os.department_ids) || []
              }
            }));
        } catch (Ve) {
          g.error(Ve.message || 'No se pudo cargar el detalle del grupo');
        }
    }, []);
  (n.useEffect(() => {
    M();
    ...
    n.useEffect(() => {
      r != null && r.id && V(r);
    }, [r == null ? void 0 : r.id, V]),
    n.useEffect(() => {
      p != null && p.id && K(p);
    }, [p == null ? void 0 : p.id, K]));
  const ye = n.useMemo(() => {
      const a = new Set(D.map((u) => u.id));
      return d.usuarios.filter((u) => !a.has(u.id));
    }, [d.usuarios, D]),
    Ee = n.useMemo(() => {
      const a = new Set(y.map((u) => u.id));
      return d.usuarios.filter((u) => !a.has(u.id));
    }, [d.usuarios, y]),
    xe = async () => {
      const a = await Ua(k);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo guardar el equipo');
      (g.success('Equipo guardado'), await M());
    },
    me = async () => {
      if (!(r != null && r.id) || !window.confirm('¿Eliminar este equipo?')) return;
      const a = await Fa(r.id);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo eliminar el equipo');
      (g.success('Equipo eliminado'), N(null), R(Qe), q([]), b([]), await M());
    },
    _e = async () => {
      const a = await Ga(f);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo guardar el grupo');
      (g.success('Grupo guardado'), await M());
    },
    Re = async () => {
      if (!(p != null && p.id) || !window.confirm('¿Eliminar este grupo?')) return;
      const a = await Va(p.id);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo eliminar el grupo');
      (g.success('Grupo eliminado'), C(null), j(We), P([]), o([]), await M());
    },
    pe = async () => {
      if (!(r != null && r.id) || !$) return;
      const a = await Ba(r.id, $);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo agregar el miembro');
      (O(''), g.success('Miembro agregado al equipo'), await V(r), await M());
    },
    s = async () => {
      if (!(p != null && p.id) || !I) return;
      const a = await Ka(p.id, I);
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo agregar el miembro');
      (ve(''), g.success('Miembro agregado al grupo'), await K(p), await M());
    },
    v = async () => {
      if (!(r != null && r.id) || !H.role) return g.error('Selecciona un rol');
      const a = await cs({
        principalType: 'team',
        principalId: r.id,
        role: H.role,
      ...
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo asignar el rol');
      (g.success('Rol asignado al equipo'),
        Ae({ role: '', scopeType: 'global', scopeCode: '' }),
        await V(r),
        await M());
    },
    A = async () => {
      if (!(p != null && p.id) || !B.role) return g.error('Selecciona un rol');
      const a = await cs({
        principalType: 'group',
        principalId: p.id,
        role: B.role,
        scopeType: B.scopeType,
        scopeCode: B.scopeCode || null
      });
      if (!(a != null && a.ok))
        return g.error((a == null ? void 0 : a.error) || 'No se pudo asignar el rol');
      (g.success('Rol asignado al grupo'),
        de({ role: '', scopeType: 'global', scopeCode: '' }),
        await K(p),
        await M());
    },
    _ = async () => {
      const a = await Ja((p == null ? void 0 : p.tipo) === 'dynamic' ? p.id : null);
      if (!(a != null && a.ok))
        return g.error(
          (a == null ? void 0 : a.error) || 'No se pudieron refrescar los grupos dinámicos'
        );
      (g.success(`Refresh OK: ${a.miembros_actualizados || 0} membresías recalculadas`),
        p != null && p.id && (await K(p)),
        await M());
    };
  return Ge
    ? e.jsx(ne, {})
    : Ne
      ? e.jsx(ce, { mensaje: Ne, onRetry: M })
      : e.jsxs('div', {
          className: 'space-y-4',
          children: [
            e.jsx('div', {
              ...
              children: [
                ...
                m === 'groups' &&
                  e.jsxs('button', {
                    ...
                    children: [e.jsx(le, { size: 14 }), ' Refrescar dinámicos']
                  })
              ]
            }),
            m === 'teams' &&
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className:
                          'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                        children: [e.jsx(X, { size: 12 }), ' Equipos (', i.length, ')']
                      }),
                      i.length
                        ? e.jsx('div', {
                            className: 'divide-y divide-slate-100',
                            children: i.map((a) =>
                              e.jsxs(
                                ...
                                {
                                  onClick: () => N(a),
                                  className: `w-full text-left px-4 py-3 hover:bg-slate-50 ${(r == null ? void 0 : r.id) === a.id ? 'bg-orange-50/70' : ''}`,
                                  children: [
                                    e.jsx('div', {
                                    ...
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        a.codigo,
                                        ' · ',
                                        a.departamento || 'Sin departamento',
                                        ' · ',
                                        a.miembros,
                                        ' miembro(s)'
                                      ]
                        ...
                        : e.jsx(W, { children: 'No hay equipos creados.' })
                    ]
                  }),
                  e.jsxs('div', {
                    className: 'space-y-4',
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsx('h3', {
                                  ...
                                  children: k.id ? 'Editar equipo' : 'Nuevo equipo'
                                }),
                                k.id
                                  ? e.jsx('button', {
                                      onClick: () => R(Qe),
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsxs('label', {
                                  className: 'block',
                                  children: [
                                    e.jsx('span', { className: J, children: 'Código' }),
                                    e.jsx('input', {
                                      value: k.codigo,
                                      onChange: (a) =>
                                        R((u) => ({ ...u, codigo: a.target.value.toUpperCase() })),
                                      className: `${G} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  className: 'block',
                                  children: [
                                    e.jsx('span', { className: J, children: 'Nombre' }),
                                    e.jsx('input', {
                                      value: k.nombre,
                                      onChange: (a) => R((u) => ({ ...u, nombre: a.target.value })),
                                      className: `${G} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  className: 'block',
                                  children: [
                                    e.jsx('span', { className: J, children: 'Departamento' }),
                                    e.jsxs('select', {
                                      value: k.departamento_id,
                                      onChange: (a) =>
                                        R((u) => ({ ...u, departamento_id: a.target.value })),
                                      className: `${G} mt-1`,
                                      children: [
                                        e.jsx('option', { value: '', children: '—' }),
                                        d.departamentos.map((a) =>
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    className:
                                      'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                                    children: [e.jsx(ss, { size: 12 }), ' Miembros del equipo']
                                  }),
                                  e.jsx(vs, {
                                    rows: D,
                                    onRemove: x
                                      ? async (a) => {
                                          const u = await La(r.id, a);
                                          if (!(u != null && u.ok))
                                            return g.error(
                                              (u == null ? void 0 : u.error) || 'No se pudo quitar'
                                            );
                                          (g.success('Miembro removido'), await V(r), await M());
                                        }
                                      : null
                                  })
                                ]
                              ...
                              e.jsx(fs, {
                                ...
                                onRemove: x
                                  ? async (a) => {
                                      ...
                                      if (!(u != null && u.ok))
                                        return g.error(
                                          (u == null ? void 0 : u.error) || 'No se pudo revocar'
                                        );
                                      (g.success('Asignación revocada'), await V(r), await M());
                                    }
                                  : null,
                                canEdit: x
                              })
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className:
                          'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                        children: [e.jsx(es, { size: 12 }), ' Grupos (', z.length, ')']
                      }),
                      z.length
                        ? e.jsx('div', {
                            className: 'divide-y divide-slate-100',
                            children: z.map((a) =>
                              e.jsxs(
                                ...
                                {
                                  onClick: () => C(a),
                                  className: `w-full text-left px-4 py-3 hover:bg-slate-50 ${(p == null ? void 0 : p.id) === a.id ? 'bg-orange-50/70' : ''}`,
                                  children: [
                                    e.jsx('div', {
                                      className: 'font-bold text-slate-800',
                                      children: a.nombre
                        ...
                        : e.jsx(W, { children: 'No hay grupos creados.' })
                    ]
                  }),
                  e.jsxs('div', {
                    className: 'space-y-4',
                              ...
                              children: [
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('input', {
                                      value: f.codigo,
                                      onChange: (a) =>
                                        j((u) => ({ ...u, codigo: a.target.value.toUpperCase() })),
                                      className: `${G} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('input', {
                                      value: f.nombre,
                                      onChange: (a) => j((u) => ({ ...u, nombre: a.target.value })),
                                      className: `${G} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  className: 'block',
                                  children: [
                                    e.jsx('span', { className: J, children: 'Tipo' }),
                                    e.jsxs('select', {
                                      value: f.tipo,
                                      onChange: (a) => j((u) => ({ ...u, tipo: a.target.value })),
                                      className: `${G} mt-1`,
                                      children: [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('label', {
                                    className: 'block',
                                    children: [
                                      e.jsx('span', { className: J, children: 'User IDs' }),
                                      e.jsx('input', {
                                        value: (
                                          ((E = f.regla) == null ? void 0 : E.user_ids) || []
                                        ).join(','),
                                        onChange: (a) =>
                                          j((u) => ({
                                            ...u,
                                  ...
                                  e.jsxs('label', {
                                    className: 'block',
                                    children: [
                                      e.jsx('span', { className: J, children: 'Team IDs' }),
                                      e.jsx('input', {
                                        value: (
                                          ((U = f.regla) == null ? void 0 : U.team_ids) || []
                                        ).join(','),
                                        onChange: (a) =>
                                          j((u) => ({
                                            ...u,
                                  ...
                                  e.jsxs('label', {
                                    className: 'block',
                                    children: [
                                      e.jsx('span', { className: J, children: 'Department IDs' }),
                                      e.jsx('input', {
                                        value: (
                                          ((ue = f.regla) == null ? void 0 : ue.department_ids) ||
                                          []
                                        ).join(','),
                                        onChange: (a) =>
                                          j((u) => ({
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    className:
                                      'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                                    children: [e.jsx(ss, { size: 12 }), ' Miembros del grupo']
                                  }),
                                  e.jsx(vs, {
                                    rows: y,
                                    dynamic: p.tipo === 'dynamic',
                                    onRemove:
                                      x && p.tipo === 'static'
                                        ? async (a) => {
                                            const u = await qa(p.id, a);
                                            if (!(u != null && u.ok))
                                              return g.error(
                                                (u == null ? void 0 : u.error) ||
                                                  'No se pudo quitar'
                                              );
                                            (g.success('Miembro removido'), await K(p), await M());
                                          }
                                        : null
                                  })
                                ]
                              ...
                              e.jsx(fs, {
                                ...
                                onRemove: x
                                  ? async (a) => {
                                      ...
                                      (g.success('Asignación revocada'), await K(p), await M());
                                    }
                                  : null,
                                canEdit: x
                              })
...
const yt = [
  { id: 'usuarios', label: 'Usuarios', icon: X, path: '/admin/users' },
  { id: 'roles', label: 'Roles y Permisos', icon: ie, path: '/admin/roles' },
  { id: 'scopes', label: 'Ámbitos', icon: As, path: '/admin/roles?vista=scopes' },
  { id: 'teams', label: 'Equipos y Grupos', icon: es, path: '/admin/roles?vista=teams' },
  {
    id: 'sesiones',
    label: 'Sesiones',
    icon: ua,
  ...
  { id: 'accesos', label: 'Accesos', icon: Os, path: '/admin/roles?vista=accesos', soloAdmin: !0 },
  {
    id: 'auditoria',
    label: 'Auditoría',
    icon: ls,
  ...
  { id: 'escala', label: 'Escala', icon: Is, path: '/admin/roles?vista=escala', soloAdmin: !0 },
  {
    id: 'politicas',
    label: 'Políticas',
    icon: Ze,
...
function Et() {
  const l = Ms(),
    ...
    { user: x } = Ue(),
    m =
      (x == null ? void 0 : x.rol) === 'ADMIN' || (x == null ? void 0 : x.es_admin_delegado) === !0,
    t = l.pathname.includes('/roles'),
    d = new URLSearchParams(l.search).get('vista'),
    i = t
      ? [
          'scopes',
          'teams',
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      e.jsx('div', {
        className: 'flex gap-2 flex-wrap',
        children: yt
          .filter((h) => !h.soloAdmin || m)
          .map(({ id: h, label: z, icon: S, path: r }) =>
            e.jsxs(
              'button',
              {
                onClick: () => c(r),
                ...
                children: [e.jsx(S, { size: 15 }), ' ', z]
              },
              h
            )
          )
      }),
      i === 'usuarios' && e.jsx(Qa, { embedded: !0 }),
      i === 'roles' && e.jsx(re, { embedded: !0 }),
      i === 'scopes' && e.jsx(at, {}),
      i === 'teams' && e.jsx(wt, {}),
      i === 'sesiones' && (m ? e.jsx(ot, {}) : e.jsx(re, { embedded: !0 })),
      i === 'accesos' && (m ? e.jsx(Nt, {}) : e.jsx(re, { embedded: !0 })),
      i === 'auditoria' && (m ? e.jsx(xt, {}) : e.jsx(re, { embedded: !0 })),
      i === 'escala' && (m ? e.jsx(pt, {}) : e.jsx(re, { embedded: !0 })),
      i === 'politicas' && (m ? e.jsx(ht, {}) : e.jsx(re, { embedded: !0 })),
      i === 'delegaciones' && (m ? e.jsx(vt, {}) : e.jsx(re, { embedded: !0 }))
    ]
  });
}
