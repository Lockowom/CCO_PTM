import { d as J, c as Y, j as e } from './query-vendor-BNjBrM5A.js';
import { r as m } from './react-vendor-6aw4XXjH.js';
import { u as X, g as Z } from './animation-vendor-JfdD7EdN.js';
import {
  aN as ee,
  R as se,
  aJ as te,
...
import { s as k } from './index-Cm4s-gCR.js';
import { Q as pe } from './QueryErrorState-Ct5YgOln.js';
...
async function he({ lookback: a, level: r, kind: o, moduleFilter: c, search: d, alertStatus: x }) {
  const h = be(a);
  let p = k
    .from('system_logs')
    .select(
  ...
  const O = k
    ...
    v = k
      ...
      .limit(20);
  x !== 'all' && v.eq('status', x);
  const [{ data: z, error: n, count: $ }, i, f, g, j] = await Promise.all([p, O, _, E, v]);
  if (n) throw n;
  ...
  const t = z || [],
    ...
    y = (() => {
      ...
      return l.length ? Math.round(l.reduce((b, T) => b + T, 0) / l.length) : null;
    })();
  return {
    logs: t,
    totals: {
      ...
      warns: g.count || 0,
      slow: f.count || 0,
      openAlerts: u.filter((l) => l.status === 'open').length,
      liveAlerts: L.length,
      historicalOpenAlerts: u.filter((l) => l.status === 'open' && !R(l)).length,
      usersAffected: S,
      avgDuration: y
    },
    alerts: u,
    topFingerprints: D(N, (l) => l.fingerprint || l.message, 6),
    topModules: D(t, (l) => l.module, 6),
    topActions: D(
...
function K(a) {
  return ue[a] || 'bg-slate-100 text-slate-700 border-slate-200';
}
function R(a) {
...
function _e() {
  ...
  const {
      ...
      queryKey: ['observability_snapshot', r, c, x, p, v, _],
      queryFn: () =>
        he({ lookback: r, level: c, kind: x, moduleFilter: p, search: v, alertStatus: _ }),
      refetchInterval: 15e3
    }),
    y = Y({
      mutationFn: async ({ alertId: s, status: A, note: V }) => {
        const { data: G, error: P } = await k.rpc('update_system_alert_status', {
          p_alert_id: s,
          p_status: A,
          p_note: V || null
        });
      ...
      onError: (s) =>
        B.error((s == null ? void 0 : s.message) || 'No se pudo actualizar el incidente.')
    }),
    l = (t == null ? void 0 : t.logs) || [],
    b = (t == null ? void 0 : t.alerts) || [],
    T = m.useMemo(() => (t == null ? void 0 : t.modules) || [], [t]),
    U = m.useMemo(() => (t == null ? void 0 : t.kinds) || [], [t]);
  return e.jsxs('div', {
    ref: a,
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [e.jsx(se, { size: 16, className: L ? 'animate-spin' : '' }), 'Actualizar']
          })
        ]
      }),
      e.jsxs('div', {
              ...
              e.jsxs('div', {
                children: [
                  ...
                  e.jsxs('select', {
                    ...
                    children: [
                      e.jsx('option', { value: 'all', children: 'Todos' }),
                      U.map((s) => e.jsx('option', { value: s, children: F[s] || s }, s))
                    ]
                  })
                ]
              }),
              e.jsxs('div', {
                children: [
                  ...
                  e.jsxs('select', {
                    ...
                    children: [
                      e.jsx('option', { value: 'all', children: 'Todos' }),
                      T.map((s) => e.jsx('option', { value: s, children: s }, s))
                    ]
                  })
                ]
              }),
              e.jsxs('div', {
                children: [
                  ...
                  e.jsxs('div', {
                    className: 'relative',
                    children: [
                      e.jsx(ae, { size: 16, className: 'absolute left-3 top-3 text-slate-400' }),
                      e.jsx('input', {
                        value: v,
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsx(C, {
                  ...
                  value: (t == null ? void 0 : t.totals.total) ?? (u ? '…' : 0),
                  tone: 'sky',
                  helper: `Vista ${((I = Q.find((s) => s.value === r)) == null ? void 0 : I.label) || r}`
                }),
                e.jsx(C, {
                  icon: e.jsx(q, { size: 20 }),
                  label: 'Incidentes vigentes',
                  value: (t == null ? void 0 : t.totals.liveAlerts) ?? (u ? '…' : 0),
                  tone: 'rose',
                ...
                e.jsx(C, {
                  ...
                  label: 'Warnings',
                  value: (t == null ? void 0 : t.totals.warns) ?? (u ? '…' : 0),
                  tone: 'amber',
                ...
                e.jsx(C, {
                  ...
                  value: (t == null ? void 0 : t.totals.slow) ?? (u ? '…' : 0),
                  tone: 'emerald',
                ...
                e.jsx(C, {
                  ...
                  value: (t == null ? void 0 : t.totals.usersAffected) ?? (u ? '…' : 0),
                  helper: `Promedio: ${M(t == null ? void 0 : t.totals.avgDuration)}`
                })
              ]
            }),
            e.jsx('div', {
              ...
              children: e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('button', {
                    ...
                    children: [e.jsx(oe, { size: 16 }), 'Ver pendientes']
                  })
                ]
              })
            }),
                            ...
                            children: e.jsxs('div', {
                              ...
                              children: [
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    e.jsx('span', {
                                      className: `text-[10px] font-black uppercase rounded-lg border px-2 py-1 ${K(s.severity)}`,
                                      children: s.severity
                                    }),
                                    e.jsx('span', {
                                      className:
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('span', { children: H(s.last_seen_at || s.created_at) })
                                  ]
                                })
                              ]
                            })
                  ...
                  children: [
                    e.jsxs('div', {
                      children: [
                        ...
                        e.jsxs('p', {
                          className: 'text-[12px] text-slate-400 mt-1',
                          children: ['Últimos ', l.length, ' registros según los filtros actuales.']
                        })
                      ]
                    }),
                    t != null && t.lastError
                              ...
                              children: e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      e.jsx('span', {
                                        className: `text-[10px] font-black uppercase rounded-lg border px-2 py-1 ${W(s.level)}`,
                                        children: s.level
                                      }),
                                      e.jsx('span', {
                                        className:
                                          'text-[10px] font-black uppercase rounded-lg border px-2 py-1 bg-slate-100 text-slate-600 border-slate-200',
                                        children: F[s.kind] || s.kind
                                      }),
                                      e.jsx('span', {
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsxs('span', {
                                        children: [
                                          e.jsx(ce, { size: 12, className: 'inline mr-1' }),
                                          M(s.duration_ms)
                                        ]
                                      })
                                    ]
                  ...
                  e.jsxs('div', {
                    children: [
                      e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('span', {
                            className: `text-[10px] font-black uppercase rounded-lg border px-2 py-1 ${K(i.severity)}`,
                            children: i.severity
                          }),
                          e.jsx('span', {
                            className:
                      ...
                      e.jsxs('p', {
                        ...
                        children: ['Última evidencia: ', w(i.last_seen_at || i.created_at)]
                      })
                    ]
                  }),
                  e.jsx('button', {
                    ...
                    children: [
                      i.status === 'open' &&
                        e.jsxs('button', {
                          ...
                          onClick: () => y.mutate({ alertId: i.id, status: 'ack', note: g }),
                          className:
                          ...
                          children: [e.jsx(q, { size: 16 }), ' Reconocer']
                        }),
                      i.status !== 'resolved' &&
                        e.jsxs('button', {
                          type: 'button',
                          disabled: y.isPending,
                          onClick: () => y.mutate({ alertId: i.id, status: 'resolved', note: g }),
                          className:
                          ...
                          children: [e.jsx(xe, { size: 16 }), ' Resolver incidente']
                        })
                    ]
                  })
                ]
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('span', {
                            className: `text-[10px] font-black uppercase rounded-lg border px-2 py-1 ${W(n.level)}`,
                            children: n.level
                          }),
                          e.jsx('span', {
                            className:
                              'text-[10px] font-black uppercase rounded-lg border px-2 py-1 bg-slate-100 text-slate-600 border-slate-200',
                            children: F[n.kind] || n.kind
                          }),
                          e.jsx('span', {
                            className: 'text-[11px] font-mono text-slate-400',
                            children: w(n.created_at)
                          })
                        ]
                      }),
                      e.jsx('h3', {
