...
import { s as Oe, u as Si } from './index-BGSkqVb2.js';
...
const Yi = {
    ...
    sourceVersion: '1.55.146',
    fingerprint: '580f35aa8e4d',
    totals: {
      module: 10,
      screen: 69,
      component: 33,
  ...
  ea = [
    ...
    },
    {
      ...
      label: 'rpc',
      displayLabel: 'Rpc',
      description: 'Ejecuta rpc; participa en RPC, Realtime.',
  ...
  k = { meta: Yi, modules: Zi, countsByModule: Ji, nodes: ea, connections: ia },
  be = {
    module: { label: 'Módulo', icon: oe, tone: 'bg-orange-50 text-orange-700 border-orange-200' },
    screen: { label: 'Pantalla', icon: Ie, tone: 'bg-sky-50 text-sky-700 border-sky-200' },
    component: {
      label: 'Componente',
      icon: oi,
    ...
    table: { label: 'Tabla', icon: si, tone: 'bg-slate-50 text-slate-700 border-slate-200' },
...
function sa({ node: o, counts: m, active: g, onClick: _ }) {
...
function na({ onOpenFlow: o }) {
  const m = ze(),
    ...
    [q, F] = l.useState(''),
    [d, p] = l.useState(null),
    b = l.useMemo(() => new Map(k.nodes.map((a) => [a.id, a])), []),
    se = l.useMemo(() => {
      const a = new Map();
      for (const y of k.connections) {
        const j = a.get(y.to) || [];
        (j.push(y), a.set(y.to, j));
      }
      return a;
    }, []),
    U = l.useMemo(() => {
      const a = new Map();
      for (const y of k.connections) {
        const j = a.get(y.from) || [];
        (j.push(y), a.set(y.from, j));
      }
      return a;
    }, []),
    K = l.useMemo(() => aa.map((a) => b.get(`module:${a}`)).filter(Boolean), [b]),
    u = d ? b.get(d) : null,
    S = d ? se.get(d) || [] : [],
    C = d ? U.get(d) || [] : [],
    L = Ae(q.trim()),
    T = l.useMemo(
      () =>
        k.nodes.filter((a) =>
          a.kind === 'module' || (f !== 'all' && a.module !== f) || (h !== 'all' && a.kind !== h)
            ? !1
            : L
              ? Ae(
                  [
    ...
    R = x ? U.get(x.id) || [] : [],
    A = (a) => {
      (G(a), p(`module:${a}`), _('connections'));
    },
    E = () => {
      const a = new Blob([JSON.stringify(k, null, 2)], { type: 'application/json' }),
        ...
        children: [
          ...
          e.jsx('div', {
            ...
            children: [
              ...
              ['Pantallas', k.meta.totals.screen, Ie, 'text-sky-600'],
              ['Funciones', k.meta.totals.function + k.meta.totals.action, Le, 'text-emerald-600'],
        ...
        children: e.jsxs('div', {
          ...
          children: [
              ...
              children: [
                ...
                e.jsxs(
                  'button',
                  {
                    type: 'button',
                    onClick: () => _(a),
                    className: `inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-[10px] font-black transition sm:flex-none ${g === a ? 'bg-white text-slate-950 shadow-sm' : 'text-slate-500 hover:text-slate-800'}`,
            ...
            e.jsxs('select', {
              ...
              onChange: (a) => {
                (G(a.target.value),
                  p(a.target.value === 'all' ? null : `module:${a.target.value}`));
              },
              className:
              ...
              children: [
                ...
                K.map((a) => e.jsx('option', { value: a.module, children: a.label }, a.id))
              ]
            })
          ]
        })
            ...
            e.jsx('div', {
              ...
              children: K.map((a) =>
                e.jsx(
                  ...
                  {
                    node: a,
                    counts: k.countsByModule[a.module] || {},
                    active: f === a.module,
                    onClick: () => A(a.module)
                  },
                  a.id
                  ...
                  children: [
                    ...
                    e.jsxs('select', {
                      ...
                      children: [
                        ...
                        Object.entries(be)
                          .filter(([a]) => a !== 'module')
                          .map(([a, y]) => e.jsx('option', { value: a, children: y.label }, a))
                      ]
                    })
                  ]
                }),
                    ...
                    T.slice(0, 300).map((a) =>
                      e.jsxs(
                        'button',
                        {
                          type: 'button',
                          onClick: () => p(a.id),
                          className: `flex w-full items-center gap-3 px-4 py-3 text-left transition hover:bg-orange-50/50 ${d === a.id ? 'bg-orange-50' : ''}`,
                          children: [
                            e.jsx(ce, { kind: a.kind, compact: !0 }),
                            e.jsxs('div', {
                              className: 'min-w-0 flex-1',
                              children: [
                                e.jsx('p', {
                                  className: 'truncate text-xs font-black text-slate-800',
                                  children: a.displayLabel || a.label
                                }),
                                e.jsx('p', {
                                  className: 'mt-0.5 truncate text-[9px] text-slate-400',
                                  children: a.route || a.signature || a.source || a.description
                                })
                              ]
                            }),
                            e.jsx('span', {
...
const ie = {
  ...
  Te = (o) => (ra.find(([m]) => m.test(o || '')) || [])[1] || null,
  ta = {
    'master-data':
...
function fa() {
  ...
  return o === 'architecture'
    ? e.jsx(na, { onOpenFlow: () => m('operational') })
    : e.jsxs(e.Fragment, {
        children: [
          e.jsxs('div', {
            className:
...
function la() {
  ...
  const a = l.useRef(null),
    ...
    ne = l.useCallback(
      async (i) => {
        ...
        (n ||
          ((n = { nodes: s.seed.nodes, edges: s.seed.edges }),
          (r = ((v = s.seed._meta) == null ? void 0 : v.titulo) || s.titulo)),
  ...
  const Fe = (i) => {
    ...
    Ge = (i) => {
      if (I.current) {
        const s = (i.clientX - I.current.px) / j.s,
          n = (i.clientY - I.current.py) / j.s;
        ((I.current.px = i.clientX),
          (I.current.py = i.clientY),
          (I.current.moved = !0),
          je((r) => r.map((t) => (t.id === I.current.id ? { ...t, x: t.x + s, y: t.y + n } : t))));
        return;
      }
      if ($.current) {
        const s = i.clientX - $.current.x,
          n = i.clientY - $.current.y;
        (($.current = { x: i.clientX, y: i.clientY }),
          B((r) => ({ ...r, x: r.x + s, y: r.y + n })));
      }
    },
    ye = () => {
      var i;
      ((i = I.current) != null && i.moved && D(), (I.current = null), ($.current = null));
    },
    Ue = (i, s) => {
      (i.stopPropagation(),
        C === null &&
          (S({ kind: 'node', id: s.id }),
          b && (I.current = { id: s.id, px: i.clientX, py: i.clientY, moved: !1 })));
    },
    He = (i, s) => {
      if ((i.stopPropagation(), C !== null)) {
        ...
        (C !== s.id &&
          (P((n) => ({ ...n, edges: [...n.edges, { id: xe('e'), from: C, to: s.id, label: '' }] })),
          D()),
          L(''));
        return;
      }
    ...
    $e = (i, s) => {
      ...
      const n = window.prompt('Etiqueta del nodo:', s.label);
      n != null && Y(s.id, { label: n });
    },
    Y = (i, s) => {
      (je((n) => n.map((r) => (r.id === i ? { ...r, ...s } : r))), D());
    },
    Qe = (i, s) => {
      (P((n) => ({ ...n, edges: n.edges.map((r) => (r.id === i ? { ...r, ...s } : r)) })), D());
    },
    Ke = (i) => {
      const s = a.current,
        n = (s.clientWidth / 2 - j.x) / j.s,
        r = (s.clientHeight / 2 - j.y) / j.s,
        t = ie[i].dim,
        v = {
          id: xe('n'),
          type: i,
    ...
    Z = l.useCallback(() => {
      u &&
        (u.kind === 'node'
          ? P((i) => ({
              nodes: i.nodes.filter((s) => s.id !== u.id),
              edges: i.edges.filter((s) => s.from !== u.id && s.to !== u.id)
            }))
          : P((i) => ({ ...i, edges: i.edges.filter((s) => s.id !== u.id) })),
        S(null),
        D());
    }, [u]);
  l.useEffect(() => {
    const i = (s) => {
      b &&
        (s.key === 'Delete' || s.key === 'Backspace') &&
        u &&
        !/input|textarea|select/i.test(s.target.tagName) &&
        (s.preventDefault(), Z());
    };
    return (window.addEventListener('keydown', i), () => window.removeEventListener('keydown', i));
  }, [b, u, Z]);
  const We = async () => {
      const i = await Xi(f, q, h);
      i != null && i.ok
    ...
    Xe = () => {
      ...
      ((n.href = s), (n.download = `flujo-${f}.json`), n.click(), URL.revokeObjectURL(s));
    },
    Ye = (i) => {
      var r;
      const s = (r = i.target.files) == null ? void 0 : r[0];
      if (!s) return;
    ...
    Ze = async () => {
      ...
      try {
        ...
        (v = c == null ? void 0 : c.modelo) != null && v.nodes && (s = c.modelo);
      } catch {}
      s || (s = { nodes: me.nodes, edges: me.edges });
      const n = s.nodes.filter((c) => i.test(c.label || ''));
      if (!n.length) {
        V.error('El maestro no tiene nodos de este dominio');
        return;
      }
      const r = new Set(n.map((c) => c.id)),
        t = s.edges.filter((c) => r.has(c.from) && r.has(c.to));
            ...
            Je.map(([i, s]) =>
              e.jsxs(
                'button',
                {
                  ...
                  children: [e.jsx(s, { size: 13 }), ' ', i[0].toUpperCase() + i.slice(1)]
                },
                i
              )
            ),
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [
                ...
                children: [
                  ...
                  h.edges.map((i) => {
                    const s = W[i.from],
                      n = W[i.to];
                    if (!s || !n) return null;
                    const r = ke(s, n.x + n.w / 2, n.y + n.h / 2),
                      t = ke(n, s.x + s.w / 2, s.y + s.h / 2),
                      v = (r.x + t.x) / 2,
                      c = (r.y + t.y) / 2,
              ...
              h.nodes.map((i) => {
                const s = { ...(ie[i.type] || ie.tarea), ...(A[i.type] || A.tarea) },
                      ...
                      e.jsxs('label', {
                        ...
                        children: [
                          ...
                          e.jsx('textarea', {
                            rows: 2,
                            value: w.label,
                            onChange: (i) => Y(w.id, { label: i.target.value }),
                            className:
                        ...
                        children: [
                          ...
                          e.jsxs('select', {
                            ...
                            onChange: (i) => {
                              ...
                              Y(w.id, { type: s, w: ie[s].dim[0], h: ie[s].dim[1], color: void 0 });
                            },
                            className:
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            onChange: (i) => Y(w.id, { color: i.target.value }),
                            className: 'w-8 h-8 rounded border border-slate-200 p-0.5'
                          }),
                          w.color &&
                            e.jsx('button', {
                              onClick: () => Y(w.id, { color: void 0 }),
                              className:
