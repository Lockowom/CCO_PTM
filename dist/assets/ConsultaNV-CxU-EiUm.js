...
import { r as i, R as w } from './react-vendor-CA7EHQ1X.js';
import { s as k } from './index-CMd8_LWN.js';
import { z as _, X as C, af as E, h as S, d as R } from './ui-vendor-C7KFTQPV.js';
                ...
                Object.entries(y).map(([s, n]) =>
                  e.jsxs(
                    'span',
                    {
                      ...
                      style: { backgroundColor: v[s] || '#64748b' },
                      children: [s, ' (', n, ')']
                    },
                    s
                  )
