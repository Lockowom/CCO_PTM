...
import {
  ...
  g as We,
  h as Ye
} from './dashData-DejTfXOa.js';
import { s as G } from './index-BOtfZs_6.js';
      ...
      e.jsx(ye, {
        ...
        children: e.jsxs(Ne, {
          ...
          children: [
            ...
            e.jsx(Y, { dataKey: 'semana', tick: { fontSize: 10 }, interval: 'preserveStartEnd' }),
            e.jsx(q, { tick: { fontSize: 10 } }),
            e.jsx(J, {
              contentStyle: {
                borderRadius: 8,
                border: 'none',
      ...
      const g = performance.now(),
        C = (k) => {
          const $ = k - g,
            _ = Math.min($ / t, 1),
            L = m + i * js(_);
          (x(L.toFixed(n)), _ < 1 ? (h.current = requestAnimationFrame(C)) : (d.current = s));
        };
      return ((h.current = requestAnimationFrame(C)), () => cancelAnimationFrame(h.current));
    }, [s, t, n]),
...
function Ms() {
  const [s, t] = l.useState(null),
    ...
    P = l.useCallback(
      async (o) => {
        (re(o), ce(!0));
        try {
          const b = await Xe(o, j.from, j.to);
          le(b);
        } catch (b) {
  ...
  l.useEffect(() => {
    ...
    (y(o.from, o.to),
      We()
        .then((b) => {
          b.operadores.length > 0 && Ae(b.operadores);
        })
        .catch(() => {}),
      Ye(6)
        .then((b) => Se(b))
    ...
    l.useEffect(() => {
      ...
      const b = () => {
        ...
        p = G.channel('tms-oper-changes')
          ...
          .subscribe();
      return () => {
        (o && clearTimeout(o), G.removeChannel(p));
      };
    }, [y]));
            ...
            children: [
              ...
              e.jsxs('main', {
                ...
                children: [
                  ...
                  e.jsx(As, { alertasOp: B }),
                  e.jsx(Ss, { data: A, onOpenIncidencias: Pe }),
                  e.jsx(Ts, { rankTransp: z, rankVend: D }),
                  e.jsx(ks, { auditKpis: Ce }),
                  e.jsx(Es, { divisions: a }),
                  e.jsx($s, { tendencia: Te }),
                  e.jsxs('div', {
                    className: 'text-center text-xs text-gray-400 py-4',
                    children: ['Fecha de la última actualización: ', X]
                  })
                ]
              }),
