...
import { s as F, h as as, A as As, i as Fe, j as ns, u as Je } from './index-DpKQy1E-.js';
...
function Ct() {
  ...
  const { hasPermission: r, user: c } = Je(),
    ...
    [A, R] = n.useState(''),
    [P, we] = n.useState(''),
    [H, We] = n.useState({ role: '', scopeType: 'global', scopeCode: '' }),
  ...
  const $e = n.useMemo(() => {
    ...
    ge = async () => {
      ...
      (b.success('Rol asignado al equipo'),
        We({ role: '', scopeType: 'global', scopeCode: '' }),
        await B(d),
        await $());
    },
    ne = async () => {
