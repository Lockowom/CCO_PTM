...
import { r as c } from './react-vendor-CByR7_Pi.js';
import {
  W as Fe,
  j as st,
  k as ze,
...
import { _ as $e, c as pt, s as ce } from './index-DpKQy1E-.js';
import { t as Ie } from './ui-vendor-DggzEJgL.js';
...
function ut({ data: t, onSelectEstado: s }) {
  return e.jsx('div', {
            ...
            e.jsxs(
              'tr',
              {
                ...
                children: [
                  ...
                  e.jsx('td', {
                    className: 'text-left',
                    children: e.jsx('span', { className: ht(n.estado), children: n.estado })
                  }),
                  e.jsx('td', {
                    className: 'font-bold',
                    style: { color: '#f57c00' },
...
const ft = c.memo(ut);
function bt({ data: t }) {
  const s = ({ active: n, payload: l, label: r }) => {
    var m;
    if (!n || !(l != null && l.length)) return null;
    const a = ((m = l[0]) == null ? void 0 : m.payload) || {},
      p = Number(a.balanceCola || 0);
    return e.jsxs('div', {
      className: 'rounded-lg bg-white px-3 py-2 text-xs shadow-xl border border-gray-100',
      children: [
        e.jsxs('p', { className: 'font-bold text-gray-700 mb-1', children: ['Semana ', r] }),
        e.jsxs('p', {
          className: 'text-orange-600',
          children: ['Aprobadas: ', a.aprobadas || 0, ' (', a.aprobadasDia || 0, '/día)']
        }),
        e.jsxs('p', {
          className: 'text-green-700',
          children: ['Entregadas: ', a.entregadas || 0, ' (', a.entregadasDia || 0, '/día)']
        }),
        e.jsxs('p', {
          className: `mt-1 font-semibold ${p >= 0 ? 'text-green-700' : 'text-red-600'}`,
          children: [
            p >= 0 ? `Cola reducida en ${p}` : `Cola aumentó en ${Math.abs(p)}`,
            ' ',
            'N.V.'
          ]
        })
  ...
  return e.jsxs('div', {
    ...
    children: [
      e.jsx('h3', {
        ...
        children: 'Entradas vs salidas reales por semana'
      }),
      e.jsx('p', {
        className: 'text-[11px] text-gray-400 mt-1 mb-4',
        children:
          'Aprobadas por fecha de aprobación · Entregadas por fecha real de entrega · promedio sobre 5 días hábiles'
      }),
      e.jsxs('div', {
        className:
          'mb-3 rounded-lg border border-blue-100 bg-blue-50 px-3 py-2 text-[11px] text-blue-800',
        children: [
          'Cobertura confiable desde el ',
          e.jsx('strong', { children: Fe }),
          '. El historial anterior no se grafica porque no cuenta con fechas de entrega completas.'
        ]
      }),
      t != null && t.length
        ? e.jsx(ke, {
            ...
            children: e.jsxs(Be, {
              data: t,
              children: [
                e.jsx(de, { strokeDasharray: '3 3', stroke: '#f0f0f0' }),
                e.jsx(xe, {
                  dataKey: 'semana',
                  tick: { fontSize: 10 },
                  interval: 'preserveStartEnd'
                }),
                e.jsx(me, { tick: { fontSize: 10 } }),
                e.jsx(pe, { content: e.jsx(s, {}) }),
                e.jsx(it, { wrapperStyle: { fontSize: 11 } }),
                e.jsx(he, {
                  type: 'monotone',
                  dataKey: 'aprobadas',
                  stroke: '#f57c00',
        ...
        : e.jsx('div', {
            className:
              'flex h-[300px] items-center justify-center rounded-lg border border-dashed border-gray-200 bg-gray-50 px-6 text-center text-xs text-gray-500',
            'data-reliable-from': st,
            children:
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx('div', {
                ...
                children: Object.keys(ie).map((x) =>
                  e.jsx(
                    'button',
                    {
                      onClick: () => r(x),
                      className: `px-2.5 py-1 rounded-md text-[11px] font-medium transition-colors ${l === x ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-400 hover:text-gray-600'}`,
                      children: ie[x].label
                    },
                    x
                  )
          ...
          s === 'barras'
            ? e.jsxs(dt, {
                ...
                children: [
                  ...
                  e.jsx(pe, { ...m }),
                  e.jsx(De, { y: 0, stroke: '#ccc' }),
                  e.jsx(xt, {
                    dataKey: l,
                    radius: [4, 4, 0, 0],
                    children: t.map((x, f) =>
                      e.jsx(mt, { fill: l === 'dias' ? jt(x.dias) : Nt(x.pctAtiempo) }, f)
                    )
                  })
                ]
              })
...
function wt({ onFilter: t, defaultFrom: s, defaultTo: n }) {
  const [l, r] = c.useState(() => Ve('panel_filter_from', s)),
    [a, p] = c.useState(() => Ve('panel_filter_to', n));
  function m(h, d) {
    (r(h), p(d), At(h, d), t(h, d));
  }
  const x = [
...
const Ue = {
  ...
  St = { REZAGADA_COMERCIAL: 'Rezagada comercial', RETIRO_CLIENTE: 'Retiro de cliente' },
  Ke = (t) => St[t] || t || '—',
  Ge = (t) => {
    const s = Math.floor(Math.max(0, Number(t) || 0) / 86400);
    return s > 0 ? `${s} día(s)` : 'Menos de 1 día';
  },
  V = (t) => oe(t, '—'),
  F = (t) => oe(t, '');
function Ct(t, s) {
  const n = [
    ...
    r = s.map((d) =>
      [
        ...
        d.reabierta ? 'SI' : 'NO',
        d.motivo_reapertura || '',
        F(d.fecha_registro_nv),
        F(d.fecha_aprobacion),
        F(d.fecha_aprobacion_real),
        d.dif_aprobacion === null ? '' : d.dif_aprobacion,
        F(d.fecha_compromiso),
        F(d.fecha_promesa_efectiva),
        d.dias_atraso_ingreso > 0 ? d.dias_atraso_ingreso : '',
        F(d.fecha_despacho),
        d.dias_entrega === null ? '' : d.dias_entrega,
        Ke(d.shipping_subestado),
        F(d.shipping_pausa_desde),
        d.shipping_pausa_motivo || '',
        d.shipping_pausa_elegible_sla ? 'EXCLUIDA TEMPORALMENTE' : 'CONTABILIZA EN SLA',
        Ge(d.shipping_pausa_total_segundos)
      ]
        .map(l)
        .join(';')
    ),
    a =
      ...
      [n.join(';'), ...r].join(`\r
`),
    p = new Blob([a], { type: 'text/csv;charset=utf-8;' }),
    m = URL.createObjectURL(p),
    x = document.createElement('a'),
    f = (Ue[t] || t).replace(/[^\wáéíóúñ]+/gi, '_').replace(/^_+|_+$/g, ''),
    h = new Date().toISOString().slice(0, 10);
  ((x.href = m), (x.download = `NVs_${f}_${h}.csv`), x.click(), URL.revokeObjectURL(m));
}
const j = 'bg-white',
  P = 'bg-blue-50/60',
  w = 'bg-amber-50/60';
function Et({ estado: t, data: s, loading: n, onClose: l }) {
  if (
    (c.useEffect(() => {
      function a(p) {
        p.key === 'Escape' && l();
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('span', {
                      ...
                      children: [
                        e.jsx('span', {
                          className: 'w-2.5 h-2.5 rounded bg-amber-100 border border-amber-200'
                        }),
                        ' ',
                        'Logística'
                      ]
                      ...
                      children: [
                        e.jsxs('tr', {
                          children: [
                            ...
                            e.jsx('th', {
                              colSpan: 4,
                              className: `${P} px-3 py-1 text-[10px] font-semibold text-blue-400 text-left border-b border-blue-100 border-l border-l-blue-200/50`,
                              children: 'APROBACIÓN'
                            }),
                            e.jsx('th', {
                              colSpan: 5,
                              className: `${w} px-3 py-1 text-[10px] font-semibold text-amber-500 text-left border-b border-amber-100 border-l border-l-amber-200/50`,
                              children: 'LOGÍSTICA'
                            }),
                            r &&
                              e.jsx('th', {
                                colSpan: 5,
                                className:
                                  'bg-violet-50/70 px-3 py-1 text-[10px] font-semibold text-violet-500 text-left border-b border-violet-100 border-l border-l-violet-200/50',
                                children: 'PAUSA SHIPPING'
                              })
                          ]
                        }),
                        e.jsxs('tr', {
                          ...
                          children: [
                            ...
                            e.jsx('th', { className: `${j} px-3 py-2`, children: 'Vendedor' }),
                            e.jsx('th', { className: `${j} px-3 py-2`, children: 'Transportista' }),
                            e.jsx('th', { className: `${j} px-3 py-2`, children: 'Tipo Desp.' }),
                            e.jsx('th', { className: `${j} px-3 py-2`, children: 'División' }),
                            e.jsx('th', {
                            ...
                            e.jsx('th', {
                              className: `${P} px-3 py-2 border-l border-l-blue-200/50`,
                              children: 'Fecha N.V'
                            }),
                            e.jsx('th', {
                              className: `${P} px-3 py-2`,
                              children: 'Fecha Creación N.V'
                            }),
                            e.jsx('th', { className: `${P} px-3 py-2`, children: 'Aprob. Real' }),
                            e.jsx('th', {
                              className: `${P} px-3 py-2 text-center`,
                              children: 'Dif.'
                            }),
                            e.jsx('th', {
                              className: `${w} px-3 py-2 border-l border-l-amber-200/50`,
                              children: 'Compromiso'
                            }),
                            e.jsx('th', {
                            ...
                            e.jsx('th', { className: `${w} px-3 py-2`, children: 'Despacho' }),
                            e.jsx('th', {
                              className: `${w} px-3 py-2 text-center`,
                              children: 'Tiempo'
                            }),
                            r &&
                              e.jsxs(e.Fragment, {
                                children: [
                                  e.jsx('th', {
                                    className:
                                      'bg-violet-50/70 px-3 py-2 border-l border-l-violet-200/50',
                                    children: 'Subestado'
                                  }),
                                  e.jsx('th', {
                                    className: 'bg-violet-50/70 px-3 py-2',
                                    children: 'Desde'
                                  }),
                                  e.jsx('th', {
                                    className: 'bg-violet-50/70 px-3 py-2',
                        ...
                        e.jsxs(
                          'tr',
                          {
                            ...
                            children: [
                              ...
                              e.jsx('td', { className: `${j} px-3 py-2`, children: a.cliente }),
                              e.jsx('td', { className: `${j} px-3 py-2`, children: a.vendedor }),
                              e.jsx('td', {
                              ...
                              e.jsx('td', { className: `${j} px-3 py-2`, children: a.division }),
                              e.jsx('td', {
                                className: `${j} px-3 py-2 text-center`,
                              ...
                              e.jsx('td', {
                                className: `${P} px-3 py-2 whitespace-nowrap border-l border-l-blue-200/30`,
                                children: V(a.fecha_registro_nv)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 whitespace-nowrap`,
                                children: V(a.fecha_aprobacion)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 whitespace-nowrap`,
                                children: V(a.fecha_aprobacion_real)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 text-center`,
                                children:
                                  a.dif_aprobacion === null
                                    ...
                                    : e.jsxs('span', {
                                        ...
                                        style: {
                                          ...
                                          color: a.dif_aprobacion === 0 ? '#2e7d32' : '#e65100'
                                        },
                                        title:
                              ...
                              e.jsx('td', {
                                className: `${w} px-3 py-2 whitespace-nowrap border-l border-l-amber-200/30`,
                                children: V(a.fecha_compromiso)
                              }),
                              e.jsx('td', {
                                ...
                                children:
                                  a.dias_atraso_ingreso > 0
                                    ? e.jsx('span', {
                                        ...
                                        children: V(a.fecha_promesa_efectiva)
                                      })
                                    : V(a.fecha_promesa_efectiva)
                              }),
                              e.jsx('td', {
                                className: `${w} px-3 py-2 text-center`,
                                children:
                                ...
                                children:
                                  a.dias_entrega === null
                                    ...
                                    : e.jsx('span', {
                                        ...
                                        children:
                                          a.dias_entrega <= 0 ? 'A tiempo' : `+${a.dias_entrega}d`
                                      })
                              }),
                              r &&
                                e.jsxs(e.Fragment, {
                                  children: [
                                    e.jsx('td', {
                                      className:
                                        'bg-violet-50/50 px-3 py-2 border-l border-l-violet-200/30 whitespace-nowrap font-semibold text-violet-700',
                                      children: Ke(a.shipping_subestado)
                                    }),
                                    e.jsx('td', {
                                      className: 'bg-violet-50/50 px-3 py-2 whitespace-nowrap',
                                      children: V(a.shipping_pausa_desde)
                                    }),
                                    e.jsx('td', {
                                      className: 'bg-violet-50/50 px-3 py-2 min-w-[220px]',
                                      children:
                                        a.shipping_pausa_motivo ||
                                        e.jsx('span', { className: 'text-gray-300', children: '—' })
                                    }),
                                    e.jsx('td', {
                                      className: 'bg-violet-50/50 px-3 py-2 whitespace-nowrap',
                                      children: e.jsx('span', {
                                        className: `inline-block rounded-full px-2 py-0.5 text-[10px] font-bold ${a.shipping_pausa_elegible_sla ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}`,
                                        children: a.shipping_pausa_elegible_sla
                                          ? 'EXCLUIDA'
                                          : 'CONTABILIZA'
                                      })
                                    }),
                                    e.jsx('td', {
                                      className: 'bg-violet-50/50 px-3 py-2 whitespace-nowrap',
                                      children: Ge(a.shipping_pausa_total_segundos)
                                    })
                                  ]
                                })
                            ]
...
const Tt = (t) => oe(t, '—');
function _t({ open: t, data: s, loading: n, onClose: l }) {
  return (
    c.useEffect(() => {
      function r(a) {
        a.key === 'Escape' && l();
                          ...
                          e.jsx('thead', {
                            ...
                            children: e.jsxs('tr', {
                              ...
                              children: [
                                ...
                                e.jsx('th', { className: 'px-3 py-2', children: 'Área' }),
...
function Dt({ open: t, data: s, onClose: n }) {
  return (
    c.useEffect(() => {
      function l(r) {
        r.key === 'Escape' && n();
                  ...
                  s.detalle.length === 0
                    ...
                    : e.jsxs('table', {
                        ...
                        children: [
                          ...
                          e.jsx('tbody', {
                            children: s.detalle.map((l, r) =>
                              e.jsxs(
                                'tr',
                                {
                                  className: `border-t border-gray-100 ${Pt(l.diasVencido)}`,
                                  children: [
                                    e.jsx('td', {
                                      className: 'px-3 py-2 font-semibold',
                                      style: { color: '#f57c00' },
                                    ...
                                    e.jsx('td', {
                                      className: 'px-3 py-2 whitespace-nowrap',
                                      children: Lt(l.fecha_compromiso)
                                    })
                                  ]
                                },
                                r
...
function $t({ open: t, data: s, onClose: n }) {
  if (
    (c.useEffect(() => {
      function r(a) {
        a.key === 'Escape' && n();
    ...
    return null;
  const l = Object.entries(s.porTipo).sort((r, a) => a[1] - r[1]);
  return e.jsx('div', {
    className: 'fixed inset-0 z-[200] flex items-center justify-center bg-black/40 p-4',
    onClick: n,
    children: e.jsxs('div', {
                ...
                children: l.map(([r, a]) =>
                  e.jsxs(
                    'span',
                    {
                      ...
                      children: [r, e.jsx('span', { className: 'font-bold', children: a })]
                    },
                    r
                  )
                )
      ...
      const g = performance.now(),
        E = (R) => {
          const D = R - g,
            T = Math.min(D / s, 1),
            _ = h + d * Vt(T);
          (m(_.toFixed(n)), T < 1 ? (f.current = requestAnimationFrame(E)) : (x.current = t));
        };
      return ((f.current = requestAnimationFrame(E)), () => cancelAnimationFrame(f.current));
    }, [t, s, n]),
    e.jsxs('span', { className: a, children: [l, p, r] })
  );
}
function Mt({ children: t, glowColor: s = '245,124,0', className: n = '', onClick: l }) {
  const r = c.useRef(null),
    a = (p) => {
      const m = r.current;
      if (!m) return;
      const x = m.getBoundingClientRect();
      (m.style.setProperty('--mx', `${p.clientX - x.left}px`),
        m.style.setProperty('--my', `${p.clientY - x.top}px`));
    };
  return e.jsxs('div', {
    ref: r,
    onMouseMove: a,
...
function Ft({ title: t, value: s, subtitle: n, color: l = '#f57c00', icon: r, onClick: a }) {
  const p = typeof s == 'number',
    m = typeof s == 'string' && /^\d+([.,]\d+)?%$/.test(s),
    x = p ? s : m ? parseFloat(s.replace(',', '.')) : null;
  return e.jsxs(Mt, {
    glowColor: nt(l),
    onClick: a,
    className: `kpi-card${a ? ' cursor-pointer' : ''}`,
    children: [
      e.jsxs('div', {
        ...
        children: [
          ...
          r && e.jsx('span', { className: 'text-xl', children: r })
        ]
      }),
      e.jsx('div', {
        className: 'text-3xl font-bold',
        style: { color: l },
        children: x !== null ? e.jsx(Ot, { end: x, decimals: m ? 1 : 0, suffix: m ? '%' : '' }) : s
      }),
...
const J = c.memo(Ft);
function zt({ kpis: t, onDetalle: s }) {
  var n, l, r, a;
  return e.jsxs('div', {
    ...
    children: [
      ...
      e.jsx(J, {
        ...
        value: ((n = t == null ? void 0 : t.shippingPausadas) == null ? void 0 : n.total) || 0,
        subtitle: `${((l = t == null ? void 0 : t.shippingPausadas) == null ? void 0 : l.rezagadaComercial) || 0} comercial · ${((r = t == null ? void 0 : t.shippingPausadas) == null ? void 0 : r.retiroCliente) || 0} retiro · ${((a = t == null ? void 0 : t.shippingPausadas) == null ? void 0 : a.excluidasSla) || 0} excluidas de SLA`,
        color: '#7c3aed',
        icon: '⏸',
        onClick: () => s('SHIPPING_PAUSADAS')
      })
    ]
  });
}
function kt({ calidadData: t, onOpen: s }) {
  return t.total > 0
    ? e.jsxs('button', {
        onClick: s,
        className:
...
function Ut({
  ...
  const x = c.useRef(null),
    ...
    R = c.useCallback(
      (v) => {
        ...
        const b = k.getBoundingClientRect(),
          L = (v - b.left) / b.width,
          B = Math.max(0, Math.min(1, L));
        L < 0 ? g(Math.max(-1, L * 2)) : L > 1 ? g(Math.min(1, (L - 1) * 2)) : g(0);
        const U = t + B * (s - t),
          K = Math.round(U / n) * n;
    ...
    D = (v) => {
      (h(!0), v.target.setPointerCapture(v.pointerId), r(R(v.clientX)));
    },
    T = (v) => {
      f && r(R(v.clientX));
    },
  ...
  const z = d !== 0 ? `scaleX(${1 + Math.abs(d) * 0.04}) translateX(${d * 6}px)` : 'scaleX(1)';
  return e.jsxs('div', {
    ...
    children: [
      a &&
        e.jsxs('div', {
          ...
          children: [
            e.jsx('span', { className: 'text-[12px] font-semibold text-gray-600', children: a }),
            e.jsxs('span', {
        ...
        children: [
          ...
          e.jsx('div', {
            ...
            style: {
              left: `${E}%`,
              borderColor: m,
              transform: `translateX(-50%) scale(${f ? 1.25 : 1})`,
              transition: f ? 'none' : 'transform 0.3s cubic-bezier(0.16, 1.4, 0.3, 1)'
            }
          })
        ]
      })
...
function Kt({ alertasOp: t }) {
  const [s, n] = c.useState(1),
    l = c.useMemo(() => Math.max(1, ...t.map((a) => a.cantidad)), [t]),
    r = c.useMemo(() => t.filter((a) => a.cantidad >= s), [t, s]);
  return t.length === 0
    ? null
    : e.jsxs('div', {
        className: 'table-container',
                      ...
                      children: [
                        ...
                        e.jsxs('p', {
                          ...
                          children: [
                            'NVs: ',
                            a.nvs.join(', '),
                            a.cantidad > a.nvs.length ? ` (+${a.cantidad - a.nvs.length})` : ''
                          ]
                        })
                      ]
                    },
...
function Gt({ rankTransp: t, rankVend: s }) {
  return e.jsxs('div', {
...
function Wt({ data: t = [], onOpenIncidencias: s }) {
  const n = t.reduce((r, a) => r + (a.total || 0), 0),
    l = t.reduce((r, a) => r + (a.fuera48h || 0), 0);
                    ...
                    e.jsxs(
                      'tr',
                      {
                        ...
                        children: [
                          ...
                          e.jsx('td', {
                            className: 'px-4 py-3 text-center',
                            children: r.transporte
                          }),
                          e.jsx('td', {
                            className: 'px-4 py-3 text-center',
                            children: e.jsx('span', {
                              className: `inline-flex min-w-[44px] items-center justify-center rounded-full px-2 py-1 text-xs font-bold ${r.fuera48h > 0 ? 'bg-red-100 text-red-700' : 'bg-emerald-100 text-emerald-700'}`,
                              children: r.fuera48h
                            })
                          }),
                          e.jsx('td', { className: 'px-4 py-3 text-center', children: r.clientes }),
                          e.jsx('td', {
                            className: 'px-4 py-3 text-center',
                            children: r.transportistas
                          }),
                          e.jsx('td', {
...
const y = '—',
  W = (t) => (t == null || t === '' ? y : String(t)),
  G = (t) => (t == null ? y : `${t}%`),
  re = (t) => (t == null ? y : `${t} días`),
  Oe = (t) =>
    t === 'REZAGADA_COMERCIAL'
      ? 'Rezagada comercial'
      : t === 'RETIRO_CLIENTE'
        ? 'Retiro de cliente'
        : t || '',
  ...
  S = (t, s, n) => ({
    table: {
      ...
      widths: n,
      body: [
        t.map((l) => ({ text: l, style: 'headerCell' })),
        ...s.map((l) => l.map((r) => ({ text: W(r), style: 'cell' })))
      ]
    },
    layout: {
      hLineColor: () => H,
        ...
        [
          {
            ...
            margin: [9, 8, 9, 8],
            stack: [
              { text: t.toUpperCase(), fontSize: 6.5, bold: !0, color: '#64748b' },
              { text: W(s), fontSize: 17, bold: !0, color: l, margin: [0, 5, 0, 2] },
              { text: n || '', fontSize: 6.5, color: '#94a3b8' }
            ]
          }
        ]
      ]
...
async function qt({
  ...
  var B, U, K, $, X, Y;
  const D = await $e(
      () => import('./pdfmake-CkMY3Ap1.js').then((o) => o.p),
      __vite__mapDeps([0, 1])
    ),
    T = await $e(() => import('./vfs_fonts-8ICcZKi6.js').then((o) => o.v), __vite__mapDeps([2, 1])),
    _ = D.default || D,
    z = T.default || T;
  _.vfs = ((B = z.pdfMake) == null ? void 0 : B.vfs) || z.vfs || _.vfs;
  const v = `${(t == null ? void 0 : t.from) || 'Inicio'} al ${(t == null ? void 0 : t.to) || 'Hoy'}`,
    k = new Date().toLocaleString('es-CL'),
    b = [
      {
        columns: [
          {
...
DASHBOARD`,
          ...
          },
          {
            ...
            alignment: 'right',
            stack: [
              { text: 'PERÍODO FILTRADO', fontSize: 6.5, bold: !0, color: '#94a3b8' },
              { text: v, fontSize: 9, bold: !0, color: ee },
              { text: `Actualizado: ${k}`, fontSize: 6.5, color: '#94a3b8', margin: [0, 3, 0, 0] }
            ]
          }
        ],
        margin: [0, 0, 0, 14]
...
`,
                  ...
                  { text: W(s == null ? void 0 : s.countNvPtm), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: W(s == null ? void 0 : s.nvOrange), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: W(s == null ? void 0 : s.nvFarmapack), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: W(s == null ? void 0 : s.nvVarios), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              }
            ]
      ...
      },
      {
        columns: [
          Q(
            ...
            'Backlog en vivo - no depende del rango',
            '#1264c5'
          ),
          Q(
            'Tardanza prom.',
            re(s == null ? void 0 : s.leadTimeTardanza),
            'Solo entregas tardías',
            '#e11d48'
          ),
          Q(
            'A tiempo',
            G(s == null ? void 0 : s.pctAtiempo),
            'Entregado según compromiso',
            '#15803d'
          ),
          Q(
            'Fill rate',
            G((U = s == null ? void 0 : s.fillRateShipping) == null ? void 0 : U.pct),
            'Salida de En Proceso según compromiso',
            le
          ),
          Q(
            'Shipping pausadas',
            ((K = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : K.total) || 0,
            `${(($ = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : $.rezagadaComercial) || 0} comercial · ${((X = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : X.retiroCliente) || 0} retiro · ${((Y = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : Y.excluidasSla) || 0} excluidas de SLA`,
            '#7c3aed'
          )
        ],
        columnGap: 7,
      ...
      },
      {
        text:
          x != null && x.total
            ? `⚠ Datos con ${x.total} observación(es) de calidad.`
            : '✓ Datos consistentes - sin problemas detectados',
        color: x != null && x.total ? '#b45309' : '#15803d',
        fillColor: x != null && x.total ? '#fffbeb' : '#ecfdf5',
        margin: [8, 7, 8, 7],
        fontSize: 8,
        bold: !0
      },
      ...
      S(
        ...
        n.map((o) => [o.estado, o.ptm, o.orange, o.farmapack, o.varios, o.total]),
        ['*', 'auto', 'auto', 'auto', 'auto', 'auto']
      ),
      { text: 'ENTRADAS VS SALIDAS REALES POR SEMANA', style: 'section' },
      {
        text: `Aprobadas por fecha de aprobación. Entregadas por fecha real de entrega. Promedio diario calculado sobre 5 días hábiles. Cobertura confiable desde ${Fe}; el historial anterior se excluye por falta de fechas de entrega completas.`,
        fontSize: 6.5,
        color: '#64748b',
        margin: [0, 0, 0, 4]
      },
      S(
        ...
        r.map((o) => [
          ...
          o.entregadas,
          o.entregadasDia,
          o.balanceCola >= 0 ? `-${o.balanceCola}` : `+${Math.abs(o.balanceCola)}`,
          re(o.tardanza),
          G(o.fillRate)
        ]),
      ...
      S(
        ...
        a.map((o) => [o.semana, o.dias, G(o.pctAtiempo), o.count]),
        ['*', 'auto', 'auto', 'auto']
      ),
      { text: 'TIEMPOS DE CICLO', style: 'section' },
      S(
        ['Etapa', 'Días promedio', 'N.V. evaluadas'],
        ((p == null ? void 0 : p.etapas) || []).map((o) => [
          o.nombre,
          o.dias === null ? y : re(o.dias),
          o.n
        ]),
        ['*', 'auto', 'auto']
      )
  ...
  (f.length &&
    (b.push({ text: 'ALERTAS OPERACIONALES', style: 'section' }),
    b.push(
      S(
        ['Vencidas', 'Vencen hoy', 'Vencen mañana', 'Total'],
        [[m.vencidos || 0, m.hoy || 0, m.manana || 0, m.total || 0]],
        ['25%', '25%', '25%', '25%']
      )
    ),
    b.push(
      S(
        ...
        f.map((o) => [o.estado, o.cantidad, (o.nvs || []).join(', ')]),
        ['30%', '20%', '50%']
      )
    )),
    b.push({ text: 'SHIPPING PAUSADAS — BACKLOG EN VIVO', style: 'section' }),
    b.push({
    ...
    b.push(
      S(
        ...
        R.map((o) => [
          o.nv,
          o.cliente,
          Oe(o.shipping_subestado),
          o.shipping_pausa_desde ? String(o.shipping_pausa_desde).slice(0, 10) : y,
          o.shipping_pausa_motivo || y,
          o.shipping_pausa_elegible_sla ? 'Excluida temporalmente' : 'Contabiliza'
        ]),
        [45, 120, 80, 60, '*', 85]
      )
    ),
    b.push({ text: 'RANKINGS Y DISTRIBUCIÓN', style: 'section' }),
    b.push(
      S(
        ['Transportista', 'N.V.', '% a tiempo', 'Tardanza'],
        h.map((o) => [o.nombre, o.total, G(o.pctATiempo), re(o.tardanzaProm)]),
        ['*', 'auto', 'auto', 'auto']
      )
    ),
    b.push(
    ...
    b.push(
      S(
        ...
        Array.from({ length: Math.max(g.length, l.length) }, (o, C) => {
          var te, u, se, I;
          return [
            ((te = g[C]) == null ? void 0 : te.division) || y,
            ((u = g[C]) == null ? void 0 : u.cantidad) ?? y,
            ((se = l[C]) == null ? void 0 : se.estado) || y,
            ((I = l[C]) == null ? void 0 : I.count) ?? y
          ];
        }),
        ['35%', '15%', '35%', '15%']
      )
    ),
    b.push({ text: 'DETALLE DE N.V. DEL PERÍODO FILTRADO', style: 'section', pageBreak: 'before' }),
    b.push(
      S(
        [
          'N.V.',
        ...
        E.map((o) => [
          ...
          o.cliente,
          o.vendedor,
          o.shipping_subestado ? `${o.estado} · ${Oe(o.shipping_subestado)}` : o.estado,
          o.transportista,
          o.fecha_aprobacion ? String(o.fecha_aprobacion).slice(0, 10) : y,
          o.fecha_compromiso ? String(o.fecha_compromiso).slice(0, 10) : y,
          o.fecha_despacho ? String(o.fecha_despacho).slice(0, 10) : y,
          o.fecha_entregado ? String(o.fecha_entregado).slice(0, 10) : y
        ]),
  ...
  const L = _.createPdf({
    ...
    content: b,
    footer: (o, C) => ({
      text: `CCO | Panel PTM | ${v} | Página ${o} de ${C}`,
      alignment: 'center',
      color: '#94a3b8',
      fontSize: 7,
      margin: [0, 5, 0, 0]
    }),
    defaultStyle: { fontSize: 8, color: ee },
    styles: {
      tiny: { fontSize: 6.5, bold: !0, color: '#94a3b8' },
      nota: { fontSize: 14, bold: !0, color: le },
      section: { fontSize: 9, bold: !0, color: ee, margin: [0, 9, 0, 4] },
      headerCell: {
        fontSize: 7,
        bold: !0,
        color: '#ffffff',
...
function Me() {
  return typeof window > 'u'
    ? { from: ue, to: fe }
    : {
        from: localStorage.getItem('panel_filter_from') || ue,
        to: localStorage.getItem('panel_filter_to') || fe
      };
}
function rs() {
  const [t, s] = c.useState(null),
    ...
    [Ye, Se] = c.useState(!1),
    [Ce, qe] = c.useState(!1),
    [Ze, Je] = c.useState({ vencidos: 0, hoy: 0, manana: 0, total: 0, detalle: [] }),
    [Ee, Te] = c.useState(!1),
    [_e, Qe] = c.useState({ total: 0, porTipo: {}, detalle: [] }),
    ae = c.useCallback((i) => {
      (s(i.kpis),
        l(i.estadoTable),
        a(i.divisions),
        ...
        d(i.leadTimeSemanal),
        E(i.tiemposCiclo),
        D(i.rankingTransportistas),
        _(i.rankingVendedores),
        v(i.incidenciasPorVendedor || []),
        b(i.alertasOperacionales),
        Je(i.alertas),
        Qe(i.calidad),
    ...
    ne = c.useCallback(
      async (i) => {
        (je(i), ye(!0));
        try {
          const N = await Pe(i, u.from, u.to);
          Ne(N);
        } catch (N) {
          (console.error('Error cargando detalle:', N), Ne([]));
        }
        ye(!1);
      },
      [u]
    ),
    et = c.useCallback(async () => {
      (Ae(!0), Se(!0));
      try {
        const i = await rt(u.from, u.to);
        we(i);
      } catch (i) {
        (console.error('Error cargando incidencias:', i), we([]));
      }
      Se(!1);
    }, [u]),
    A = c.useCallback(
      async (i, N) => {
        (X(!0), o(null), se({ from: i, to: N }));
        try {
          const M = await Re(i, N);
          ae(M);
        } catch (M) {
          (console.error('Error loading data:', M),
            o('Error al cargar los datos. Verifica tu conexión e intenta de nuevo.'));
        }
        X(!1);
      },
      [ae]
    ),
    tt = c.useCallback(async () => {
      if (!(!t || I)) {
        be(!0);
        try {
          const [i, N, M] = await Promise.all([
            Re(u.from, u.to, { force: !0 }),
            lt(u.from, u.to),
            Pe('SHIPPING_PAUSADAS', u.from, u.to)
          ]);
          (ae(i),
            await qt({
              range: u,
              kpis: i.kpis,
              estadoTable: i.estadoTable,
              resumen: i.estadoResumen,
              weekly: i.weeklyTrend,
              leadTime: i.leadTimeSemanal,
              tiemposCiclo: i.tiemposCiclo,
              alertas: i.alertas,
              calidad: i.calidad,
              alertasOperacionales: i.alertasOperacionales,
              rankTransp: i.rankingTransportistas,
              rankVend: i.rankingVendedores,
              divisions: i.divisions,
              operaciones: N,
              shippingPausadas: M
            }),
            Ie.success('PDF descargado correctamente.'));
        } catch (i) {
          (console.error('Error exportando PDF del panel:', i),
            Ie.error(i.message || 'No se pudo generar el PDF. Intenta nuevamente.'));
        } finally {
          be(!1);
        }
      }
  ...
  c.useEffect(() => {
    ...
    (A(i.from, i.to),
      ot()
        .then((N) => {
          N.operadores.length > 0 && B(N.operadores);
        })
        .catch(() => {}),
      ct(6)
        .then((N) => K(N))
    ...
    c.useEffect(() => {
      ...
      const N = () => {
          (typeof document < 'u' && document.hidden) ||
            (i && clearTimeout(i), (i = setTimeout(() => A(q.current.from, q.current.to), 2500)));
        },
        M = ce
          ...
          .subscribe();
      return () => {
        (i && clearTimeout(i), ce.removeChannel(M));
      };
    }, [A]));
  const [Le, Z] = c.useState(120),
    O = c.useRef(120);
  return (
    c.useEffect(() => {
      ((O.current = 120), Z(120));
      const i = setInterval(() => {
        if (((O.current -= 1), Z(O.current), O.current <= 0)) {
          if (((O.current = 120), Z(120), typeof document < 'u' && document.hidden)) return;
          A(u.from, u.to);
        }
      }, 1e3);
    ...
    c.useEffect(() => {
      const i = () => {
        typeof document < 'u' &&
          !document.hidden &&
          ((O.current = 120), Z(120), A(q.current.from, q.current.to));
      };
      return (
        ...
        ? e.jsx('div', {
            ...
            children: e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('p', { className: 'text-gray-500 mb-4', children: Y }),
                e.jsx('button', {
                  onClick: () => A(u.from, u.to),
                  className:
            ...
            children: [
                ...
                children: e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      className: 'flex items-center gap-4',
                      children: [
                        e.jsx(wt, { onFilter: A, defaultFrom: ue, defaultTo: fe }),
                        e.jsxs('button', {
                          onClick: tt,
                          disabled: $ || I || !t,
                          className:
                          ...
                          children: [
                            e.jsx('svg', {
                              className: `w-3.5 h-3.5 ${I ? 'animate-bounce' : ''}`,
                              fill: 'none',
                              stroke: 'currentColor',
                              viewBox: '0 0 24 24',
                              children: e.jsx('path', {
                            ...
                            e.jsx('span', { children: I ? 'Generando...' : 'Descargar PDF' })
                          ]
                        }),
                        e.jsxs('button', {
                          onClick: () => {
                            ((O.current = 120), Z(120), A(u.from, u.to));
                          },
                          disabled: $,
                          className:
                          ...
                          children: [
                            ...
                            e.jsxs('span', {
                              children: [Math.floor(Le / 60), ':', String(Le % 60).padStart(2, '0')]
                            })
                          ]
                        }),
                        C &&
              ...
              e.jsxs('main', {
                ...
                children: [
                  ...
                  e.jsx(It, { kpis: t, onSelect: ne }),
                  e.jsx(zt, { kpis: t, onDetalle: ne }),
                  e.jsx(kt, { calidadData: _e, onOpen: () => Te(!0) }),
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [
                          e.jsx(ft, { data: n, onSelectEstado: ne }),
                          e.jsx('div', {
                            className: 'table-container',
                            children: e.jsxs('table', {
                              children: [
                                    ...
                                    e.jsxs(
                                      'tr',
                                      {
                                        ...
                                        children: [
                                          ...
                                          e.jsx('td', { className: 'font-bold', children: i.count })
                                        ]
                                      },
                                      i.estado
                                    )
                      ...
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [e.jsx(gt, { data: p }), e.jsx(vt, { data: h })]
                      })
                    ]
                  }),
                  e.jsx(Bt, { tiemposCiclo: g }),
                  e.jsx(Kt, { alertasOp: k }),
                  e.jsx(Wt, { data: z, onOpenIncidencias: et }),
                  e.jsx(Gt, { rankTransp: R, rankVend: T }),
                  e.jsx(Ht, { auditKpis: L }),
                  e.jsx(Xt, { divisions: r }),
                  e.jsx(Yt, { tendencia: U }),
                  e.jsxs('div', {
                    className: 'text-center text-xs text-gray-400 py-4',
                    children: ['Fecha de la última actualización: ', C]
                  })
                ]
              }),
              ge && e.jsx(Et, { estado: ge, data: We, loading: He, onClose: () => je(null) }),
              ve && e.jsx(_t, { open: ve, data: Xe, loading: Ye, onClose: () => Ae(!1) }),
              Ce && e.jsx(Dt, { open: Ce, data: Ze, onClose: () => qe(!1) }),
              Ee && e.jsx($t, { open: Ee, data: _e, onClose: () => Te(!1) })
            ]
          })
  );
}
