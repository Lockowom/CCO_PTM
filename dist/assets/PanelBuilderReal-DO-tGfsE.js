...
import { r as u, g as Ha, a as oa, i as Wa, R as Ke } from './react-vendor-C8fdn38R.js';
import { s as bt, u as ia } from './index-BOtfZs_6.js';
...
import { d as er, e as tr, g as nr, h as ar, i as rr } from './dashData-DejTfXOa.js';
...
function Tt(e, t, a, s, r, l, c) {
  ...
  if (
    ...
    if (Number.isFinite(s)) {
      const F = Math.round((d + i[0]) * (t + s) + f[0]) - b - g;
      F !== i[0] && (g += F - i[0]);
    }
    if (Number.isFinite(r)) {
      const F = Math.round((h + i[1]) * (a + r) + f[1]) - T - R;
      F !== i[1] && (R += F - i[1]);
    }
  }
...
function dt(e, t, a, s, r, l, c, i, f) {
  ...
  for (let F = 0; F < T.length; F++) {
    const M = T[F];
    M !== void 0 && (M.moved || (M.static ? (O = An(O, M, t, r, c)) : (O = An(O, t, M, r, c))));
  }
  return O;
}
...
var Sa = { exports: {} },
  Kr = 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED',
  Jr = Kr,
  Zr = Jr;
function Ra() {}
function Da() {}
...
`),
  ...
  e.body && gs(e.body, 'react-draggable-transparent-selection');
}
function qn(e) {
...
function ys(e, t, a) {
  ...
  if (typeof s == 'string') {
    ...
    s = {
      ...
      right: ls(f) - os(r) - r.offsetLeft + ze(d.paddingRight) - ze(h.marginRight),
      bottom: is(f) - ss(r) - r.offsetTop + ze(d.paddingBottom) - ze(h.marginBottom)
    };
  }
  return (
...
function Ue(...e) {
  es.DRAGGABLE_DEBUG && console.log(...e);
}
var qe = {
        ...
        (this.handleDragStart = (e) => {
          ...
          (Ue('DraggableCore: handleDragStart: %j', i),
            ...
            !(this.props.onStart(e, i) === !1 || this.mounted === !1) &&
              (this.props.enableUserSelectHack && hs(a, this.props.nonce),
              (this.dragging = !0),
              (this.lastX = l),
              (this.lastY = c),
...
var Yt = class extends u.Component {
  ...
  render() {
    ...
    const b = !!!i || this.state.dragging,
      O = i || s,
      F = { x: bs(this) && b ? this.state.x : O.x, y: vs(this) && b ? this.state.y : O.y };
    this.state.isElementSVG ? (R = us(F, f)) : (g = ds(F, f));
...
const ks = Object.freeze(
  Object.defineProperty({ __proto__: null, DraggableCore: it, default: Ns }, Symbol.toStringTag, {
    value: 'Module'
  })
);
var Fn = { exports: {} },
  ...
  resizeHandler(t, a) {
    return (s, r) => {
      ...
      if (this.lastHandleRect != null) {
        if (O === 'w') {
          const w = F.left - this.lastHandleRect.left;
          d += w;
        }
        if (b === 'n') {
          const w = F.top - this.lastHandleRect.top;
          g += w;
        }
      }
      ((this.lastHandleRect = F), O === 'w' && (d = -d), b === 'n' && (g = -g));
...
Ct.default = Tn;
Tn.propTypes = Ps.resizableProps;
Tn.defaultProps = {
  axis: 'both',
  handleSize: [20, 20],
  lockAspectRatio: !1,
...
Xt.default = Pa;
Pa.propTypes = Ht(Ht({}, $s.resizableProps), {}, { children: Hs.default.element });
Fn.exports = function () {
  throw new Error("Don't instantiate Resizable directly! Use require('react-resizable').Resizable");
};
var Gs = (Fn.exports.Resizable = Ct.default);
...
function Zn(e) {
  ...
  const Ee = u.useRef(null),
    ...
    mt = u.useCallback(
      (Q) => {
        if (O != null && O.calcStyle) return O.calcStyle(Q);
        if (R) return ua(Q);
        const ee = pr(Q);
        return T ? { ...ee, left: Mn(Q.left / s), width: Mn(Q.width / s) } : ee;
      },
      [O, R, T, s]
    ),
    We = u.useCallback(
      (Q, { node: ee }) => {
        ...
        const ae = ue.getBoundingClientRect(),
          ...
          Pe = ae.top / b;
        let Le;
        if (O != null && O.calcDragPosition) {
          const q = Q;
          Le = O.calcDragPosition(q.clientX, q.clientY, q.clientX - ye.left, q.clientY - ye.top);
    ...
    tt = u.useCallback(
      (Q, { node: ee, deltaX: ue, deltaY: ae }) => {
        ...
        K(_, Le, Ve, { e: Q, node: ee, newPosition: Ne });
      },
      [K, x, Z, F, d, C, c, r, oe, s, y, _, le, Me, ve]
    ),
    Ye = u.useCallback(
      (Q, { node: ee }) => {
        if (!J || !Z) return;
        ...
        J(_, Ne, Pe, { e: Q, node: ee, newPosition: je });
      },
      [J, Z, oe, le, Me, ve, _]
    );
  ((Ee.current = We), (xe.current = tt));
  const _e = u.useCallback(
      (Q, { node: ee, size: ue, handle: ae }, ye, je) => {
        ...
        Se(_, Le, Ve, { e: Q.nativeEvent, node: ee, size: Ne, handle: ae });
      },
  ...
  u.useEffect(() => {
    ...
    const ee = we.current || { left: 0, top: 0 },
      ue = Z && (M.left !== ee.left || M.top !== ee.top);
    if (Z) {
      if (ue) {
  ...
  const Ie = Tt(oe, m, N, y, C, Z ? Y.current : null, fe ? be.current : null),
...
function Ks(e) {
  const {
    ...
    { enabled: Z, defaultItem: L, onDragOver: fe } = D,
    U = f ?? Rn('vertical'),
    Ce = U.type,
    Y = U.allowOverlap,
  ...
  const P = u.useMemo(() => {
    ...
    ht = u.useCallback(
      (j, q, $, te) => {
        ...
        const Te = Xe.current;
        ((nt.current = null), (Xe.current = null), ve(null), oe(me), Te && !Qe(Te, me) && F(me));
      },
      [Oe, be, Ce, S, Y, U, se, F]
    ),
    Q = u.useCallback(
    ...
    Pe = u.useCallback(
      ...
      [de, a, S, X, xe, G, _, K, x, Ae, $e, ht, Q, ee, ue, o, ke, k, Be, Fe, Ee, i, J, Ye, Re, z, h]
    ),
    Le = () =>
      Oe
        ? n.jsx(Zn, {
  ...
  return n.jsxs('div', {
    ...
    style: H,
    onDrop: Z ? Ne : void 0,
    onDragLeave: Z ? je : void 0,
    onDragEnter: Z ? Se : void 0,
    onDragOver: Z ? ye : void 0,
    children: [
...
var Js = { lg: 1200, md: 996, sm: 768, xs: 480, xxs: 0 },
  Zs = { lg: 12, md: 10, sm: 6, xs: 4, xxs: 2 },
  dn = () => {};
function Qs(e, t, a, s) {
  const r = [];
...
function eo(e) {
  ...
  const K = u.useMemo(() => (Qe(c, o.current) ? null : en(c, r, m, m, y, F)), [c, r, m, y, F]),
    J = K ?? w;
  (u.useEffect(() => {
    ...
    }, [a, s, r, l, m, y, w, t, F, M, re, h, d, R, T, b]));
...
function lo(e, t) {
  ...
  return a.length === 0 ? e : e.filter((s) => a.every((r) => io(s[r.field], r.op, r.value)));
}
function co(e, t) {
  var a, s, r, l, c;
  if (e === 'none') return {};
...
function go({ widget: e, data: t, editMode: a, onEdit: s, onRemove: r }) {
  var T;
  let l = co(e.dataSource, t);
  Array.isArray(l) && (T = e.config.filters) != null && T.length && (l = lo(l, e.config.filters));
  const c = () => {
      var b, O, F, M, re, se, ce, he;
      if (!l)
        return n.jsx('div', {
      ...
      switch (e.type) {
        ...
        case 'donut-chart': {
          const m = Array.isArray(l) ? l : [],
            ...
            y =
              e.config.valueField ||
              ((O = (b = e.config.yFields) == null ? void 0 : b[0]) == null ? void 0 : O.key) ||
              'total',
        ...
        case 'horizontal-bars': {
          const m = Array.isArray(l) ? l : [],
            ...
            y =
              e.config.valueField ||
              ((M = (F = e.config.yFields) == null ? void 0 : F[0]) == null ? void 0 : M.key) ||
              'total',
...
function yo({ widget: e, onSave: t, onCancel: a, calcFields: s = [] }) {
  const [r, l] = u.useState(() => JSON.parse(JSON.stringify(e))),
    c = kt.find((o) => o.key === r.dataSource),
    i = c ? { ...c, fields: oo(r.dataSource, s) } : void 0,
                        ...
                        children: [
                          n.jsx('div', {
                            ...
                            children: n.jsxs('select', {
                              className: 'field-input text-[12px]',
                              value: o.key,
                              onChange: (x) => F(k, { key: x.target.value }),
                              children: [
                                n.jsx('option', { value: '', children: 'campo' }),
                                i == null
                                  ? void 0
                          ...
                          n.jsx('input', {
                            ...
                            value: o.label,
                            onChange: (x) => F(k, { label: x.target.value }),
      ...
      children: [
        ...
        n.jsxs('div', {
          ...
          children: [
            ...
            e.map((b) => {
              const O = hn(a, b.minRoleEdit || 'supervisor');
              return n.jsxs(
                'div',
                {
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            n.jsxs('span', {
                              ...
                              children: [
                                (b.pages || []).reduce((F, M) => {
                                  var re;
                                  return F + (((re = M.widgets) == null ? void 0 : re.length) || 0);
                                }, 0),
                                ' widgets · ',
                                (b.pages || []).length,
                                ' hoja(s)'
                    ...
                    T &&
                      n.jsxs('select', {
                        ...
                        onChange: (F) => i(b.id, F.target.value),
                        className:
...
function wo({ editable: e, onClose: t }) {
  ...
  const he = r[f] || {},
    ...
    X = async () => {
      ...
      O(!0);
      const o = await fo({ ...d, created_by: se });
      if ((O(!1), !o.ok)) {
...
Esos widgets/campos quedarán sin este dato.`)),
        confirm(K) && (await po(o.id), d.id === o.id && G(), await ce()));
    };
  return n.jsx('div', {
    className:
          ...
          children: [
            ...
            n.jsxs('section', {
              ...
              children: [
                        ...
                        ? D && !D.ok
                          ...
                          : n.jsxs('div', {
                              ...
                              children: [
                                ...
                                d.tipo === 'badge'
                                  ? (() => {
                                      const o = Co(D == null ? void 0 : D.value);
                                      return n.jsxs('span', {
                                        className:
                ...
                F && n.jsx('p', { className: 'text-[12px] text-red-600', children: F }),
                e &&
                  n.jsxs('div', {
...
function Ho() {
  const [e, t] = u.useState(!1),
    ...
    [k, x] = u.useState('idle'),
    { width: K, containerRef: J } = Ur({ initialWidth: 1200 }),
    ke = u.useRef({}),
    Re = u.useCallback((p) => {
      const E = p.id;
  ...
  const z = u.useMemo(() => a.find((p) => p.id === r) || null, [a, r]),
    Z = u.useMemo(() => (z ? hn(o, z.minRoleEdit || 'supervisor') : !1), [z, o]),
    L = u.useMemo(
  ...
  const fe = u.useCallback(
    ...
    Y = u.useMemo(() => (w === 'custom' && D && _ ? { from: D, to: _ } : Ro(w)), [w, D, _]),
  ...
  const Fe = u.useCallback(
      (p, E) => {
        var Q, ee, ue, ae, ye, je, Se, Ne, Pe, Le, Ve;
        if (!z || !L) return;
        ...
        if (
          ...
          ['bar-chart', 'line-chart'].includes(p) &&
            I.type === 'array' &&
            ((P.xField =
              ((Q = I.fields.find((H) => H.type === 'string')) == null ? void 0 : Q.key) ||
              I.fields[0].key),
            (P.yFields = I.fields
    ...
    Ye = async () => {
      ...
      (s((E) => [...E, p]), l(p.id), i(p.pages[0].id), jt(p.id), O(!1), await At(Mt(p)));
    },
    _e = async (p) => {
      const E = a.filter((A) => A.id !== p);
      E.length !== 0 && (s(E), r === p && (l(E[0].id), jt(E[0].id)), await uo(p));
    },
    nt = (p, E) => {
      s((A) => {
  ...
  return ce
    ...
    : n.jsxs('div', {
        ...
        children: [
                        ...
                        children: [
                          f === p.id
                            ...
                            : n.jsxs('button', {
                                ...
                                title: e && Z ? 'Doble clic para renombrar' : void 0,
                                children: [
                                  p.name,
                                  E &&
                                    n.jsxs('span', {
              ...
              L &&
                ...
                n.jsx(
                  eo,
                  {
                    ...
                    resizeConfig: { enabled: e && Z, handles: ['se'] },
                    onLayoutChange: oe,
                    compactor: Sn,
                    margin: [12, 12],
          ...
          d && n.jsx(bo, { onAdd: Fe, onClose: () => g(!1) }),
          F &&
            n.jsx(wo, {
              editable: !!Z,
              onClose: () => {
          ...
          Ie && n.jsx(yo, { widget: Ie, onSave: de, onCancel: () => T(null), calcFields: Ee }),
          b &&
            n.jsx(vo, {
              layouts: a,
              activeId: r,
