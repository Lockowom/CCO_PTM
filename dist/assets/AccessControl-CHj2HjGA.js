import { u as zs, d as Ee, c as Re, j as e } from './query-vendor-BNjBrM5A.js';
import { s as F, g as as, A as As, h as Fe, i as ns, u as Je } from './index-BSnpYyAh.js';
import { r as n, R as Q, e as Bs, u as Vs } from './react-vendor-6aw4XXjH.js';
import { u as Ks, g as Js } from './animation-vendor-JfdD7EdN.js';
import {
  I as H,
  R as re,
  b9 as Qs,
...
import {
  ...
  J as bs,
  K as Ya
} from './iamService-DOBvH-c9.js';
import './supabase-vendor-4Fjsfb0a.js';
const gs = { background: '#1e293b', border: '1px solid #10b981', color: '#f8fafc' },
  hs = { background: '#1e293b', border: '1px solid #ef4444', color: '#f8fafc' },
  js = { background: '#1e293b', border: '1px solid #f59e0b', color: '#f8fafc' },
  vs = (r) => {
    if (!r) return 'Nunca';
    const c = new Date(r);
  ...
  Xa = ({ embedded: r = !1 }) => {
    ...
    const { data: j = [], isLoading: A } = Ee({
      ...
      R = Q.useMemo(() => Object.fromEntries(j.map((a) => [a.id, a])), [j]),
      { data: P = [], isLoading: we } = Ee({
    ...
    const Y = Q.useCallback(
        (a) => {
          var s;
          return Array.isArray((s = R[a]) == null ? void 0 : s.permisos_json)
            ? R[a].permisos_json
            : [];
        },
        [R]
      ...
      ie = Re({
        ...
        onSuccess: async (a, s) => {
          await _e();
          const o = oe(s);
          (b.success(`Usuario ${D ? 'actualizado' : 'creado'} exitosamente`, { style: gs }),
            o.needsReloginNotice &&
              b(
                ...
                { style: js, duration: 7e3 }
              ),
            M(!1));
        },
        onError: (a) => b.error('Error al guardar usuario: ' + a.message, { style: hs })
      }),
      Pe = Re({
        mutationFn: async (a) => {
      ...
      $ = Re({
        ...
        onError: (a) => b.error('Error en la acción: ' + a.message, { style: hs })
      }),
      B = (a = null) => {
        (K(a),
          f(!1),
      ...
      J = (a) => {
        ...
        const s = R[t.rol];
        if (t.rol !== 'ADMIN' && !Fe((s == null ? void 0 : s.permisos_json) || [])) {
          b.error('Ese rol no tiene ninguna pantalla habilitada. Configura sus permisos primero.');
          return;
        }
        ie.mutate(t);
      },
      ...
      X = Q.useMemo(() => {
        const a = P.filter((g) => {
            ...
            const z =
                ...
                ((Oe = g.email) == null ? void 0 : Oe.toLowerCase().includes(l.toLowerCase())),
              O = !w || g.rol === w,
          ...
          s = (g) => {
            var z;
            return ((z = R[g.rol]) == null ? void 0 : z.nombre) || g.rol || '';
          },
          o =
            {
      ...
      ge = (a, s = null) => {
        ...
        if (o.length !== 0) {
          if (a === 'rol' && s !== 'ADMIN') {
            const g = R[s];
            if (!Fe((g == null ? void 0 : g.permisos_json) || [])) {
              b.error(
                'Ese rol no tiene ninguna pantalla habilitada. Configura sus permisos primero.'
              );
              return;
            }
          }
      ...
      ne = Q.useMemo(
        () => ({
          total: P.length,
          active: P.filter((a) => a.activo).length,
          admins: P.filter((a) => {
            var s;
            return (
          ...
          supervisors: P.filter((a) => {
            var s;
            return ((s = a.rol) == null ? void 0 : s.toUpperCase()) === 'SUPERVISOR';
          }).length,
          panel: P.filter((a) => oe(a).hasManagePanel).length
        }),
        [oe, P]
      ),
      Ce = (a) => {
      ...
      Se = (a) => {
        switch (a == null ? void 0 : a.toUpperCase()) {
          ...
          case 'SUPERVISOR':
            return e.jsx(Ye, { size: 14 });
          case 'OPERADOR':
            return e.jsx(ea, { size: 14 });
          default:
            return e.jsx(H, { size: 14 });
        }
      },
    ...
    return e.jsxs('div', {
      ...
      children: [
                  ...
                  e.jsxs('h1', {
                    ...
                    children: [
                      e.jsx('div', {
                        ...
                        children: e.jsx(H, { className: 'text-orange-400', size: 28 })
                      }),
                      'Control de ',
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsxs('button', {
                  ...
                  children: [e.jsx(Qs, { size: 20 }), ' Nuevo Usuario']
                })
              ]
            })
          ]
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsx(Z, {
              icon: e.jsx(H, { size: 24 }),
              label: 'Total Usuarios',
              value: ne.total,
              glowColor: 'orange'
            }),
            e.jsx(Z, {
              icon: e.jsx(Es, { size: 24 }),
              label: 'Activos',
              value: ne.active,
              glowColor: 'emerald'
            }),
        ...
        e.jsx('div', {
          ...
          children: e.jsxs('div', {
            ...
            children: [
              e.jsx(cs, { size: 16, className: 'text-amber-500 shrink-0 mt-0.5' }),
              e.jsxs('p', {
                children: [
                  'La pestaña ',
              ...
              children: [
                e.jsxs('select', {
                  ...
                  children: [
                    ...
                    j.map((a) => e.jsx('option', { value: a.id, children: a.nombre }, a.id))
                  ]
                }),
                e.jsxs('select', {
                  className:
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('button', {
                ...
                children: [e.jsx(Rs, { size: 14 }), ' Activar']
              }),
              e.jsxs('button', {
                ...
                children: [e.jsx(Ps, { size: 14 }), ' Desactivar']
              }),
              e.jsx('div', {
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('span', { children: [X.length, ' de ', P.length, ' usuarios'] }),
            X.length > 0 &&
              e.jsxs('button', {
                onClick: De,
                className:
                ...
                children: [
                  ke ? e.jsx(Te, { size: 15 }) : e.jsx(qe, { size: 15 }),
                  ' Seleccionar todos'
                ]
              })
          ]
                ...
                ? e.jsxs('div', {
                    ...
                    children: [
                      e.jsx('div', {
                        ...
                        children: e.jsx(Ge, { size: 48, className: 'text-slate-500' })
                      }),
                      e.jsx('h3', {
                                ...
                                children: [
                                  e.jsx('th', {
                                    ...
                                    children: e.jsx('button', {
                                      onClick: De,
                                      children: ke
                                        ? e.jsx(Te, { size: 16, className: 'text-orange-600' })
                                    ...
                                    children: [
                                      ...
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('span', {
                                          ...
                                          children: [
                                            Se(a.rol),
                                            ((z = R[a.rol]) == null ? void 0 : z.nombre) || a.rol
                                          ]
                                        })
                                      }),
                                      e.jsx('td', {
                          ...
                          'div',
                          {
                            ...
                            children: [
                              ...
                              e.jsx('button', {
                                ...
                                children: s
                                  ? e.jsx(Te, { size: 18, className: 'text-orange-600' })
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Ke, { size: 16 }), ' Editar']
                                      }),
                                      e.jsx('button', {
                                        onClick: () => $e(a.id),
                                        className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: t.nombre,
                                  onChange: (a) => v({ ...t, nombre: a.target.value })
                                })
                              ]
                            })
                          ]
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: t.email,
                                  onChange: (a) => v({ ...t, email: a.target.value })
                                })
                              ]
                            })
                          ]
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: t.password,
                                  onChange: (a) => v({ ...t, password: a.target.value }),
                                ...
                                e.jsx('button', {
                                  ...
                                  children: C ? e.jsx(Xs, { size: 20 }) : e.jsx(Zs, { size: 20 })
                                })
                              ]
                            })
                          ]
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    e.jsxs('select', {
                                      ...
                                      value: t.rol,
                                      onChange: (a) => v({ ...t, rol: a.target.value }),
                                      children: [
                                        e.jsx('option', {
                                          value: '',
                                          disabled: !0,
                        ...
                        t.rol &&
                          (() => {
                            ...
                            const s = a.permisos_json || [],
                              { modulos: o } = as(s),
                              g =
                                ((he = As.find((L) => L.value === a.landing_page)) == null
                                  ? void 0
                                  : he.label) || a.landing_page,
                              z = s.includes('manage_panel'),
                              O = s.includes('manage_roles');
                            return e.jsxs('div', {
                              className:
                                  ...
                                  children: [
                                    o.map((L) =>
                                      e.jsxs(
                                        'span',
                                        {
                                          title: L.rutas.map((Oe) => Oe.label).join(`
`),
  ...
  ee = (r) => {
    var c, p;
    return (
      ((p = (c = ns.find((u) => u.id === r)) == null ? void 0 : c.permissions) == null
        ? void 0
        : p.map((u) => u.id)) || []
    );
  },
  se = (r) => Array.from(new Set(r)),
  Za = se(ns.flatMap((r) => r.permissions.map((c) => c.id))),
  et = [
  ...
  lt = Object.fromEntries(tt.map((r) => [r.id, r]));
function Xe(r) {
  return lt[r] || null;
}
(ee('inventario'),
  ...
  ee('admin'));
const rt = {
    dashboard: e.jsx(ia, { size: 16 }),
    tms: e.jsx(oa, { size: 16 }),
    inbound: e.jsx(ra, { size: 16 }),
    outbound: e.jsx(la, { size: 16 }),
    queries: e.jsx(Ge, { size: 16 }),
    analytics: e.jsx(ta, { size: 16 }),
    quality: e.jsx(Qe, { size: 16 }),
    admin: e.jsx(aa, { size: 16 })
  },
  fs = ns.map((r) => ({ ...r, icon: rt[r.id] || e.jsx(xe, { size: 16 }) })),
  ce = ({ embedded: r = !1 }) => {
    const { refreshPermissions: c } = Je(),
      p = zs(),
      u = Q.useRef(),
      [l, m] = n.useState(null),
      [w, i] = n.useState(!1),
      ...
      { data: k = [], isLoading: d } = Ee({
        ...
        queryFn: async () => {
          const { data: t, error: v } = await F.from('tms_roles').select('*').order('nombre');
          if (v) throw v;
          ...
          return (
            ...
            t.map((j) => ({ ...j, usuarios: f[j.id] || 0, permisos: j.permisos_json || [] }))
          );
        }
      }),
      _ = Re({
        mutationFn: async (t) => {
          const v = h ? t.nombre.toUpperCase().replace(/\s+/g, '_') : t.id,
            C = t.id === 'ADMIN' ? 'Administrador' : t.nombre,
            f = Fe(t.permisos || [], t.landing_page),
            { error: j } = await F.from('tms_roles').upsert(
              {
                id: v,
                nombre: C,
          ...
          if (j) throw j;
          return { ...t, id: v, nombre: C, landing_page: f };
        },
        onSuccess: async (t) => {
      ...
      x = Re({
        mutationFn: async (t) => {
          const { error: v } = await F.from('tms_roles').delete().eq('id', t);
          if (v) throw v;
        },
        onSuccess: async () => {
          (await p.invalidateQueries({ queryKey: ['admin_roles'] }),
      ...
      N = () => {
        if (
          ...
          !Fe((l == null ? void 0 : l.permisos) || [])
        ) {
          b.error('El rol debe tener al menos una pantalla habilitada antes de guardarlo.');
          return;
        }
        _.mutate(l);
      },
      E = () => {
        const t = Xe(l == null ? void 0 : l.id);
        t &&
          (m((v) => ({
            ...v,
            nombre: t.nombre,
      ...
      D = (t) => {
        w &&
          m((v) => {
            const C = v.permisos || [],
              f = C.includes(t) ? C.filter((j) => j !== t) : [...C, t];
            return { ...v, permisos: f };
          });
      },
      K = (t) => {
        if (!w) return;
        const C = fs.find((f) => f.id === t).permissions.map((f) => f.id);
        m((f) => {
          const j = f.permisos || [],
            R = C.every((P) => j.includes(P))
              ? j.filter((P) => !C.includes(P))
              : [...new Set([...j, ...C])];
          return { ...f, permisos: R };
        });
      };
                ...
                children: [
                  ...
                  !l &&
                    ...
                    e.jsxs('button', {
                      ...
                      children: [e.jsx(V, { size: 24 }), ' Nuevo Rol']
                    })
                ]
              }),
            e.jsx('div', {
                                  ...
                                  children: [
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        ...
                                        ((v = t.permisos) == null ? void 0 : v.length) || 0,
                                        ' permisos'
                                      ]
                                    }),
                                    e.jsxs('span', {
                                      ...
                                      children: ['Editar ', e.jsx(Ke, { size: 16 })]
                                    })
                                  ]
                                })
                              ]
                        ...
                        e.jsxs('button', {
                          ...
                          children: [
                            e.jsx('div', {
                              ...
                              children: e.jsx(V, { size: 40, strokeWidth: 3 })
                            }),
                            e.jsx('span', {
                                            ...
                                            children: [
                                              ...
                                              l.id === 'ADMIN' &&
                                                e.jsxs('span', {
                                                  ...
                                                  children: [
                                                    e.jsx(ts, { size: 12, strokeWidth: 3 }),
                                                    ' Sistema'
                                                  ]
                                                })
                                            ]
                                    ...
                                    children: [
                                      Xe(l == null ? void 0 : l.id) &&
                                        e.jsxs('button', {
                                          ...
                                          children: [e.jsx(ls, { size: 20 }), ' Cargar Plantilla']
                                        }),
                                      e.jsx('button', {
                                        onClick: () => {
                                          (i(!1), S(!1), h && m(null));
                                ...
                                : e.jsxs(e.Fragment, {
                                    children: [
                                      ...
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Ke, { size: 20 }), ' Editar Permisos']
                                      })
                                    ]
                                  })
                            })
                        ...
                        e.jsx('div', {
                          ...
                          children: e.jsxs('div', {
                            ...
                            children: [
                              (() => {
                                var C;
                                const { modulos: t } = as(l.permisos || []),
                                  v =
                                    (C = As.find((f) => f.value === l.landing_page)) == null
                                      ? void 0
                                      : C.label;
                                return e.jsxs('div', {
...
`),
                              ...
                              e.jsx('div', {
                                ...
                                children: fs.map((t) => {
                                  const v = t.permissions.map((A) => A.id),
                                    C = v.filter((A) => {
                                      var R;
                                      return (R = l.permisos) == null ? void 0 : R.includes(A);
                                    }).length,
                                    f = C === v.length,
                                    j = C === 0;
                                  return e.jsxs(
                                      ...
                                      children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    !w &&
                                                      e.jsxs('span', {
                                                        ...
                                                        children: [C, ' de ', v.length, ' activos']
                                                      })
                                                  ]
                                                })
                                              ]
                                        ...
                                        e.jsx('div', {
                                          ...
                                          children: t.permissions.map((A) => {
                                            var P;
                                            const R =
                                              (P = l.permisos) == null ? void 0 : P.includes(A.id);
                                            return e.jsxs(
                                              'div',
                                              {
                                                role: 'checkbox',
                                                ...
                                                children: [
                                                  e.jsx('div', {
                                                    className: `mt-0.5 w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${R ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'bg-white border-slate-200'}`,
                                                    children:
                                                      R && e.jsx(Qe, { size: 14, strokeWidth: 4 })
                                                  }),
                                                  e.jsx('div', {
                                                    children: e.jsx('span', {
                                                      className: `text-sm block leading-tight tracking-tight ${R ? 'text-slate-900 font-black' : 'text-slate-500 font-bold'}`,
                                                      children: A.label
                                                    })
                                                  })
                                                ]
...
function ue({ mensaje: r, onRetry: c }) {
  return e.jsxs('div', {
    ...
    children: [
      e.jsx(cs, { size: 28, className: 'mx-auto text-red-400 mb-2' }),
...
function G({ children: r }) {
  return e.jsxs('div', {
    ...
    children: [e.jsx(na, { size: 26, className: 'text-slate-300' }), e.jsx('span', { children: r })]
  });
}
const Ns = [
...
function ot() {
  const { hasPermission: r, user: c, loading: p, isAuthenticated: u } = Je(),
    l =
      r('manage_roles') ||
    ...
    N = n.useCallback(async () => {
      ...
      (k(!0), _(null));
      try {
        const [t, v] = await Promise.all([ms(), Gs()]);
        (w(t), h(v));
      } catch (t) {
  ...
  const E = n.useMemo(
    ...
    M = async () => {
      ...
      T(!0);
      const t = await Na(x.userId, x.role, x.scopeType, x.scopeCode, x.expires || null);
      (T(!1),
        t != null && t.ok
    ...
    D = async (t) => {
      ...
      v != null && v.ok
        ...
        : b.error((v == null ? void 0 : v.error) || 'Error');
    },
    K = (t) => {
      var v;
      return ((v = Ns.find((C) => C.id === t)) == null ? void 0 : v.label) || t;
    };
  return e.jsxs('div', {
    className: 'space-y-4',
    children: [
      e.jsxs('div', {
        ...
        children: [
          e.jsx(ca, { size: 18, className: 'text-sky-500 shrink-0 mt-0.5' }),
          e.jsxs('p', {
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                e.jsx(V, { size: 15, className: 'text-orange-500' }),
                e.jsx('h3', {
            ...
            e.jsx('div', {
              ...
              children: e.jsxs('button', {
                ...
                children: [e.jsx(V, { size: 16 }), ' ', I ? 'Asignando…' : 'Asignar ámbito']
              })
            })
          ]
        }),
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            ...
            children: [e.jsx(ls, { size: 12 }), ' Asignaciones con ámbito (', i.length, ')']
          }),
          S
            ? e.jsx(pe, {})
            : d
                    ...
                    children: i.map((t) =>
                      e.jsxs(
                        'div',
                        {
                          ...
                          children: [
                            e.jsx(Is, { size: 15, className: 'text-slate-300 shrink-0' }),
                            e.jsxs('div', {
                              className: 'min-w-0',
                              children: [
                                e.jsx('div', {
                            ...
                            ws(t.expires_at) &&
                              e.jsxs('span', {
                                ...
                                children: [e.jsx(Ve, { size: 10 }), ' expira ', ws(t.expires_at)]
                              }),
                            l &&
                              e.jsx('button', {
                                onClick: () => D(t.id),
...
const it = (r) => {
  ...
  nt = (r = '') => /Android|iPhone|iPad|Mobile|CCO|Capacitor/i.test(r),
  ct = (r = '') =>
    /Android/i.test(r)
      ? 'Android'
                            ...
                            children: [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  ' · visto',
                                  ' ',
                                  it(d.refreshed_at || d.created_at)
                                ]
                              })
                            ]
                          }),
...
function ut({ r }) {
  const [c, p] = n.useState(!1),
    u = n.useMemo(() => (r.antes || r.despues ? pt(r.antes, r.despues) : []), [r]),
    l = mt[r.accion] || 'text-slate-600 bg-slate-50 border-slate-200';
  return e.jsxs('div', {
    className: 'text-[13px]',
    children: [
      e.jsxs('button', {
        ...
        children: [
          u.length > 0
            ? c
              ...
              : e.jsx(Os, { size: 14, className: 'text-slate-400 shrink-0' })
            ...
            children: u.map((m) =>
              e.jsxs(
                'div',
                {
                  ...
                  children: [
                    m.tipo === 'add'
                      ? e.jsx(V, { size: 12, className: 'text-emerald-500 mt-0.5 shrink-0' })
                      : m.tipo === 'del'
                        ? e.jsx(pa, { size: 12, className: 'text-red-500 mt-0.5 shrink-0' })
...
function bt() {
  const [r, c] = n.useState([]),
    ...
    k = n.useCallback(async () => {
      ...
      try {
        c(
          await ka({ tabla: l.tabla, accion: l.accion, desde: l.desde, hasta: l.hasta, limit: 300 })
        );
      } catch (d) {
        ...
        e.jsxs('div', {
          ...
          children: [
            ...
            e.jsxs('span', {
              ...
              children: [e.jsx(xs, { size: 13 }), ' ', p.total, ' eventos registrados']
            })
          ]
        }),
        e.jsx('div', {
          ...
          children: w
            ...
            : h
              ...
              : r.length === 0
                ...
                : e.jsx('div', {
                    className: 'divide-y divide-slate-100',
                    children: r.map((d) => e.jsx(ut, { r: d }, d.id))
                  })
        }),
        e.jsx('p', {
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('div', {
                className: 'flex items-center gap-2',
                children: [
                  e.jsx(qs, { size: 16, className: 'text-orange-500' }),
                  e.jsx('h3', {
                    className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              e.jsx(H, { size: 16, className: 'text-orange-500' }),
              e.jsx('h3', {
                className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('button', {
                ...
                children: [
                  w ? e.jsx(Ne, { size: 16, className: 'animate-spin' }) : e.jsx(ba, { size: 16 }),
                  ' ',
                  'Cargar usuarios'
                ]
              })
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsxs('span', {
                      ...
                      children: [e.jsx(Qe, { size: 14 }), ' ', h.creados, ' creados']
                    }),
                    e.jsxs('span', {
                    ...
                    ((I = h.errores) == null ? void 0 : I.length) > 0 &&
                      e.jsxs('span', {
                        ...
                        children: [e.jsx(cs, { size: 13 }), ' ', h.errores.length, ' error(es)']
                      }),
                    (h.detalle || []).some((N) => N.password) &&
                      e.jsxs('button', {
                        ...
                        children: [e.jsx(ga, { size: 12 }), ' Copiar credenciales']
                      })
                  ]
                }),
                ((T = h.errores) == null ? void 0 : T.length) > 0 &&
                  e.jsx('ul', {
...
function vt({ data: r, onClose: c, onSave: p }) {
  const u = !!r.codigo,
    [l, m] = n.useState({
      codigo: r.codigo || '',
...
function ft({ p: r, onToggle: c, onEdit: p }) {
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsx('button', {
            ...
            children: u ? e.jsx(Ds, { size: 15 }) : e.jsx(Os, { size: 15 })
          }),
          e.jsx('span', {
          ...
          e.jsx('button', {
            ...
            children: r.activo ? e.jsx(Rs, { size: 15 }) : e.jsx(Ps, { size: 15 })
          }),
          e.jsx('button', {
            onClick: () => p(r),
            className:
...
function Nt() {
  ...
  const M = async (j) => {
    ...
    D = async (j) => {
      const A = await Ra(j.id, !j.activo);
      A != null && A.ok
        ? c((R) => R.map((P) => (P.id === j.id ? { ...P, activo: !j.activo } : P)))
        : b.error((A == null ? void 0 : A.error) || 'Error');
    },
    K = async () => {
      if (!h) {
      ...
      (N(!0), I(null));
      try {
        I(await Pa(Number(h), k || null));
      } catch (j) {
        b.error(j.message || 'Error');
      } finally {
        N(!1);
      }
    },
  ...
  return e.jsxs('div', {
    ...
    children: [
            ...
            : l
              ...
              : r.length === 0
                ...
                : e.jsx('div', {
                    className: 'divide-y divide-slate-100',
                    children: r.map((j) =>
                      e.jsx(ft, { p: j, onToggle: D, onEdit: (A) => i(A) }, j.id)
                    )
                  })
        ]
      }),
      e.jsxs('div', {
        ...
        children: [
          e.jsxs('div', {
            className: 'flex items-center gap-2',
            children: [
              e.jsx(rs, { size: 16, className: 'text-orange-500' }),
              e.jsx('h3', {
                className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
            ...
            children: [
              e.jsxs('label', {
                ...
                children: [
                  ...
                  e.jsx('input', {
                    value: h,
                    onChange: (j) => S(j.target.value.replace(/\D/g, '')),
                    inputMode: 'numeric',
                    placeholder: '1234',
                ...
                children: [
                  ...
                  e.jsxs('select', {
                    ...
                    children: [
                      ...
                      _.map((j) => e.jsx('option', { value: j.id, children: j.nombre }, j.id))
                    ]
                  })
                ]
              }),
              e.jsxs('button', {
                ...
                children: [e.jsx(rs, { size: 15 }), ' ', T ? 'Evaluando…' : 'Evaluar']
              })
            ]
          }),
          y &&
                  ...
                  children: [
                    e.jsx('div', {
                      ...
                      children: y.permitida
                        ? e.jsxs(e.Fragment, {
                            children: [
                              e.jsx(Qe, { size: 17, className: 'text-emerald-600' }),
                              e.jsx('span', {
                        ...
                        : e.jsxs(e.Fragment, {
                            children: [
                              e.jsx(ts, { size: 16, className: 'text-red-500' }),
                                ...
                                e.jsxs('li', {
                                  children: [
                                    ...
                                    e.jsx('b', {
                                      className: 'font-mono',
                                      children:
                                        ((v = y.nv) == null ? void 0 : v.centro_costo) || '—'
                                    })
                                  ]
                                }),
                                e.jsxs('li', {
      ...
      w && e.jsx(vt, { data: w, onClose: () => i(null), onSave: M })
    ]
  });
}
const ys = (r) => {
...
function wt({ usuarios: r, roles: c, onClose: p, onSave: u }) {
...
function yt() {
  ...
  return e.jsxs('div', {
    ...
    children: [
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [e.jsx(V, { size: 16 }), ' Nueva']
          })
        ]
      }),
      e.jsx('div', {
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsx(ha, { size: 12, className: 'text-slate-300' }),
                                  e.jsx('span', {
                                    className: 'truncate',
      ...
      h && e.jsx(wt, { usuarios: p.usuarios, roles: p.roles, onClose: () => S(!1), onSave: d })
    ]
  });
}
const Ze =
...
function kt() {
  const [r, c] = n.useState([]),
    ...
    k = n.useCallback(async () => {
      (i(!0), S(null));
      try {
        c(await Da({ desde: l.desde, hasta: l.hasta, q: l.q, limit: 400 }));
      } catch (_) {
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          p.ultimo &&
            e.jsxs('span', {
              className: 'ml-auto text-[11px] text-slate-400 inline-flex items-center gap-1.5',
              children: [e.jsx(Ve, { size: 12 }), ' último ingreso ', _s(p.ultimo)]
            })
        ]
      }),
      e.jsx('div', {
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx(Us, { size: 12, className: 'text-emerald-500' }),
                                  ' ',
                                  _t(_.fecha)
                                ]
                              }),
...
const q =
  ...
  es = { id: '', codigo: '', nombre: '', departamento_id: '', activo: !0 },
  ss = {
    id: '',
    codigo: '',
    nombre: '',
...
function ks({ active: r, icon: c, label: p, onClick: u }) {
...
function Cs({ rows: r, onRemove: c, dynamic: p = !1 }) {
  return r.length
    ? e.jsx('div', {
        className: 'divide-y divide-slate-100',
        children: r.map((u) =>
              ...
              children: [
                ...
                p &&
                  ...
                  e.jsxs('span', {
                    ...
                    children: [e.jsx(ja, { size: 11 }), ' dinámico']
                  }),
                c &&
                  (!p || !u.dinamico) &&
                  e.jsx('button', {
...
function Ss({ rows: r, roles: c, form: p, setForm: u, onAssign: l, onRemove: m, canEdit: w }) {
  return e.jsxs('div', {
    className: 'rounded-2xl border border-slate-200 bg-white overflow-hidden',
    children: [
      e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('div', {
              ...
              children: e.jsxs('button', {
                ...
                children: [e.jsx(V, { size: 16 }), ' Asignar rol']
              })
            })
          ]
        }),
...
function Ct() {
  var Se, Z, a;
  const { hasPermission: r, user: c } = Je(),
    p =
      r('manage_roles') ||
      (c == null ? void 0 : c.rol) === 'ADMIN' ||
      (c == null ? void 0 : c.es_admin_delegado),
    ...
    [A, R] = n.useState(''),
    [P, we] = n.useState(''),
    [W, He] = n.useState({ role: '', scopeType: 'global', scopeCode: '' }),
    ...
    $ = n.useCallback(async () => {
      (_e(!0), Pe(null));
      try {
        const [s, o, g] = await Promise.all([Ta(), qa(), La()]);
    ...
    B = n.useCallback(async (s) => {
      if (s)
        try {
          const [o, g] = await Promise.all([Ua(s.id), ps('team', s.id)]);
          (T(o),
            D(g),
            C({
              id: s.id,
    ...
    J = n.useCallback(async (s) => {
      ...
      if (s)
        try {
          const [O, he] = await Promise.all([Fa(s.id), ps('group', s.id)]);
          (E(O),
            t(he),
            j({
              id: s.id,
          ...
          b.error(O.message || 'No se pudo cargar el detalle del grupo');
        }
    }, []);
  (n.useEffect(() => {
    $();
  ...
  const $e = n.useMemo(() => {
    ...
    We = async () => {
      ...
      const s = await Ka(d.id);
      if (!(s != null && s.ok))
        return b.error((s == null ? void 0 : s.error) || 'No se pudo eliminar el equipo');
      (b.success('Equipo eliminado'), _(null), C(es), T([]), D([]), await $());
    },
    X = async () => {
      const s = await Ja(f);
      if (!(s != null && s.ok))
    ...
    Ce = async () => {
      const s = await Ya((x == null ? void 0 : x.tipo) === 'dynamic' ? x.id : null);
      if (!(s != null && s.ok))
        return b.error(
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className:
                          'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                        children: [e.jsx(H, { size: 12 }), ' Equipos (', i.length, ')']
                      }),
                      i.length
                        ? e.jsx('div', {
                            className: 'divide-y divide-slate-100',
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsx('h3', {
                                  ...
                                  children: v.id ? 'Editar equipo' : 'Nuevo equipo'
                                }),
                                v.id
                                  ? e.jsx('button', {
                                      onClick: () => C(es),
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    className:
                                      'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                                    children: [e.jsx(is, { size: 12 }), ' Miembros del equipo']
                                  }),
                                  e.jsx(Cs, {
                                    rows: I,
                                    onRemove: p
                                      ? async (s) => {
                                          const o = await Ga(d.id, s);
                                          if (!(o != null && o.ok))
                                            return b.error(
                                              (o == null ? void 0 : o.error) || 'No se pudo quitar'
                                            );
                                          (b.success('Miembro removido'), await B(d), await $());
                                        }
                                      : null
                                  })
                                ]
                              ...
                              e.jsx(Ss, {
                                ...
                                onRemove: p
                                  ? async (s) => {
                                      ...
                                      (b.success('Asignación revocada'), await B(d), await $());
                                    }
                                  : null,
                                canEdit: p
                              })
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className:
                          'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                        children: [e.jsx(os, { size: 12 }), ' Grupos (', S.length, ')']
                      }),
                      S.length
                        ? e.jsx('div', {
                            className: 'divide-y divide-slate-100',
                              ...
                              children: [
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('input', {
                                      value: f.codigo,
                                      onChange: (s) =>
                                        j((o) => ({ ...o, codigo: s.target.value.toUpperCase() })),
                                      className: `${q} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('input', {
                                      value: f.nombre,
                                      onChange: (s) => j((o) => ({ ...o, nombre: s.target.value })),
                                      className: `${q} mt-1`
                                    })
                                  ]
                                }),
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsxs('select', {
                                      value: f.tipo,
                                      onChange: (s) => j((o) => ({ ...o, tipo: s.target.value })),
                                      className: `${q} mt-1`,
                                      children: [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('div', {
                                    className:
                                      'px-4 py-2.5 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-wide flex items-center gap-1.5',
                                    children: [e.jsx(is, { size: 12 }), ' Miembros del grupo']
                                  }),
                                  e.jsx(Cs, {
                                    rows: N,
...
const St = [
  { id: 'usuarios', label: 'Usuarios', icon: H, path: '/admin/users' },
  { id: 'roles', label: 'Roles y Permisos', icon: xe, path: '/admin/roles' },
  { id: 'scopes', label: 'Ámbitos', icon: Be, path: '/admin/roles?vista=scopes' },
  { id: 'teams', label: 'Equipos y Grupos', icon: os, path: '/admin/roles?vista=teams' },
  {
    id: 'sesiones',
    label: 'Sesiones',
    icon: fa,
  ...
  { id: 'accesos', label: 'Accesos', icon: Us, path: '/admin/roles?vista=accesos', soloAdmin: !0 },
  {
    id: 'auditoria',
    label: 'Auditoría',
    icon: xs,
  ...
  { id: 'escala', label: 'Escala', icon: qs, path: '/admin/roles?vista=escala', soloAdmin: !0 },
  {
    id: 'politicas',
    label: 'Políticas',
    icon: rs,
...
function Mt() {
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      e.jsx('div', {
        className: 'flex gap-2 flex-wrap',
        children: St.filter((h) => !h.soloAdmin || u).map(({ id: h, label: S, icon: k, path: d }) =>
          e.jsxs(
            'button',
            {
              onClick: () => c(d),
      ...
      i === 'usuarios' && e.jsx(Xa, { embedded: !0 }),
      i === 'roles' && e.jsx(ce, { embedded: !0 }),
      i === 'scopes' && e.jsx(ot, {}),
      i === 'teams' && e.jsx(Ct, {}),
      i === 'sesiones' && (u ? e.jsx(dt, {}) : e.jsx(ce, { embedded: !0 })),
      i === 'accesos' && (u ? e.jsx(kt, {}) : e.jsx(ce, { embedded: !0 })),
      i === 'auditoria' && (u ? e.jsx(bt, {}) : e.jsx(ce, { embedded: !0 })),
      i === 'escala' && (u ? e.jsx(ht, {}) : e.jsx(ce, { embedded: !0 })),
      i === 'politicas' && (u ? e.jsx(Nt, {}) : e.jsx(ce, { embedded: !0 })),
      i === 'delegaciones' && (u ? e.jsx(yt, {}) : e.jsx(ce, { embedded: !0 }))
    ]
  });
}
