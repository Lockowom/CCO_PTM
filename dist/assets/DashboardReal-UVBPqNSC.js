...
import { _ as De, s as ce } from './index-BGSkqVb2.js';
import { t as Ie } from './ui-vendor-D-GGkV9M.js';
...
function pt({ data: t, onSelectEstado: s }) {
  return e.jsx('div', {
  ...
  const s = ({ active: n, payload: l, label: r }) => {
    ...
    return e.jsxs('div', {
      ...
      children: [
        ...
        e.jsxs('p', {
          className: `mt-1 font-semibold ${h >= 0 ? 'text-green-700' : 'text-red-600'}`,
          children: [
            h >= 0 ? `Cola reducida en ${h}` : `Cola aumentó en ${Math.abs(h)}`,
            ' ',
            'N.V.'
          ]
        })
            ...
            ? e.jsxs(dt, {
                ...
                children: [
                  ...
                  e.jsx(xt, {
                    ...
                    radius: [4, 4, 0, 0],
                    children: t.map((x, f) =>
                      e.jsx(mt, { fill: l === 'dias' ? gt(x.dias) : jt(x.pctAtiempo) }, f)
                    )
                  })
                ]
              })
...
function At({ onFilter: t, defaultFrom: s, defaultTo: n }) {
  const [l, r] = c.useState(() => Ve('panel_filter_from', s)),
    [a, h] = c.useState(() => Ve('panel_filter_to', n));
  function m(p, d) {
    (r(p), h(d), vt(p, d), t(p, d));
  }
  const x = [
...
const Ue = {
  ...
  wt = { REZAGADA_COMERCIAL: 'Rezagada comercial', RETIRO_CLIENTE: 'Retiro de cliente' },
  Ke = (t) => wt[t] || t || '—',
  Ge = (t) => {
...
`),
  ...
  ((x.href = m), (x.download = `NVs_${f}_${p}.csv`), x.click(), URL.revokeObjectURL(m));
}
const j = 'bg-white',
  P = 'bg-blue-50/60',
  w = 'bg-amber-50/60';
function Ct({ estado: t, data: s, loading: n, onClose: l }) {
  if (
    (c.useEffect(() => {
      function a(h) {
        h.key === 'Escape' && l();
                          ...
                          'tr',
                          {
                            ...
                            children: [
                              ...
                              e.jsx('td', {
                                ...
                                children: I(a.fecha_registro_nv)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 whitespace-nowrap`,
                                children: I(a.fecha_aprobacion)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 whitespace-nowrap`,
                                children: I(a.fecha_aprobacion_real)
                              }),
                              e.jsx('td', {
                                className: `${P} px-3 py-2 text-center`,
                                children:
                                ...
                                children:
                                  a.dias_atraso_ingreso > 0
                                    ? e.jsx('span', {
                                        ...
                                        children: I(a.fecha_promesa_efectiva)
                                      })
                                    : I(a.fecha_promesa_efectiva)
                              }),
                              e.jsx('td', {
                                className: `${w} px-3 py-2 text-center`,
                                children:
                                ...
                                e.jsxs(e.Fragment, {
                                  children: [
                                    ...
                                    e.jsx('td', {
                                      ...
                                      children: I(a.shipping_pausa_desde)
                                    }),
                                    e.jsx('td', {
...
const Et = (t) => oe(t, '—');
function Tt({ open: t, data: s, loading: n, onClose: l }) {
  return (
    c.useEffect(() => {
      function r(a) {
        a.key === 'Escape' && l();
...
function Rt({ open: t, data: s, onClose: n }) {
  return (
    c.useEffect(() => {
      function l(r) {
        r.key === 'Escape' && n();
                          ...
                          e.jsx('tbody', {
                            children: s.detalle.map((l, r) =>
                              e.jsxs(
                                'tr',
                                {
                                  className: `border-t border-gray-100 ${Lt(l.diasVencido)}`,
                                  children: [
                                    e.jsx('td', {
                                      className: 'px-3 py-2 font-semibold',
                                      style: { color: '#f57c00' },
                                    ...
                                    e.jsx('td', {
                                      className: 'px-3 py-2 whitespace-nowrap',
                                      children: _t(l.fecha_compromiso)
                                    })
                                  ]
                                },
                                r
...
function Vt({
  ...
  return (
    ...
    e.jsxs('span', { className: a, children: [l, h, r] })
  );
}
function Ot({ children: t, glowColor: s = '245,124,0', className: n = '', onClick: l }) {
  const r = c.useRef(null),
    a = (h) => {
      const m = r.current;
      if (!m) return;
      const x = m.getBoundingClientRect();
      (m.style.setProperty('--mx', `${h.clientX - x.left}px`),
        m.style.setProperty('--my', `${h.clientY - x.top}px`));
    };
  return e.jsxs('div', {
    ref: r,
    onMouseMove: a,
...
function Mt({ title: t, value: s, subtitle: n, color: l = '#f57c00', icon: r, onClick: a }) {
  const h = typeof s == 'number',
    m = typeof s == 'string' && /^\d+([.,]\d+)?%$/.test(s),
    x = h ? s : m ? parseFloat(s.replace(',', '.')) : null;
  return e.jsxs(Ot, {
    glowColor: nt(l),
    onClick: a,
    ...
    children: [
      ...
      e.jsx('div', {
        ...
        style: { color: l },
        children: x !== null ? e.jsx(Vt, { end: x, decimals: m ? 1 : 0, suffix: m ? '%' : '' }) : s
      }),
...
const J = c.memo(Mt);
function Ft({ kpis: t, onDetalle: s }) {
  var n, l, r, a;
  return e.jsxs('div', {
...
function zt({ calidadData: t, onOpen: s }) {
  return t.total > 0
    ? e.jsxs('button', {
        onClick: s,
        className:
...
function Bt({
  ...
  const x = c.useRef(null),
    ...
    $ = (v) => {
      (p(!0), v.target.setPointerCapture(v.pointerId), r(R(v.clientX)));
    },
    T = (v) => {
      f && r(R(v.clientX));
    },
  ...
  const F = d !== 0 ? `scaleX(${1 + Math.abs(d) * 0.04}) translateX(${d * 6}px)` : 'scaleX(1)';
  return e.jsxs('div', {
...
function Kt({ rankTransp: t, rankVend: s }) {
  return e.jsxs('div', {
...
function Gt({ data: t = [], onOpenIncidencias: s }) {
...
async function Yt({
  ...
  const $ = await De(
    ...
    T = await De(() => import('./vfs_fonts-8ICcZKi6.js').then((o) => o.v), __vite__mapDeps([2, 1])),
    _ = $.default || $,
    F = T.default || T;
  _.vfs = ((C = F.pdfMake) == null ? void 0 : C.vfs) || F.vfs || _.vfs;
  const v = `${(t == null ? void 0 : t.from) || 'Inicio'} al ${(t == null ? void 0 : t.to) || 'Hoy'}`,
    z = new Date().toLocaleString('es-CL'),
    b = [
      {
        columns: [
          {
...
DASHBOARD`,
          ...
          },
          {
            ...
            stack: [
              ...
              { text: `Actualizado: ${z}`, fontSize: 6.5, color: '#94a3b8', margin: [0, 3, 0, 0] }
            ]
          }
        ],
        margin: [0, 0, 0, 14]
...
`,
      ...
      },
      {
        columns: [
          ...
          Q(
            'Fill rate',
            G((k = s == null ? void 0 : s.fillRateShipping) == null ? void 0 : k.pct),
            'Salida de En Proceso según compromiso',
            le
          ),
          Q(
            'Shipping pausadas',
            ((B = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : B.total) || 0,
            `${((U = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : U.rezagadaComercial) || 0} comercial · ${((D = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : D.retiroCliente) || 0} retiro · ${((X = s == null ? void 0 : s.shippingPausadas) == null ? void 0 : X.excluidasSla) || 0} excluidas de SLA`,
            '#7c3aed'
          )
        ],
        columnGap: 7,
  ...
  (f.length &&
    ...
    b.push(
      S(
        ...
        p.map((o) => [o.nombre, o.total, G(o.pctATiempo), re(o.tardanzaProm)]),
        ['*', 'auto', 'auto', 'auto']
      )
    ),
    b.push(
    ...
    b.push(
      S(
        ...
        Array.from({ length: Math.max(g.length, l.length) }, (o, L) => {
          var K, te, u, se;
          return [
            ((K = g[L]) == null ? void 0 : K.division) || y,
            ((te = g[L]) == null ? void 0 : te.cantidad) ?? y,
            ((u = l[L]) == null ? void 0 : u.estado) || y,
            ((se = l[L]) == null ? void 0 : se.count) ?? y
          ];
        }),
        ['35%', '15%', '35%', '15%']
      )
    ...
    _.createPdf({
      ...
      content: b,
      footer: (o, L) => ({
        text: `CCO | Panel PTM | ${v} | Página ${o} de ${L}`,
        alignment: 'center',
        color: '#94a3b8',
        fontSize: 7,
        margin: [0, 5, 0, 0]
...
function ns() {
  const [t, s] = c.useState(null),
    ...
    A = c.useCallback(
      async (i, N) => {
        (X(!0), L(null), se({ from: i, to: N }));
        try {
          const O = await Re(i, N);
          ae(O);
        } catch (O) {
          (console.error('Error loading data:', O),
            L('Error al cargar los datos. Verifica tu conexión e intenta de nuevo.'));
        }
        X(!1);
      },
      [ae]
  ...
  c.useEffect(() => {
    ...
    (A(i.from, i.to),
      ot()
        .then((N) => {
          N.operadores.length > 0 && k(N.operadores);
        })
        .catch(() => {}),
      ct(6)
        .then((N) => U(N))
    ...
    c.useEffect(() => {
      ...
      const N = () => {
        ...
        O = ce
          ...
          .subscribe();
      return () => {
        (i && clearTimeout(i), ce.removeChannel(O));
      };
    }, [A]));
  ...
  return (
    c.useEffect(() => {
      ((V.current = 120), Z(120));
      const i = setInterval(() => {
        if (((V.current -= 1), Z(V.current), V.current <= 0)) {
          if (((V.current = 120), Z(120), typeof document < 'u' && document.hidden)) return;
          A(u.from, u.to);
        }
      }, 1e3);
    ...
    c.useEffect(() => {
      const i = () => {
        typeof document < 'u' &&
          !document.hidden &&
          ((V.current = 120), Z(120), A(q.current.from, q.current.to));
      };
      return (
        ...
        ? e.jsx('div', {
            ...
            children: e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('p', { className: 'text-gray-500 mb-4', children: o }),
                e.jsx('button', {
            ...
            children: [
                ...
                children: e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      className: 'flex items-center gap-4',
                      children: [
                        e.jsx(At, { onFilter: A, defaultFrom: ue, defaultTo: fe }),
                        e.jsxs('button', {
                          onClick: tt,
                          disabled: D || Y || !t,
                          className:
                          ...
                          children: [
                            e.jsx('svg', {
                              className: `w-3.5 h-3.5 ${Y ? 'animate-bounce' : ''}`,
                              fill: 'none',
                              stroke: 'currentColor',
                              viewBox: '0 0 24 24',
                              children: e.jsx('path', {
                            ...
                            e.jsx('span', { children: Y ? 'Generando...' : 'Descargar PDF' })
                          ]
                        }),
                        e.jsxs('button', {
                          onClick: () => {
                            ((V.current = 120), Z(120), A(u.from, u.to));
                          },
                          disabled: D,
                          className:
              ...
              e.jsxs('main', {
                ...
                children: [
                  ...
                  e.jsx(Dt, { kpis: t, onSelect: ne }),
                  e.jsx(Ft, { kpis: t, onDetalle: ne }),
                  e.jsx(zt, { calidadData: _e, onOpen: () => Te(!0) }),
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [
                          e.jsx(ut, { data: n, onSelectEstado: ne }),
                          e.jsx('div', {
                            className: 'table-container',
                            children: e.jsxs('table', {
                              children: [
                      ...
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [e.jsx(bt, { data: h }), e.jsx(yt, { data: p })]
                      })
                    ]
                  }),
                  e.jsx(kt, { tiemposCiclo: g }),
                  e.jsx(Ut, { alertasOp: z }),
                  e.jsx(Gt, { data: F, onOpenIncidencias: et }),
                  e.jsx(Kt, { rankTransp: R, rankVend: T }),
                  e.jsx(Wt, { auditKpis: C }),
                  e.jsx(Ht, { divisions: r }),
                  e.jsx(Xt, { tendencia: B }),
                  e.jsxs('div', {
                    className: 'text-center text-xs text-gray-400 py-4',
                    children: ['Fecha de la última actualización: ', K]
                  })
                ]
              }),
              ge && e.jsx(Ct, { estado: ge, data: We, loading: He, onClose: () => je(null) }),
              ve && e.jsx(Tt, { open: ve, data: Xe, loading: Ye, onClose: () => Ae(!1) }),
              Ce && e.jsx(Rt, { open: Ce, data: Ze, onClose: () => qe(!1) }),
