...
import { u as ze, r as l } from './react-vendor-6aw4XXjH.js';
import {
  c0 as ei,
  a1 as Ee,
  bk as fe,
...
import { s as Oe, u as Si } from './index-puW0B3h7.js';
...
const Yi = {
    ...
    sourceVersion: '1.55.144',
    fingerprint: '1a626bd5f2cd',
    totals: {
      module: 10,
      screen: 67,
      component: 29,
  ...
  es = [
    ...
    },
    {
      ...
      description: `Asigna este dispositivo a un canal (requiere que el canal permita "self-assign" en el panel de Capgo). Al volver a 'production' se deshace.`,
    ...
    },
    {
      ...
      description:
        'Cliente del despliegue OTA (Edge Function `capgo-deploy`). La API key de Capgo NO está aquí — vive solo en la función; estas llamadas van con el JWT de la sesión (Supabase lo adjunta) y la función verifica el permiso `deploy_ota`. Lista los',
      signature: 'listarDespliegueOTA()',
      source: 'src/services/otaDeployService.js',
      operations: ['Edge Function'],
      resources: [{ kind: 'edge-function', name: 'capgo-deploy' }]
    },
    {
      status: 'activo',
    ...
    },
    {
      ...
      description: 'Elimina un bundle viejo de Capgo (limpieza). No toca canales activos.',
    ...
    },
    {
      ...
      source: 'src/services/otaDeployService.js',
      operations: ['RPC'],
      resources: [{ kind: 'rpc', name: 'ota_dispositivos_resumen' }]
    },
    {
      status: 'activo',
    ...
    },
    {
      ...
      description: '── Aviso por push (Capgo/FCM) de una nueva versión ──────────────────────────',
    ...
    {
      status: 'activo',
      id: 'resource:rpc:ota-dispositivos-resumen',
      kind: 'rpc',
      module: 'admin',
      label: 'ota_dispositivos_resumen',
      description: 'RPC utilizada por la aplicación.',
      source: null
    },
    {
    ...
    },
    {
      ...
      description:
        'Ejecuta handle move; participa en lectura, actualización, eliminación sobre wms_ubicaciones.',
      signature: 'handleMove(item, newUbicacion)',
      source: 'src/pages/Admin/LocationManager.jsx',
      operations: ['lectura', 'actualización', 'eliminación'],
      resources: [{ kind: 'table', name: 'wms_ubicaciones' }]
    },
    {
      status: 'activo',
      ...
      description: 'Ejecuta handle delete; participa en eliminación sobre wms_ubicaciones.',
    ...
    },
    {
      ...
      description:
        'Ejecuta build visual location rows; participa en creación sobre wms_putaway_ubicaciones, tms_historial_cargas.',
      signature: 'buildVisualLocationRows(items)',
      source: 'src/pages/Inbound/Entry.jsx',
      operations: ['creación'],
      resources: [
        { kind: 'table', name: 'wms_putaway_ubicaciones' },
        { kind: 'table', name: 'tms_historial_cargas' }
      ]
    },
    {
      status: 'activo',
      id: 'resource:table:wms-putaway-ubicaciones',
      kind: 'table',
      module: 'inbound',
      label: 'wms_putaway_ubicaciones',
      description: 'Tabla utilizada por la aplicación.',
      source: null
    },
    {
    ...
    },
    {
      ...
      description:
        'Consulta fetch consolidados sobre consolidados, consolidado_nvs y entrega el resultado a la interfaz.',
      signature: 'fetchConsolidados()',
      source: 'src/pages/Panel/dash/dashData.js',
      operations: ['lectura'],
      resources: [
        { kind: 'table', name: 'consolidados' },
        { kind: 'table', name: 'consolidado_nvs' }
      ]
    },
    {
      status: 'activo',
    ...
    {
      status: 'activo',
      id: 'resource:table:consolidados',
      kind: 'table',
      module: 'panel',
      label: 'consolidados',
      description: 'Tabla utilizada por la aplicación.',
    ...
    {
      status: 'activo',
      id: 'resource:table:consolidado-nvs',
      kind: 'table',
      module: 'panel',
      label: 'consolidado_nvs',
      description: 'Tabla utilizada por la aplicación.',
      source: null
    },
    {
      ...
      label: 'run',
      displayLabel: 'Run',
      description: 'Ejecuta run; participa en lectura sobre consolidado_nvs.',
      signature: 'run()',
      source: 'src/pages/Panel/dash/dashData.js',
      operations: ['lectura'],
      resources: [{ kind: 'table', name: 'consolidado_nvs' }]
    },
    {
      status: 'activo',
  ...
  is = [
    ...
    {
      id: 'connection:495',
      from: 'function:src-services-mobileservice-js:buscarActualizacion',
      to: 'resource:rpc:registrar-ota-aplicado',
      relation: 'ejecuta',
      label: 'ejecuta rpc'
    },
    ...
    },
    {
      ...
      to: 'resource:rpc:ota-dispositivos-resumen',
      relation: 'ejecuta',
      label: 'ejecuta rpc'
    },
    {
    ...
    },
    {
      ...
      to: 'resource:table:wms-putaway-ubicaciones',
      relation: 'escribe',
      label: 'escribe table'
    },
    {
    ...
    },
    {
      ...
      to: 'resource:table:consolidados',
      relation: 'lee',
      label: 'lee table'
    },
    {
      id: 'connection:1243',
      from: 'action:src-pages-panel-dash-dashdata-js:fetchConsolidados',
      to: 'resource:table:consolidado-nvs',
      relation: 'lee',
      label: 'lee table'
    },
    {
  ...
  k = { meta: Yi, modules: Zi, countsByModule: Ji, nodes: es, connections: is },
  be = {
...
function we({ node: o, relation: m, onSelect: g, direction: _ }) {
  return o
    ? e.jsxs('button', {
        type: 'button',
        onClick: () => g(o.id),
    ...
    children: [
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          ((T = o.permissions) == null ? void 0 : T.length) > 0 &&
            e.jsxs('div', {
              children: [
                e.jsxs('p', {
                  className:
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('p', {
                    className:
                      'flex items-center gap-1 text-[9px] font-black uppercase tracking-[0.15em] text-slate-400',
                    children: [e.jsx(de, { size: 11 }), ' Conexiones directas']
                  }),
                  e.jsx('span', {
        ...
        children: [
          ...
          e.jsx('div', {
            ...
            children: [
              ...
              ['Conexiones', k.connections.length, de, 'text-rose-600']
            ].map(([s, y, j, B]) =>
              e.jsxs(
                'div',
                {
                  ...
                  children: e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsxs('span', {
                        ...
                        children: [H.length, ' entradas · ', w.length, ' salidas']
                      })
                    ]
                  })
                }),
                  ...
                  children: [
                    e.jsxs('div', {
                      children: [
                        ...
                        e.jsxs('p', {
                          className: 'mt-0.5 text-[10px] text-slate-500',
                          children: [q.length, ' elementos coinciden con los filtros actuales.']
                        })
                      ]
                    }),
                    e.jsxs('select', {
                  ...
                  children: [
                      ...
                      .map((s) =>
                        e.jsxs(
                          'button',
                          {
                            type: 'button',
                            onClick: () => p(s.id),
                            className: `flex w-full items-center gap-3 px-4 py-3 text-left transition hover:bg-orange-50/50 ${u === s.id ? 'bg-orange-50' : ''}`,
                            children: [
                    ...
                    q.length === 0 &&
                      e.jsx('div', {
                        ...
                        children: e.jsxs('div', {
                          children: [
                            e.jsx(ue, { size: 28, className: 'mx-auto text-slate-300' }),
                            e.jsx('p', {
...
const ie = {
  ...
  qe = (o) => (rs.find(([m]) => m.test(o || '')) || [])[1] || null,
  ts = {
    'master-data':
...
function ls() {
  ...
  const o = ze(),
    ...
    [T, F] = l.useState('Flujo Maestro CCO'),
    [u, p] = l.useState(!1),
    [b, ae] = l.useState(!1),
    [U, K] = l.useState(''),
    [d, S] = l.useState(null),
    ...
    ne = l.useCallback(
      async (i) => {
        ...
        (n ||
          ...
          z(null),
          I(null),
          requestAnimationFrame(() => X(n.nodes)));
      },
      [X]
    );
  l.useEffect(() => {
  ...
  const Fe = (i) => {
    ...
    Z = l.useCallback(() => {
      d &&
        (d.kind === 'node'
          ? P((i) => ({
              nodes: i.nodes.filter((a) => a.id !== d.id),
              edges: i.edges.filter((a) => a.from !== d.id && a.to !== d.id)
            }))
          : P((i) => ({ ...i, edges: i.edges.filter((a) => a.id !== d.id) })),
        S(null),
        D());
    }, [d]);
  l.useEffect(() => {
  ...
  const We = async () => {
    ...
    Xe = () => {
      const i = new Blob(
          [
            JSON.stringify(
              { _meta: { titulo: T, codigo: f }, nodes: h.nodes, edges: h.edges },
              null,
              2
            )
          ],
      ...
      ((n.onload = () => {
        try {
          ...
          (P({ nodes: t.nodes.map((v) => ({ ...v })), edges: t.edges.map((v) => ({ ...v })) }),
            re(t),
            D(),
            requestAnimationFrame(() => X(t.nodes)),
    ...
    _e = q && qe(q.label),
    R = (d == null ? void 0 : d.kind) === 'node' ? W[d.id] : null,
    Q = (d == null ? void 0 : d.kind) === 'edge' ? h.edges.find((i) => i.id === d.id) : null,
    Je = [
      ['tarea', fi],
      ['decision', gi],
      ['inicio', ji],
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      e.jsxs('div', {
        ...
        onPointerUp: ye,
        onPointerLeave: ye,
        className: `relative overflow-hidden rounded-2xl border [background-size:22px_22px] select-none ${E.border} ${w ? 'bg-[radial-gradient(rgba(148,163,184,0.14)_1px,transparent_1px)]' : 'bg-[radial-gradient(theme(colors.slate.200)_1px,transparent_1px)] bg-white'} ${C !== null ? 'cursor-crosshair' : 'cursor-grab active:cursor-grabbing'}`,
        style: {
        ...
        children: [
            ...
            children: [
                ...
                children: [
                  ...
                  h.edges.map((i) => {
                    ...
                    const r = ke(a, n.x + n.w / 2, n.y + n.h / 2),
                      ...
                      v = (r.x + t.x) / 2,
                      c = (r.y + t.y) / 2,
                      O = (d == null ? void 0 : d.kind) === 'edge' && d.id === i.id;
                    return e.jsxs(
                      'g',
                      {
                        children: [
              ...
              h.nodes.map((i) => {
                const a = { ...(ie[i.type] || ie.tarea), ...(A[i.type] || A.tarea) },
                  ...
                  r = (d == null ? void 0 : d.kind) === 'node' && d.id === i.id,
                  t = C === i.id,
                  v = i.color || a.border;
                return e.jsxs(
                  'div',
          ...
          b &&
            (R || Q) &&
            e.jsxs('div', {
              className: `absolute top-3 right-3 w-60 border rounded-xl shadow-lg p-3 space-y-2.5 ${w ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`,
              children: [
                e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('label', {
                        ...
                        children: [
                          ...
                          e.jsx('textarea', {
                            rows: 2,
                            value: R.label,
                            onChange: (i) => Y(R.id, { label: i.target.value }),
                            className:
                        ...
                        children: [
                          ...
                          e.jsxs('select', {
                            ...
                            onChange: (i) => {
                              ...
                              Y(R.id, { type: a, w: ie[a].dim[0], h: ie[a].dim[1], color: void 0 });
                            },
                            className:
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            type: 'color',
                            value: R.color || A[R.type].border,
                            onChange: (i) => Y(R.id, { color: i.target.value }),
                            className: 'w-8 h-8 rounded border border-slate-200 p-0.5'
                          }),
                          R.color &&
                            e.jsx('button', {
                              onClick: () => Y(R.id, { color: void 0 }),
                              className:
          ...
          q &&
            !b &&
            e.jsxs('div', {
              className: `absolute bottom-3 right-3 w-64 border rounded-xl shadow-lg p-3 ${w ? 'bg-slate-900 border-slate-700' : 'bg-white border-slate-200'}`,
              children: [
                e.jsxs('div', {
                ...
                e.jsx('p', {
                  className: `text-[14px] font-black mt-0.5 whitespace-pre-line ${w ? 'text-slate-100' : 'text-slate-800'}`,
                  children: q.label
                }),
                _e
                  ? e.jsxs('button', {
          ...
          e.jsxs('div', {
            className: `absolute bottom-3 left-3 backdrop-blur border rounded-xl px-3 py-2 flex flex-wrap items-center gap-3 text-[10px] ${w ? 'bg-slate-900/80 border-slate-700 text-slate-300' : 'bg-white/90 border-slate-200 text-slate-500'}`,
            children: [
              e.jsxs('span', {
