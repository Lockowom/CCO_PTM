import { d as P, j as l } from './query-vendor-CojWQiBV.js';
import { r as y, b as $, R as K } from './react-vendor-CA7EHQ1X.js';
import { u as H } from './warehouseStore-CfvqF2TD.js';
import { s as q } from './index-CXl7fTg4.js';
import { C as J } from './CalidadBadge-WT_094hA.js';
import {
  n as G,
  z as F,
  X,
...
import './calidadService-Dmu7CNeU.js';
function ie(r, c, t) {
  const s = new Array(r);
  return new Proxy(s, {
    get(e, n, o) {
...
function k(r, c, t) {
  ...
  function o() {
    const i = r();
    return (
      (i.length !== s.length || i.some((u, m) => s[m] !== u)) &&
        ((s = i),
        (e = c(...i)),
...
const oe = (r, c) => Math.abs(r - c) < 1.01,
  re = (r, c, t) => {
    let s;
    return function (...e) {
      (r.clearTimeout(s), (s = r.setTimeout(() => c.apply(this, e), t)));
    };
  };
let N;
const W = () => {
    ...
    return (N = navigator.platform === 'MacIntel' && r !== void 0 && r > 0);
  },
  D = (r) => {
    const { offsetWidth: c, offsetHeight: t } = r;
    return { width: c, height: t };
  },
  le = (r) => r,
  ae = (r) => {
    const c = Math.max(r.startIndex - r.overscan, 0),
      s = Math.min(r.endIndex + r.overscan, r.count - 1) - c + 1,
      e = new Array(s);
    ...
    const n = new s.ResizeObserver((o) => {
      const i = () => {
        ...
        if (a != null && a.borderBoxSize) {
          ...
          if (u) {
            e({ width: u.inlineSize, height: u.blockSize });
            return;
          }
        }
        e(D(t));
  ...
  A = { passive: !0 },
  he = typeof window > 'u' ? !0 : 'onscrollend' in window,
  de = (r, c, t) => {
    const s = r.scrollElement;
    if (!s) return;
    const e = r.targetWindow;
    if (!e) return;
    const n = r.options.useScrollendEvent && he;
    let o = 0;
    const i = n ? null : re(e, () => c(o, !1), r.options.isScrollingResetDelay),
      a = (x) => () => {
      ...
      m = a(!1);
    return (
      s.addEventListener('scroll', u, A),
      n && s.addEventListener('scrollend', m, A),
      () => {
        (s.removeEventListener('scroll', u), n && s.removeEventListener('scrollend', m));
      }
    );
  },
  ue = (r, c) =>
    de(r, c, (t) => {
      const { horizontal: s, isRtl: e } = r.options;
  ...
  fe = (r, { adjustments: c = 0, behavior: t }, s) => {
    var e, n;
    (n = (e = s.scrollElement) == null ? void 0 : e.scrollTo) == null ||
      n.call(e, { [s.options.horizontal ? 'left' : 'top']: r + c, behavior: t });
  },
  ge = fe;
class pe {
  constructor(c) {
    ((this.unsubs = []),
                ...
                e.forEach((n) => {
                  const o = () => {
                    ...
                    if (!i.isConnected) {
                      ...
                      for (const [u, m] of this.elementsCache)
                        if (m === i) {
        ...
        if (this.scrollElement !== s) {
          ...
          if (
            ...
            (e.addEventListener('touchstart', n, A),
              e.addEventListener('touchend', o, A),
              this.unsubs.push(() => {
        ...
        (
          ...
          if (
            ...
            for (let w = x; w < t; w++) {
              const M = n(w),
                _ = m.get(M),
                h = typeof _ == 'number' ? _ : this.options.estimateSize(w);
              ((g[w * 2] = E), (g[w * 2 + 1] = h), (E += h + f));
            }
            const j = ie(t, g, n);
            return ((this.measurementsCache = j), j);
          }
          const S = this.measurementsCache.slice(0, x),
            C = new Array(i).fill(void 0);
          for (let f = 0; f < x; f++) {
            const b = S[f];
            b && (C[b.lane] = f);
          }
          for (let f = x; f < t; f++) {
            ...
            let E, j;
            const w = a === 'estimate' || m.has(b);
            if (g !== void 0 && this.options.lanes > 1) {
              E = g;
              const d = C[E],
                p = d !== void 0 ? S[d] : void 0;
              j = p ? p.end + this.options.gap : s + e;
            } else {
              const d = this.options.lanes === 1 ? S[f - 1] : this.getFurthestMeasurement(S, f);
              ((j = d ? d.end + this.options.gap : s + e),
                (E = d ? d.lane : f % this.options.lanes),
                this.options.lanes > 1 && w && this.laneAssignments.set(f, E));
            }
            const M = m.get(b),
              _ = typeof M == 'number' ? M : this.options.estimateSize(f),
              h = j + _;
            ((S[f] = { index: f, start: j, size: _, end: h, key: b, lane: E }), (C[E] = f));
          }
      ...
      (this.resizeItem = (t, s) => {
        ...
        const u = this.itemSizeCache.get(i) ?? n,
          m = s - u;
        m !== 0 &&
      ...
      (this.getVirtualItemForOffset = (t) => {
        ...
        const e = this._flatMeasurements,
          ...
          o = B(0, s.length - 1, n ? (i) => e[i * 2] : (i) => L(s[i]).start, t);
        return L(s[o]);
      }),
  ...
  reconcileScroll() {
    ...
    if (!o && oe(e, this.getScrollOffset())) {
      ...
      const i = this.getSize() || 600,
        ...
        u = this.scrollState.behavior === 'smooth' && a > i;
      ((this.scrollState.lastTargetOffset = e),
        u || (this.scrollState.behavior = 'auto'),
        this._scrollToOffset(e, { adjustments: void 0, behavior: u ? 'smooth' : 'auto' }));
    }
    this.scheduleScrollReconcile();
  }
}
...
function xe({ measurements: r, outerSize: c, scrollOffset: t, lanes: s, flat: e }) {
  const n = r.length - 1,
    o = e ? (m) => e[m * 2] : (m) => r[m].start,
    i = e ? (m) => e[m * 2] + e[m * 2 + 1] : (m) => r[m].end;
  if (r.length <= s) return { startIndex: 0, endIndex: n };
  let a = B(0, n, o, t),
    u = a;
  if (s === 1) for (; u < n && i(u) < t + c;) u++;
  else if (s > 1) {
    const m = Array(s).fill(0);
    for (; u < n && m.some((S) => S < t + c);) {
      const S = r[u];
      ((m[S.lane] = S.end), u++);
    }
    const x = Array(s).fill(t + c);
    for (; a >= 0 && x.some((S) => S >= t);) {
      const S = r[a];
      ((x[S.lane] = S.start), a--);
    }
    ((a = Math.max(0, a - (a % s))), (u = Math.min(n, u + (s - 1 - (u % s)))));
  }
  return { startIndex: a, endIndex: u };
}
const U = typeof document < 'u' ? y.useLayoutEffect : y.useEffect;
function be({ useFlushSync: r = !0, ...c }) {
  const t = y.useReducer((n) => n + 1, 0)[1],
    s = {
      ...c,
      onChange: (n, o) => {
        var i;
        (r && o ? $.flushSync(t) : t(), (i = c.onChange) == null || i.call(c, n, o));
      }
    },
    [e] = y.useState(() => new pe(s));
  return (e.setOptions(s), U(() => e._didMount(), []), U(() => e._willUpdate()), e);
}
function ve(r) {
  return be({ observeElementRect: ce, observeElementOffset: ue, scrollToFn: ge, ...r });
}
function Se() {
  const { data: r = [], isLoading: c } = P({
      queryKey: ['calidad_flags'],
      queryFn: async () => {
        const { data: n, error: o } = await q
    ...
    { byCodigo: t, byCodigoUbic: s } = y.useMemo(() => {
      const n = new Map(),
        o = new Map();
      for (const i of r) {
        const a = (i.codigo_producto || '').toUpperCase(),
          u = n.get(a);
        if (((!u || i.severidad > u.severidad) && n.set(a, i), i.ubicacion)) {
          const m = `${a}::${(i.ubicacion || '').toUpperCase()}`,
            x = o.get(m);
          (!x || i.severidad > x.severidad) && o.set(m, i);
        }
      }
      return { byCodigo: n, byCodigoUbic: o };
    }, [r]);
  function e(n, o) {
    const i = (n || '').toUpperCase();
    if (o) {
      const a = s.get(`${i}::${(o || '').toUpperCase()}`);
      if (a) return a;
    }
    return t.get(i) || null;
  }
  return { flags: r, isLoading: c, byCodigo: t, byCodigoUbic: s, flagForItem: e };
}
const R = 92,
  V = 44,
  we = K.memo(({ group: r, searchQuery: c, isExpanded: t, onToggle: s, flagForItem: e }) => {
    const n = r.matchingItems,
      o = r.allItems.length,
      i = r.allItems.reduce((b, g) => b + (Number(g.cantidad) || 0), 0),
      a = n.reduce((b, g) => b + (Number(g.cantidad) || 0), 0),
      u = c.length > 0,
      m = u ? n : r.allItems,
      x = t ? m : m.slice(0, 1),
      S = u ? a : i,
        ...
        l.jsxs('div', {
          ...
          children: [
            ...
            l.jsxs('div', {
              ...
              children: [
                ...
                l.jsxs('div', {
                  ...
                  children: [
                    l.jsx(te, { size: 11 }),
                    l.jsx('span', { className: 'font-bold text-slate-500', children: C }),
                    l.jsx('span', { children: C === 1 ? 'SKU' : 'SKUs' })
                  ]
                })
              ]
            }),
            ...
            l.jsx('div', {
              ...
              children: t ? l.jsx(se, { size: 14 }) : l.jsx(ne, { size: 14 })
            })
          ]
        }),
        x.length > 0 &&
          l.jsxs('div', {
            ...
            children: [
              x.map((b, g) => {
                const E = e ? e(b.codigo, b.ubicacion || r.ubicacion) : null;
                return l.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      ...
                      E && l.jsx(J, { estado: E.estado_calidad, size: 'xs', title: E.nota }),
                      l.jsx('span', {
  ...
  Oe = () => {
    const { inventory: r, stats: c, loading: t, fetchWarehouseData: s } = H(),
      { flagForItem: e } = Se(),
      [n, o] = y.useState(''),
      [i, a] = y.useState('all'),
      [u, m] = y.useState(!0),
      [x, S] = y.useState(new Set()),
      C = y.useRef(null),
      f = y.useRef(null);
    (y.useEffect(() => {
      s();
      ...
      y.useEffect(() => {
        const h = (d) => {
          ...
          (d.ctrlKey || d.metaKey) &&
            d.key === 'k' &&
            (d.preventDefault(), (p = f.current) == null || p.focus());
        };
        return (
    ...
    const b = y.useMemo(() => {
        ...
        return (
          Object.entries(r).forEach(([d, p]) => {
            (h[d] || (h[d] = { ubicacion: d, allItems: [], matchingItems: [] }),
              (h[d].allItems = p));
          }),
          h
        );
          ...
          (d = d.map((p) => {
            ...
            return (
              h
                ? (I = p.allItems.filter(
                    (v) =>
                      (v.ubicacion || '').toLowerCase().includes(h) ||
                      (v.codigo || '').toLowerCase().includes(h) ||
                      (v.descripcion || '').toLowerCase().includes(h)
                  ))
                : (I = p.allItems),
              { ...p, matchingItems: I }
            );
          })),
          h && (d = d.filter((p) => p.matchingItems.length > 0)),
          i === 'stock'
            ? (d = d.filter((p) =>
                (h ? p.matchingItems : p.allItems).some((v) => Number(v.cantidad) > 0)
              ))
            : i === 'empty' &&
              (d = d.filter(
                (p) => p.allItems.reduce((I, v) => I + (Number(v.cantidad) || 0), 0) === 0
              )),
          d.sort((p, I) => {
            const v = p.ubicacion.localeCompare(I.ubicacion);
            return u ? v : -v;
          }),
          d
        );
      ...
      E = y.useMemo(() => {
        const h = g.length,
          d = g.reduce((I, v) => I + (n ? v.matchingItems : v.allItems).length, 0),
          p = g.reduce(
            (I, v) =>
              I +
              (n ? v.matchingItems : v.allItems).reduce((z, O) => z + (Number(O.cantidad) || 0), 0),
            0
          );
        return { totalLocations: h, totalItems: d, totalStock: p };
      }, [g, n]),
      j = y.useCallback((h) => {
        S((d) => {
          const p = new Set(d);
          return (p.has(h) ? p.delete(h) : p.add(h), p);
        });
      }, []),
      w = ve({
        count: g.length,
        ...
        estimateSize: (h) => {
          const d = g[h];
          if (!d) return R;
          const p = x.has(d.ubicacion),
            v = n.toLowerCase().trim() ? d.matchingItems : d.allItems;
          return p
            ? R + v.length * V + 8
            : R + (v.length > 0 ? V : 0) + (v.length > 1 ? 32 : 0) + 8;
        },
        overscan: 8
      });
    y.useEffect(() => {
    ...
    const M = y.useCallback(() => {
        const h = ['Ubicacion', 'Codigo', 'Descripcion', 'Cantidad'],
          d = [];
        g.forEach((O) => {
          (n ? O.matchingItems : O.allItems).forEach((T) => {
            d.push([
              `"${(T.ubicacion || '').replace(/"/g, '""')}"`,
              `"${(T.codigo || '').replace(/"/g, '""')}"`,
          ...
          children: l.jsxs('div', {
            ...
            children: [
              l.jsx('div', {
                ...
                children: l.jsx(G, { className: 'text-amber-500', size: 28, strokeWidth: 2.2 })
              }),
              l.jsx('h1', {
              ...
              l.jsxs('div', {
                ...
                children: [
                  l.jsx('div', {
                    ...
                    children: _.map((h) =>
                      l.jsx(
                        ...
                        {
                          onClick: () => a(h.key),
                          className: `px-3.5 py-1.5 rounded-md text-xs font-bold transition-all ${i === h.key ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`,
                          children: h.label
                        },
                        h.key
                      )
                  ...
                  l.jsxs('button', {
                    ...
                    children: [l.jsx(Q, { size: 13 }), ' ', u ? 'A→Z' : 'Z→A']
                  }),
                  l.jsxs('button', {
                    onClick: M,
                    className:
                    ...
                    children: [
                      l.jsx(Z, { size: 13 }),
                      ' ',
                      l.jsx('span', { className: 'hidden sm:inline', children: 'Exportar' })
                    ]
                  }),
                  l.jsx('button', {
                    onClick: () => s(!0),
                    ...
                    title: 'Actualizar',
                    children: l.jsx(Y, { size: 14, className: t ? 'animate-spin' : '' })
                  })
                ]
              })
            ]
          ...
          children: l.jsx('div', {
            ...
            children: n.trim()
              ? t && g.length === 0
                ...
                : g.length === 0
                  ? l.jsxs('div', {
                      className: 'flex flex-col items-center justify-center py-28',
                      children: [
                        l.jsx(ee, { size: 40, className: 'text-slate-200 mb-4' }),
                        l.jsx('h3', {
                  ...
                  : l.jsx('div', {
                      ...
                      children: w.getVirtualItems().map((h) => {
                        const d = g[h.index];
                        return l.jsx(
                          'div',
                          {
                            ...
                            style: { transform: `translateY(${h.start}px)`, paddingBottom: '8px' },
                            children: l.jsx(we, {
                              group: d,
                              searchQuery: n,
                              isExpanded: x.has(d.ubicacion),
                              onToggle: () => j(d.ubicacion),
                              flagForItem: e
                            })
                          },
                          d.ubicacion
              ...
              : l.jsxs('div', {
                  ...
                  children: [
                    l.jsx(F, { size: 40, className: 'text-slate-200 mb-4' }),
                    l.jsx('h3', {
                      className: 'text-base font-bold text-slate-400 mb-1',
