...
import {
  ...
  g as rt,
  h as lt
} from './dashData-Cl8oXyuE.js';
import { _ as _e, s as le } from './index-CbBUgauO.js';
import { t as $e } from './ui-vendor-CTbhg6u_.js';
...
function ot({ data: t, onSelectEstado: s }) {
  return e.jsx('div', {
            ...
            e.jsxs(
              'tr',
              {
                ...
                children: [
                  ...
                  e.jsx('td', {
                    className: 'text-left',
                    children: e.jsx('span', { className: ct(n.estado), children: n.estado })
                  }),
                  e.jsx('td', {
                    className: 'font-bold',
                    style: { color: '#f57c00' },
      ...
      e.jsx(De, {
        ...
        children: e.jsxs(Pe, {
          ...
          children: [
            ...
            e.jsx(ie, { dataKey: 'semana', tick: { fontSize: 10 }, interval: 'preserveStartEnd' }),
            e.jsx(de, { tick: { fontSize: 10 } }),
            e.jsx(xe, {
              contentStyle: {
                borderRadius: 8,
                border: 'none',
            ...
            e.jsx(Ye, { wrapperStyle: { fontSize: 11 } }),
            e.jsx(me, {
              type: 'monotone',
              dataKey: 'aprobadas',
              stroke: '#f57c00',
          ...
          s === 'barras'
            ? e.jsxs(qe, {
                ...
                children: [
                  ...
                  e.jsx(xe, { ...m }),
                  e.jsx(Le, { y: 0, stroke: '#ccc' }),
                  e.jsx(Ze, {
                    dataKey: r,
                    radius: [4, 4, 0, 0],
                    children: t.map((d, f) =>
                      e.jsx(Je, { fill: r === 'dias' ? mt(d.dias) : ht(d.pctAtiempo) }, f)
                    )
                  })
                ]
              })
...
function bt({ onFilter: t, defaultFrom: s, defaultTo: n }) {
  const [r, a] = l.useState(() => Re('panel_filter_from', s)),
    [o, p] = l.useState(() => Re('panel_filter_to', n));
  function m(h, i) {
    (a(h), p(i), ut(h, i), t(h, i));
  }
  const d = [
  ...
  const n = [
    ...
    a = s.map((i) =>
      [
        ...
        i.reabierta ? 'SI' : 'NO',
        i.motivo_reapertura || '',
        z(i.fecha_registro_nv),
        z(i.fecha_aprobacion),
        z(i.fecha_aprobacion_real),
        i.dif_aprobacion === null ? '' : i.dif_aprobacion,
        z(i.fecha_compromiso),
        z(i.fecha_promesa_efectiva),
...
`),
    ...
    f = (Oe[t] || t).replace(/[^\wáéíóúñ]+/gi, '_').replace(/^_+|_+$/g, ''),
    h = new Date().toISOString().slice(0, 10);
  ((d.href = m), (d.download = `NVs_${f}_${h}.csv`), d.click(), URL.revokeObjectURL(m));
}
const y = 'bg-white',
  R = 'bg-blue-50/60',
  T = 'bg-amber-50/60';
function gt({ estado: t, data: s, loading: n, onClose: r }) {
  return (
    l.useEffect(() => {
      function a(o) {
        o.key === 'Escape' && r();
                            ...
                            children: [
                              e.jsxs('tr', {
                                children: [
                                  ...
                                  e.jsx('th', {
                                    colSpan: 5,
                                    className: `${T} px-3 py-1 text-[10px] font-semibold text-amber-500 text-left border-b border-amber-100 border-l border-l-amber-200/50`,
                                    children: 'LOGÍSTICA'
                                  })
                                ]
                              }),
                              e.jsxs('tr', {
                                ...
                                children: [
                                  ...
                                  e.jsx('th', {
                                    className: `${T} px-3 py-2 border-l border-l-amber-200/50`,
                                    children: 'Compromiso'
                                  }),
                                  e.jsx('th', {
                                    className: `${T} px-3 py-2`,
                                    children: 'Promesa Efect.'
                                  }),
                                  e.jsx('th', {
                                    className: `${T} px-3 py-2 text-center`,
                              ...
                              e.jsxs(
                                'tr',
                                {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('td', {
                                      className: `${T} px-3 py-2 whitespace-nowrap border-l border-l-amber-200/30`,
                                      children: I(a.fecha_compromiso)
                                    }),
                                    e.jsx('td', {
                                      className: `${T} px-3 py-2 whitespace-nowrap`,
                                      children:
...
const yt = (t) => ae(t, '—');
function Nt({ open: t, data: s, loading: n, onClose: r }) {
  return (
    l.useEffect(() => {
      function a(o) {
        o.key === 'Escape' && r();
...
function St({ open: t, data: s, onClose: n }) {
  return (
    l.useEffect(() => {
      function r(a) {
        a.key === 'Escape' && n();
                          ...
                          e.jsx('tbody', {
                            children: s.detalle.map((r, a) =>
                              e.jsxs(
                                'tr',
                                {
                                  className: `border-t border-gray-100 ${wt(r.diasVencido)}`,
                                  children: [
                                    e.jsx('td', {
                                      className: 'px-3 py-2 font-semibold',
                                      style: { color: '#f57c00' },
                                    ...
                                    e.jsx('td', {
                                      className: 'px-3 py-2 whitespace-nowrap',
                                      children: vt(r.fecha_compromiso)
                                    })
                                  ]
                                },
                                a
...
function Ct({ open: t, data: s, onClose: n }) {
  if (
    (l.useEffect(() => {
      function a(o) {
        o.key === 'Escape' && n();
    ...
    return null;
  const r = Object.entries(s.porTipo).sort((a, o) => o[1] - a[1]);
  return e.jsx('div', {
    className: 'fixed inset-0 z-[200] flex items-center justify-center bg-black/40 p-4',
    onClick: n,
    children: e.jsxs('div', {
      ...
      const b = performance.now(),
        $ = (A) => {
          const V = A - b,
            v = Math.min(V / s, 1),
            D = h + i * Et(v);
          (m(D.toFixed(n)), v < 1 ? (f.current = requestAnimationFrame($)) : (d.current = t));
        };
      return ((f.current = requestAnimationFrame($)), () => cancelAnimationFrame(f.current));
    }, [t, s, n]),
    e.jsxs('span', { className: o, children: [r, p, a] })
  );
}
function _t({ children: t, glowColor: s = '245,124,0', className: n = '', onClick: r }) {
  const a = l.useRef(null),
    o = (p) => {
      const m = a.current;
      if (!m) return;
      const d = m.getBoundingClientRect();
      (m.style.setProperty('--mx', `${p.clientX - d.left}px`),
        m.style.setProperty('--my', `${p.clientY - d.top}px`));
    };
  return e.jsxs('div', {
    ref: a,
    onMouseMove: o,
...
function $t({ title: t, value: s, subtitle: n, color: r = '#f57c00', icon: a, onClick: o }) {
  const p = typeof s == 'number',
    m = typeof s == 'string' && /^\d+([.,]\d+)?%$/.test(s),
    d = p ? s : m ? parseFloat(s.replace(',', '.')) : null;
  return e.jsxs(_t, {
    glowColor: et(r),
    onClick: o,
    ...
    children: [
      ...
      e.jsx('div', {
        ...
        style: { color: r },
        children: d !== null ? e.jsx(Lt, { end: d, decimals: m ? 1 : 0, suffix: m ? '%' : '' }) : s
      }),
...
const Q = l.memo($t);
function Rt({ kpis: t, onDetalle: s }) {
  return e.jsxs('div', {
...
function Vt({ calidadData: t, onOpen: s }) {
  return t.total > 0
    ? e.jsxs('button', {
        onClick: s,
        className:
...
function Pt({
  ...
  const d = l.useRef(null),
    ...
    V = (S) => {
      (h(!0), S.target.setPointerCapture(S.pointerId), a(A(S.clientX)));
    },
    v = (S) => {
      f && a(A(S.clientX));
    },
  ...
  const M = i !== 0 ? `scaleX(${1 + Math.abs(i) * 0.04}) translateX(${i * 6}px)` : 'scaleX(1)';
  return e.jsxs('div', {
...
function kt({ alertasOp: t }) {
  const [s, n] = l.useState(1),
    r = l.useMemo(() => Math.max(1, ...t.map((o) => o.cantidad)), [t]),
    a = l.useMemo(() => t.filter((o) => o.cantidad >= s), [t, s]);
  return t.length === 0
    ? null
    : e.jsxs('div', {
        className: 'table-container',
...
function Ot({ rankTransp: t, rankVend: s }) {
  return e.jsxs('div', {
...
function It({ data: t = [], onOpenIncidencias: s }) {
  const n = t.reduce((a, o) => a + (o.total || 0), 0),
    r = t.reduce((a, o) => a + (o.fuera48h || 0), 0);
...
const w = '—',
  U = (t) => (t == null || t === '' ? w : String(t)),
  B = (t) => (t == null ? w : `${t}%`),
  ee = (t) => (t == null ? w : `${t} días`),
  te = '#f57c00',
  q = '#0d1b2a',
  K = '#e5e7eb',
  _ = (t, s, n) => ({
    table: {
      ...
      widths: n,
      body: [
        t.map((r) => ({ text: r, style: 'headerCell' })),
        ...s.map((r) => r.map((a) => ({ text: U(a), style: 'cell' })))
      ]
    },
    layout: {
      hLineColor: () => K,
        ...
        [
          {
            ...
            stack: [
              ...
              { text: U(s), fontSize: 17, bold: !0, color: r, margin: [0, 5, 0, 2] },
...
async function Bt({
  ...
  var k, E;
  const A = await _e(
      () => import('./pdfmake-pNuCVKVo.js').then((c) => c.p),
      __vite__mapDeps([0, 1])
    ),
    V = await _e(() => import('./vfs_fonts-CfcbzCvn.js').then((c) => c.v), __vite__mapDeps([2, 1])),
    v = A.default || A,
    D = V.default || V;
  v.vfs = ((k = D.pdfMake) == null ? void 0 : k.vfs) || D.vfs || v.vfs;
  const M = `${(t == null ? void 0 : t.from) || 'Inicio'} al ${(t == null ? void 0 : t.to) || 'Hoy'}`,
    S = new Date().toLocaleString('es-CL'),
    j = [
      {
        columns: [
          {
...
DASHBOARD`,
          ...
          },
          {
            ...
            stack: [
              ...
              { text: M, fontSize: 9, bold: !0, color: q },
              { text: `Actualizado: ${S}`, fontSize: 6.5, color: '#94a3b8', margin: [0, 3, 0, 0] }
            ]
          }
        ],
        margin: [0, 0, 0, 14]
...
`,
                  ...
                  { text: U(s == null ? void 0 : s.countNvPtm), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: U(s == null ? void 0 : s.nvOrange), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: U(s == null ? void 0 : s.nvFarmapack), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              },
              {
...
`,
                  ...
                  { text: U(s == null ? void 0 : s.nvVarios), style: 'nota' }
                ],
                margin: [8, 8, 8, 8]
              }
            ]
      ...
      },
      {
        columns: [
          ...
          se(
            'Tardanza prom.',
            ee(s == null ? void 0 : s.leadTimeTardanza),
            'Solo entregas tardías',
            '#e11d48'
          ),
          se(
            'A tiempo',
            B(s == null ? void 0 : s.pctAtiempo),
            'Entregado según compromiso',
            '#15803d'
          ),
          se(
            'Fill rate',
            B((E = s == null ? void 0 : s.fillRateShipping) == null ? void 0 : E.pct),
      ...
      },
      {
        text:
          d != null && d.total
            ? `⚠ Datos con ${d.total} observación(es) de calidad.`
            : '✓ Datos consistentes - sin problemas detectados',
        color: d != null && d.total ? '#b45309' : '#15803d',
        fillColor: d != null && d.total ? '#fffbeb' : '#ecfdf5',
        margin: [8, 7, 8, 7],
        fontSize: 8,
        bold: !0
      },
  ...
  (f.length &&
    (j.push({ text: 'ALERTAS OPERACIONALES', style: 'section' }),
    j.push(
      _(
    ...
    j.push(
      _(
        ...
        f.map((c) => [c.estado, c.cantidad, (c.nvs || []).join(', ')]),
        ['30%', '20%', '50%']
      )
    )),
    j.push({ text: 'RANKINGS Y DISTRIBUCIÓN', style: 'section' }),
    j.push(
      _(
        ['Transportista', 'N.V.', '% a tiempo', 'Tardanza'],
        h.map((c) => [c.nombre, c.total, B(c.pctATiempo), ee(c.tardanzaProm)]),
        ['*', 'auto', 'auto', 'auto']
      )
    ),
    j.push(
    ...
    j.push(
      _(
        ...
        Array.from({ length: Math.max(b.length, r.length) }, (c, L) => {
          var F, P, W, G;
          return [
            ((F = b[L]) == null ? void 0 : F.division) || w,
            ((P = b[L]) == null ? void 0 : P.cantidad) ?? w,
            ((W = r[L]) == null ? void 0 : W.estado) || w,
            ((G = r[L]) == null ? void 0 : G.count) ?? w
          ];
        }),
        ['35%', '15%', '35%', '15%']
      )
    ),
    j.push({ text: 'DETALLE DE N.V. DEL PERÍODO FILTRADO', style: 'section', pageBreak: 'before' }),
    j.push(
      _(
        [
          'N.V.',
        ...
        $.map((c) => [
          ...
          c.estado,
          c.transportista,
          c.fecha_aprobacion ? String(c.fecha_aprobacion).slice(0, 10) : w,
          c.fecha_compromiso ? String(c.fecha_compromiso).slice(0, 10) : w,
          c.fecha_despacho ? String(c.fecha_despacho).slice(0, 10) : w,
          c.fecha_entregado ? String(c.fecha_entregado).slice(0, 10) : w
        ]),
    ...
    v
      .createPdf({
        ...
        content: j,
        footer: (c, L) => ({
          text: `CCO | Panel PTM | ${M} | Página ${c} de ${L}`,
          alignment: 'center',
          color: '#94a3b8',
          fontSize: 7,
          margin: [0, 5, 0, 0]
        }),
        defaultStyle: { fontSize: 8, color: q },
        styles: {
          tiny: { fontSize: 6.5, bold: !0, color: '#94a3b8' },
          nota: { fontSize: 14, bold: !0, color: te },
          section: { fontSize: 9, bold: !0, color: q, margin: [0, 9, 0, 4] },
          headerCell: {
            fontSize: 7,
            bold: !0,
            color: '#ffffff',
...
function Zt() {
  const [t, s] = l.useState(null),
    ...
    [L, F] = l.useState([]),
    [P, W] = l.useState(!0),
    [G, fe] = l.useState(null),
    [ne, Ie] = l.useState(''),
    [u, Me] = l.useState(Ve),
    [H, ue] = l.useState(!1),
    [be, je] = l.useState(null),
    [Fe, ge] = l.useState([]),
    [ze, ye] = l.useState(!1),
    [Ne, ve] = l.useState(!1),
    [Be, we] = l.useState([]),
    [Ue, Ae] = l.useState(!1),
    [Se, Ke] = l.useState(!1),
    [re, We] = l.useState({ vencidos: 0, hoy: 0, manana: 0, total: 0, detalle: [] }),
    [Ce, Te] = l.useState(!1),
    [Z, Ge] = l.useState({ total: 0, porTipo: {}, detalle: [] }),
    J = l.useCallback(
      async (x) => {
        (je(x), ye(!0));
        try {
          const N = await tt(x, u.from, u.to);
          ge(N);
        } catch (N) {
          (console.error('Error cargando detalle:', N), ge([]));
        }
        ye(!1);
      },
      [u]
    ),
    He = l.useCallback(async () => {
      (ve(!0), Ae(!0));
      try {
        const x = await st(u.from, u.to);
        we(x);
      } catch (x) {
        (console.error('Error cargando incidencias:', x), we([]));
      }
      Ae(!1);
    }, [u]),
    C = l.useCallback(async (x, N) => {
      (W(!0), fe(null), Me({ from: x, to: N }));
      try {
        const g = await at(x, N);
        (s(g.kpis),
          r(g.estadoTable),
          o(g.divisions),
          m(g.weeklyTrend),
          ...
          i(g.leadTimeSemanal),
          $(g.tiemposCiclo),
          V(g.rankingTransportistas),
          D(g.rankingVendedores),
          S(g.incidenciasPorVendedor || []),
          k(g.alertasOperacionales),
          We(g.alertas),
          Ge(g.calidad),
          Ie(new Date().toLocaleString('es-CL')));
      } catch (g) {
        (console.error('Error loading data:', g),
          fe('Error al cargar los datos. Verifica tu conexión e intenta de nuevo.'));
      }
      W(!1);
    }, []),
    Xe = l.useCallback(async () => {
      if (!(!t || H)) {
        ue(!0);
        try {
          const x = await nt(u.from, u.to);
          (await Bt({
            range: u,
            kpis: t,
            estadoTable: n,
            ...
            alertas: re,
            calidad: Z,
            alertasOperacionales: j,
            rankTransp: A,
            rankVend: v,
            divisions: a,
            operaciones: x
          }),
            $e.success('PDF descargado correctamente.'));
        } catch (x) {
          (console.error('Error exportando PDF del panel:', x),
            $e.error(x.message || 'No se pudo generar el PDF. Intenta nuevamente.'));
        } finally {
          ue(!1);
        }
      }
    }, [re, j, Z, a, n, H, t, h, u, A, v, d, b, p]);
  l.useEffect(() => {
    const x = Ve();
    (C(x.from, x.to),
      rt()
        .then((N) => {
          N.operadores.length > 0 && c(N.operadores);
        })
        .catch(() => {}),
      lt(6)
        .then((N) => F(N))
    ...
    l.useEffect(() => {
      ...
      const N = () => {
          (typeof document < 'u' && document.hidden) ||
            (x && clearTimeout(x), (x = setTimeout(() => C(X.current.from, X.current.to), 2500)));
        },
        g = le
          ...
          .subscribe();
      return () => {
        (x && clearTimeout(x), le.removeChannel(g));
      };
    }, [C]));
  const [Ee, Y] = l.useState(120),
    O = l.useRef(120);
  return (
    l.useEffect(() => {
      ((O.current = 120), Y(120));
      const x = setInterval(() => {
        if (((O.current -= 1), Y(O.current), O.current <= 0)) {
          if (((O.current = 120), Y(120), typeof document < 'u' && document.hidden)) return;
          C(u.from, u.to);
        }
      }, 1e3);
    ...
    l.useEffect(() => {
      const x = () => {
        typeof document < 'u' &&
          !document.hidden &&
          ((O.current = 120), Y(120), C(X.current.from, X.current.to));
      };
      return (
            ...
            children: [
                ...
                children: e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      className: 'flex items-center gap-4',
                      children: [
                        e.jsx(bt, { onFilter: C, defaultFrom: he, defaultTo: pe }),
                        e.jsxs('button', {
                          onClick: Xe,
                          disabled: P || H || !t,
                          className:
                          ...
                          children: [
                            e.jsx('svg', {
                              className: `w-3.5 h-3.5 ${H ? 'animate-bounce' : ''}`,
                              fill: 'none',
                              stroke: 'currentColor',
                              viewBox: '0 0 24 24',
                              children: e.jsx('path', {
                            ...
                            e.jsx('span', { children: H ? 'Generando...' : 'Descargar PDF' })
                          ]
                        }),
                        e.jsxs('button', {
                          onClick: () => {
                            ((O.current = 120), Y(120), C(u.from, u.to));
                          },
                          disabled: P,
                          className:
                          ...
                          children: [
                            ...
                            e.jsxs('span', {
                              children: [Math.floor(Ee / 60), ':', String(Ee % 60).padStart(2, '0')]
                            })
                          ]
                        }),
                        ne &&
              ...
              e.jsxs('main', {
                ...
                children: [
                  ...
                  e.jsx(Tt, { kpis: t, onSelect: J }),
                  e.jsx(Rt, { kpis: t, onDetalle: J }),
                  e.jsx(Vt, { calidadData: Z, onOpen: () => Te(!0) }),
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [
                          e.jsx(it, { data: n, onSelectEstado: J }),
                          e.jsx('div', {
                            className: 'table-container',
                            children: e.jsxs('table', {
                              children: [
                      ...
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [e.jsx(xt, { data: p }), e.jsx(ft, { data: h })]
                      })
                    ]
                  }),
                  e.jsx(Dt, { tiemposCiclo: b }),
                  e.jsx(kt, { alertasOp: j }),
                  e.jsx(It, { data: M, onOpenIncidencias: He }),
                  e.jsx(Ot, { rankTransp: A, rankVend: v }),
                  e.jsx(Mt, { auditKpis: E }),
                  e.jsx(Ft, { divisions: a }),
                  e.jsx(zt, { tendencia: L }),
                  e.jsxs('div', {
                    className: 'text-center text-xs text-gray-400 py-4',
                    children: ['Fecha de la última actualización: ', ne]
                  })
                ]
              }),
              be && e.jsx(gt, { estado: be, data: Fe, loading: ze, onClose: () => je(null) }),
              Ne && e.jsx(Nt, { open: Ne, data: Be, loading: Ue, onClose: () => ve(!1) }),
              Se && e.jsx(St, { open: Se, data: re, onClose: () => Ke(!1) }),
              Ce && e.jsx(Ct, { open: Ce, data: Z, onClose: () => Te(!1) })
            ]
          })
  );
}
