import { u as Pe, d as Le, c as ze, j as e } from './query-vendor-CojWQiBV.js';
import { r as x } from './react-vendor-CA7EHQ1X.js';
import { u as Fe, f as A, w as ue, s as k } from './index-CXl7fTg4.js';
import { u as Me } from './useRealtimeTable-DyyDuzgP.js';
import { u as $e } from './useBarcodeScanner-CdHcw5UK.js';
import {
  u as Ue,
  f as ae,
  ag as Be,
...
import { l as cs } from './logUpload-8hNdGiD4.js';
...
const Ns = () => {
    ...
    const { user: c } = Fe(),
      ...
      [g, D] = x.useState('dashboard'),
      [j, q] = x.useState(null),
      [p, T] = x.useState({ search: '', estado: '', desde: '', hasta: '' }),
      [is, xs] = x.useState(!1),
      [m, B] = x.useState(null),
      [n, N] = x.useState({
    ...
    (x.useEffect(() => {
      ...
      x.useEffect(() => {
        ...
        try {
          ...
          } else (localStorage.removeItem(K), H(null), Q(!1), W(''));
        } catch {}
      }, [n, d, g, j, ne]));
    const ce = () => {
        try {
    ...
    (Ue(
      ...
      x.useEffect(() => {
        g === 'form' && !u && (D('dashboard'), q(null));
      }, [g, u]),
      Me('tms_recepciones_nacionales', [['recepciones_nac']]));
    const { data: z = [], isLoading: Ae } = Le({
      ...
      ee = ze({
        mutationFn: async () => {
          ...
          const t = d.map((l) => ({
            ...
            { error: a } = await k.from('tms_recepcion_items_nacionales').insert(t);
          if (a) throw a;
        },
        onSuccess: (s, t) => {
...
¿Agregarla de todos modos? Quedará marcada como duplicada.`)
      ...
      De = (s, t) => {
        ...
        ((i['!cols'] = [
          ...
          A.book_append_sheet(l, i, 'Detalle Items'));
        const h = [
            {
      ...
      Te = () => {
        ...
        ((a['!cols'] = [
          ...
          A.book_append_sheet(t, a, 'Recepciones'),
          ue(t, `Recepciones_Nacionales_${new Date().toLocaleDateString('en-CA')}.xlsx`),
                  ...
                  e.jsxs(e.Fragment, {
                    children: [
                      e.jsxs('button', {
                        ...
                        children: [e.jsx(Be, { size: 14 }), ' Exportar']
                      }),
                      u
                        ? e.jsxs('button', {
                            onClick: () => {
                            ...
                            children: [e.jsx(fe, { size: 14 }), ' Nueva Recepción']
                          })
                        : e.jsx('span', {
                            className:
                  ...
                  e.jsxs(e.Fragment, {
                    children: [
                      e.jsxs(
                        'span',
                        {
                          className: `inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold border ${J ? 'bg-emerald-50 border-emerald-200 text-emerald-700 anim-saved' : 'bg-slate-50 border-slate-200 text-slate-400'}`,
                          title:
                            'Tu progreso se guarda solo en este dispositivo; puedes recargar o cerrar sin perderlo.',
                          children: [
                            e.jsx(ge, { size: 14 }),
                            ' ',
                            J ? `Guardado ${X}` : 'Se guardará solo'
                          ]
                        },
                        X
                      ),
                      e.jsxs('button', {
                        ...
                        className:
                          'px-3 py-2 bg-white border border-slate-300 hover:bg-slate-50 text-slate-600 rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-colors',
                        children: [e.jsx(Ge, { size: 14 }), ' Volver']
                      })
                    ]
                  })
              ]
            ...
            children: [
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsxs('p', {
                          ...
                          children: [e.jsx(je, { size: 15 }), ' Tienes una recepción sin terminar']
                        }),
                        e.jsxs('p', {
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('input', {
                        ...
                        value: p.search,
                        onChange: (s) => T((t) => ({ ...t, search: s.target.value })),
                        className:
                  ...
                  e.jsxs('select', {
                    value: p.estado,
                    onChange: (s) => T((t) => ({ ...t, estado: s.target.value })),
                    className:
                  ...
                  e.jsx('input', {
                    type: 'date',
                    value: p.desde,
                    onChange: (s) => T((t) => ({ ...t, desde: s.target.value })),
                    className:
                      'px-2 py-2 bg-slate-50 border border-slate-200 rounded-md text-sm outline-none focus:border-slate-400'
                  }),
                  e.jsx('span', {
                  ...
                  e.jsx('input', {
                    type: 'date',
                    value: p.hasta,
                    onChange: (s) => T((t) => ({ ...t, hasta: s.target.value })),
                    className:
                      'px-2 py-2 bg-slate-50 border border-slate-200 rounded-md text-sm outline-none focus:border-slate-400'
                  }),
                  F &&
                    e.jsx('button', {
                      onClick: () => T({ search: '', estado: '', desde: '', hasta: '' }),
                      className:
                              ...
                              children: E.porProveedor.map((s, t) => {
                                ...
                                return e.jsxs(
                                  'tr',
                                  {
                                    ...
                                    onClick: () => T((i) => ({ ...i, search: s.proveedor })),
                                    children: [
                                      e.jsx('td', {
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsxs('button', {
                        ...
                        children: [e.jsx(fe, { size: 22 }), ' AGREGAR ÍTEM']
                      })
                    ]
                  }),
                  e.jsxs('div', {
                              ...
                              J &&
                                e.jsxs(
                                  'span',
                                  {
                                    ...
                                    children: [e.jsx(ge, { size: 12 }), ' Guardado ', X]
                                  },
                                  X
                                )
                            ]
                        ...
                        children:
                          d.length === 0
                            ? e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx(ls, { size: 40, className: 'mx-auto mb-2 opacity-30' }),
                                              ...
                                              children: [
                                                ...
                                                a &&
                                                  e.jsxs('span', {
                                                    ...
                                                    children: [e.jsx(_e, { size: 9 }), ' DUPLICADA']
                                                  })
                                              ]
                                            }),
                                            e.jsx('td', {
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('button', {
                      ...
                      children: [e.jsx(os, { size: 16 }), ' DESCARGAR EXCEL']
                    }),
                    u &&
                      e.jsxs('button', {
