import { j as t } from './query-vendor-BNjBrM5A.js';
import { u as $e, r as d } from './react-vendor-6aw4XXjH.js';
import {
  bk as ze,
  x as Oe,
  X as Z,
...
import { s as fe, u as at } from './index-BRrXUgfV.js';
...
async function St(S, M, j) {
  const { data: G, error: b } = await fe.rpc('flujo_guardar', {
    p_codigo: S,
    p_titulo: M,
    p_modelo: j
  });
  return b ? { ok: !1, error: b.message } : G || { ok: !0 };
}
const V = {
  ...
  me = [
    { codigo: 'maestro', titulo: 'Flujo Maestro', seed: K },
  ...
  xe = (S) => (At.find(([M]) => M.test(S || '')) || [])[1] || null,
  Dt = {
    'master-data':
...
function Ot() {
  ...
  const je = (e) => {
    ...
    Ne = (e) => {
      e.target.closest('[data-node]') ||
        ...
        (u(null), E(null), (D.current = { x: e.clientX, y: e.clientY }));
    },
    ke = (e) => {
      if (y.current) {
      ...
      if (D.current) {
        const a = e.clientX - D.current.x,
          o = e.clientY - D.current.y;
    ...
    ie = () => {
      var e;
      ((e = y.current) != null && e.moved && N(), (y.current = null), (D.current = null));
    },
    Ce = (e, a) => {
      (e.stopPropagation(),
        p === null &&
  ...
  const De = async () => {
      ...
      e != null && e.ok
        ? (A.success('Diagrama guardado'), Y(!1))
        : A.error((e == null ? void 0 : e.error) || 'No se pudo guardar');
    },
    Ie = () => {
      const e = new Blob(
          [
      ...
      ((o.onload = () => {
        try {
          ...
          (g({ nodes: i.nodes.map((r) => ({ ...r })), edges: i.edges.map((r) => ({ ...r })) }),
            ...
            A.success('Importado — recuerda Guardar'));
        } catch {
          A.error('JSON inválido (se espera {nodes, edges})');
        }
      }),
        o.readAsText(a),
        (e.target.value = ''));
    ...
    Te = async () => {
      ...
      const e = Dt[b];
      if (!e) {
        A.error('Este diagrama no tiene filtro de dominio');
        return;
      }
      if (
        U &&
      ...
      a || (a = { nodes: K.nodes, edges: K.edges });
      const o = a.nodes.filter((n) => e.test(n.label || ''));
      if (!o.length) {
        A.error('El maestro no tiene nodos de este dominio');
        return;
      }
      ...
      (g({ nodes: o.map((n) => ({ ...n })), edges: i.map((n) => ({ ...n })) }),
        ...
        A.success(`Recortado: ${o.length} nodos · ${i.length} conexiones (revisa y Guarda)`));
    },
    re = (e, a, o) => {
      const l = e.x + e.w / 2,
        i = e.y + e.h / 2,
        ...
        t.jsxs('div', {
          ...
          children: [
            ...
            t.jsxs('button', {
              ...
              children: [t.jsx(Ye, { size: 13 }), ' Conectar']
            }),
            t.jsxs('button', {
              onClick: L,
              disabled: !s,
              ...
              children: [t.jsx(Q, { size: 13 }), ' Borrar']
            }),
            t.jsx('span', { className: 'w-px h-5 bg-slate-200 mx-1' }),
            t.jsxs('button', {
              onClick: Ie,
            ...
            b !== 'maestro' &&
              t.jsxs('button', {
                ...
                children: [t.jsx(Ze, { size: 13 }), ' Recortar del maestro']
              }),
            t.jsxs('button', {
              onClick: () => X(b),
              className:
                'inline-flex items-center gap-1 px-2 py-1.5 rounded-lg text-[12px] font-bold text-slate-500 hover:bg-slate-100',
              children: [t.jsx(Qe, { size: 13 }), ' Recargar']
            }),
            t.jsxs('button', {
              onClick: De,
              disabled: !U,
              ...
              children: [t.jsx(Ke, { size: 14 }), ' Guardar']
            })
          ]
        }),
      t.jsxs('div', {
                      ...
                      t.jsxs('div', {
                        ...
                        children: [
                          ...
                          t.jsxs('button', {
                            ...
                            children: [t.jsx(Q, { size: 12 }), ' Borrar']
                          })
                        ]
                      })
                    ]
                  ...
                  t.jsxs(t.Fragment, {
                    children: [
                      ...
                      t.jsxs('button', {
                        ...
                        children: [t.jsx(Q, { size: 12 }), ' Borrar conexión']
                      })
                    ]
                  })
              ]
