...
import { u as X, s as w, e as q } from './index-BGSkqVb2.js';
...
import { u as le } from './useRealtimeTable-C0gO6_tl.js';
    ...
    G = (s) => {
      ...
      if ((s.preventDefault(), !c.ubicacion || !c.codigo)) {
        (g('Faltan campos obligatorios (Ubicación y Código)'),
          u.to(D.current, { x: [-10, 10, -10, 10, 0], duration: 0.4 }));
        return;
      }
      const r = {
        id:
