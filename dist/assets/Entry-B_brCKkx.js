import { u as Y, c as H, j as e } from './query-vendor-CzTZLhyg.js';
import { r as i } from './react-vendor-CByR7_Pi.js';
import { u as X, s as w, e as q } from './index-DpKQy1E-.js';
import { u as Z, g as u } from './animation-vendor-DqxLxWcj.js';
import {
  aN as A,
  aG as ee,
  aE as se,
...
import { u as le } from './useRealtimeTable-7JQgQ4NY.js';
...
const me = () => {
  const { user: d } = X(),
    ...
    D = i.useRef(null),
    y = i.useRef([]);
  le('wms_ubicaciones', [['putaway_visual'], ['warehouse-data']]);
  const [c, m] = i.useState({
      ubicacion: '',
      codigo: '',
      serie: '',
      partida: '',
    ...
    i.useEffect(() => {
      ...
      if (s)
        try {
          ...
          console.error('Entry data load error:', r);
        }
    }, []),
    i.useEffect(() => {
  ...
  i.useEffect(() => {
    ...
    if ((N.current && clearTimeout(N.current), !s || s.length < 3)) {
      (h(!1), b.current && !s && (m((r) => ({ ...r, descripcion: '' })), g(null)), (b.current = s));
      return;
    }
    if (s !== b.current) {
      if (j.current.has(s)) {
        const r = j.current.get(s);
        (m((t) => ({ ...t, descripcion: r || '' })),
          g(r ? null : 'SKU NO ENCONTRADO'),
          h(!1),
          (b.current = s));
        return;
      }
      return (
        (N.current = setTimeout(async () => {
          ...
          try {
            ...
            if (t != null && t.producto) {
              (j.current.set(s, t.producto),
                m((n) => (n.codigo === s ? { ...n, descripcion: t.producto } : n)),
                (b.current = s),
                h(!1));
              return;
            }
            ...
            console.error('Desc lookup error:', t);
          } finally {
  ...
  const M = async () => {
      if (!c.ubicacion || c.ubicacion.length < 3) {
        _(null);
        return;
      }
      try {
        const { data: s, error: r } = await w
          .from('wms_ubicaciones')
          .select('ubicacion')
          ...
          .maybeSingle();
        if (r) {
          console.error('Ubicacion validation error:', r);
          return;
        }
    ...
    T = (s) => {
      const { name: r, value: t } = s.target;
      let o = t;
      (r === 'ubicacion'
        ? (o = t.toUpperCase().slice(0, 12))
        : r === 'codigo' && (o = t.toUpperCase().slice(0, 20)),
        m((n) => ({ ...n, [r]: o })));
    },
    Q = (s) => {
      var t, o;
      if ((s.preventDefault(), !c.ubicacion || !c.codigo)) {
        (g('Faltan campos obligatorios (Ubicación y Código)'),
          u.to(U.current, { x: [-10, 10, -10, 10, 0], duration: 0.4 }));
        return;
      }
      const r = {
        id:
          ((o = (t = globalThis.crypto) == null ? void 0 : t.randomUUID) == null
            ? void 0
            : o.call(t)) || `${Date.now()}-${Math.random()}`,
        ...c,
    ...
    V = (s, r) => {
      ...
      u.to(t, {
        ...
        duration: 0.3,
        onComplete: () => {
          (p(l.filter((o) => o.id !== s)), u.set(t, { x: 0, opacity: 1 }));
        }
      });
    },
    W = () => {
    ...
    R = (s) =>
      s.map((r) => ({
        ...
        talla: r.talla || null,
        color: r.color || null,
        creado_por: (d == null ? void 0 : d.id) || null,
        creado_por_nombre: (d == null ? void 0 : d.nombre) || (d == null ? void 0 : d.email) || null
      })),
    $ = H({
      mutationFn: async () => {
        const s = R(l),
          { data: r, error: t } = await w.rpc('registrar_putaway_ubicaciones', { p_items: s });
        if (t) throw t;
        if (!r || Number(r.guardados) !== s.length)
          ...
          try {
            await w
              ...
              .insert([
                {
                  usuario_id: d.id,
                  usuario_nombre: d.nombre || d.email || 'Usuario Desconocido',
            ...
            console.error('Entry operation error:', o);
          }
        return { saved: s.length };
      },
      onSuccess: ({ saved: s }) => {
        (x.success(
          `✅ ${s} ubicación(es) guardadas y verificadas. Ya están disponibles en Ubicaciones.`
        ),
          u.to(D.current, { y: 10, duration: 0.1, yoyo: !0, repeat: 1 }),
          p([]),
          z.invalidateQueries({ queryKey: ['putaway_visual'] }),
          z.invalidateQueries({ queryKey: ['warehouse-data'] }));
      },
      onError: async (s) => {
        var t, o, n;
        if (
          !navigator.onLine ||
          ((t = s.message) == null ? void 0 : t.includes('Failed to fetch')) ||
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsx('div', {
                      ...
                      children: e.jsx(A, { size: 28, strokeWidth: 2.4 })
                    }),
                    e.jsxs('div', {
                      className: 'space-y-3',
                      children: [
                  ...
                  children: [
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsxs('div', {
                          className: `mt-2 inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-black ${f ? 'border-emerald-200 bg-emerald-50 text-emerald-700' : 'border-rose-200 bg-rose-50 text-rose-700'}`,
                          children: [
                            f ? e.jsx(ee, { size: 14 }) : e.jsx(se, { size: 14 }),
                            f ? 'Sistema en línea' : 'Sin conexión'
                          ]
                        }),
                        e.jsx('p', {
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            L
                              ? e.jsx(A, { size: 14, className: 'text-emerald-600' })
                              : e.jsx(P, { size: 14, className: 'text-amber-500' }),
                            L ? 'Lista para agregar' : 'Completa obligatorios'
                          ]
                        }),
                        e.jsx('p', {
                          className: 'mt-3 text-xs text-slate-500',
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('div', {
                                ...
                                style: { color: a.navy },
                                children: c.ubicacion || 'Pendiente'
                              })
                            ]
                          }),
                          e.jsxs('div', {
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            ...
                            e.jsxs('button', {
                              ...
                              children: [e.jsx(K, { size: 15 }), 'Vaciar todo']
                            })
                          ]
                        })
                      ]
