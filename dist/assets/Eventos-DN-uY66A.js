...
function $e() {
  const { hasPermission: a, user: o } = ce(),
    m =
      a('manage_eventos') ||
      (o == null ? void 0 : o.rol) === 'ADMIN' ||
      (o == null ? void 0 : o.es_admin_delegado),
    [x, t] = r.useState('mis'),
    [c, n] = r.useState([]),
    [w, R] = r.useState([]),
    [v, O] = r.useState([]),
    ...
    p = r.useCallback(async () => {
      const [s, l, i, Z] = await Promise.all([xe({ agregado: k }), me(), pe({}), he()]);
      (n(s), R(l), O(i), y(Z));
    }, [k]);
  r.useEffect(() => {
    p();
  ...
  const _ = async (s, l) => {
      ...
      return i != null && i.ok
        ? (u.success(l), !0)
        : (u.error((i == null ? void 0 : i.error) || 'Error'), !1);
    },
    I = async (s) => {
    ...
    F = async (s) => {
      (await ue(s), y((l) => l.filter((i) => i.id !== s)));
    },
    B = async () => {
                    ...
                    return e.jsxs(
                      'div',
                      {
                        ...
                        children: [
                          ...
                          e.jsx('span', {
                            className: `text-[9px] font-black rounded px-1.5 py-0.5 shrink-0 ${i}`,
                            children: s.estado
                          }),
                          e.jsx('span', {
...
function we({ data: a, onClose: o, onSave: m }) {
  const x = !!a.id,
    [t, c] = r.useState({
      id: a.id || '',
      nombre: a.nombre || '',
