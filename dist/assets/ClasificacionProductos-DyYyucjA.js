...
import { y as k, bx as L, _ as E, a9 as P, ak as _, t as w } from './ui-vendor-C7KFTQPV.js';
import { u as z, s as y } from './index-CMd8_LWN.js';
import { ai as R, aj as A } from './calidadService-CcaE66Wh.js';
import './supabase-vendor-jY4wIOEF.js';
function D() {
  const { hasPermission: g, user: n } = z(),
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [
              i ? e.jsx(P, { size: 18, className: 'animate-spin' }) : e.jsx(_, { size: 18 }),
