...
import { u as Me, s as k } from './index-BGSkqVb2.js';
import { u as $e } from './useRealtimeTable-C0gO6_tl.js';
import { u as Ue } from './useBarcodeScanner-DTxRt-wM.js';
import { u as Be, g as Ge } from './animation-vendor-DqxLxWcj.js';
import { l as Ve } from './logUpload-D3kU6aSy.js';
import {
  f as ae,
  an as qe,
  P as ue,
...
const is = ['3-4', '1HCX20', '1HCX40', '2HCX40', 'LCL', 'AEREO'],
  Ce = {
    EN_REVISION: {
      label: 'En Revisión',
      color: 'bg-amber-500',
...
const Cs = () => {
    ...
    const { data: F = [], isLoading: ke } = ze({
      ...
      S = p.useMemo(
        () =>
          F.filter((s) => {
            ...
            return !(
              (m.estado && s.estado !== m.estado) ||
              (m.desde && s.fecha_recepcion < m.desde) ||
              (m.hasta && s.fecha_recepcion > m.hasta)
            );
          }),
        [F, m]
      ),
      ...
      I = p.useMemo(() => {
        const s = S,
          t = s.length,
          a = s.filter((A) => A.estado === 'EN_REVISION').length,
          l = s.filter((A) => A.estado === 'COMPLETADO').length,
          x = s.reduce((A, V) => A + (V.cant_bultos || 0), 0),
          N = s.reduce((A, V) => A + (V.pallets_usados || 0), 0),
          T = t > 0 ? (N / t).toFixed(1) : 0,
          $ = t > 0 ? Math.round(x / t) : 0,
          r = F.length,
          n = F.reduce((A, V) => A + (V.pallets_usados || 0), 0),
          te = r > 0 ? (n / r).toFixed(1) : 0;
        return {
          total: t,
          enRevision: a,
          completados: l,
      ...
      O = p.useMemo(() => {
        ...
        N.forEach((r) => {
          const [n, te] = r.mes.split('-');
          r.label = `${t[parseInt(te) - 1]} ${n.slice(2)}`;
        });
        const T = {};
        s.forEach((r) => {
      ...
      Re = () => {
        ...
        const t = G(f.serie);
        if (t) {
          const l = d.findIndex((x) => G(x.serie) === t);
          if (
            l !== -1 &&
...
¿Agregarla de todos modos? Quedará marcada como duplicada.`)
      ...
      ie = (s) => {
        u({
          onScan: (t) => {
            const a = t.trim();
            (C((l) => ({ ...l, [s]: a })), b.success(`${s.toUpperCase()} escaneado: ${a}`));
          },
          onError: (t) => b.error(t)
        });
      },
      ...
      De = (s, t) => {
        ...
        const N = [
            {
              ...
              'TOTAL CANTIDAD': t.reduce((r, n) => r + (n.cantidad || 0), 0)
            }
          ],
          T = D.json_to_sheet(N);
        ((T['!cols'] = [
        ...
        const $ = `RecepcionNacional_${s.proveedor}_${s.fecha_recepcion || 'sin-fecha'}.xlsx`;
      ...
      Pe = () => {
        ...
        ((a['!cols'] = [
          ...
          D.book_append_sheet(t, a, 'Recepciones'),
            ...
            children: [
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsx('input', {
                        ...
                        value: m.search,
                        onChange: (s) => P((t) => ({ ...t, search: s.target.value })),
                        className:
                  ...
                  e.jsxs('select', {
                    value: m.estado,
                    onChange: (s) => P((t) => ({ ...t, estado: s.target.value })),
                    className:
                  ...
                  e.jsx('input', {
                    type: 'date',
                    value: m.desde,
                    onChange: (s) => P((t) => ({ ...t, desde: s.target.value })),
                    className:
                      'px-2 py-2 bg-slate-50 border border-slate-200 rounded-md text-sm outline-none focus:border-slate-400'
                  }),
                  e.jsx('span', {
                  ...
                  e.jsx('input', {
                    type: 'date',
                    value: m.hasta,
                    onChange: (s) => P((t) => ({ ...t, hasta: s.target.value })),
                    className:
                      'px-2 py-2 bg-slate-50 border border-slate-200 rounded-md text-sm outline-none focus:border-slate-400'
                  }),
                  M &&
                    ...
                    ? e.jsx('div', {
                        ...
                        children: e.jsxs('table', {
                          ...
                          children: [
                            ...
                            e.jsx('tbody', {
                              children: O.porProveedor.map((s, t) => {
                                ...
                                return e.jsxs(
                                  'tr',
                                  {
                                    ...
                                    onClick: () => P((x) => ({ ...x, search: s.proveedor })),
                                    children: [
                                      e.jsx('td', {
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  onChange: (s) =>
                                    y((t) => ({ ...t, fecha_recepcion: s.target.value })),
                                  className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: c.proveedor,
                                  onChange: (s) =>
                                    y((t) => ({ ...t, proveedor: s.target.value.toUpperCase() })),
                                  className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  type: 'text',
                                  value: c.oc,
                                  onChange: (s) => y((t) => ({ ...t, oc: s.target.value })),
                                  className:
                                    'w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                                  placeholder: '21073...'
                                })
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: c.cant_bultos,
                                  onChange: (s) =>
                                    y((t) => ({ ...t, cant_bultos: s.target.value })),
                                  className:
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  onChange: (s) =>
                                    y((t) => ({ ...t, pallets_usados: s.target.value })),
                                  className:
                                    'w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                                  placeholder: '0',
                                  min: '0'
                        ...
                        e.jsxs('div', {
                          children: [
                            ...
                            e.jsx('select', {
                              ...
                              onChange: (s) =>
                                y((t) => ({ ...t, tipo_contenedor: s.target.value })),
                              className:
                                'w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                              children: is.map((s) => e.jsx('option', { value: s, children: s }, s))
                            })
                          ]
                        }),
                        e.jsxs('div', {
                          children: [
                            ...
                            e.jsx('textarea', {
                              rows: 2,
                              value: c.notas,
                              onChange: (s) => y((t) => ({ ...t, notas: s.target.value })),
                              className:
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            value: f.reff,
                            onChange: (s) =>
                              C((t) => ({ ...t, reff: s.target.value.toUpperCase() })),
                            className:
                          ...
                          e.jsxs('div', {
                            children: [
                              ...
                              e.jsx('input', {
                                type: 'number',
                                value: f.cantidad,
                                onChange: (s) => C((t) => ({ ...t, cantidad: s.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            children: [
                              ...
                              e.jsx('input', {
                                type: 'text',
                                value: f.box,
                                onChange: (s) => C((t) => ({ ...t, box: s.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('input', {
                                type: 'text',
                                value: f.serie,
                                onChange: (s) => C((t) => ({ ...t, serie: s.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('input', {
                                type: 'text',
                                value: f.lote,
                                onChange: (s) => C((t) => ({ ...t, lote: s.target.value })),
                                className:
                                  'flex-1 p-4 bg-slate-50 border-2 border-slate-200 rounded-2xl text-base font-mono outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all',
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            onChange: (s) =>
                              C((t) => ({ ...t, fecha_vencimiento: s.target.value })),
                            className:
                              'w-full p-4 bg-slate-50 border-2 border-slate-200 rounded-2xl text-base font-bold outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all'
                          })
                        ]
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('button', {
                      ...
                      children: [e.jsx(ss, { size: 16 }), ' DESCARGAR EXCEL']
                    }),
                    i &&
                      e.jsxs('button', {
                  ...
                  children: [
                    ...
                    e.jsxs('span', {
                      ...
                      children: [
                        'Total cantidad:',
                        ' ',
                        (h.items || []).reduce((s, t) => s + (t.cantidad || 0), 0)
                      ]
                    })
                  ]
                })
