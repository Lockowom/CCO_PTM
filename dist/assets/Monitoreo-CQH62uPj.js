...
import { j as e, u as da } from './query-vendor-CzTZLhyg.js';
import { r as b, R as Ls, j as xa } from './react-vendor-CByR7_Pi.js';
import {
  X as Oe,
  R as _e,
  ay as ma,
...
import { _ as we, f as cs, c as ds, u as ye, C as Ca } from './index-DpKQy1E-.js';
import { e as Ea } from './exportExcel-CrAs1BHm.js';
import { a as xs, s as ms } from './storageUrl-DXi8LLxG.js';
import {
  E as Le,
  d as Aa,
  u as Oa,
  ...
  ae as bt,
  f as ht
} from './calidadService--yDCooYO.js';
import { C as gt } from './CalidadBadge-Doq1PKT5.js';
import { f as ft } from './panelPtm-NWLfEp6V.js';
import { o as Nt } from './ingresarService-_cVRia8V.js';
import { u as Rs } from './useRealtimeTable-7JQgQ4NY.js';
...
function js(s) {
  const m = Is.codigos[s] || { codigo: 'FO-CAL-000', revision: '01' };
  return { ...Is, ...m };
}
function jt(s) {
  const m = (s || '').split(',')[1] || '',
    d = atob(m),
    x = new Uint8Array(d.length);
  for (let y = 0; y < d.length; y++) x[y] = d.charCodeAt(y);
  return x;
}
const vs = [40, 82, 40, 54];
function _s(s) {
  const m = js(s);
  return () => ({
    margin: [40, 16, 40, 0],
    stack: [
      {
        columns: [
          ...(m.logo ? [{ image: m.logo, width: 96, margin: [0, 0, 10, 0] }] : []),
          {
            width: '*',
            stack: [
              { text: m.empresa, bold: !0, fontSize: 13 },
              { text: m.subtitulo, fontSize: 8, color: '#64748b' }
            ]
          },
          {
            width: 'auto',
            table: {
              ...
              body: [
                [
                  ...
                  { text: m.codigo, fontSize: 7 }
                ],
                [
                  { text: 'Revisión', bold: !0, fontSize: 7 },
                  { text: m.revision, fontSize: 7 }
                ],
                [
                  { text: 'Norma', bold: !0, fontSize: 7 },
                  { text: m.norma, fontSize: 7 }
                ]
              ]
            },
            layout: 'noBorders'
...
function ws(s) {
  ...
  return (d, x) => ({
    ...
    stack: [
      ...
      {
        columns: [
          { text: `${m.codigo} · Rev. ${m.revision} · ${m.norma}`, fontSize: 7, color: '#94a3b8' },
          {
            text: `Documento controlado · Página ${d} de ${x}`,
            fontSize: 7,
            color: '#94a3b8',
            alignment: 'right'
          }
...
function ys(s, m) {
  const {
    ...
    p = {
      ...
      left: { style: i.NONE },
      right: { style: i.NONE },
      insideHorizontal: { style: i.NONE },
      insideVertical: { style: i.NONE }
    },
    L = new d({
      children: [
        new a({
          ...
          rows: [
            new u({
              children: [
                new g({
                  width: { size: 60, type: O.PERCENTAGE },
                  borders: p,
                  children: [
                    ...(z.logo
                      ? [
                          new y({
                            children: [
                              new D({
                                ...
                                transformation: {
                                  width: 120,
                                  height: Math.round((120 * z.logo_h) / z.logo_w)
                                }
                              })
                            ]
                          })
                      ...
                      : []),
                    new y({ children: [new f({ text: z.empresa, bold: !0, size: 22 })] }),
                    new y({ children: [new f({ text: z.subtitulo, size: 15, color: '64748B' })] })
                  ]
                }),
                new g({
                  width: { size: 40, type: O.PERCENTAGE },
                  borders: p,
                  children: [
                    new y({
                      alignment: w.RIGHT,
                      children: [
                        new f({ text: `Código: ${z.codigo}  ·  Rev. ${z.revision}`, size: 15 })
                      ]
                    }),
                    new y({
                      alignment: w.RIGHT,
                      children: [
                        new f({
                          text: `${z.norma}  ·  Vig. ${z.fecha_revision}`,
                          size: 15,
                          color: '64748B'
                        })
                      ]
    ...
    M = new x({
      children: [
        new y({
          alignment: w.CENTER,
          border: { top: { style: i.SINGLE, size: 4, color: 'CBD5E1' } },
          children: [
            new f({
              text: `${z.codigo} · Rev. ${z.revision} · ${z.norma} · Documento controlado · Página `,
              size: 14,
              color: '94A3B8'
            }),
            new f({ children: [N.CURRENT], size: 14, color: '94A3B8' }),
            new f({ text: ' de ', size: 14, color: '94A3B8' }),
            new f({ children: [N.TOTAL_PAGES], size: 14, color: '94A3B8' })
          ]
        })
      ]
    });
  return { header: L, footer: M };
}
const ea = (s) =>
  s != null && s.storage_path
    ? xs('monitoreo-evidencias', s.storage_path)
    : Promise.resolve((s == null ? void 0 : s.imagen_url) || '');
async function vt(s) {
  const m = await fetch(s);
  if (!m.ok) throw new Error('No se pudo cargar una imagen de evidencia');
...
async function _t(s) {
  ...
  return await new Promise((x, y) => {
    const f = new FileReader();
    ((f.onload = () => x(f.result)), (f.onerror = y), f.readAsDataURL(d));
  });
}
function sa(s, m, d) {
  const x = s.reporte || {},
  ...
  return (
    (d || []).forEach((f) => {
      const a = f.item_id || 'general';
      (y[a] = y[a] || []).push(f);
    }),
    { rep: x, evByItem: y }
  );
}
async function wt(s, m = [], d = []) {
  const x = await we(() => import('./index-BmpJy8SR.js'), []),
    {
      Document: y,
      Packer: f,
      Paragraph: a,
    ...
    { header: p, footer: L } = ys(x, 'danos'),
    { rep: M, evByItem: _ } = sa(s, m, d),
    S = (h, v) =>
      new w({
        children: [
          new N({
            width: { size: 35, type: i.PERCENTAGE },
            children: [new a({ children: [new u({ text: h, bold: !0 })] })]
          }),
          new N({ width: { size: 65, type: i.PERCENTAGE }, children: [new a(String(v ?? '—'))] })
        ]
      }),
    j = [];
  (j.push(
    new a({ text: 'INFORME DE DAÑOS / NO CONFORMIDAD', heading: g.TITLE, alignment: z.CENTER })
  ),
    M.tipo_producto && j.push(new a({ text: M.tipo_producto, alignment: z.CENTER })),
    j.push(new a({ text: s.numero || '', alignment: z.CENTER })),
    j.push(new a('')),
    j.push(
      new O({
        width: { size: 100, type: i.PERCENTAGE },
        rows: [
    ...
    j.push(new a('')));
  const t = (h, v) => {
    (j.push(new a({ text: h, heading: g.HEADING_2 })), v && j.push(new a(String(v))));
  };
  (M.antecedentes && t('1. ANTECEDENTES', M.antecedentes),
    M.descripcion_hallazgo && t('2. DESCRIPCIÓN DEL HALLAZGO', M.descripcion_hallazgo),
    j.push(new a({ text: '3. DAÑOS IDENTIFICADOS', heading: g.HEADING_2 })));
  let o = 0;
  for (const h of m) {
    o += 1;
    const v =
      ...
      h.producto ||
      `Hallazgo ${o}`;
    j.push(new a({ text: `3.${o} ${v}`, heading: g.HEADING_3 }));
    const A = [];
    ((h.producto || h.codigo_producto) &&
      A.push(
        `Producto: ${h.producto || ''} ${h.codigo_producto ? `(${h.codigo_producto})` : ''}`.trim()
      ),
      Number(h.cantidad) > 0 && A.push(`Cantidad: ${Number(h.cantidad)}`),
      h.ubicacion && A.push(`Ubicación: ${h.ubicacion}`),
      h.partida && A.push(`Lote: ${h.partida}`),
      h.tipo_dano && A.push(`Tipo de daño: ${h.tipo_dano}`),
      h.componente_afectado && A.push(`Componente afectado: ${h.componente_afectado}`),
      h.consecuencia && A.push(`Consecuencia: ${h.consecuencia}`),
      h.observaciones && A.push(`Observaciones: ${h.observaciones}`),
      A.forEach((W) => j.push(new a({ children: [new u(W)] }))));
    const q = _[h.id] || [];
    for (const W of q)
      try {
        const oe = await vt(await ea(W));
        (j.push(
          new a({
            children: [
              new D({ data: oe, type: 'jpg', transformation: { width: 320, height: 240 } })
            ]
          })
        ),
          W.descripcion &&
            j.push(new a({ children: [new u({ text: W.descripcion, italics: !0, size: 18 })] })));
      } catch {}
    j.push(new a(''));
  }
  (Array.isArray(M.cuadro_resumen) &&
    M.cuadro_resumen.length &&
    (j.push(new a({ text: '4. CUADRO RESUMEN DE HALLAZGOS', heading: g.HEADING_2 })),
    j.push(
      new O({
        width: { size: 100, type: i.PERCENTAGE },
        rows: [
          new w({
            children: [
              new N({ children: [new a({ children: [new u({ text: 'Indicador', bold: !0 })] })] }),
              new N({ children: [new a({ children: [new u({ text: 'Valor', bold: !0 })] })] })
            ]
          }),
          ...M.cuadro_resumen.map(
            (h) =>
              new w({
                children: [
                  new N({ children: [new a(String(h.indicador ?? ''))] }),
                  new N({ children: [new a(String(h.valor ?? ''))] })
                ]
              })
          )
        ]
    ...
    j.push(new a(''))),
    M.analisis_causa && t('5. ANÁLISIS Y CAUSA PROBABLE', M.analisis_causa),
    Array.isArray(M.acciones_recomendadas) &&
      M.acciones_recomendadas.length &&
      (j.push(new a({ text: '6. ACCIONES RECOMENDADAS', heading: g.HEADING_2 })),
      M.acciones_recomendadas
        .filter(Boolean)
        .forEach((h) => j.push(new a({ text: h, bullet: { level: 0 } }))),
      j.push(new a(''))),
    j.push(new a('')),
    j.push(
      new O({
        ...
        rows: [
          new w({
            children: [
              new N({
                children: [
                  new a('_______________________________'),
                  new a({
                    children: [
                      new u({
                  ...
                  new a('Elaborado por — Control de Operaciones')
                ]
              }),
              new N({
                children: [
                  new a('_______________________________'),
                  new a({
                    children: [new u({ text: M.revisado_por || 'Nombre / Firma', bold: !0 })]
                  }),
                  new a('Revisado por — Jefatura / Supervisión')
                ]
              })
            ]
          })
  ...
  const n = new y({
      sections: [{ headers: { default: p }, footers: { default: L }, children: j }]
    }),
    l = await f.toBlob(n);
  await cs(l, `${s.numero || 'Informe_Danos'}.docx`, { label: 'Informe Word' });
}
async function yt(s, m = [], d = []) {
  var z;
  const x = await we(
      () => import('./pdfmake-CkMY3Ap1.js').then((p) => p.p),
      __vite__mapDeps([0, 1])
    ),
    y = await we(() => import('./vfs_fonts-8ICcZKi6.js').then((p) => p.v), __vite__mapDeps([2, 1])),
    f = x.default || x,
    a = y.default || y;
  f.vfs = ((z = a.pdfMake) == null ? void 0 : z.vfs) || a.vfs || f.vfs;
  const { rep: u, evByItem: g } = sa(s, m, d),
    O = [];
  (O.push({ text: 'INFORME DE DAÑOS / NO CONFORMIDAD', style: 'title' }),
    u.tipo_producto && O.push({ text: u.tipo_producto, alignment: 'center', margin: [0, 0, 0, 2] }),
    O.push({ text: s.numero || '', alignment: 'center', margin: [0, 0, 0, 10], color: '#64748b' }));
  const w = (p, L) => [{ text: p, bold: !0 }, { text: String(L ?? '—') }];
  O.push({
    table: {
      widths: ['35%', '65%'],
      body: [
        w('Fecha de recepción', u.fecha_recepcion || s.fecha),
        w('Tipo de producto', u.tipo_producto),
        w('Área responsable', u.area_responsable),
        w('Clasificación', u.clasificacion),
        w('Bodega', s.bodega),
        w('Analista', s.analista_nombre)
      ]
    },
  ...
  const N = (p, L) => {
    (O.push({ text: p, style: 'h2' }), L && O.push({ text: String(L), margin: [0, 0, 0, 8] }));
  };
  (u.antecedentes && N('1. ANTECEDENTES', u.antecedentes),
    u.descripcion_hallazgo && N('2. DESCRIPCIÓN DEL HALLAZGO', u.descripcion_hallazgo),
    O.push({ text: '3. DAÑOS IDENTIFICADOS', style: 'h2' }));
  let i = 0;
  for (const p of m) {
    i += 1;
    const L =
      ...
      p.producto ||
      `Hallazgo ${i}`;
    O.push({ text: `3.${i} ${L}`, style: 'h3' });
    const M = [];
    ((p.producto || p.codigo_producto) &&
      M.push(
        `Producto: ${p.producto || ''} ${p.codigo_producto ? `(${p.codigo_producto})` : ''}`.trim()
      ),
      Number(p.cantidad) > 0 && M.push(`Cantidad: ${Number(p.cantidad)}`),
      p.ubicacion && M.push(`Ubicación: ${p.ubicacion}`),
      p.partida && M.push(`Lote: ${p.partida}`),
      p.tipo_dano && M.push(`Tipo de daño: ${p.tipo_dano}`),
      p.componente_afectado && M.push(`Componente afectado: ${p.componente_afectado}`),
      p.consecuencia && M.push(`Consecuencia: ${p.consecuencia}`),
      p.observaciones && M.push(`Observaciones: ${p.observaciones}`),
      M.length && O.push({ ul: M, margin: [0, 0, 0, 6] }));
    const _ = g[p.id] || [],
      S = [];
    for (const j of _)
      try {
        const t = await _t(await ea(j));
        S.push({ image: t, width: 220, margin: [0, 4, 8, 4] });
      } catch {}
    S.length && O.push({ columns: S, columnGap: 8, margin: [0, 0, 0, 8] });
  }
  (Array.isArray(u.cuadro_resumen) &&
    u.cuadro_resumen.length &&
    (O.push({ text: '4. CUADRO RESUMEN DE HALLAZGOS', style: 'h2' }),
    O.push({
      table: {
        widths: ['70%', '30%'],
        body: [
          ...
          ...u.cuadro_resumen.map((p) => [String(p.indicador ?? ''), String(p.valor ?? '')])
        ]
      },
      layout: 'lightHorizontalLines',
      margin: [0, 0, 0, 12]
    })),
    u.analisis_causa && N('5. ANÁLISIS Y CAUSA PROBABLE', u.analisis_causa),
    Array.isArray(u.acciones_recomendadas) &&
      u.acciones_recomendadas.length &&
      (O.push({ text: '6. ACCIONES RECOMENDADAS', style: 'h2' }),
      O.push({ ul: u.acciones_recomendadas.filter(Boolean), margin: [0, 0, 0, 12] })),
    O.push({
      columns: [
        {
          stack: [
            { text: '_______________________________', margin: [0, 20, 0, 0] },
            { text: u.elaborado_por || s.analista_nombre || 'Nombre / Firma', bold: !0 },
        ...
        },
        {
          stack: [
            { text: '_______________________________', margin: [0, 20, 0, 0] },
            { text: u.revisado_por || 'Nombre / Firma', bold: !0 },
  ...
  await ds(f.createPdf(D), `${s.numero || 'Informe_Danos'}.pdf`, { label: 'Informe de daños' });
}
const qe = {
  LIBERAR: 'Liberado',
...
function aa(s) {
  const m = (x) => s.filter(x).length,
    d = [...new Set(s.map((x) => x.condicion_observada).filter(Boolean))];
  return {
    total: s.length,
    dictaminados: m((x) => x.dictamen),
    pendientes: m((x) => !x.dictamen),
    problema: m((x) => x.condicion_observada && x.condicion_observada !== 'OK'),
    noReg: m((x) => x.no_registrado),
    rojo: m((x) => x.semaforo === 'ROJO'),
    naranja: m((x) => x.semaforo === 'NARANJA'),
    verde: m((x) => x.semaforo === 'VERDE'),
    porDictamen: ['LIBERAR', 'CUARENTENA', 'REPROCESO', 'RECHAZAR', 'BAJA']
      .map((x) => ({ d: x, n: m((y) => y.dictamen === x) }))
      .filter((x) => x.n > 0),
    porCondicion: d.map((x) => ({ x, n: m((y) => y.condicion_observada === x) }))
  };
}
async function kt(s, m = []) {
  const d = await we(() => import('./index-BmpJy8SR.js'), []),
    {
      Document: x,
      Packer: y,
      Paragraph: f,
    ...
    { header: D, footer: z } = ys(d, 'monitoreo'),
    p = aa(m),
    L = (o, n) =>
      new O({
        children: [
          new w({
            width: { size: 35, type: N.PERCENTAGE },
            children: [new f({ children: [new a({ text: o, bold: !0 })] })]
          }),
          new w({ width: { size: 65, type: N.PERCENTAGE }, children: [new f(String(n ?? '—'))] })
        ]
      }),
    M = (o) => new w({ children: [new f({ children: [new a({ text: o, bold: !0, size: 18 })] })] }),
    _ = (o) =>
      new w({ children: [new f({ children: [new a({ text: String(o ?? '—'), size: 18 })] })] }),
    S = [];
  (S.push(new f({ text: 'INFORME DE MONITOREO A CALIDAD', heading: u.TITLE, alignment: i.CENTER })),
    S.push(new f({ text: s.numero || '', alignment: i.CENTER })),
    S.push(new f('')),
    S.push(
      new g({
        width: { size: 100, type: N.PERCENTAGE },
        rows: [
          L('Fecha', s.fecha),
          L('Bodega', s.bodega),
    ...
    S.push(new f('')),
    S.push(new f({ text: '1. RESUMEN EJECUTIVO', heading: u.HEADING_2 })),
    S.push(
      new g({
        width: { size: 100, type: N.PERCENTAGE },
        rows: [
          L('Total de ítems', p.total),
          L('Dictaminados', p.dictaminados),
          L('Pendientes', p.pendientes),
          L('Con problema (condición ≠ OK)', p.problema),
          L('No registrados en sistema', p.noReg),
          L('Semáforo vencimiento (🔴/🟠/🟢)', `${p.rojo} / ${p.naranja} / ${p.verde}`),
          ...p.porDictamen.map((o) => L(`Dictamen · ${qe[o.d] || o.d}`, o.n))
        ]
      })
    ),
    S.push(new f('')),
    S.push(new f({ text: '2. DETALLE DE ÍTEMS', heading: u.HEADING_2 })),
    S.push(
      new g({
        width: { size: 100, type: N.PERCENTAGE },
        rows: [
            ...
            (o) =>
              new O({
                children: [
                  ...
                  _(o.ubicacion),
                  _(o.cantidad),
                  _(o.cantidad_afectada || 0),
                  _((o.no_registrado ? 'NO REG · ' : '') + (o.condicion_observada || '')),
                  _(o.dictamen ? qe[o.dictamen] || o.dictamen : 'Pendiente')
                ]
              })
          )
        ]
            ...
            children: [
              new w({
                children: [
                  ...
                  new f({
                    children: [new a({ text: s.analista_nombre || 'Nombre / Firma', bold: !0 })]
                  }),
              ...
              new w({
                children: [
                  new f('_______________________________'),
                  new f({ children: [new a({ text: 'Nombre / Firma', bold: !0 })] }),
  ...
  const j = new x({
      sections: [{ headers: { default: D }, footers: { default: z }, children: S }]
    }),
    t = await y.toBlob(j);
  await cs(t, `${s.numero || 'Informe_Monitoreo'}.docx`, { label: 'Informe Word' });
}
async function Ct(s, m = []) {
  var w;
  const d = await we(
      () => import('./pdfmake-CkMY3Ap1.js').then((N) => N.p),
      __vite__mapDeps([0, 1])
    ),
    x = await we(() => import('./vfs_fonts-8ICcZKi6.js').then((N) => N.v), __vite__mapDeps([2, 1])),
    y = d.default || d,
    f = x.default || x;
  y.vfs = ((w = f.pdfMake) == null ? void 0 : w.vfs) || f.vfs || y.vfs;
  const a = aa(m),
    u = (N, i) => [{ text: N, bold: !0 }, { text: String(i ?? '—') }],
    g = [];
  (g.push({ text: 'INFORME DE MONITOREO A CALIDAD', style: 'title' }),
    ...
    g.push({
      table: {
        ...
        body: [
          u('Fecha', s.fecha),
          u('Bodega', s.bodega),
          u('Analista', s.analista_nombre),
          u('Periodicidad', s.periodicidad),
          u('Estado', (s.estado || '').replace('_', ' '))
        ]
      },
      layout: 'lightHorizontalLines',
      margin: [0, 0, 0, 12]
    ...
    g.push({
      table: {
        widths: ['60%', '40%'],
        body: [
          u('Total de ítems', a.total),
          u('Dictaminados', a.dictaminados),
          u('Pendientes', a.pendientes),
          u('Con problema (condición ≠ OK)', a.problema),
          u('No registrados en sistema', a.noReg),
          u('Semáforo vencimiento (R/N/V)', `${a.rojo} / ${a.naranja} / ${a.verde}`),
          ...a.porDictamen.map((N) => u(`Dictamen · ${qe[N.d] || N.d}`, N.n))
        ]
      },
      layout: 'lightHorizontalLines',
      margin: [0, 0, 0, 12]
      ...
      table: {
        ...
        body: [
          ['SKU', 'Producto', 'Lote/Serie', 'Ubic.', 'Cant', 'Afe.', 'Condición', 'Dictamen'].map(
            (N) => ({ text: N, bold: !0, fontSize: 8 })
          ),
          ...m.map((N) => [
            { text: N.codigo_producto || '', fontSize: 8 },
            { text: N.producto || '', fontSize: 8 },
            { text: N.partida || '', fontSize: 8 },
            { text: N.ubicacion || '', fontSize: 8 },
            { text: String(N.cantidad ?? ''), fontSize: 8 },
            { text: String(N.cantidad_afectada || 0), fontSize: 8 },
            {
              text: (N.no_registrado ? 'NO REG · ' : '') + (N.condicion_observada || ''),
              fontSize: 8
            },
            { text: N.dictamen ? qe[N.dictamen] || N.dictamen : 'Pendiente', fontSize: 8 }
          ])
        ]
      },
      layout: 'lightHorizontalLines',
  ...
  await ds(O, `${s.numero || 'Informe_Monitoreo'}.pdf`, { label: 'Informe de monitoreo' });
}
async function ks(s) {
  try {
    const m = await createImageBitmap(s),
      d = 1600;
    let { width: x, height: y } = m;
    if (x > d || y > d) {
      const g = Math.min(d / x, d / y);
      ((x = Math.round(x * g)), (y = Math.round(y * g)));
    }
    const f = document.createElement('canvas');
    return (
      (f.width = x),
      (f.height = y),
      f.getContext('2d').drawImage(m, 0, 0, x, y),
      (await new Promise((g) => f.toBlob(g, 'image/jpeg', 0.82))) || s
    );
  } catch {
    return s;
  }
}
const Cs = ({ onCapture: s, onClose: m }) => {
    const d = b.useRef(null),
      x = b.useRef(null),
      [y, f] = b.useState('environment'),
      [a, u] = b.useState(null),
      [g, O] = b.useState(null),
      [w, N] = b.useState(null),
      [i, D] = b.useState(!0),
      z = b.useCallback(() => {
        var t;
        try {
          (t = x.current) == null || t.getTracks().forEach((o) => o.stop());
        } catch {}
        x.current = null;
      }, []),
      p = b.useCallback(
        async (t) => {
          ...
          try {
            ...
            const n = await navigator.mediaDevices.getUserMedia({
              video: { facingMode: { ideal: t }, width: { ideal: 1920 }, height: { ideal: 1080 } },
              audio: !1
            });
            ((x.current = n),
              d.current && ((d.current.srcObject = n), await d.current.play().catch(() => {})));
          } catch {
            N(
    ...
    b.useEffect(() => (p(y), z), []);
    const L = () => {
        const t = y === 'environment' ? 'user' : 'environment';
        (f(t), p(t));
      },
      M = () => {
        const t = d.current;
        if (!t || !t.videoWidth) return I.error('La cámara aún no está lista');
        const o = document.createElement('canvas');
        ((o.width = t.videoWidth),
          (o.height = t.videoHeight),
          o.getContext('2d').drawImage(t, 0, 0, o.width, o.height),
          o.toBlob(
            (n) => {
              if (!n) return I.error('No se pudo capturar la foto');
              (O(n), u(URL.createObjectURL(n)), z());
            },
            'image/jpeg',
            0.9
          ));
      ...
      _ = () => {
        (a && URL.revokeObjectURL(a), u(null), O(null), p(y));
      },
      S = () => {
        if (!g) return;
        const t = new File([g], `foto-${Date.now()}.jpg`, { type: 'image/jpeg' });
        (a && URL.revokeObjectURL(a), s == null || s(t), m == null || m());
      },
      j = () => {
        (z(), a && URL.revokeObjectURL(a), m == null || m());
      };
    return e.jsxs('div', {
  ...
  Et = ({
    ...
    const { user: a } = ye(),
      ...
      [g, O] = b.useState(!1),
      [w, N] = b.useState(!1),
      i = Ca.isNativePlatform() || (typeof navigator < 'u' && navigator.maxTouchPoints > 0),
      [D, z] = b.useState(null),
      [p, L] = b.useState({});
    b.useEffect(() => {
      let t = !0;
    ...
    const M = y && !!s && !!m,
      _ = async (t) => {
        ...
        if (((t.target.value = ''), !(!o.length || !s))) {
          N(!0);
          try {
            for (const l of o) {
              if (!l.type.startsWith('image/')) continue;
              const h = await ks(l);
              await Oa({ informeId: s, itemId: m, blob: h, user: a });
            }
            (I.success(o.length > 1 ? 'Fotos agregadas' : 'Foto agregada'), x == null || x());
          } catch (l) {
            I.error(
              (n = l == null ? void 0 : l.message) != null && n.includes('row-level security')
      ...
      S = async (t) => {
        if (confirm('¿Eliminar esta foto?'))
          try {
            (await Aa(t), I.success('Foto eliminada'), x == null || x());
          } catch {
            I.error('No se pudo eliminar la foto');
          }
      },
      j = f ? 'w-16 h-16' : 'w-20 h-20';
    return e.jsxs('div', {
      children: [
        e.jsxs('div', {
          ...
          children: [
            d.map((t) =>
              e.jsxs(
                'div',
                {
                  className: `relative group ${j} rounded-xl overflow-hidden border border-slate-200 bg-slate-100 shrink-0`,
                  children: [
                    e.jsx('img', {
                      src: p[t.storage_path] || '',
                      alt: t.descripcion || '',
                      className: 'w-full h-full object-cover cursor-zoom-in',
                      onClick: () => p[t.storage_path] && z(p[t.storage_path])
                    }),
                    y &&
                      e.jsx('button', {
                        onClick: () => S(t),
            ...
            y &&
              ...
              e.jsxs('button', {
                ...
                onClick: () => O(!0),
                disabled: !M || w,
                title: m ? 'Tomar foto con la cámara' : 'Guarda el borrador para adjuntar fotos',
                className: `${j} shrink-0 rounded-xl border-2 border-dashed border-emerald-300 text-emerald-500 flex flex-col items-center justify-center gap-1 hover:border-emerald-500 hover:bg-emerald-50 disabled:opacity-40 disabled:cursor-not-allowed`,
                children: [
                  w ? e.jsx(_e, { size: 18, className: 'animate-spin' }) : e.jsx(Te, { size: 18 }),
                  e.jsx('span', {
            ...
            y &&
              e.jsxs('button', {
                ...
                onClick: () => {
                  var t;
                  return (t = u.current) == null ? void 0 : t.click();
                },
                disabled: !M || w,
                title: m
                  ? 'Subir foto desde archivos/galería'
                  : 'Guarda el borrador para adjuntar fotos',
                className: `${j} shrink-0 rounded-xl border-2 border-dashed border-slate-300 text-slate-400 flex flex-col items-center justify-center gap-1 hover:border-emerald-400 hover:text-emerald-500 disabled:opacity-40 disabled:cursor-not-allowed`,
                children: [
                  w ? e.jsx(_e, { size: 18, className: 'animate-spin' }) : e.jsx(ls, { size: 18 }),
                  e.jsx('span', {
                    className: 'text-[8px] font-black uppercase tracking-wider',
                    children: i ? 'Galería' : 'Foto'
                  })
                ]
              }),
            d.length === 0 &&
              ...
              e.jsxs('span', {
                ...
                children: [e.jsx(ua, { size: 14 }), ' Sin fotos']
              })
          ]
        }),
        y &&
        ...
        g &&
          e.jsx(Cs, {
            onCapture: (t) => _({ target: { files: [t], value: '' } }),
            onClose: () => O(!1)
          }),
        D &&
          e.jsxs('div', {
  ...
  ta = { OK: 'Conforme', NO: 'No conforme', NA: 'N/A' },
  At = { IMPORTACION: 'Importación', NACIONAL: 'Nacional' };
function Me(s, m = {}) {
  return m.tipo === 'SALIDA' || s.tipo === 'CERTIFICADO_SALIDA';
}
function oa(s, m = {}) {
  if (Me(s, m))
  ...
  const d = m.soloNoSanitario ? ' (PRODUCTO NO SANITARIO)' : '';
  return s.resultado === 'CONFORME'
...
const ts = (s, m) => (Me(s, m) ? 'salida' : 'checklist');
function We(s = {}) {
  const m = s.categorias || [];
  return m.length
    ? m
...
function la(s, m) {
  ...
  return `${String(d).replace(/[^\w.-]+/g, '_')}.${m}`;
}
async function na(s, m = [], d = {}) {
  var W, oe, se, ae, le, F, K;
  const x = await we(() => import('./index-BmpJy8SR.js'), []),
    {
      Document: y,
      Packer: f,
    ...
    j = {
      ...
      left: { style: p.NONE },
      right: { style: p.NONE },
      insideHorizontal: { style: p.NONE },
      insideVertical: { style: p.NONE }
    },
    t = (R, V) =>
      new w({
        children: [
          new N({
            width: { size: 35, type: i.PERCENTAGE },
            children: [new a({ children: [new u({ text: R, bold: !0 })] })]
          }),
          new N({ width: { size: 65, type: i.PERCENTAGE }, children: [new a(String(V ?? '—'))] })
        ]
      }),
    o = (R) => new N({ children: [new a({ children: [new u({ text: R, bold: !0, size: 18 })] })] }),
    n = (R) =>
      new N({ children: [new a({ children: [new u({ text: String(R ?? '—'), size: 18 })] })] }),
    l = [];
  (l.push(new a({ text: oa(s, d), heading: g.TITLE, alignment: D.CENTER })),
    d.soloNoSanitario &&
      l.push(
        new a({
          alignment: D.CENTER,
      ...
      new O({
        ...
        rows: [
          new w({
            children: [
              new N({
                shading: { fill: S ? 'ECFDF5' : 'FEF2F2', type: z.CLEAR, color: 'auto' },
                children: [
                  new a({
                    children: [
                      new u({
                  ...
                  new a({
                    children: [new u({ text: `Folio: ${s.folio || '—'}`, bold: !0, size: 26 })]
                  }),
                  new a({
                    children: [
                      new u({
    ...
    l.push(
      new O({
        width: { size: 100, type: i.PERCENTAGE },
        rows: [
          ...ra(s, d).map(([R, V]) => t(R, V)),
          t(
            'Resultado',
            S ? 'CONFORME' : s.resultado === 'NO_CONFORME' ? 'NO CONFORME' : s.estado || '—'
          ),
          ...(_ ? [t('Estado de despacho', `${Ce(s).emoji} ${Ce(s).label}`)] : []),
          ...(We(d) ? [t('Familias de producto', We(d))] : []),
          ...(s.disposicion ? [t('Disposición / Acción a tomar', s.disposicion)] : []),
          t('Responsable de Calidad', s.realizado_nombre),
          t(
    ...
    l.push(new a('')));
  const h = _ && Array.isArray((W = s.contexto) == null ? void 0 : W.skus) ? s.contexto.skus : [];
  h.length &&
    (l.push(new a({ text: 'SKUs del despacho', heading: g.HEADING_2 })),
    l.push(
      new O({
        width: { size: 100, type: i.PERCENTAGE },
        rows: [
          new w({ children: ['Código', 'Producto', 'Ubicación', 'Cantidad'].map(o) }),
          ...h.map(
            (R) =>
              new w({
                children: [
                  ...
                  n(R.producto),
                  n(R.ubicacion),
                  n(`${R.cantidad ?? '—'} ${R.unidad_medida || ''}`.trim())
                ]
              })
          )
        ]
  ...
  if (
    (m.forEach((R) => {
      (l.push(new a({ text: R.titulo, heading: g.HEADING_2 })),
        l.push(
          new O({
            width: { size: 100, type: i.PERCENTAGE },
            rows: [
              new w({ children: ['Requisito', 'Resultado', 'Evidencia', 'Observación'].map(o) }),
              ...R.params.map((V) => {
                var te, Y, k;
                return new w({
                  children: [
                    n(V.label),
                    n(ta[(te = v[V.id]) == null ? void 0 : te.estado] || '—'),
                    n(((Y = v[V.id]) == null ? void 0 : Y.evidencia) || '—'),
                    n(((k = v[V.id]) == null ? void 0 : k.nota) || '')
                  ]
                });
              })
            ]
    ...
    const R = Se(s);
    (Array.isArray(R.clasificacion) &&
      R.clasificacion.length &&
      (l.push(new a({ text: 'Clasificación del producto', heading: g.HEADING_2 })),
      us.forEach((Y) => {
        l.push(new a(`${R.clasificacion.includes(Y.id) ? '☑' : '☐'} ${Y.label}`));
      }),
      l.push(new a(''))),
      R.embalaje &&
        Object.values(R.embalaje).some(Boolean) &&
        (l.push(new a({ text: 'Evaluación del embalaje', heading: g.HEADING_2 })),
        l.push(
          new O({
            width: { size: 100, type: i.PERCENTAGE },
            rows: ps.map((Y) => t(Y.label, R.embalaje[Y.id] || '—'))
          })
        ),
        l.push(new a(''))));
    const V = bs(s.checklist);
    (l.push(
      new O({
        width: { size: 100, type: i.PERCENTAGE },
        rows: [
          ...(R.disposicionInmediata ? [t('Disposición inmediata', R.disposicionInmediata)] : []),
          t('Riesgo de la recepción', `${V.emoji} ${V.label}`)
        ]
      })
    ),
      l.push(new a('')));
    const te = hs(s);
    (l.push(new a({ text: 'Indicadores ISO', heading: g.HEADING_2 })),
      l.push(
        new O({
          width: { size: 100, type: i.PERCENTAGE },
          rows: [
            t('Tiempo recepción', te.minutos != null ? `${te.minutos} minutos` : '—'),
            t('Inspector', te.inspector || '—'),
            t('N° ítems', te.items),
            t('Conformes', te.ok),
            t('No conformes', te.no),
            t('Resultado', te.pct != null ? `${String(te.pct).replace('.', ',')}%` : '—')
          ]
        })
      ),
      l.push(new a('')));
  ...
  if (_) {
    const R = Se(s),
      V = gs(
        (oe = R.pesos) == null ? void 0 : oe.esperado,
        (se = R.pesos) == null ? void 0 : se.registrado
      );
    (((ae = R.pesos) != null && ae.esperado) || ((le = R.pesos) != null && le.registrado)) &&
      (l.push(new a({ text: 'Control de peso', heading: g.HEADING_2 })),
      l.push(
        new O({
          width: { size: 100, type: i.PERCENTAGE },
          rows: [
            t(
              'Peso esperado',
              (F = R.pesos) != null && F.esperado ? `${R.pesos.esperado} kg` : '—'
            ),
            t(
              'Peso registrado',
              (K = R.pesos) != null && K.registrado ? `${R.pesos.registrado} kg` : '—'
            ),
            t('Resultado', V || '—')
          ]
        })
      ...
      l.push(new a('')));
    const te = Number(R.bultosTotal ?? s.bultos) || 0;
    if (te > 0) {
      const Y = Array.isArray(R.bultosEtiquetas) ? R.bultosEtiquetas : [];
      (l.push(new a({ text: 'Verificación de bultos', heading: g.HEADING_2 })),
        l.push(
          new O({
            width: { size: 100, type: i.PERCENTAGE },
            rows: [
              new w({ children: ['Bulto', 'Etiqueta'].map(o) }),
              ...Array.from(
                { length: Math.min(te, 60) },
                (k, G) =>
                  new w({
                    children: [n(`Bulto ${G + 1}/${te}`), n(Y[G] ? 'Etiqueta OK' : 'Pendiente')]
                  })
              )
            ]
          })
    ...
    (Array.isArray(R.riesgos) &&
      R.riesgos.length &&
      (l.push(new a({ text: 'Riesgos evaluados', heading: g.HEADING_2 })),
      fs.forEach((Y) => {
        l.push(new a(`${R.riesgos.includes(Y.id) ? '☑' : '☐'} ${Y.label}`));
      }),
      l.push(new a(''))),
      Array.isArray(R.evidencias) &&
        R.evidencias.length &&
        (l.push(new a({ text: 'Evidencia fotográfica', heading: g.HEADING_2 })),
        ['PALLET', 'EMBALAJE', 'CAMION'].forEach((Y) => {
          const k = R.evidencias.filter((G) => G.tipo === Y).length;
          k && l.push(new a(`📷 ${Je[Y]}: ${k} foto(s) asociada(s) al certificado.`));
        }),
        l.push(
          new a({
            children: [
  ...
  if (!_) {
    ...
    Array.isArray(R.evidencias) &&
      R.evidencias.length &&
      (l.push(new a({ text: 'Evidencia fotográfica', heading: g.HEADING_2 })),
      [...new Set(R.evidencias.map((V) => V.tipo))].forEach((V) => {
        const te = R.evidencias.filter((Y) => Y.tipo === V).length;
        te && l.push(new a(`📷 ${Je[V] || V}: ${te} foto(s) asociada(s) al checklist.`));
      }),
      l.push(
        new a({
          children: [
  ...
  (s.observaciones &&
    (l.push(new a({ text: 'Observaciones', heading: g.HEADING_2 })),
    l.push(new a(s.observaciones)),
    l.push(new a(''))),
    l.push(new a('')),
    l.push(
      new O({
            ...
            children: [
              new N({
                ...
                children: [
                  new a('_______________________________'),
                  new a({
                    children: [new u({ text: s.realizado_nombre || 'Nombre / Firma', bold: !0 })]
                  }),
                  new a(_ ? 'Calidad — Certificación de salida' : 'Calidad — Inspección de ingreso')
                ]
              }),
              new N({
                borders: j,
                children: [
                  new a('_______________________________'),
                  new a({ children: [new u({ text: 'Nombre / Firma', bold: !0 })] }),
                  new a(_ ? 'Despacho / Bodega' : 'Recepción / Bodega')
                ]
              })
            ]
          })
    ...
    s.firma_digital &&
      (l.push(new a('')),
      l.push(new a({ children: [new u({ text: 'FIRMA ELECTRÓNICA', bold: !0 })] })),
      l.push(
        new a({
          children: [
            new u({
      ...
      l.push(new a({ children: [new u({ text: s.firma_digital, size: 12, color: '94A3B8' })] })),
      l.push(
        new a({
          children: [
            new u({
  ...
  const A = new y({
      sections: [{ headers: { default: L }, footers: { default: M }, children: l }]
    }),
    q = await f.toBlob(A);
  await cs(q, la(s, 'docx'), { label: 'Informe Word' });
}
async function ia(s, m = [], d = {}) {
  var p, L, M, _, S, j, t, o;
  const x = await we(
      () => import('./pdfmake-CkMY3Ap1.js').then((n) => n.p),
      __vite__mapDeps([0, 1])
    ),
    y = await we(() => import('./vfs_fonts-8ICcZKi6.js').then((n) => n.v), __vite__mapDeps([2, 1])),
    f = x.default || x,
    a = y.default || y;
  f.vfs = ((p = a.pdfMake) == null ? void 0 : p.vfs) || a.vfs || f.vfs;
  const u = s.checklist || {},
    g = Me(s, d),
    O = s.resultado === 'CONFORME',
    w = s.completado_en ? new Date(s.completado_en).toLocaleString('es-CL') : '—',
    N = (n, l) => [{ text: n, bold: !0 }, { text: String(l ?? '—') }],
    i = [];
  (i.push({
    text: oa(s, d),
    style: 'title',
    color: O ? '#047857' : s.resultado === 'NO_CONFORME' ? '#be123c' : '#0f172a'
  }),
    d.soloNoSanitario &&
      i.push({
        text: 'Documento de conformidad de recepción — no constituye certificación de dispositivo médico bajo ISO 13485.',
    ...
    i.push({
          ...
          [
            {
              ...
              stack: [
                ...
                {
                  text: `${s.realizado_nombre || ''}${s.completado_en ? ' · ' + w : ''}`,
                  fontSize: 8,
                  color: '#475569',
                  margin: [0, 2, 0, 0]
                }
      ...
      layout: {
        hLineColor: () => (O ? '#a7f3d0' : '#fecaca'),
        vLineColor: () => (O ? '#a7f3d0' : '#fecaca'),
        hLineWidth: () => 1,
        vLineWidth: () => 1
      },
      margin: [0, 6, 0, 12]
    ...
    i.push({
      table: {
        widths: ['35%', '65%'],
        body: [
          ...ra(s, d).map(([n, l]) => N(n, l)),
          N(
            'Resultado',
            O ? 'CONFORME' : s.resultado === 'NO_CONFORME' ? 'NO CONFORME' : s.estado || '—'
          ),
          ...(g
            ? [
                [
            ...
            : []),
          ...(We(d) ? [N('Familias de producto', We(d))] : []),
          ...(s.disposicion ? [N('Disposición / Acción a tomar', s.disposicion)] : []),
          N('Responsable de Calidad', s.realizado_nombre),
          N('Fecha de finalización', w)
        ]
      },
      layout: 'lightHorizontalLines',
      margin: [0, 0, 0, 12]
    }));
  const D = g && Array.isArray((L = s.contexto) == null ? void 0 : L.skus) ? s.contexto.skus : [];
  if (
    (D.length &&
      (i.push({ text: 'SKUs del despacho', style: 'h2' }),
      i.push({
        table: {
          headerRows: 1,
          widths: ['auto', '*', 'auto', 'auto'],
          body: [
            ['Código', 'Producto', 'Ubicación', 'Cantidad'].map((n) => ({
              text: n,
              bold: !0,
              fontSize: 9
            })),
            ...D.map((n) => [
              { text: n.codigo_producto || '—', fontSize: 9 },
              { text: n.producto || '—', fontSize: 9 },
              { text: n.ubicacion || '—', fontSize: 9 },
              { text: `${n.cantidad ?? '—'} ${n.unidad_medida || ''}`.trim(), fontSize: 9 }
            ])
          ]
        },
        layout: 'lightHorizontalLines',
    ...
    m.forEach((n) => {
      (i.push({ text: n.titulo, style: 'h2' }),
        i.push({
          table: {
            headerRows: 1,
            widths: ['*', 'auto', 'auto', '28%'],
            body: [
              ['Requisito', 'Resultado', 'Evidencia', 'Observación'].map((l) => ({
                text: l,
                bold: !0,
                fontSize: 9
              })),
              ...n.params.map((l) => {
                var v, A, q;
                const h = (v = u[l.id]) == null ? void 0 : v.estado;
                return [
                  { text: l.label, fontSize: 9 },
                  {
                    text: ta[h] || '—',
                    fontSize: 9,
                    bold: !0,
                    color: h === 'NO' ? '#be123c' : h === 'OK' ? '#047857' : '#64748b'
                  },
                  {
                    text: ((A = u[l.id]) == null ? void 0 : A.evidencia) || '—',
                    fontSize: 9,
                    color: '#475569'
                  },
                  { text: ((q = u[l.id]) == null ? void 0 : q.nota) || '', fontSize: 9 }
                ];
              })
            ]
          },
    ...
    const n = Se(s);
    (Array.isArray(n.clasificacion) &&
      n.clasificacion.length &&
      (i.push({ text: 'Clasificación del producto', style: 'h2' }),
      i.push({
        columns: [0, 1].map((v) => ({
          stack: us
            .filter((A, q) => q % 2 === v)
            .map((A) => ({
              text: `${n.clasificacion.includes(A.id) ? '☑' : '☐'} ${A.label}`,
              fontSize: 9,
              margin: [0, 1, 0, 1]
            }))
        })),
      ...
      n.embalaje &&
        Object.values(n.embalaje).some(Boolean) &&
        (i.push({ text: 'Evaluación del embalaje', style: 'h2' }),
        i.push({
          table: {
            widths: ['35%', '65%'],
            body: ps.map((v) => {
              const A = n.embalaje[v.id] || '—',
                q =
                  ['Malo', 'Incorrecto', 'Sí'].includes(A) ||
                  (v.id === 'pallet' && A === 'Regular');
              return [
                { text: v.label, bold: !0 },
                { text: A, bold: !0, color: A === '—' ? '#64748b' : q ? '#be123c' : '#047857' }
              ];
            })
          },
          layout: 'lightHorizontalLines',
    ...
    const l = bs(s.checklist);
    i.push({
      table: {
        widths: ['35%', '65%'],
        body: [
          ...(n.disposicionInmediata
            ? [
                [
                  { text: 'Disposición inmediata', bold: !0 },
                  { text: n.disposicionInmediata, bold: !0 }
                ]
              ]
            : []),
          [
            { text: 'Riesgo de la recepción', bold: !0 },
            { text: `● ${l.label}`, bold: !0, color: l.color }
          ]
        ]
      },
      layout: 'lightHorizontalLines',
    ...
    const h = hs(s);
    (i.push({ text: 'Indicadores ISO', style: 'h2' }),
      i.push({
        table: {
          headerRows: 1,
          widths: ['*', '*', '*', '*', '*', '*'],
          body: [
            ...
            [
              { text: h.minutos != null ? `${h.minutos} min` : '—', fontSize: 9 },
              { text: h.inspector || '—', fontSize: 9 },
              { text: String(h.items), fontSize: 9 },
              { text: String(h.ok), fontSize: 9, color: '#047857', bold: !0 },
              {
                text: String(h.no),
                fontSize: 9,
                color: h.no > 0 ? '#be123c' : '#64748b',
                bold: !0
              },
              {
                text: h.pct != null ? `${String(h.pct).replace('.', ',')}%` : '—',
                fontSize: 9,
                bold: !0
              }
            ]
  ...
  if (g) {
    const n = Se(s),
      l = gs(
        (M = n.pesos) == null ? void 0 : M.esperado,
        (_ = n.pesos) == null ? void 0 : _.registrado
      );
    (((S = n.pesos) != null && S.esperado) || ((j = n.pesos) != null && j.registrado)) &&
      (i.push({ text: 'Control de peso', style: 'h2' }),
      i.push({
        table: {
          widths: ['35%', '65%'],
          body: [
            N(
              'Peso esperado',
              (t = n.pesos) != null && t.esperado ? `${n.pesos.esperado} kg` : '—'
            ),
            N(
              'Peso registrado',
              (o = n.pesos) != null && o.registrado ? `${n.pesos.registrado} kg` : '—'
            ),
            [
              { text: 'Resultado', bold: !0 },
              { text: l || '—', bold: !0, color: l === 'CONFORME' ? '#047857' : '#be123c' }
            ]
          ]
        },
        layout: 'lightHorizontalLines',
    ...
    const h = Number(n.bultosTotal ?? s.bultos) || 0;
    if (h > 0) {
      const A = Array.isArray(n.bultosEtiquetas) ? n.bultosEtiquetas : [];
      (i.push({ text: 'Verificación de bultos', style: 'h2' }),
        i.push({
          table: {
            headerRows: 1,
            widths: ['auto', '*'],
            body: [
              ['Bulto', 'Etiqueta'].map((q) => ({ text: q, bold: !0, fontSize: 9 })),
              ...Array.from({ length: Math.min(h, 60) }, (q, W) => [
                { text: `Bulto ${W + 1}/${h}`, fontSize: 9 },
                {
                  text: A[W] ? 'Etiqueta OK' : 'Pendiente',
                  fontSize: 9,
                  bold: !0,
                  color: A[W] ? '#047857' : '#b45309'
                }
              ])
            ]
          },
    ...
    Array.isArray(n.riesgos) &&
      n.riesgos.length &&
      (i.push({ text: 'Riesgos evaluados', style: 'h2' }),
      i.push({
        columns: [0, 1].map((A) => ({
          stack: fs
            .filter((q, W) => W % 2 === A)
            .map((q) => ({
              text: `${n.riesgos.includes(q.id) ? '☑' : '☐'} ${q.label}`,
              fontSize: 9,
              margin: [0, 1, 0, 1]
            }))
        })),
    ...
    if (v.length || (Array.isArray(n.evidencias) && n.evidencias.length))
      if ((i.push({ text: 'Evidencia fotográfica', style: 'h2' }), v.length))
        for (let A = 0; A < v.length; A += 2)
          i.push({
            columns: v.slice(A, A + 2).map((q) => ({
              width: '50%',
              stack: [
                { image: q.dataUrl, fit: [230, 160] },
                { text: Je[q.tipo] || q.tipo, fontSize: 8, color: '#64748b', margin: [0, 2, 0, 0] }
              ]
            })),
            columnGap: 12,
            margin: [0, 0, 0, 8]
        ...
        i.push({
          text: `${(n.evidencias || []).length} foto(s) asociada(s) al certificado en el sistema CCO.`,
          fontSize: 9,
          color: '#64748b',
          margin: [0, 0, 0, 12]
        });
  ...
  if (!g) {
    const n = Se(s),
      l = Array.isArray(d.evidenciasImg) ? d.evidenciasImg : [];
    if (l.length || (Array.isArray(n.evidencias) && n.evidencias.length))
      if ((i.push({ text: 'Evidencia fotográfica', style: 'h2' }), l.length))
        for (let h = 0; h < l.length; h += 2)
          i.push({
            columns: l.slice(h, h + 2).map((v) => ({
              width: '50%',
              stack: [
                { image: v.dataUrl, fit: [230, 160] },
                { text: Je[v.tipo] || v.tipo, fontSize: 8, color: '#64748b', margin: [0, 2, 0, 0] }
              ]
            })),
            columnGap: 12,
            margin: [0, 0, 0, 8]
        ...
        i.push({
          text: `${(n.evidencias || []).length} foto(s) asociada(s) al checklist en el sistema CCO.`,
          fontSize: 9,
          color: '#64748b',
          margin: [0, 0, 0, 12]
        });
  ...
  if (
    (s.observaciones &&
      (i.push({ text: 'Observaciones', style: 'h2' }),
      i.push({ text: s.observaciones, margin: [0, 0, 0, 12] })),
    i.push({
      columns: [
        {
          stack: [
    ...
    const n = `${window.location.origin}/verificar?folio=${encodeURIComponent(s.folio || '')}`;
    i.push({
      columns: [
        {
          width: '*',
        ...
        },
        {
          width: 'auto',
          stack: [
            { qr: n, fit: 84, foreground: '#0f172a', margin: [0, 2, 0, 0] },
  ...
  await ds(z, la(s, 'pdf'), { label: 'Informe de calidad' });
}
const Ot = (s) => ({
    nivel: `cat_${s.codigo}`,
  ...
  St = ({ tarea: s, onBack: m, canManage: d, onGenerarDanos: x }) => {
    var ue, c, P, B;
    const { user: y } = ye(),
      f = qs(),
      a = Js(),
      { data: u, isLoading: g } = Ra(s.id),
      O = s.estado === 'CONFORME' || s.estado === 'NO_CONFORME',
      w = O || !d,
      N = (r) => {
        const { _extras: E, ...U } = r || {};
        return { resp: U, extras: E || {} };
      },
      [i, D] = b.useState(() => N(s.checklist).resp),
      [z, p] = b.useState(() => N(s.checklist).extras),
      [L, M] = b.useState(s.observaciones || ''),
      [_, S] = b.useState(s.disposicion || '');
    b.useEffect(() => {
      const { resp: r, extras: E } = N(s.checklist);
      (D(r), p(E), M(s.observaciones || ''), S(s.disposicion || ''));
    }, [s.id]);
    const j = (r, E) => D((U) => ({ ...U, [r]: { ...U[r], estado: E } })),
      t = (r, E) => D((U) => ({ ...U, [r]: { ...U[r], nota: E } })),
      o = (r, E) => D((U) => ({ ...U, [r]: { ...U[r], evidencia: E } })),
      n = (r, E) => p((U) => ({ ...U, [r]: E })),
      l = (r = z) => ({ ...i, _extras: r }),
      h = (r) =>
        p((E) => {
          const U = new Set(E.clasificacion || []);
          return (U.has(r) ? U.delete(r) : U.add(r), { ...E, clasificacion: [...U] });
        }),
      v = (u == null ? void 0 : u.categorias) || [],
      A = !!(u != null && u.solo_no_sanitario),
      q = (u == null ? void 0 : u.sin_clasificar) || 0,
      W = b.useMemo(() => {
        const r = v.filter((E) => (E.params || []).length > 0).map(Ot);
        return [...Ia, ...r];
      }, [v]),
      oe = b.useMemo(() => W.flatMap((r) => r.params), [W]),
      {
        answeredAll: se,
        hasNo: ae,
        faltan: le
        ...
        let r = 0,
          E = !1;
        for (const J of oe) {
          const de = (U = i[J.id]) == null ? void 0 : U.estado;
          (de && r++, de === 'NO' && (E = !0));
        }
        return { answeredAll: r === oe.length, hasNo: E, faltan: oe.length - r };
      }, [i, oe]),
      F = async () => {
        if (
          confirm(
          ...
          try {
            const r = await a.mutateAsync(s.id);
            I.success(
              `Documento firmado digitalmente por ${(r == null ? void 0 : r.firmado_nombre) || ''}`
            );
          } catch (r) {
            I.error(`No se pudo firmar: ${r.message}`);
          }
      },
      K = async (r) => {
        try {
          const E = { categorias: v, soloNoSanitario: A };
          if (r === 'pdf') {
            const U = z.evidencias || [],
              J = [];
            for (const de of U)
              try {
                const ve = await xs(Le, de.path);
                if (!ve) continue;
                ...
                const Fe = await new Promise((Ae, je) => {
                  ...
                  ((Be.onload = () => Ae(Be.result)), (Be.onerror = je), Be.readAsDataURL(ke));
                });
                J.push({ tipo: de.tipo, dataUrl: Fe });
              } catch {}
            ((E.evidenciasImg = J), await ia(s, W, E));
          } else await na(s, W, E);
        } catch (E) {
          I.error(`No se pudo generar el documento: ${E.message}`);
        }
      },
      R = async () => {
        try {
          (await f.mutateAsync({
            ...
            I.success('Avance guardado'));
        } catch (r) {
          I.error(`No se pudo guardar: ${r.message}`);
        }
      },
      V = async () => {
        if (g) {
          I.error('Cargando las familias de producto de la recepción…');
          return;
        }
        if (!se) {
          I.error(`Faltan ${le} ítem(s) por responder`);
          return;
        }
        const r = ae ? 'NO_CONFORME' : 'CONFORME';
        if (r === 'NO_CONFORME' && !_) {
          I.error('Selecciona la Disposición / Acción a tomar antes de finalizar');
          return;
        }
        if (r === 'NO_CONFORME' && !z.disposicionInmediata) {
          I.error('Marca la Disposición inmediata de la recepción (cuarentena, rechazo, etc.)');
          return;
        }
        if (
          confirm(
            r === 'CONFORME'
              ...
              : `Hay ítems NO conformes → se marcará NO CONFORME (folio ACTA-), disposición "${_}", y se generará la tarea urgente del Informe de Daños. ¿Continuar?`
          )
        )
          try {
            const E = await f.mutateAsync({
              tareaId: s.id,
              checklist: l(),
              observaciones: L,
              disposicion: _,
            ...
            r === 'CONFORME'
              ? (I.success(
                ...
                m())
              : I.warning('Recepción NO CONFORME. Tarea urgente del Informe de Daños generada.');
          } catch (E) {
            I.error(`No se pudo finalizar: ${E.message}`);
          }
      },
      te = ({ pid: r, val: E, icon: U, activeCls: J }) => {
        var ve;
        const de = ((ve = i[r]) == null ? void 0 : ve.estado) === E;
        return e.jsx('button', {
          type: 'button',
          disabled: w,
          onClick: () => j(r, E),
          className: `w-9 h-9 rounded-lg border flex items-center justify-center transition-colors shrink-0
          ${de ? J : 'bg-white border-slate-200 text-slate-300 hover:border-slate-300'} ${w ? 'opacity-60 cursor-default' : ''}`,
          children: U
        });
      },
      Y = $e[s.estado] || {},
      k = b.useMemo(() => bs({ ...i, _extras: z }), [i, z]),
      G = b.useMemo(() => hs({ ...s, checklist: { ...i, _extras: z } }), [i, z, s]),
      Q =
        G.minutos ??
        (s.created_at
    ...
    const ne = (r, E = 'galeria') => {
        var U;
        (xe(r), E === 'camara' ? $(!0) : (U = ee.current) == null || U.click());
      },
      ce = async (r) => {
        var U;
        const E = Array.from(r.target.files || []);
        if (((r.target.value = ''), !(!E.length || !X))) {
          Ne(!0);
          try {
            const J = [];
            for (const de of E) {
              if (!de.type.startsWith('image/')) continue;
              const ve = await ks(de),
                ke = await Pa({ tareaId: s.id, tipo: X, blob: ve });
              J.push({ tipo: X, path: ke, subido_en: new Date().toISOString() });
            }
            if (J.length) {
              const de = { ...z, evidencias: [...H, ...J] };
              (p(de),
                await f.mutateAsync({
                  tareaId: s.id,
                  checklist: l(de),
                ...
                I.success(J.length > 1 ? 'Fotos agregadas' : 'Foto agregada'));
            }
          } catch (J) {
            I.error(
              (U = J == null ? void 0 : J.message) != null && U.includes('row-level security')
                ? 'No tienes permiso para subir fotos'
                : `Error al subir: ${J.message}`
            );
          } finally {
            (Ne(!1), xe(null));
          }
      ...
      he = async (r) => {
        if (confirm('¿Eliminar esta foto?'))
          try {
            await Qs(r.path);
            const E = { ...z, evidencias: H.filter((U) => U.path !== r.path) };
            (p(E),
              await f.mutateAsync({
                tareaId: s.id,
                checklist: l(E),
    ...
    return e.jsxs('div', {
      children: [
        e.jsxs('button', {
          ...
          children: [e.jsx(De, { size: 18 }), ' Volver a la cola']
        }),
        e.jsxs('div', {
          className:
                  ...
                  children: [
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('span', {
                          ...
                          children: ((c = os[s.origen]) == null ? void 0 : c.label) || s.origen
                        }),
                        e.jsx('span', {
                    ...
                    e.jsxs('p', {
                      ...
                      children: [
                        ...
                        e.jsxs('span', {
                          className: 'flex items-center gap-1',
                          children: [e.jsx(Ms, { size: 12 }), ' ', s.fecha_recepcion || '—']
                        }),
                        s.bultos != null &&
                          e.jsxs('span', { children: ['· ', s.bultos, ' bultos'] }),
                        ((P = s.contexto) == null ? void 0 : P.pallets) != null &&
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                ...
                g && e.jsx(be, { size: 14, className: 'animate-spin text-slate-300' })
              ]
            }),
            v.length === 0
              ? e.jsx('p', {
              ...
              : e.jsx('div', {
                  ...
                  children: v.map((r) => {
                    ...
                    return e.jsxs(
                      'span',
                      {
                        className: `text-[11px] font-black px-2.5 py-1 rounded-lg border flex items-center gap-1.5 ${((E = Da[r.codigo]) == null ? void 0 : E.cls) || 'bg-slate-100 text-slate-600 border-slate-200'}`,
                        title: r.descripcion || '',
                        children: [
                          r.label,
                          ' · ',
        ...
        e.jsxs('div', {
          ...
          children: [
            e.jsxs('h3', {
              ...
              children: [
                e.jsx(Ie, { size: 16, className: 'text-slate-400' }),
            ...
            e.jsx('div', {
              className: 'flex flex-wrap gap-2',
              children: us.map((r) => {
                const E = (z.clasificacion || []).includes(r.id);
                return e.jsxs(
                  'button',
                  {
                    type: 'button',
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsxs('span', {
                  className: `text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border ${k.cls}`,
                  children: [k.emoji, ' ', k.label]
                })
              ]
            }),
            !w &&
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('button', {
                    type: 'button',
                    onClick: () => n('embalaje', { ...ie, ...Ss.conforme }),
                    className:
                  ...
                  e.jsxs('button', {
                    type: 'button',
                    onClick: () => n('embalaje', { ...ie, ...Ss.sinPallet }),
                    className:
                        ...
                        children: r.opciones.map((E) => {
                          ...
                          return e.jsx(
                            'button',
                            {
                              type: 'button',
                              disabled: w,
                              onClick: () => n('embalaje', { ...ie, [r.id]: U ? void 0 : E }),
                              className: `px-3 py-1.5 rounded-lg border text-xs font-black transition-colors ${U ? (de ? 'bg-slate-400 border-slate-400 text-white' : J ? 'bg-rose-500 border-rose-500 text-white' : 'bg-emerald-500 border-emerald-500 text-white') : 'bg-white border-slate-200 text-slate-500 hover:border-slate-300'}`,
                              children: E
                            },
                            E
                          );
        ...
        e.jsxs('div', {
          ...
          children: [
                ...
                'div',
                {
                  ...
                  children: [
                    e.jsxs('h3', {
                      ...
                      children: [
                        r.categoria &&
                          e.jsx(ba, { size: 14, className: 'text-emerald-500 shrink-0' }),
                        r.titulo
                      ]
                    }),
                    e.jsx('div', {
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  ((U = i[E.id]) == null ? void 0 : U.estado) &&
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        ...
                                        e.jsxs('select', {
                                          value:
                                            ((J = i[E.id]) == null ? void 0 : J.evidencia) || '',
                                          disabled: w,
                                          onChange: (je) => o(E.id, je.target.value),
                                          className: `px-2 py-1 rounded-lg border text-[11px] font-bold ${(de = i[E.id]) != null && de.evidencia ? 'border-emerald-200 bg-emerald-50/50 text-emerald-700' : 'border-slate-200 text-slate-400'}`,
                                          children: [
                                            e.jsx('option', {
                                              value: '',
                                  ...
                                  ((ve = i[E.id]) == null ? void 0 : ve.estado) === 'NO' &&
                                    e.jsx('input', {
                                      value: ((ke = i[E.id]) == null ? void 0 : ke.nota) || '',
                                      disabled: w,
                                      onChange: (je) => t(E.id, je.target.value),
                                  ...
                                  ((Fe = i[E.id]) == null ? void 0 : Fe.estado) === 'NA' &&
                                    e.jsx('input', {
                                      value: ((Ae = i[E.id]) == null ? void 0 : Ae.nota) || '',
                                      disabled: w,
                                      onChange: (je) => t(E.id, je.target.value),
                                      placeholder:
            ...
            e.jsxs('div', {
              className: `bg-white rounded-2xl border p-5 ${ae && !z.disposicionInmediata ? 'border-rose-200' : 'border-slate-200'}`,
              children: [
                e.jsxs('label', {
                  className: `text-[10px] font-black uppercase tracking-widest ${ae && !z.disposicionInmediata ? 'text-rose-500' : 'text-slate-400'}`,
                  children: [
                    'Disposición inmediata ',
                    ae && e.jsx('span', { children: '*obligatoria (hay no conformes)' })
                  ]
                }),
                e.jsx('div', {
                  className: 'flex flex-wrap gap-2 mt-2',
                  children: za.map((r) => {
                    const E = z.disposicionInmediata === r,
                    ...
                    return e.jsxs(
                      'button',
                      {
                        type: 'button',
                        disabled: w,
                        onClick: () => n('disposicionInmediata', E ? void 0 : r),
                        className: `px-3 py-2 rounded-xl border text-xs font-black transition-colors ${E ? (U ? 'bg-rose-500 border-rose-500 text-white' : 'bg-emerald-500 border-emerald-500 text-white') : 'bg-white border-slate-200 text-slate-500 hover:border-slate-300'}`,
                        children: [E ? '☑' : '☐', ' ', r]
                      },
                      r
                    );
            ...
            (ae || _) &&
              e.jsxs('div', {
                className: `rounded-2xl border p-5 ${ae ? 'bg-rose-50/40 border-rose-200' : 'bg-white border-slate-200'}`,
                children: [
                  e.jsxs('label', {
                    className:
                    ...
                    children: [
                      ...
                      ae && e.jsx('span', { children: '*obligatoria' })
                    ]
                  }),
                  e.jsxs('select', {
                    value: _,
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('div', {
                  ...
                  children: $a.map((r) => {
                    const E = H.filter((U) => U.tipo === r.id);
                    return e.jsxs(
                      'div',
                      {
                ...
                me &&
                  e.jsx(Cs, {
                    onCapture: (r) => ce({ target: { files: [r], value: '' } }),
                    onClose: () => $(!1)
                  }),
                e.jsx('p', {
                  className: 'text-[10px] text-slate-400 mt-2',
              ...
              children: [
                ...
                e.jsx('div', {
                  ...
                  children: [
                    ...
                    ['Inspector', G.inspector || (y == null ? void 0 : y.nombre) || '—'],
                    ['N° ítems', G.items || 0],
                    ['Conformes', G.ok || 0],
                    ['No conformes', G.no || 0],
            ...
            children: [
              ...
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsx('button', {
                    onClick: V,
                    disabled: f.isPending || le > 0,
                    className: `px-4 py-2.5 rounded-xl text-white font-black text-sm flex items-center gap-2 disabled:opacity-40 ${ae ? 'bg-rose-600 hover:bg-rose-700' : 'bg-emerald-600 hover:bg-emerald-700'}`,
                    children: ae
                      ? e.jsxs(e.Fragment, {
                          children: [e.jsx(As, { size: 16 }), ' Finalizar (No Conforme)']
                        })
                      : e.jsxs(e.Fragment, {
                          children: [e.jsx(Pe, { size: 16 }), ' Finalizar y certificar']
                        })
                  })
                ]
              })
            ...
            children: [
              ...
              x &&
                e.jsxs('button', {
                  ...
                  children: [e.jsx(As, { size: 16 }), ' Generar Informe de Daños']
                })
            ]
          })
      ]
  ...
  Rt = ({ onGenerarDanos: s }) => {
    const { hasPermission: m, user: d } = ye(),
      x = m('manage_quality') || m('manage_monitoreo'),
      y = (d == null ? void 0 : d.rol) === 'ADMIN' || (d == null ? void 0 : d.es_admin_delegado),
      { data: f = [], isLoading: a, refetch: u, isFetching: g } = Sa(),
      O = Ks(),
      [w, N] = b.useState(null),
      [i, D] = b.useState(''),
      [z, p] = b.useState('TODOS'),
      L = async (j, t) => {
        if (
          (t.stopPropagation(),
          !!confirm(
            `¿Eliminar la tarea de ${j.proveedor || 'recepción'} (OC ${j.oc || '—'})? Esta acción no se puede deshacer.`
          ))
        )
          try {
            (await O.mutateAsync(j.id), I.success('Tarea eliminada'));
          } catch (o) {
            I.error(`No se pudo eliminar: ${o.message}`);
          }
      },
      M = f.filter((j) => j.estado === 'PENDIENTE' || j.estado === 'EN_PROCESO').length,
      _ = b.useMemo(() => {
        const j = i.trim().toLocaleLowerCase('es-CL');
        return f.filter(
          (t) =>
            (!j ||
              [t.oc, t.proveedor, t.folio, t.origen].some((n) =>
                String(n || '')
      ...
      S = w ? f.find((j) => j.id === w.id) || w : null;
    return S
      ? e.jsx(St, { tarea: S, onBack: () => N(null), canManage: x, onGenerarDanos: s })
      : e.jsxs('div', {
          className: 'anim-fade-up',
          children: [
            e.jsxs('div', {
              className:
                'quality-mobile-hero mb-4 rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-4 shadow-sm',
              children: [
                e.jsxs('div', {
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsx(Xe, { label: 'Total', value: f.length, tone: 'slate' }),
                    e.jsx(Xe, { label: 'Por revisar', value: M, tone: 'amber' }),
                    e.jsx(Xe, { label: 'Finalizadas', value: f.length - M, tone: 'emerald' })
                  ]
                }),
                e.jsxs('div', {
                      ...
                      children: ['TODOS', 'PENDIENTE', 'EN_PROCESO', 'CONFORME', 'NO_CONFORME'].map(
                        (j) => {
                          ...
                          return e.jsx(
                            ...
                            {
                              onClick: () => p(j),
                              className: `whitespace-nowrap rounded-lg px-3 py-2 text-[10px] font-black tracking-wide transition ${z === j ? 'bg-emerald-600 text-white shadow-sm' : 'bg-white text-slate-500 border border-slate-200 hover:border-emerald-200'}`,
                              children:
                                j === 'TODOS'
                                  ? 'Todos'
                                  : ((t = $e[j]) == null ? void 0 : t.label) || j
                            },
                            j
                          );
                        }
                ...
                !a &&
                  e.jsxs('p', {
                    ...
                    children: ['Mostrando ', _.length, ' de ', f.length, ' recepciones.']
                  })
              ]
            }),
            a
              ...
              : f.length === 0
                ...
                : _.length === 0
                  ...
                  : e.jsx('div', {
                      className:
                        'anim-stagger grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4',
                      children: _.map((j) => {
                        var l, h, v;
                        const t = $e[j.estado] || {},
                          o = os[j.origen] || {},
                          n = j.estado === 'PENDIENTE' || j.estado === 'EN_PROCESO';
                        return e.jsxs(
                          'div',
                          {
                            role: 'button',
                            tabIndex: 0,
                            onClick: () => N(j),
                            className: `quality-mobile-card cursor-pointer text-left bg-white rounded-3xl border p-5 transition-all hover:-translate-y-0.5 hover:shadow-lg active:scale-[.99] ${n ? 'border-amber-200 hover:border-amber-300' : 'border-slate-200 hover:border-emerald-300'}`,
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('span', {
                                    ...
                                    children: [
                                      e.jsx(Ie, { size: 16, className: 'text-slate-400 shrink-0' }),
                                      j.proveedor || 'Sin proveedor'
                                    ]
                                  }),
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      e.jsx('span', {
                                        className: `text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border ${t.cls}`,
                                        children: t.label || j.estado
                                      }),
                                      y &&
                                        e.jsx('button', {
                                          onClick: (A) => L(j, A),
                              ...
                              e.jsxs('p', {
                                ...
                                children: ['OC ', j.oc || '—', ' · ', j.fecha_recepcion || '—']
                              }),
                              (j.bultos != null ||
                                ((l = j.contexto) == null ? void 0 : l.pallets) != null) &&
                                e.jsxs('p', {
                                  className: 'text-xs text-slate-400 mt-1',
                                  children: [
                                    j.bultos != null ? `${j.bultos} bultos` : '',
                                    ((h = j.contexto) == null ? void 0 : h.pallets) != null
                                      ? ` · ${j.contexto.pallets} pallets`
                                      : '',
                                    (v = j.contexto) != null && v.tipo_contenedor
                                      ? ` · ${j.contexto.tipo_contenedor}`
                                      : ''
                                  ]
                                })
                            ]
  ...
  Xe = ({ label: s, value: m, tone: d }) => {
    ...
    return e.jsxs('div', {
      className: `rounded-xl border px-3 py-2 ${x[d] || x.slate}`,
      children: [
        e.jsx('p', { className: 'text-lg font-black leading-none', children: m }),
        e.jsx('p', {
  ...
  It = ({ onClose: s }) => {
    const m = Ua(),
      ...
      [g, O] = b.useState([]),
      [w, N] = b.useState(''),
      [i, D] = b.useState('NORMAL'),
      z = b.useCallback(async () => {
        f(!0);
        try {
          u(await Zs(d, !1));
        } catch (o) {
          I.error(`Error buscando stock: ${o.message}`);
        } finally {
          f(!1);
        }
      }, [d]),
      p = (o) => `${o.codigo_producto}|${o.partida || ''}|${o.ubicacion || ''}`,
      L = (o) => ({
        _key: p(o),
        ...
        tipo: o.tipo || 'NO_PERECIBLE',
        fecha_vencimiento: o.fecha_vencimiento || null,
        semaforo: o.semaforo || 'NA'
      }),
      M = (o) => {
        const n = p(o);
        if (g.some((l) => l._key === n)) {
          I.info('Ese SKU ya está en la asignación');
          return;
        }
        O((l) => [...l, L(o)]);
      },
      _ = (o) => O((n) => n.filter((l) => l._key !== o)),
      S = (o) => {
        const n = p(o);
        g.some((l) => l._key === n) ? _(n) : M(o);
      },
      j = () => {
        if (a.every((n) => g.some((l) => l._key === p(n)))) {
          const n = new Set(a.map(p));
          O((l) => l.filter((h) => !n.has(h._key)));
          return;
        }
        O((n) => {
          const l = new Set(n.map((v) => v._key)),
            h = a.map(L).filter((v) => (l.has(v._key) ? !1 : (l.add(v._key), !0)));
          return [...n, ...h];
        });
      },
      t = async () => {
        if (g.length === 0) {
          I.error('Elige al menos un SKU');
          return;
        }
        try {
          const o = g.map(({ _key: n, ...l }) => l);
          (await m.mutateAsync({ skus: o, motivo: w, prioridad: i }),
            I.success(`${o.length} SKU(s) asignados a Calidad`),
            s());
        } catch (o) {
          I.error(`No se pudo asignar: ${o.message}`);
        }
      };
    return e.jsx('div', {
        ...
        children: [
                  ...
                  children: [
                    e.jsxs('label', {
                      ...
                      children: [
                        e.jsx('input', {
                          type: 'checkbox',
                          checked: a.every((o) => g.some((n) => n._key === p(o))),
                          onChange: j,
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('button', {
                onClick: t,
                disabled: m.isPending || g.length === 0,
                className:
  ...
  Dt = ({ canAssign: s, canManageQuality: m, onGenerarInforme: d }) => {
    const { user: x } = ye(),
      y = (x == null ? void 0 : x.rol) === 'ADMIN' || (x == null ? void 0 : x.es_admin_delegado),
      { data: f = [], isLoading: a } = La(),
      u = Ma(),
      g = Fa(),
      [O, w] = b.useState(!1),
      [N, i] = b.useState(''),
      D = async (_) => {
        if (confirm('¿Anular esta asignación? No se podrá revertir.'))
          try {
            (await u.mutateAsync(_.id), I.success('Asignación anulada'));
          } catch (S) {
            I.error(`No se pudo anular: ${S.message}`);
          }
      },
      z = async (_) => {
        if (confirm('¿Eliminar esta asignación definitivamente? Esta acción no se puede deshacer.'))
          try {
            (await g.mutateAsync(_.id), I.success('Asignación eliminada'));
          } catch (S) {
            I.error(`No se pudo eliminar: ${S.message}`);
          }
      },
      p = f.filter((_) => _.estado === 'PENDIENTE' || _.estado === 'EN_PROCESO').length,
      L = f.filter((_) => _.estado === 'RESUELTA').length,
      M = b.useMemo(() => {
        const _ = N.trim().toLocaleLowerCase('es'),
          S = { EN_PROCESO: 0, PENDIENTE: 1, RESUELTA: 2, ANULADA: 3 };
        return [...f]
          .filter((j) => {
            if (!_) return !0;
            const t = Array.isArray(j.skus) ? j.skus : [];
            return [
              j.motivo,
              j.asignado_nombre,
              j.locked_by_name,
              ...t.map((o) => o.codigo_producto)
            ]
              .join(' ')
          ...
          .sort(
            (j, t) =>
              (S[j.estado] ?? 9) - (S[t.estado] ?? 9) ||
              new Date(t.created_at || 0) - new Date(j.created_at || 0)
          );
      }, [f, N]);
    return e.jsxs('div', {
      className: 'mb-6 space-y-4 anim-fade-up',
      children: [
        e.jsx('section', {
          className:
            'quality-mobile-hero overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 text-white shadow-xl shadow-emerald-950/10',
          children: e.jsxs('div', {
          ...
          children: [
            e.jsxs('label', {
              ...
              children: [
                ...
                N && e.jsx('button', { onClick: () => i(''), children: e.jsx(Oe, { size: 15 }) })
              ]
            }),
            s &&
              e.jsxs('button', {
        ...
        a
          ...
          : f.length === 0
            ? e.jsxs('div', {
                ...
                children: [
                  e.jsx(ha, { size: 30, className: 'text-slate-200 mx-auto mb-2' }),
                  e.jsx('p', {
            ...
            : e.jsx('div', {
                className: 'anim-stagger grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-3',
                children: M.map((_) => {
                  const S = Ba[_.estado] || {},
                    j = Array.isArray(_.skus) ? _.skus : [],
                    t = _.estado === 'PENDIENTE' || _.estado === 'EN_PROCESO',
                    o =
                      t &&
                      _.locked_by &&
                      _.locked_at &&
                      Date.now() - new Date(_.locked_at).getTime() < 15 * 60 * 1e3,
                    n = o && _.locked_by !== (x == null ? void 0 : x.id),
                    l = _.estado === 'RESUELTA' ? 100 : _.estado === 'EN_PROCESO' ? 66 : 33,
                    h = `H2-${String(_.id || '')
                      .slice(0, 8)
                      .toUpperCase()}`;
                  return e.jsxs(
                    'div',
                    {
                      className: `quality-mobile-card relative overflow-hidden rounded-3xl border bg-white p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg active:scale-[.99] ${_.estado === 'EN_PROCESO' ? 'border-blue-200' : t ? 'border-amber-200' : 'border-emerald-200'}`,
                      children: [
                        e.jsx('div', {
                          className: 'absolute inset-x-0 top-0 h-1 bg-slate-100',
                          children: e.jsx('div', {
                            className: `h-full transition-all ${_.estado === 'RESUELTA' ? 'bg-emerald-500' : _.estado === 'EN_PROCESO' ? 'bg-blue-500' : 'bg-amber-400'}`,
                            style: { width: `${l}%` }
                          })
                        }),
                        e.jsxs('div', {
                        ...
                        o &&
                          e.jsxs('div', {
                            className: `mt-2 rounded-lg border px-2.5 py-2 text-[11px] font-bold ${n ? 'border-rose-200 bg-rose-50 text-rose-700' : 'border-emerald-200 bg-emerald-50 text-emerald-700'}`,
                            children: [
                              '🔒 ',
                              n ? 'En proceso por' : 'Tarea tomada por',
                              ' ',
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              m &&
                                e.jsxs('button', {
                                  onClick: () => d(_),
                                  title: n ? 'El sistema verificará el bloqueo antes de abrir' : '',
                                  className: `flex-1 px-3 py-2 rounded-xl text-white font-black text-xs flex items-center justify-center gap-1.5 ${n ? 'bg-slate-500 hover:bg-slate-600' : 'bg-emerald-600 hover:bg-emerald-700'}`,
                                  children: [
                                    e.jsx(ze, { size: 14 }),
        ...
        O && e.jsx(It, { onClose: () => w(!1) })
      ]
    });
  },
  zt = ({ onClose: s, onCreated: m }) => {
    var ee, me;
    const d = Ka(),
      [x, y] = b.useState(''),
      [f, a] = b.useState(''),
    ...
    b.useEffect(() => {
      ...
      return (
        ...
        Nt()
          .then((Z) => {
            $ && i((Z == null ? void 0 : Z.transportistas) || []);
          })
          .catch((Z) => {
            $ && I.error(`No se pudo cargar el catálogo de transportistas: ${Z.message}`);
          })
          .finally(() => {
            $ && z(!1);
          }),
    ...
    const K = b.useMemo(() => (O && !N.includes(O) ? [O, ...N] : N), [O, N]),
      R = b.useCallback(
        async ({ silent: $ = !1, force: Z = !1 } = {}) => {
          if (!x.trim()) {
            $ || I.error('Escribe primero el número de N.V.');
            return;
          }
          const X = x.trim();
          if (!Z && F.current === X) return;
          const xe = ++le.current;
          (oe(!0), ae(''));
          try {
            const re = await ft(X);
            if (xe !== le.current) return;
            if (((F.current = X), !re)) {
              (q(null),
                a(''),
                ae(`La N.V. ${X} no existe en el Panel PTM.`),
                $ || I.error(`La N.V. ${X} no fue encontrada.`));
              return;
            }
            (q(re),
              a(re.cliente || ''),
              ...
              w(re.transportista || ''),
              L(re.bultos || ''),
              re.cliente || ae(`La N.V. ${re.nv} no tiene un cliente asociado.`),
              $ || I.success(`N.V ${re.nv} encontrada: cliente cargado automáticamente`));
          } catch (re) {
            if (xe !== le.current) return;
            (q(null),
              a(''),
              ae(`No se pudo consultar la N.V.: ${re.message}`),
              $ || I.error(`No se pudo consultar el Panel PTM: ${re.message}`));
          } finally {
            xe === le.current && oe(!1);
          }
        },
    ...
    b.useEffect(() => {
      ...
      const $ = window.setTimeout(() => R({ silent: !0 }), 650);
      return () => window.clearTimeout($);
    }, [x, R]);
    const V = ($) => {
        const Z = String($ || '').replace(/[^0-9]/g, '');
        Z !== x &&
          ((le.current += 1),
          (F.current = ''),
          y(Z),
      ...
      te = ($) => {
        ...
        return (
          ($ || []).forEach((X) => {
            const xe = `${X.codigo_producto}|${X.partida || ''}`,
              re = Z.get(xe);
            re
              ? (re.disponible = Number(re.disponible || 0) + (Number(X.disponible) || 0))
              : Z.set(xe, { ...X, ubicacion: '', disponible: Number(X.disponible) || 0 });
          }),
          [...Z.values()]
        );
      },
      Y = b.useCallback(async () => {
        j(!0);
        try {
          l(te(await qa(M)));
        } catch ($) {
          I.error(`Error buscando stock: ${$.message}`);
        } finally {
          (o(!0), j(!1));
        }
      }, [M]),
      k = ($) => `${$.codigo_producto}|${$.partida || ''}`,
      G = ($) => {
        const Z = k($);
        if (h.some((X) => X._key === Z)) {
          I.info('Ese SKU ya está agregado');
          return;
        }
        v((X) => [
          ...X,
          {
            ...
            ubicacion: '',
            partida: $.partida || '',
            cantidad: Number($.disponible) > 0 ? Number($.disponible) : 1,
            unidad_medida: $.unidad_medida || 'UN'
          }
        ]);
      },
      Q = ($) => v((Z) => Z.filter((X) => X._key !== $)),
      ie = async () => {
        if (!x.trim()) {
          I.error('Escribe la N.V.');
          return;
        }
        if (!A || !f.trim()) {
          I.error('Primero valida la N.V. para cargar el cliente desde el Panel PTM.');
          return;
        }
        if (h.length === 0) {
          I.error('Agrega al menos un SKU');
          return;
        }
        try {
          const $ = h.map(({ _key: X, ...xe }) => xe),
            Z = await d.mutateAsync({
              nv: x.trim(),
              skus: $,
              cliente: f.trim() || null,
              guia: u.trim() || null,
              transportista: O.trim() || null,
              bultos: p ? Number(p) : null
            });
          (I.success('Certificación de salida creada'), m(Z == null ? void 0 : Z.id));
        } catch ($) {
          I.error(`No se pudo crear: ${$.message}`);
        }
      };
    return e.jsx('div', {
      className:
                    ...
                    children: [
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsxs('div', {
                            className: `flex h-12 items-center overflow-hidden rounded-xl border bg-white transition ${se ? 'border-rose-300 ring-4 ring-rose-50' : A ? 'border-emerald-300 ring-4 ring-emerald-50' : 'border-slate-200 focus-within:border-indigo-400 focus-within:ring-4 focus-within:ring-indigo-50'}`,
                            children: [
                              e.jsx(ja, { size: 17, className: 'ml-3 shrink-0 text-slate-400' }),
                              e.jsx('input', {
                                value: x,
                                onChange: ($) => V($.target.value),
                                onKeyDown: ($) => $.key === 'Enter' && R({ silent: !1, force: !0 }),
                                inputMode: 'numeric',
                          ...
                          e.jsx('div', {
                            ...
                            children: W
                              ...
                              : se
                                ? e.jsx('span', { className: 'text-rose-600', children: se })
                                : A
                                  ? e.jsx('span', {
                                      className: 'text-emerald-600',
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsxs('span', {
                                ...
                                children: [e.jsx(Pe, { size: 11 }), ' Automático · no editable']
                              })
                            ]
                          }),
                          e.jsxs('div', {
                            className: `flex h-12 items-center gap-3 rounded-xl border px-3.5 ${f ? 'border-emerald-200 bg-emerald-50/70' : 'border-slate-200 bg-slate-100/70'}`,
                            title: f || 'Se cargará al validar la N.V.',
                            children: [
                              e.jsx(va, {
                                size: 18,
                                className: f
                              ...
                              e.jsx('span', {
                                className: `truncate text-sm font-bold ${f ? 'text-slate-800' : 'text-slate-400'}`,
                                children: f || 'Se cargará desde la N.V. seleccionada'
                              }),
                              f &&
                                e.jsx(He, {
                                  size: 17,
                    ...
                    children: [
                      ...
                      e.jsxs('div', {
                        children: [
                          ...
                          e.jsx('input', {
                            value: p,
                            onChange: ($) => L($.target.value.replace(/[^0-9]/g, '')),
                            placeholder: '0',
                            inputMode: 'numeric',
                            className:
                              'h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 outline-none transition focus:border-emerald-400 focus:ring-4 focus:ring-emerald-50'
                        ...
                        children: [
                          ...
                          e.jsxs('select', {
                            ...
                            children: [
                              e.jsx('option', {
                                value: '',
                                children: D ? 'Cargando…' : '— Seleccionar —'
                              }),
                              K.map(($) => e.jsx('option', { value: $, children: $ }, $))
                            ]
                          }),
                          e.jsx('p', {
                      ...
                      children: [
                        ...
                        e.jsx('div', {
                          ...
                          children: [
                            ...
                            [
                              'Compromiso',
                              (ee = A.fechaCompromiso) == null
                                ? void 0
                                : ee.split('-').reverse().join('-')
                            ],
                            ['División', A.division],
                ...
                children: [
                  e.jsxs('div', {
                    ...
                    children: [
                      ...
                      e.jsxs('span', {
                        ...
                        children: [h.length, ' seleccionado', h.length === 1 ? '' : 's']
                      })
                    ]
                  }),
                  e.jsxs('div', {
                              ...
                              e.jsxs('span', {
                                ...
                                children: [
                                  ...
                                  e.jsxs('span', {
                                    ...
                                    children: [
                                      e.jsx('span', { children: $.partida || 'Sin partida' }),
                                      e.jsx('span', { children: '·' }),
                                      e.jsxs('span', {
                                        children: [
                                          $.disponible,
                  ...
                  t &&
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsx(Ie, { size: 21, className: 'mx-auto mb-1.5 text-slate-300' }),
                        e.jsx('p', {
                              ...
                              e.jsxs(
                                'div',
                                {
                                  ...
                                  children: [
                                    ...
                                    e.jsxs('span', {
                                      ...
                                      children: [
                                        e.jsxs('span', {
                                          ...
                                          children: [$.codigo_producto, ' · ', $.producto]
                                        }),
                                        e.jsxs('span', {
                                    ...
                                    e.jsxs('label', {
                                      ...
                                      children: [
                                        ...
                                        e.jsx('input', {
                                          ...
                                          value: $.cantidad,
                                          onChange: (X) => {
                                            const xe = Math.max(1, Number(X.target.value) || 1);
                                            v((re) =>
                                              re.map((Ne) =>
                                                Ne._key === $._key ? { ...Ne, cantidad: xe } : Ne
                                              )
                                            );
                                          },
                                          className:
                                    ...
                                    e.jsx('button', {
                                      onClick: () => Q($._key),
                                      'aria-label': `Quitar ${$.codigo_producto}`,
                                      className:
            ...
            children: [
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('span', {
                    className: `rounded-full px-2.5 py-1 ${f ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-400'}`,
                    children: [f ? '✓' : '2', ' Cliente cargado']
                  }),
                  e.jsxs('span', {
                    className: `rounded-full px-2.5 py-1 ${h.length ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-400'}`,
                    children: [h.length ? '✓' : '3', ' ', h.length, ' SKU']
                  })
                ]
              }),
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('button', {
                    onClick: ie,
                    disabled: d.isPending || !A || !f.trim() || h.length === 0,
                    className:
  ...
  $t = ({ tarea: s, onBack: m, canManage: d }) => {
    const x = qs(),
      y = Js(),
      ...
      [O, w] = b.useState(() => g(s.checklist).resp),
      [N, i] = b.useState(() => g(s.checklist).extras),
      [D, z] = b.useState(s.observaciones || ''),
      [p, L] = b.useState(s.disposicion || '');
    b.useEffect(() => {
      const { resp: C, extras: T } = g(s.checklist);
      (w(C), i(T), z(s.observaciones || ''), L(s.disposicion || ''));
    }, [s.id]);
    const M = (C, T) => w((H) => ({ ...H, [C]: { ...H[C], estado: T } })),
      _ = (C, T) => w((H) => ({ ...H, [C]: { ...H[C], nota: T } })),
      S = (C, T) => w((H) => ({ ...H, [C]: { ...H[C], evidencia: T } })),
      j = (C, T) => i((H) => ({ ...H, [C]: T })),
      {
        answeredAll: t,
        hasNo: o,
        ...
        let C = 0,
          T = !1;
        for (const ne of Ze) {
          const ce = (H = O[ne.id]) == null ? void 0 : H.estado;
          (ce && C++, ce === 'NO' && (T = !0));
        }
        return { answeredAll: C === Ze.length, hasNo: T, faltan: Ze.length - C };
      }, [O]),
      l = async (C) => {
        try {
          const T = { tipo: 'SALIDA' };
          if (C === 'pdf') {
            const H = g(s.checklist).extras.evidencias || N.evidencias || [],
              ne = [];
            for (const ce of H)
              try {
                const he = await xs(Le, ce.path);
                if (!he) continue;
                const ue = await fetch(he).then((P) => (P.ok ? P.blob() : null));
                if (!ue || !/image\/(jpeg|png)/.test(ue.type)) continue;
                const c = await new Promise((P, B) => {
                  const r = new FileReader();
                  ((r.onload = () => P(r.result)), (r.onerror = B), r.readAsDataURL(ue));
                });
                ne.push({ tipo: ce.tipo, dataUrl: c });
              } catch {}
            ((T.evidenciasImg = ne), await ia(s, Ye, T));
          } else await na(s, Ye, T);
        } catch (T) {
          I.error(`No se pudo generar el documento: ${T.message}`);
        }
      },
      h = async () => {
        if (
          ...
          try {
            const C = await y.mutateAsync(s.id);
            I.success(`Documento firmado por ${(C == null ? void 0 : C.firmado_nombre) || ''}`);
          } catch (C) {
            I.error(`No se pudo firmar: ${C.message}`);
          }
      },
      v = (C = N) => ({ ...O, _extras: C }),
      A = async () => {
        try {
          ...
          I.error(`No se pudo guardar: ${C.message}`);
        }
      },
      q = async () => {
        if (!t) {
          I.error(`Faltan ${n} ítem(s) por responder`);
          return;
        }
        const C = o ? 'NO_CONFORME' : 'CONFORME';
        if (C === 'NO_CONFORME' && !p) {
          I.error('Selecciona la disposición antes de finalizar');
          return;
        }
        if (
          confirm(
            C === 'CONFORME'
              ...
              : `Hay ítems NO conformes → SALIDA NO CONFORME (folio ACTA-SAL-), disposición "${p}". No despachar hasta resolver. ¿Continuar?`
          )
        )
          try {
            const T = await x.mutateAsync({
              tareaId: s.id,
              checklist: v(),
              observaciones: D,
              disposicion: p,
            ...
            C === 'CONFORME'
              ? (I.success(`Salida certificada ${(T == null ? void 0 : T.folio) || ''}`), m())
              : I.warning('Salida NO CONFORME. No despachar hasta resolver.');
          } catch (T) {
            I.error(`No se pudo finalizar: ${T.message}`);
          }
      },
      W = b.useRef(null),
      [oe, se] = b.useState(!1),
      ae = typeof navigator < 'u' && navigator.maxTouchPoints > 0,
      [le, F] = b.useState(null),
      [K, R] = b.useState(!1),
      [V, te] = b.useState({}),
      Y = N.evidencias || [];
    b.useEffect(() => {
    ...
    }, [JSON.stringify(Y.map((C) => C.path))]);
    const k = (C, T = 'galeria') => {
        var H;
        (F(C), T === 'camara' ? se(!0) : (H = W.current) == null || H.click());
      },
      G = async (C) => {
        var H;
        const T = Array.from(C.target.files || []);
        if (((C.target.value = ''), !(!T.length || !le))) {
          R(!0);
          try {
            const ne = [];
            for (const ce of T) {
              if (!ce.type.startsWith('image/')) continue;
              const he = await ks(ce),
                ue = await Ja({ tareaId: s.id, tipo: le, blob: he });
              ne.push({ tipo: le, path: ue, subido_en: new Date().toISOString() });
            }
            if (ne.length) {
              const ce = { ...N, evidencias: [...Y, ...ne] };
              (i(ce),
                await x.mutateAsync({
                  tareaId: s.id,
                  checklist: v(ce),
                ...
                I.success(
                  ne.length > 1 ? 'Fotos agregadas al certificado' : 'Foto agregada al certificado'
                ));
            }
          } catch (ne) {
            I.error(
              (H = ne == null ? void 0 : ne.message) != null && H.includes('row-level security')
                ? 'No tienes permiso para subir fotos'
                : `Error al subir: ${ne.message}`
            );
          } finally {
            (R(!1), F(null));
          }
      ...
      Q = async (C) => {
        if (confirm('¿Eliminar esta foto del certificado?'))
          try {
            await Qs(C.path);
            const T = { ...N, evidencias: Y.filter((H) => H.path !== C.path) };
            (i(T),
              await x.mutateAsync({
                tareaId: s.id,
                checklist: v(T),
      ...
      ie = (C) =>
        i((T) => {
          ...
          return C === 'NINGUNO'
            ...
            : (H.delete('NINGUNO'), H.has(C) ? H.delete(C) : H.add(C), { ...T, riesgos: [...H] });
        }),
      ee = Number(N.bultosTotal ?? s.bultos) || 0,
      me = Array.isArray(N.bultosEtiquetas) ? N.bultosEtiquetas : [],
      $ = (C) => {
        const T = Array.from({ length: ee }, (H, ne) => !!me[ne]);
        ((T[C] = !T[C]), j('bultosEtiquetas', T));
      },
      Z = N.pesos || {},
      X = gs(Z.esperado, Z.registrado),
      xe = f
        ? Ce(s)
        : t
          ? o
            ? p === 'Despachar con salvedades (autorizado)'
              ? { ...Ue.NARANJA }
              : { ...Ue.ROJO }
            : { ...Ue.VERDE }
          : { ...Ue.PENDIENTE },
      re = ({ pid: C, val: T, icon: H, activeCls: ne }) => {
        var he;
        const ce = ((he = O[C]) == null ? void 0 : he.estado) === T;
        return e.jsx('button', {
          type: 'button',
          disabled: a,
          onClick: () => M(C, T),
          className: `w-9 h-9 rounded-lg border flex items-center justify-center transition-colors shrink-0
          ${ce ? ne : 'bg-white border-slate-200 text-slate-300 hover:border-slate-300'} ${a ? 'opacity-60 cursor-default' : ''}`,
          children: H
        });
      },
      Ne = $e[s.estado] || {};
    return e.jsxs('div', {
      children: [
                  ...
                  children: [
                    e.jsxs('div', {
                      ...
                      children: [
                        e.jsx('span', {
                          className: 'font-black text-slate-900',
                          children: s.proveedor || u.cliente || 'Sin cliente'
                        }),
                        e.jsx('span', {
                    ...
                    e.jsxs('p', {
                      ...
                      children: [
                        e.jsxs('span', { children: ['NV ', s.oc || u.nv || '—'] }),
                        e.jsxs('span', { children: ['Guía ', u.guia || '—'] }),
                        u.factura && e.jsxs('span', { children: ['Factura ', u.factura] }),
                        e.jsxs('span', {
                          className: 'flex items-center gap-1',
                          children: [e.jsx(Ms, { size: 12 }), ' ', s.fecha_recepcion || '—']
                        }),
        ...
        e.jsxs('div', {
          className: `rounded-2xl border-2 p-4 mb-4 flex items-center justify-between gap-3 flex-wrap ${xe.cls}`,
          children: [
            e.jsxs('div', {
              className: 'flex items-center gap-3',
              children: [
                e.jsx('span', { className: 'text-3xl leading-none', children: xe.emoji }),
                e.jsxs('div', {
                  children: [
                    e.jsx('p', {
                    ...
                    e.jsx('p', {
                      ...
                      children: f
                        ? s.disposicion
                          ...
                          : `Folio ${s.folio || '—'}`
                        : n > 0
                          ? `${n} ítem(s) del checklist por responder`
            ...
            X &&
              e.jsxs('span', {
                className: `text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border ${X === 'CONFORME' ? 'bg-emerald-50 text-emerald-700 border-emerald-300' : 'bg-rose-50 text-rose-700 border-rose-300'}`,
                children: ['Peso ', X]
              })
          ]
        }),
        Array.isArray(u.skus) &&
          u.skus.length > 0 &&
          e.jsxs('div', {
            className: 'bg-white rounded-2xl border border-slate-200 p-5 mb-4',
            children: [
              ...
              e.jsxs(
                'div',
                {
                  ...
                  children: [
                    ...
                    e.jsx('div', {
                      className: 'space-y-2.5',
                      children: C.params.map((T) => {
                        var H, ne, ce, he, ue, c, P;
                        return e.jsxs(
                          'div',
                          {
                            className:
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  ((H = O[T.id]) == null ? void 0 : H.estado) &&
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        ...
                                        e.jsxs('select', {
                                          value:
                                            ((ne = O[T.id]) == null ? void 0 : ne.evidencia) || '',
                                          disabled: a,
                                          onChange: (B) => S(T.id, B.target.value),
                                          className: `px-2 py-1 rounded-lg border text-[11px] font-bold ${(ce = O[T.id]) != null && ce.evidencia ? 'border-emerald-200 bg-emerald-50/50 text-emerald-700' : 'border-slate-200 text-slate-400'}`,
                                          children: [
                                            e.jsx('option', {
                                              value: '',
                                              children: '— cómo se verificó —'
                                  ...
                                  ((he = O[T.id]) == null ? void 0 : he.estado) === 'NO' &&
                                    e.jsx('input', {
                                      value: ((ue = O[T.id]) == null ? void 0 : ue.nota) || '',
                                      disabled: a,
                                      onChange: (B) => _(T.id, B.target.value),
                                      placeholder: 'Detalle de la no conformidad…',
                                      className:
                                        'mt-1.5 w-full px-3 py-1.5 rounded-lg border border-rose-200 bg-rose-50/40 text-xs outline-none focus:border-rose-400'
                                    }),
                                  ((c = O[T.id]) == null ? void 0 : c.estado) === 'NA' &&
                                    e.jsx('input', {
                                      value: ((P = O[T.id]) == null ? void 0 : P.nota) || '',
                                      disabled: a,
                                      onChange: (B) => _(T.id, B.target.value),
                                      placeholder:
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('h3', {
                  className: 'text-sm font-black text-slate-800 mb-3 flex items-center gap-2',
                  children: [
                    e.jsx(Na, { size: 16, className: 'text-slate-400' }),
                    ' Control de peso'
                  ]
                }),
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsxs('div', {
                      children: [
                        ...
                        e.jsx('input', {
                          ...
                          inputMode: 'decimal',
                          onChange: (C) =>
                            j('pesos', { ...Z, esperado: C.target.value.replace(/[^0-9.,]/g, '') }),
                          placeholder: 'Ej. 125',
                          className:
                            'w-full mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400'
                        })
                    ...
                    e.jsx('div', {
                      ...
                      children: X
                        ? e.jsxs('span', {
                            className: `inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border text-sm font-black ${X === 'CONFORME' ? 'bg-emerald-50 text-emerald-700 border-emerald-300' : 'bg-rose-50 text-rose-700 border-rose-300'}`,
                            children: [
                              X === 'CONFORME' ? e.jsx(Re, { size: 15 }) : e.jsx(fe, { size: 15 }),
                              ' ',
                              X
                            ]
                          })
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('input', {
                          value: N.bultosTotal ?? s.bultos ?? '',
                          disabled: a,
                          inputMode: 'numeric',
                          onChange: (C) => j('bultosTotal', C.target.value.replace(/[^0-9]/g, '')),
                          className:
                ...
                ee > 0
                  ? e.jsxs(e.Fragment, {
                      children: [
                        e.jsx('div', {
                          className: 'flex flex-wrap gap-2',
                          children: Array.from({ length: Math.min(ee, 60) }, (C, T) =>
                            e.jsxs(
                              'button',
                              {
                                type: 'button',
                                disabled: a,
                                onClick: () => $(T),
                                className: `px-3 py-2 rounded-xl border text-xs font-black transition-colors ${me[T] ? 'bg-emerald-500 border-emerald-500 text-white' : 'bg-white border-slate-200 text-slate-500 hover:border-emerald-300'}`,
                                children: [
                                  'Bulto ',
                                  T + 1,
                                  '/',
                        ...
                        e.jsxs('p', {
                          ...
                          children: [
                            me.slice(0, ee).filter(Boolean).length,
                            '/',
                            ee,
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('div', {
                  className: 'flex flex-wrap gap-2',
                  children: fs.map((C) => {
                    const T = (N.riesgos || []).includes(C.id);
                    return e.jsxs(
                      'button',
                      {
                        type: 'button',
                        disabled: a,
                        onClick: () => ie(C.id),
                        className: `px-3 py-2 rounded-xl border text-xs font-black transition-colors ${T ? (C.id === 'NINGUNO' ? 'bg-slate-700 border-slate-700 text-white' : 'bg-amber-500 border-amber-500 text-white') : 'bg-white border-slate-200 text-slate-500 hover:border-amber-300'}`,
                        children: [T ? '☑' : '☐', ' ', C.label]
                      },
                      C.id
                    );
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('div', {
                  ...
                  children: Va.map((C) => {
                    const T = Y.filter((H) => H.tipo === C.id);
                    return e.jsxs(
                      'div',
                      {
                        className: 'rounded-xl border border-slate-100 p-3',
              ...
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('select', {
                    ...
                    children: [
                      e.jsx('option', { value: '', children: '— Seleccionar disposición —' }),
                      Ha.map((C) => e.jsx('option', { value: C, children: C }, C))
                    ]
                  })
                ]
              }),
              ...
              e.jsx('div', {
                ...
                children:
                  n > 0
                    ? e.jsxs('span', {
                        className: 'text-slate-500',
                        children: [n, ' ítem(s) por responder']
                      })
                    : o
                      ? e.jsx('span', {
                          className: 'text-rose-600',
              ...
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsx('button', {
                    ...
                    children: o
                      ? e.jsxs(e.Fragment, {
                          children: [e.jsx(Bs, { size: 16 }), ' Finalizar (No Conforme)']
                        })
                      : e.jsxs(e.Fragment, {
                          children: [e.jsx(Pe, { size: 16 }), ' Certificar salida']
                        })
                  })
                ]
              })
  ...
  Tt = () => {
    const { hasPermission: s, user: m } = ye(),
      d = s('manage_quality') || s('manage_monitoreo'),
      x = (m == null ? void 0 : m.rol) === 'ADMIN' || (m == null ? void 0 : m.es_admin_delegado),
      { data: y = [], isLoading: f, refetch: a, isFetching: u } = Ga(),
      g = Ks(),
      [O, w] = b.useState(null),
      [N, i] = b.useState(!1),
      [D, z] = b.useState(''),
      [p, L] = b.useState('TODOS'),
      M = async (t, o) => {
        if (
          (o.stopPropagation(),
          !!confirm(
          ...
          try {
            (await g.mutateAsync(t.id), I.success('Certificación eliminada'));
          } catch (n) {
            I.error(`No se pudo eliminar: ${n.message}`);
          }
      },
      _ = y.filter((t) => t.estado === 'PENDIENTE' || t.estado === 'EN_PROCESO').length,
      S = b.useMemo(() => {
        const t = D.trim().toLocaleLowerCase('es-CL');
        return y.filter((o) => {
          const n = o.contexto || {};
          return (
            (!t ||
              [o.oc, o.proveedor, o.folio, n.cliente, n.guia, n.transportista].some((h) =>
                String(h || '')
                  .toLocaleLowerCase('es-CL')
                  .includes(t)
              )) &&
      ...
      j = (O && y.find((t) => t.id === O)) || null;
    return j
      ? e.jsx($t, { tarea: j, onBack: () => w(null), canManage: d })
      : e.jsxs('div', {
          children: [
            e.jsxs('div', {
              className:
              ...
              children: [
                      ...
                      children: [
                        ...
                        d &&
                          e.jsxs('button', {
                            ...
                            children: [e.jsx(fa, { size: 14 }), ' Certificar salida (N.V. + SKU)']
                          })
                      ]
                    })
                  ]
                ...
                e.jsxs('div', {
                  className: 'mt-4 grid grid-cols-2 sm:grid-cols-3 gap-2',
                  children: [
                    e.jsx(es, { label: 'Total', value: y.length, tone: 'slate' }),
                    e.jsx(es, { label: 'Por certificar', value: _, tone: 'amber' }),
                    e.jsx(es, { label: 'Emitidas', value: y.length - _, tone: 'emerald' })
                  ]
                }),
                e.jsxs('div', {
                  className: 'mt-4 flex flex-col lg:flex-row gap-2',
                      ...
                      children: ['TODOS', 'PENDIENTE', 'EN_PROCESO', 'CONFORME', 'NO_CONFORME'].map(
                        (t) => {
                          ...
                          return e.jsx(
                            ...
                            {
                              onClick: () => L(t),
                              className: `whitespace-nowrap rounded-lg px-3 py-2 text-[10px] font-black tracking-wide transition ${p === t ? 'bg-teal-600 text-white shadow-sm' : 'bg-white text-slate-500 border border-slate-200 hover:border-teal-200'}`,
                              children:
                                t === 'TODOS'
                                  ? 'Todos'
                                  : ((o = $e[t]) == null ? void 0 : o.label) || t
                            },
                            t
                          );
                        }
                ...
                !f &&
                  e.jsxs('p', {
                    className: 'mt-2 text-[11px] font-bold text-slate-400',
                    children: ['Mostrando ', S.length, ' de ', y.length, ' certificaciones.']
                  })
              ]
            }),
            f
                ...
                : S.length === 0
                  ...
                  : e.jsx('div', {
                      ...
                      children: S.map((t) => {
                        const o = $e[t.estado] || {},
                          n = t.contexto || {},
                          l = t.estado === 'PENDIENTE' || t.estado === 'EN_PROCESO';
                        return e.jsxs(
                          'div',
                          {
                            role: 'button',
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsxs('span', {
                                    ...
                                    children: [
                                      e.jsx(Ie, { size: 16, className: 'text-slate-400 shrink-0' }),
                                      t.proveedor || n.cliente || 'Sin cliente'
                                    ]
                                  }),
                                  e.jsxs('div', {
                                    className: 'flex items-center gap-1.5 shrink-0',
                                ...
                                children: [
                                  ...
                                  (t.estado === 'CONFORME' || t.estado === 'NO_CONFORME') &&
                                    (() => {
                                      const h = Ce(t);
                                      return e.jsxs('span', {
                                        className: `text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-md border ${h.cls}`,
                              ...
                              e.jsxs('p', {
                                className: 'text-sm text-slate-500 font-medium',
                                children: ['Guía ', n.guia || '—', ' · ', t.fecha_recepcion || '—']
                              }),
                              t.bultos != null &&
                                e.jsxs('p', {
                                  className: 'text-xs text-slate-400 mt-1',
                                  children: [
                                    ...
                                    ' bultos ·',
                                    ' ',
                                    n.transportista || n.empresa_transporte || 's/transportista'
                                  ]
                                })
                            ]
                          },
  ...
  Lt = ({ codigo: s, value: m, onSelect: d }) => {
    const [x, y] = b.useState(!1),
      [f, a] = b.useState(''),
      [u, g] = b.useState([]),
      [O, w] = b.useState(!1),
      N = Ls.useRef(null);
    (b.useEffect(() => {
      ...
      b.useEffect(() => {
        const D = (z) => {
          N.current && !N.current.contains(z.target) && y(!1);
        };
        return (
          x && document.addEventListener('mousedown', D),
          () => document.removeEventListener('mousedown', D)
        );
      }, [x]));
    const i = (D) => {
      (d(D.valor, D.ubicacion || ''), y(!1), a(''));
    };
    return e.jsxs('div', {
      className: 'relative',
      ref: N,
      children: [
        e.jsxs('button', {
          ...
          children: [
            e.jsx('span', {
              className: m ? 'text-slate-800 truncate' : 'text-slate-300',
              children: m || 'Elegir lote / serie…'
            }),
                    ...
                    : u.map((D, z) =>
                        e.jsxs(
                          'button',
                          {
                            ...
                            children: [
                              e.jsx('span', {
                                className: `text-[9px] font-black px-1.5 py-0.5 rounded ${D.tipo === 'P' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'}`,
                                children: D.tipo === 'P' ? 'LOTE' : 'SERIE'
                              }),
                              e.jsx('span', {
                                className:
                              ...
                              D.ubicacion &&
                                e.jsx('span', {
                                  ...
                                  children: D.ubicacion
                                }),
                              e.jsx('span', {
                                className: `text-xs font-bold shrink-0 ${Number(D.disponible) > 0 ? 'text-emerald-600' : 'text-slate-300'}`,
                                children: Number(D.disponible) || 0
                              })
                            ]
                          },
                          z
  ...
  zs = 'Lote no encontrado en el sistema al momento de la inspección',
  Mt = [
  ...
  Ft = ({ item: s, onChange: m }) => {
    const d = s.batch_source || (s.partida ? 'system' : 'none'),
      x = s.batch_value ?? s.partida ?? '',
      y = (a) => {
        var g;
        const u = {
          batch_source: a,
          batch_value: ['none', 'not_found'].includes(a) ? null : '',
          partida: ''
        };
        (a === 'not_found' &&
          !String(s.observaciones || '').includes(zs) &&
          (u.observaciones = [(g = s.observaciones) == null ? void 0 : g.trim(), zs]
            .filter(Boolean)
            .join(' · ')),
          m(u));
      },
      f = (a, u = '') =>
        m({ batch_value: a || null, partida: a || '', ...(u ? { ubicacion: u } : {}) });
    return e.jsxs('div', {
      ...
      children: [
        e.jsx('div', {
          ...
          children: Mt.map((a) =>
            e.jsxs(
              'label',
              {
                className: `flex items-center gap-2 rounded-lg border px-2.5 py-2 text-[11px] font-bold cursor-pointer ${d === a.id ? 'border-emerald-300 bg-emerald-50 text-emerald-700' : 'border-slate-200 bg-white text-slate-500'}`,
                children: [
                  e.jsx('input', {
                    type: 'radio',
                    name: `batch-${s._key}`,
        ...
        d === 'system' && e.jsx(Lt, { codigo: s.codigo_producto, value: x, onSelect: f }),
        d === 'manual' &&
          e.jsx('input', {
            value: x,
  ...
  $s = ({
    ...
    const { user: a } = ye(),
      ...
      O = et(),
      w = st(),
      { data: N } = Ns(g ? s.id : null),
      i = (d == null ? void 0 : d.id) || x || null,
      [D, z] = b.useState((s == null ? void 0 : s.bodega) || ''),
      [p, L] = b.useState((s == null ? void 0 : s.periodicidad) || 'SEMANAL'),
      [M, _] = b.useState((s == null ? void 0 : s.observaciones) || ''),
      [S, j] = b.useState(''),
      [t, o] = b.useState(!1),
      [n, l] = b.useState([]),
      [h, v] = b.useState(!1),
      [A, q] = b.useState([]),
      [W, oe] = b.useState(null),
      [se, ae] = b.useState([]),
      [le, F] = b.useState(!i),
      [K, R] = b.useState({ status: 'idle', savedAt: null, error: '' }),
      [V, te] = b.useState(
        i
          ? {
              name:
                (d == null ? void 0 : d.locked_by_name) ||
                (a == null ? void 0 : a.nombre) ||
                'Usuario actual',
              at: (d == null ? void 0 : d.locked_at) || new Date().toISOString()
            }
          : null
      ),
      Y = b.useRef(!1);
      ...
      g &&
        ...
        q(
          N.map((c) => ({
            ...
            estado_inventario: c.estado_inventario || 'Disponible',
            tipo: c.tipo || 'NO_PERECIBLE',
            fecha_vencimiento: c.fecha_vencimiento || null,
            semaforo: c.semaforo || 'NA',
            condicion_observada: c.condicion_observada || 'OK',
            cantidad_afectada: Number(c.cantidad_afectada) || 0,
            no_registrado: !!c.no_registrado,
            motivo: c.motivo || 'Rutina',
            observaciones: c.observaciones || '',
            batch_source: c.batch_source || (c.partida ? 'system' : 'none'),
            batch_value: c.batch_value ?? c.partida ?? null,
            revision_estado: c.revision_estado || 'PENDIENTE'
          }))
        ));
    }, [g, N]);
    const k = b.useRef(!1);
    b.useEffect(() => {
      ...
      if (!g && i && !k.current) {
        k.current = !0;
        const r = d == null ? void 0 : d.progress_data,
          E = Array.isArray(r == null ? void 0 : r.items) ? r.items : null;
        if (E != null && E.length) {
          (z(((c = r == null ? void 0 : r.header) == null ? void 0 : c.bodega) || ''),
            L(((P = r == null ? void 0 : r.header) == null ? void 0 : P.periodicidad) || 'SEMANAL'),
            _(((B = r == null ? void 0 : r.header) == null ? void 0 : B.observaciones) || ''),
            ae(Array.isArray(r == null ? void 0 : r.selected_sku_ids) ? r.selected_sku_ids : []),
            q(
              E.map((J, de) => ({
                ...J,
                _key:
                  J._key ||
                  `${J.codigo_producto}|${J.batch_value || J.partida || ''}|${J.ubicacion || ''}|${de}`,
                revision_estado: J.revision_estado || 'PENDIENTE',
                batch_source: J.batch_source || (J.partida ? 'system' : 'none'),
                batch_value: J.batch_value ?? J.partida ?? null
              }))
            ),
            R({
              status: 'saved',
              savedAt:
                (d == null ? void 0 : d.progress_updated_at) ||
        ...
        const U = Array.isArray(m) ? m : (d == null ? void 0 : d.skus) || [];
        (q(
          U.map((J) => ({
            _key: `${J.codigo_producto}|${J.partida || ''}|${J.ubicacion || ''}`,
            codigo_producto: J.codigo_producto,
            partida: J.partida || '',
            ubicacion: J.ubicacion || '',
            producto: J.producto || '',
            unidad_medida: J.unidad_medida || 'UN',
            cantidad: Number(J.cantidad) || 0,
            estado_inventario: 'Disponible',
            tipo: J.tipo || 'NO_PERECIBLE',
            fecha_vencimiento: J.fecha_vencimiento || null,
            semaforo: J.semaforo || 'NA',
    ...
    const G = b.useCallback(async () => {
        v(!0);
        try {
          const c = await Zs(S, t);
          l(c);
        } catch (c) {
          I.error(`Error buscando stock: ${c.message}`);
        } finally {
          v(!1);
        }
      }, [S, t]),
      Q = (c) => {
        const P = `${c.codigo_producto}|${c.partida || ''}|${c.ubicacion || ''}`;
        if (A.some((B) => B._key === P)) {
          I.info('Ese ítem ya está en el informe');
          return;
        }
        q((B) => [
          ...B,
      ...
      ie = () => {
        const c = (W.codigo || '').trim().toUpperCase(),
          P = (W.ubicacion || '').trim().toUpperCase();
        if (!c) {
          I.error('Ingresa el código del producto');
          return;
        }
        if (!P) {
          I.error('La ubicación es obligatoria');
          return;
        }
        const B = `MAN|${c}|${(W.partida || '').trim()}|${P}`;
        ...
        (q((r) => [
          ...
          oe(null),
          I.success('Ítem manual agregado (no registrado)'));
      },
      ee = (c, P, B) => {
        q((r) => r.map((E) => (E._key === c ? { ...E, [P]: B } : E)));
      },
      me = (c, P) => {
        q((B) => B.map((r) => (r._key === c ? { ...r, ...P } : r)));
      },
      $ = (c, P) =>
        q((B) =>
          B.map((r) =>
            r._key === c
              ? {
                  ...r,
                  condicion_observada: P,
                  revision_estado: P === 'OK' ? 'APROBADO' : 'RECHAZADO',
                  ...(P === 'OK' ? { cantidad_afectada: 0 } : {})
                }
              : r
          )
        ),
      Z = (c) => {
        (q((P) => P.filter((B) => B._key !== c)), ae((P) => P.filter((B) => B !== c)));
      },
      X = (c) => ae((P) => (P.includes(c) ? P.filter((B) => B !== c) : [...P, c])),
      xe = () => ae((c) => (c.length === A.length ? [] : A.map((P) => P._key))),
      re = (c) => {
        if (se.length === 0) {
          I.info('Selecciona uno o más SKUs');
          return;
        }
        q((P) =>
          P.map((B) =>
      ...
      Ne = b.useMemo(
        () => ({
          ...
          header: { bodega: D, periodicidad: p, observaciones: M },
          items: A,
          selected_sku_ids: se
        }),
        [D, A, M, p, se]
    ...
    b.useEffect(() => {
      if (!i || !le || K.status === 'conflict') return;
      R((P) => ({ ...P, status: 'pending', error: '' }));
      const c = window.setTimeout(async () => {
        R((P) => ({ ...P, status: 'saving', error: '' }));
        try {
          const P = await at(i, Ne);
          (R({
            status: 'saved',
            savedAt: (P == null ? void 0 : P.saved_at) || new Date().toISOString(),
            error: ''
          }),
            te({
              name:
                (P == null ? void 0 : P.locked_by_name) ||
                (V == null ? void 0 : V.name) ||
                (a == null ? void 0 : a.nombre) ||
                'Usuario actual',
              at: (P == null ? void 0 : P.locked_at) || new Date().toISOString()
            }));
        } catch (P) {
          const B =
            (P == null ? void 0 : P.code) === 'QUALITY_TASK_LOCKED' ||
            (P == null ? void 0 : P.status) === 409;
          R({
            status: B ? 'conflict' : 'error',
            savedAt: null,
            error: (P == null ? void 0 : P.message) || 'No se pudo guardar el progreso'
          });
        }
      }, 1500);
      return () => window.clearTimeout(c);
    }, [le, Ne, i, a == null ? void 0 : a.nombre]);
    const C = async () => {
        if (i && K.status !== 'conflict')
          try {
            await mt(i);
          } catch (c) {
            console.warn('No se pudo liberar el bloqueo de Calidad', c);
          }
        y();
      },
      T = async (c) => {
        if (A.length === 0) {
          I.error('Agrega al menos un ítem');
          return;
        }
        if (c === 'ENVIADO_CALIDAD') {
          const B = A.filter((U) => !(U.ubicacion || '').trim());
          if (B.length > 0) {
            I.error(`${B.length} ítem(s) sin ubicación. Es obligatoria para enviar a Calidad.`);
            return;
          }
          const r = A.filter(
            (U) =>
          ...
          if (r.length > 0) {
            I.error(`${r.length} ítem(s) requieren elegir o escribir el lote.`);
            return;
          }
          const E = A.filter((U) => U.revision_estado === 'PENDIENTE');
          if (i && E.length > 0) {
            I.error(`Aún faltan ${E.length} SKU(s) por aprobar o rechazar.`);
            return;
          }
        }
        const P = A.map(({ _key: B, ...r }) => r);
        try {
          if (i) {
            const r = await Xs(i);
            te({
          ...
          let B = g ? s.id : null;
          if (g) {
            const r = { bodega: D || null, periodicidad: p, estado: c, observaciones: M || null };
            (await w.mutateAsync({ informeId: s.id, cabecera: r, items: P }),
              I.success('Informe actualizado'));
          } else {
            const r = {
              ...
              E = await O.mutateAsync({
                cabecera: r,
                items: P,
                asignacionId: c === 'ENVIADO_CALIDAD' ? i : null
              });
            ((B = (E == null ? void 0 : E.id) || null),
              I.success(
                c === 'ENVIADO_CALIDAD' ? 'Informe enviado a Calidad' : 'Borrador guardado'
              ),
              i &&
                (E == null ? void 0 : E.asignacion_estado) === 'RESUELTA' &&
                I.success('Asignación de estancia resuelta'));
          }
          if (c === 'ENVIADO_CALIDAD' && B)
            try {
              const r = await ut(B);
              ((r == null ? void 0 : r.flags) > 0 &&
                (u.invalidateQueries({ queryKey: ['calidad_flags'] }),
                I.info(`${r.flags} ubicación(es) marcadas "En Auditoría"`)),
                (r == null ? void 0 : r.alertas) > 0 &&
                  (I.warning(`${r.alertas} alerta(s) a Inventario por SKU no registrado`),
                  pt(r.alertas, B)));
            } catch (r) {
          ...
          I.error(`Error al guardar: ${B.message}`);
        }
      },
      H = A.filter((c) => !(c.ubicacion || '').trim()).length,
      ne = A.filter((c) => c.revision_estado !== 'PENDIENTE').length,
      ce = A.length > 0 ? Math.round((ne / A.length) * 100) : 0,
      he = (c, P) =>
        P
          ? c === 'OK'
      ...
      ue = O.isPending || w.isPending;
    return K.status === 'conflict'
      ? e.jsxs('div', {
          className: 'space-y-4',
          children: [
            e.jsxs('button', {
              ...
              children: [e.jsx(De, { size: 17 }), ' Volver a las tareas']
            }),
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('p', { className: 'mt-2 text-sm font-bold', children: K.error }),
                e.jsx('p', {
            ...
            e.jsxs('div', {
              ...
              children: [
                e.jsx('button', {
                  ...
                  children: e.jsx(De, { size: 22 })
                }),
                e.jsx('h2', {
                  className: 'text-2xl font-black text-slate-900',
                  children: g ? `Editar Informe ${s.numero}` : 'Nuevo Informe de Monitoreo'
                })
              ]
            }),
            i &&
                        ...
                        'div',
                        {
                          ...
                          children: [
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsx('span', {
                                  className: `w-2.5 h-2.5 rounded-full ${rs[c.semaforo] || 'bg-slate-300'}`
                                }),
                                e.jsx('span', {
                                  className:
                                ...
                                c.partida &&
                                  e.jsxs('span', {
                                    className: 'text-[10px] text-slate-400',
                                    children: ['lote ', c.partida]
                                  }),
                                c.ubicacion &&
                                  e.jsxs('span', {
                                    className: 'text-[10px] text-slate-400',
                                    children: ['· ', c.ubicacion]
                                  })
                              ]
                            }),
                            e.jsx('button', {
              ...
              children: [
                        ...
                        children: [
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                value: W.codigo,
                                onChange: (c) =>
                                  oe((P) => ({ ...P, codigo: c.target.value.toUpperCase() })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                value: W.ubicacion,
                                onChange: (c) =>
                                  oe((P) => ({ ...P, ubicacion: c.target.value.toUpperCase() })),
                                className:
                                  'w-full mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-mono font-bold outline-none focus:border-amber-400',
                                placeholder: 'A-12-03'
                              })
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                value: W.partida,
                                onChange: (c) =>
                                  oe((P) => ({ ...P, partida: c.target.value.toUpperCase() })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                ...
                                value: W.cantidad,
                                onChange: (c) =>
                                  oe((P) => ({ ...P, cantidad: Number(c.target.value) || 0 })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              e.jsx('input', {
                                value: W.producto,
                                onChange: (c) => oe((P) => ({ ...P, producto: c.target.value })),
                                className:
                ...
                A.length === 0
                  ...
                  : e.jsx('div', {
                      className: 'space-y-3',
                      children: A.map((c) => {
                        const P = c.condicion_observada !== 'OK',
                          B = !(c.ubicacion || '').trim();
                        return e.jsxs(
                          'div',
                          {
                            className: `rounded-xl border p-4 ${P ? 'border-amber-200 bg-amber-50/30' : 'border-slate-200'}`,
                            children: [
                              e.jsxs('div', {
                                      ...
                                      e.jsxs('div', {
                                        ...
                                        children: [
                                          e.jsxs('div', {
                                            ...
                                            children: [
                                              e.jsx('span', {
                                                className: `w-2 h-2 rounded-full ${rs[c.semaforo] || 'bg-slate-300'}`
                                              }),
                                              e.jsx('span', {
                                                className:
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx('div', {
                                    ...
                                    children: e.jsx(Ft, { item: c, onChange: (r) => me(c._key, r) })
                                  }),
                                  e.jsxs('div', {
                                    className: 'col-span-2',
                                    children: [
                                      ...
                                      e.jsx('input', {
                                        value: c.ubicacion,
                                        onChange: (r) =>
                                          ee(c._key, 'ubicacion', r.target.value.toUpperCase()),
                                  ...
                                  e.jsxs('div', {
                                    children: [
                                      ...
                                      e.jsx('input', {
                                        ...
                                        value: c.cantidad,
                                        onChange: (r) =>
                                          ee(c._key, 'cantidad', Number(r.target.value) || 0),
                                        className:
                                          'w-full mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400'
                                      })
                                    ]
                                      ...
                                      children: [
                                        ...
                                        e.jsx('input', {
                                          ...
                                          value: String(
                                            Math.max(
                                              0,
                                              Math.trunc(Number(c.cantidad_afectada) || 0)
                                            )
                                          ),
                                          onChange: (r) =>
                                            ee(
                                    ...
                                    children: tt.map((r) =>
                                      e.jsxs(
                                        'button',
                                        {
                                          type: 'button',
                                          onClick: () => $(c._key, r),
                                          className: `text-xs font-bold px-3 py-1.5 rounded-full border transition-colors ${he(r, c.condicion_observada === r)}`,
                                          children: [
                                            r !== 'OK' &&
                                              c.condicion_observada === r &&
                                              e.jsx(fe, {
                                                size: 11,
                              ...
                              e.jsx('div', {
                                ...
                                children: e.jsx('input', {
                                  ...
                                  onChange: (r) => ee(c._key, 'observaciones', r.target.value),
                              ...
                              P &&
                                ...
                                e.jsxs('p', {
                                  ...
                                  children: [
                                    ...
                                    ' Al enviar,',
                                    ' ',
                                    e.jsx('b', { className: 'font-mono', children: c.ubicacion }),
                ...
                i &&
                  e.jsx('div', {
                    className: `mt-4 text-right text-xs font-bold ${K.status === 'error' ? 'text-rose-600' : 'text-slate-500'}`,
                    children:
                      K.status === 'saving' || K.status === 'pending'
                        ? '⏳ Guardando...'
                        : K.status === 'error'
                          ? `🔴 No se pudo autoguardar: ${K.error}`
                          : K.savedAt
                            ? `🟢 Todos los cambios guardados - ${new Date(K.savedAt).toLocaleTimeString('es-CL', { hour: '2-digit', minute: '2-digit' })}`
                            : 'Autoguardado listo'
                  })
              ]
            })
  ...
  Ps = ({ informe: s, prefill: m, onCancel: d, onSaved: x }) => {
    var Y;
    const { user: y } = ye(),
      f = ot(),
      { data: a } = Ns((s == null ? void 0 : s.id) || null),
      u =
        !s && m
          ? {
              antecedentes: `Recepción ${m.oc || 's/OC'} de ${m.proveedor || 's/proveedor'} (${m.origen === 'NACIONAL' ? 'Nacional' : 'Importación'}) resultó NO CONFORME en el CheckList de ingreso. Se levanta el presente Informe de Daños / Solicitud de No Conformidad al proveedor.`,
              fecha_recepcion: m.fecha_recepcion || Ts.fecha_recepcion
            }
          : {},
      [g, O] = b.useState((s == null ? void 0 : s.id) || null),
      [w, N] = b.useState((s == null ? void 0 : s.numero) || ''),
      [i, D] = b.useState((s == null ? void 0 : s.bodega) || ''),
      [z, p] = b.useState((s == null ? void 0 : s.estado) || 'BORRADOR'),
      [L, M] = b.useState({
        ...Ts,
        ...
        elaborado_por:
          ...
          (y == null ? void 0 : y.nombre) ||
          ''
      }),
      [_, S] = b.useState([]),
      { data: j = [], refetch: t } = rt(g),
      o = b.useRef(!1);
    b.useEffect(() => {
      s != null &&
        s.id &&
        ...
        S(
          a.map((k) => ({
            ...
            tipo_dano: k.tipo_dano || '',
            componente_afectado: k.componente_afectado || '',
            consecuencia: k.consecuencia || '',
            observaciones: k.observaciones || ''
          }))
        ));
    }, [s == null ? void 0 : s.id, a]);
    const n = (k, G) => M((Q) => ({ ...Q, [k]: G })),
      l = () =>
        S((k) => [
          ...k,
          {
      ...
      h = (k, G, Q) => S((ie) => ie.map((ee) => (ee._key === k ? { ...ee, [G]: Q } : ee))),
      v = (k) => S((G) => G.filter((Q) => Q._key !== k)),
      A = () =>
        M((k) => ({
          ...k,
          cuadro_resumen: [...(k.cuadro_resumen || []), { indicador: '', valor: '' }]
        })),
      q = (k, G, Q) =>
        M((ie) => ({
          ...ie,
          cuadro_resumen: ie.cuadro_resumen.map((ee, me) => (me === k ? { ...ee, [G]: Q } : ee))
        })),
      W = (k) => M((G) => ({ ...G, cuadro_resumen: G.cuadro_resumen.filter((Q, ie) => ie !== k) })),
      oe = () =>
        M((k) => ({ ...k, acciones_recomendadas: [...(k.acciones_recomendadas || []), ''] })),
      se = (k, G) =>
        M((Q) => ({
          ...Q,
          acciones_recomendadas: Q.acciones_recomendadas.map((ie, ee) => (ee === k ? G : ie))
        })),
      ae = (k) =>
        M((G) => ({
          ...G,
          acciones_recomendadas: G.acciones_recomendadas.filter((Q, ie) => ie !== k)
        })),
      le = async (k) => {
        const G = k || z;
        try {
          const Q = g
              ...
              : {
                  fecha: new Date().toISOString().slice(0, 10),
                  analista_id: (y == null ? void 0 : y.id) || null,
                  analista_nombre: (y == null ? void 0 : y.nombre) || null,
                  bodega: i || null,
                  periodicidad: 'ADHOC',
                  estado: G,
                  observaciones: L.descripcion_hallazgo || null
            ...
            ie = _.map(({ _key: me, ...$ }) => $),
            ee = await f.mutateAsync({ informeId: g, cabecera: Q, reporte: L, hallazgos: ie });
          (O(ee.id),
            ee.numero && N(ee.numero),
            p(G),
            S(ee.hallazgos.map((me) => ({ ...me, _key: me.id }))),
            t(),
            I.success('Informe de daños guardado'));
        } catch (Q) {
          I.error(`Error al guardar: ${Q.message}`);
        }
      },
      F = {
        id: g,
        ...
        bodega: i,
        analista_nombre: L.elaborado_por || (y == null ? void 0 : y.nombre),
        reporte: L
      },
      K = async (k) => {
        if (!g) {
          I.error('Guarda el informe antes de exportar');
          return;
        }
        try {
          k === 'word' ? await wt(F, _, j) : await yt(F, _, j);
        } catch (G) {
          I.error(`Error al exportar: ${G.message}`);
        }
      },
      R =
      ...
      children: [
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('h2', {
                  className: 'text-2xl font-black text-slate-900',
                  children: g ? `Informe de Daños ${w}` : 'Nuevo Informe de Daños'
                })
              ]
            }),
            e.jsxs('div', {
            ...
            e.jsxs('div', {
              children: [
                ...
                e.jsx('input', {
                  ...
                  onChange: (k) => n('fecha_recepcion', k.target.value),
                  className: R
                })
              ]
            }),
            e.jsxs('div', {
              children: [
                ...
                e.jsx('input', {
                  ...
                  onChange: (k) => n('tipo_producto', k.target.value),
            ...
            e.jsxs('div', {
              children: [
                ...
                e.jsx('input', {
                  ...
                  onChange: (k) => n('area_responsable', k.target.value),
                  className: R
                })
              ]
            }),
            e.jsxs('div', {
              children: [
                ...
                e.jsx('select', {
                  ...
                  onChange: (k) => n('clasificacion', k.target.value),
                  className: R,
                  children: Ys.map((k) => e.jsx('option', { value: k, children: k }, k))
                })
              ]
            }),
            e.jsxs('div', {
            ...
            e.jsxs('div', {
              children: [
                ...
                e.jsx('textarea', {
                  ...
                  onChange: (k) => n('antecedentes', k.target.value),
                  className: R
                })
              ]
            }),
            e.jsxs('div', {
              children: [
                ...
                e.jsx('textarea', {
                  ...
                  onChange: (k) => n('descripcion_hallazgo', k.target.value),
                  className: R
                })
              ]
            })
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                e.jsxs('h3', {
                  className: 'text-sm font-black text-slate-700',
                  children: ['3. Daños identificados (', _.length, ')']
                }),
                e.jsxs('button', {
                  onClick: l,
                  className:
                            ...
                            children: [
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.tipo_dano,
                                    onChange: (Q) => h(k._key, 'tipo_dano', Q.target.value),
                              ...
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.componente_afectado,
                                    onChange: (Q) =>
                                      h(k._key, 'componente_afectado', Q.target.value),
                              ...
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    type: 'number',
                                    value: String(Math.max(0, Math.trunc(Number(k.cantidad) || 0))),
                                    onChange: (Q) =>
                                      h(
                                        k._key,
                                        'cantidad',
                              ...
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.codigo_producto,
                                    onChange: (Q) => h(k._key, 'codigo_producto', Q.target.value),
                                    placeholder: 'SKU',
                                    className: R
                                  })
                                ]
                              ...
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.ubicacion,
                                    onChange: (Q) => h(k._key, 'ubicacion', Q.target.value),
                                    className: R
                                  })
                                ]
                              }),
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.partida,
                                    onChange: (Q) => h(k._key, 'partida', Q.target.value),
                                    className: R
                                  })
                                ]
                              }),
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.consecuencia,
                                    onChange: (Q) => h(k._key, 'consecuencia', Q.target.value),
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsx('input', {
                                    value: k.observaciones,
                                    onChange: (Q) => h(k._key, 'observaciones', Q.target.value),
                                    className: R
                                  })
                                ]
                              })
        ...
        e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('div', {
              className: 'space-y-2',
              children: (L.cuadro_resumen || []).map((k, G) =>
                e.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      e.jsx('input', {
                        ...
                        className: `${R} mt-0 flex-1`
                      }),
                      e.jsx('input', {
                        value: k.valor,
                        onChange: (Q) => q(G, 'valor', Q.target.value),
                        placeholder: 'Valor',
                        className: `${R} mt-0 w-32`
                      }),
                      e.jsx('button', {
                        onClick: () => W(G),
                        className:
            ...
            e.jsxs('div', {
              children: [
                ...
                e.jsx('textarea', {
                  ...
                  onChange: (k) => n('analisis_causa', k.target.value),
                  className: R
                })
              ]
            }),
            e.jsxs('div', {
              children: [
                ...
                e.jsx('div', {
                  ...
                  children: (L.acciones_recomendadas || []).map((k, G) =>
                    e.jsxs(
                      'div',
                      {
                        className: 'flex gap-2 items-center',
                        children: [
                          e.jsx('input', {
                            value: k,
                            onChange: (Q) => se(G, Q.target.value),
            ...
            e.jsxs('div', {
              children: [
                ...
                e.jsx('input', {
                  ...
                  onChange: (k) => n('elaborado_por', k.target.value),
                  className: R
                })
              ]
            }),
            e.jsxs('div', {
              children: [
                ...
                e.jsx('input', {
                  ...
                  onChange: (k) => n('revisado_por', k.target.value),
                  className: R
                })
              ]
            })
        ...
        e.jsxs('div', {
          ...
          children: [
            ...
            e.jsxs('button', {
              ...
              children: [e.jsx(Vs, { size: 16 }), ' Guardar y enviar']
            })
          ]
        })
      ]
  ...
  Bt = ({ informe: s, onBack: m, onEdit: d, onDelete: x }) => {
    var j;
    const { hasPermission: y } = ye(),
      f = y('manage_quality'),
      { data: a = [], isLoading: u } = Ns(s.id),
      g = lt(),
      O = nt(),
      { data: w = [] } = it(),
      { data: N = [] } = ct(),
      ...
      L = async (t) => {
        ...
        const o = D[t.id] || {};
        if (!o.dictamen) {
          I.error('Selecciona un dictamen');
          return;
        }
        const n = Ve.find((h) => h.id === o.dictamen);
        if (n != null && n.mueve && !o.bodegaDestino) {
          I.error('Indica la bodega destino');
          return;
        }
        if (o.tipoAccion) {
          const h = Ge.find((v) => v.id === o.tipoAccion);
          if (!(o.area || (h != null && h.area))) {
            I.error('Selecciona el área responsable de la acción');
            return;
          }
        }
        try {
          if (
            ...
            I.success(
              `Dictamen registrado: ${n == null ? void 0 : n.label}${n != null && n.mueve ? ' · aviso enviado a Inventario' : ''}`
            ),
            ['CUARENTENA', 'RECHAZAR', 'BAJA'].includes(o.dictamen) &&
              bt({
                codigo: t.codigo_producto,
                ubicacion: t.ubicacion,
                estadoLabel: (n == null ? void 0 : n.label) || o.dictamen,
                tipo: 'CALIDAD_DICTAMEN'
              }),
            o.tipoAccion)
          ) {
            const h = Ge.find((A) => A.id === o.tipoAccion),
              v = o.area || (h == null ? void 0 : h.area);
            if (!v) {
              I.error('Selecciona el área responsable de la acción');
              return;
            }
            try {
              const A = await O.mutateAsync({
                itemId: t.id,
              ...
              I.success(
                `Acción promulgada ${(A == null ? void 0 : A.folio) || ''} → ${((l = w.find((q) => q.codigo === v)) == null ? void 0 : l.label) || v}`
              );
            } catch (A) {
              I.error(`Dictamen OK, pero no se pudo crear la acción: ${A.message}`);
            }
          }
        } catch (h) {
          I.error(`Error: ${h.message}`);
        }
      },
      M = () => {
        const t = a.map((v) => ({
            SKU: v.codigo_producto,
            Lote_Serie: v.partida,
            Ubicacion: v.ubicacion,
            Producto: v.producto,
            UM: v.unidad_medida,
            Cantidad: v.cantidad,
            Uds_Afectadas: v.cantidad_afectada || 0,
            No_Registrado: v.no_registrado ? 'SÍ' : '',
            Estado_Inv: v.estado_inventario,
            Tipo: v.tipo,
            Vence: v.fecha_vencimiento,
            Semaforo: v.semaforo,
            Condicion: v.condicion_observada,
            Motivo: v.motivo,
            Observaciones: v.observaciones,
            Dictamen: v.dictamen || '',
            Bodega_Destino: v.bodega_destino || '',
            Acuse: v.acuse_texto || '',
            Calidad: v.calidad_nombre || '',
            Fecha_Dictamen: v.fecha_dictamen || ''
          })),
          o = (v) => a.filter(v).length,
          n = ['LIBERAR', 'CUARENTENA', 'REPROCESO', 'RECHAZAR', 'BAJA'],
          l = [...new Set(a.map((v) => v.condicion_observada).filter(Boolean))],
          h = [
            ...
            { Campo: 'Total ítems', Valor: a.length },
            { Campo: 'Dictaminados', Valor: o((v) => v.dictamen) },
            { Campo: 'Pendientes', Valor: o((v) => !v.dictamen) },
            {
              Campo: 'Con problema (cond≠OK)',
              Valor: o((v) => v.condicion_observada && v.condicion_observada !== 'OK')
            },
            { Campo: 'No registrados', Valor: o((v) => v.no_registrado) },
            { Campo: '— Por semáforo —', Valor: '' },
            ...['ROJO', 'NARANJA', 'VERDE', 'NA'].map((v) => ({
              Campo: `Semáforo ${v}`,
              Valor: o((A) => A.semaforo === v)
            })),
            { Campo: '— Por dictamen —', Valor: '' },
            ...n.map((v) => ({ Campo: v, Valor: o((A) => A.dictamen === v) })),
            { Campo: '— Por condición —', Valor: '' },
            ...l.map((v) => ({ Campo: v, Valor: o((A) => A.condicion_observada === v) }))
          ];
        Ea({
      ...
      _ = b.useMemo(() => a.filter((t) => !t.dictamen).length, [a]),
      S = b.useMemo(() => {
        const t = a.length,
          o = a.filter((v) => v.dictamen).length,
          n = a.filter((v) => v.no_registrado).length,
          l = a.filter((v) => v.condicion_observada && v.condicion_observada !== 'OK').length,
          h = { ROJO: 0, NARANJA: 0, VERDE: 0, NA: 0 };
        return (
          a.forEach((v) => {
            h[v.semaforo] = (h[v.semaforo] || 0) + 1;
          }),
          {
            total: t,
            dictaminados: o,
                  ...
                  children: [
                    e.jsxs('div', {
                      ...
                      children: [
                        ...
                        e.jsx('span', {
                          className: `text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${ca[s.estado] || ''}`,
                          children: (j = s.estado) == null ? void 0 : j.replace('_', ' ')
                        })
                      ]
                    }),
                    e.jsxs('p', {
              ...
              children: [
                d &&
                  e.jsxs('button', {
                    ...
                    children: [e.jsx(Gs, { size: 16 }), ' Editar']
                  }),
                x &&
                  e.jsxs('button', {
                    onClick: () => x(s),
                ...
                e.jsxs('button', {
                  ...
                  children: [e.jsx(ya, { size: 16 }), ' Excel']
                })
              ]
            })
          ]
            ...
            children: [
              ...
              e.jsx('div', {
                ...
                children: [
                  ...
                  { label: 'Pendientes', value: _, cls: 'text-amber-600' },
                  ...
                  e.jsxs(
                    'div',
                    {
                      ...
                      children: [
                        ...
                        e.jsx('div', {
                          className: `text-2xl font-black tabular-nums ${t.cls}`,
                          children: t.value
                        })
                      ]
                    },
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('span', {
                                className: `w-2.5 h-2.5 rounded-full ${rs[t.semaforo] || 'bg-slate-300'}`
                              }),
                              e.jsx('span', {
                                className:
                          ...
                          t.dictamen
                            ? e.jsxs('div', {
                                className: 'flex items-center gap-2',
                                children: [
                                  e.jsx(gt, { estado: Ut(t.dictamen) }),
                                  e.jsxs('span', {
                                    className: 'text-xs font-bold text-slate-500',
                                    children: [
                                      t.dictamen,
                                      t.bodega_destino ? ` → BD ${t.bodega_destino}` : '',
                                      ' ·',
                                      ' ',
                                      t.calidad_nombre
                                    ]
                        ...
                        children: [
                          e.jsxs('span', {
                            children: [
                              ...
                              e.jsx('b', {
                                className:
                                  t.condicion_observada && t.condicion_observada !== 'OK'
                                    ? 'text-amber-700'
                                    : 'text-slate-700',
                                children: t.condicion_observada || '—'
                              })
                            ]
                          }),
                          Number(t.cantidad_afectada) > 0 &&
                            e.jsxs('span', {
                              children: [
                                'Afectadas: ',
                                e.jsxs('b', {
                                  className: 'text-amber-700',
                                  children: [t.cantidad_afectada, ' uds']
                                })
                              ]
                            }),
                          e.jsxs('span', {
                            children: [
                              'Motivo: ',
                              e.jsx('b', { className: 'text-slate-700', children: t.motivo || '—' })
                            ]
                          }),
                          t.observaciones &&
                            e.jsxs('span', {
                          ...
                          children: [
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsxs('select', {
                                  value: o.dictamen || '',
                                  onChange: (l) => p(t.id, { dictamen: l.target.value }),
                                  className:
                              ...
                              e.jsxs('div', {
                                children: [
                                  ...
                                  e.jsxs('select', {
                                    ...
                                    onChange: (l) => p(t.id, { bodegaDestino: l.target.value }),
                                    className:
                                      'block mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400',
                                    children: [
                                      e.jsx('option', { value: '', children: '— Elegir —' }),
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  value: o.acuse || '',
                                  onChange: (l) => p(t.id, { acuse: l.target.value }),
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsxs('select', {
                                  value: o.tipoAccion || '',
                                  onChange: (l) => {
                                    const h = Ge.find((v) => v.id === l.target.value);
                                    p(t.id, {
                                      tipoAccion: l.target.value,
                                      area: (h == null ? void 0 : h.area) || o.area
                                    });
                                  },
                                  className:
                                    'block mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400',
                                ...
                                children: [
                                  e.jsxs('div', {
                                    children: [
                                      ...
                                      e.jsxs('select', {
                                        value: o.area || '',
                                        onChange: (l) => p(t.id, { area: l.target.value }),
                                        className:
                                          'block mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400',
                                        children: [
                                          e.jsx('option', { value: '', children: '— Elegir —' }),
                                  ...
                                  e.jsxs('div', {
                                    children: [
                                      ...
                                      e.jsxs('select', {
                                        ...
                                        onChange: (l) => p(t.id, { prioridad: l.target.value }),
                                        className:
                                          'block mt-1 px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:border-emerald-400',
                                        children: [
                                          e.jsx('option', { value: 'NORMAL', children: 'Normal' }),
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsx('input', {
                                        value: o.descAccion || '',
                                        onChange: (l) => p(t.id, { descAccion: l.target.value }),
                                        placeholder:
                            ...
                            e.jsxs('button', {
                              onClick: () => L(t),
                              disabled: g.isPending || O.isPending,
                              className:
                              ...
                              children: [e.jsx(Pe, { size: 16 }), ' Dictaminar']
                            })
                          ]
                        })
                    ]
        ...
        f &&
          ...
          e.jsx('div', {
            ...
            children: e.jsxs('button', {
              onClick: async () => {
                try {
                  (await i.mutateAsync({ informeId: s.id, estado: 'DICTAMINADO' }),
                    I.success('Informe marcado como dictaminado'),
                    m());
                } catch (t) {
                  I.error(t.message);
                }
              ...
              children: [e.jsx(ka, { size: 16 }), ' Cerrar dictamen del informe']
            })
          })
      ]
    });
...
function Ut(s) {
  const m = Ve.find((d) => d.id === s);
  return (m == null ? void 0 : m.estado) || 'LIBERADO';
}
const to = () => {
  const [s, m] = xa(),
    { hasPermission: d, user: x } = ye(),
    y = d('manage_monitoreo') || d('manage_quality'),
    a = (x == null ? void 0 : x.rol) === 'ADMIN' || (x == null ? void 0 : x.es_admin_delegado),
    { data: u = [], isLoading: g } = Wa(),
    O = Qa(),
    [w, N] = b.useState('list'),
    [i, D] = b.useState(null),
    z = s.get('hito'),
    [p, L] = b.useState(z === '2' ? 'hito2' : z === '3' ? 'hito3' : 'hito1'),
    [M, _] = b.useState(null),
    [S, j] = b.useState(null),
    [t, o] = b.useState(''),
    n = Za(),
    ...
    h = Xa();
  b.useEffect(() => {
    L(z === '2' ? 'hito2' : z === '3' ? 'hito3' : 'hito1');
  }, [z]);
  const v = b.useCallback(
      (F) => {
        L(F);
        const K = new URLSearchParams(s);
        (K.set('hito', F.replace('hito', '')), m(K, { replace: !0 }));
      },
      [s, m]
    ),
    A = b.useMemo(() => {
  ...
  (Rs('tms_calidad_tareas', ['calidad_tareas'], { debounceMs: 400 }),
    Rs('tms_calidad_asignaciones', ['calidad_asignaciones'], { debounceMs: 400 }),
    b.useEffect(() => {
      if (w === 'detail' && i) {
        const F = u.find((K) => K.id === i.id);
        F && D(F);
      }
    }, [u]));
  const q = (F) => {
      (D(F), N(F.tipo_informe === 'DANOS' && y ? 'edit-danos' : 'detail'));
    },
    W = (F) => {
      (D(F), N(F.tipo_informe === 'DANOS' ? 'edit-danos' : 'edit'));
    },
    oe = async (F) => {
      if (confirm(`¿Eliminar el informe ${F.numero}? Esta acción no se puede deshacer.`))
        try {
          (await O.mutateAsync(F.id),
            I.success('Informe eliminado'),
            (i == null ? void 0 : i.id) === F.id && (D(null), N('list')));
        } catch (K) {
          I.error(`No se pudo eliminar: ${K.message}`);
        }
    },
    se = () => {
      (N('list'), D(null), _(null), j(null));
    },
    ae = (F) => {
      (D(null),
        _({
    ...
    le = async (F) => {
      try {
        const K = await Xs(F.id);
        (D(null), j({ ...F, ...K }), L('hito2'), N('new'));
      } catch (K) {
        I.error((K == null ? void 0 : K.message) || 'No se pudo abrir la tarea de Calidad');
      }
    };
  return e.jsxs('div', {
    ...
    children: [
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsx('div', {
                ...
                children: e.jsx(Us, { size: 30, strokeWidth: 2.4 })
              }),
              e.jsxs('div', {
                children: [
                  e.jsxs('h1', {
      ...
      w === 'list' &&
        e.jsx('div', {
          className:
            'quality-hito-nav mb-5 grid grid-cols-3 gap-2 rounded-3xl border border-slate-200/80 bg-white/90 p-2 shadow-sm backdrop-blur sm:flex sm:flex-wrap',
          children: [
            { id: 'hito1', n: 1, label: 'Recepción', sub: 'Ingreso a bodega', icon: _a, badge: n },
            {
              id: 'hito2',
              n: 2,
              label: 'Estancia',
            ...
            { id: 'hito3', n: 3, label: 'Salida', sub: 'Despacho', icon: Qe, badge: h }
          ].map((F) => {
            const K = F.icon,
              R = p === F.id;
            return e.jsxs(
              ...
              {
                onClick: () => v(F.id),
                className: `quality-hito-tab min-w-0 rounded-2xl border px-2 py-3 text-xs font-black transition-all sm:px-4 sm:py-2.5 sm:text-sm flex items-center justify-center gap-2 sm:gap-2.5 ${R ? 'border-emerald-600 bg-gradient-to-br from-emerald-500 to-emerald-700 text-white shadow-lg shadow-emerald-600/20' : 'border-transparent bg-slate-50 text-slate-600 hover:bg-slate-100'}`,
                children: [
                  e.jsx('span', {
                    className: `w-6 h-6 rounded-lg flex items-center justify-center text-[11px] ${R ? 'bg-white/20' : 'bg-slate-100 text-slate-500'}`,
                    children: F.n
                  }),
                  e.jsx(K, { size: 16, className: 'hidden shrink-0 sm:block' }),
                  e.jsxs('span', {
                    className: 'flex flex-col items-start leading-tight',
                    children: [
                      e.jsx('span', { children: F.label }),
                      e.jsx('span', {
                        className: `hidden text-[9px] font-bold sm:block ${R ? 'text-white/70' : 'text-slate-400'}`,
                        children: F.sub
                      })
                    ]
                  }),
                  F.badge > 0 &&
                    e.jsx('span', {
                      className: `text-[10px] font-black px-2 py-0.5 rounded-full ${R ? 'bg-white/25 text-white' : 'bg-amber-100 text-amber-700'}`,
                      children: F.badge
                    })
                ]
              },
      ...
      w === 'list' && p === 'hito1' && e.jsx(Rt, { onGenerarDanos: ae }),
      w === 'list' && p === 'hito3' && e.jsx(Tt, {}),
      w === 'new' &&
        e.jsx($s, {
      ...
      w === 'edit' && i && e.jsx($s, { informe: i, onCancel: se, onSaved: se }),
      w === 'new-danos' && e.jsx(Ps, { prefill: M, onCancel: se, onSaved: se }),
      w === 'edit-danos' && i && e.jsx(Ps, { informe: i, onCancel: se, onSaved: se }),
      w === 'detail' &&
        i &&
        e.jsx(Bt, { informe: i, onBack: se, onEdit: y ? W : null, onDelete: y ? oe : null }),
      w === 'list' &&
        p === 'hito2' &&
        e.jsx(Dt, { canAssign: a, canManageQuality: y, onGenerarInforme: le }),
      w === 'list' &&
        p === 'hito2' &&
        e.jsxs(e.Fragment, {
          children: [
                    ...
                    e.jsxs('div', {
                      children: [
                        ...
                        e.jsxs('h3', {
                          ...
                          children: [
                            e.jsx(Os, { size: 16, className: 'text-emerald-500' }),
            ...
            g
              ...
              : u.length === 0
                ? e.jsxs('div', {
                    ...
                    children: [
                      e.jsx(Os, { size: 44, className: 'text-slate-200 mb-4' }),
                      e.jsx('h3', {
                        className: 'text-base font-bold text-slate-400',
                            ...
                            children: [
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsx('span', {
                                    className: `text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border shrink-0 ${ca[F.estado] || ''}`,
                                    children: (R = F.estado) == null ? void 0 : R.replace('_', ' ')
                                  })
                                ]
                              }),
                              e.jsxs('button', {
                                ...
                                children: [
                                  e.jsx('div', {
                                    className: 'flex items-center gap-2 mb-2',
                                    children: e.jsx('span', {
                                      className: `text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-md border ${Ds[F.tipo_informe] || Ds.MONITOREO}`,
                                      children: K ? 'Daños' : 'Monitoreo'
                                    })
                                  }),
                                  e.jsxs('p', {
                                    className: 'text-sm text-slate-500 font-medium',
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    e.jsxs('button', {
                                      ...
                                      children: [e.jsx(Gs, { size: 14 }), ' Editar']
                                    }),
                                    e.jsxs('button', {
                                      onClick: () => oe(F),
                                      className:
