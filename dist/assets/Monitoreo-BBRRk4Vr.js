...
import { r as j, R as zs } from './react-vendor-6aw4XXjH.js';
import {
  X as Ie,
  R as Ne,
  ay as ca,
...
import { _ as je, u as ve, C as va } from './index-Pwuftu2X.js';
import { e as _a } from './exportExcel-D85v870c.js';
import { a as ls, s as is } from './storageUrl-Bw00GqOT.js';
import {
  E as Le,
  d as wa,
  u as ya,
  ...
  ae as dt,
  f as xt
} from './calidadService-J_Dg-qKj.js';
import { C as mt } from './CalidadBadge-BiQeYc4G.js';
import { f as ut } from './panelPtm-BOoEAF4f.js';
import { u as Es } from './useRealtimeTable-BTsMHpNn.js';
...
async function ft(s, d = [], l = []) {
  ...
  for (const v of d) {
    ...
    ((v.producto || v.codigo_producto) &&
      ...
      Number(v.cantidad) > 0 && I.push(`Cantidad: ${Number(v.cantidad)}`),
      v.ubicacion && I.push(`Ubicación: ${v.ubicacion}`),
      v.partida && I.push(`Lote: ${v.partida}`),
      v.tipo_dano && I.push(`Tipo de daño: ${v.tipo_dano}`),
      v.componente_afectado && I.push(`Componente afectado: ${v.componente_afectado}`),
      v.consecuencia && I.push(`Consecuencia: ${v.consecuencia}`),
      v.observaciones && I.push(`Observaciones: ${v.observaciones}`),
      I.forEach((J) => _.push(new t({ children: [new h(J)] }))));
    const Z = M[v.id] || [];
    for (const J of Z)
      try {
        const F = await bt(await Ys(J));
        (_.push(
          new t({
            children: [new z({ data: F, type: 'jpg', transformation: { width: 320, height: 240 } })]
          })
        ),
          J.descripcion &&
  ...
  const m = new E({
    ...
    n = await f.toBlob(m);
  gt(n, `${s.numero || 'Informe_Danos'}.docx`);
}
async function Nt(s, d = [], l = []) {
  ...
  f.createPdf(z).download(`${s.numero || 'Informe_Danos'}.pdf`);
}
function jt(s, d) {
  const l = URL.createObjectURL(s),
    c = document.createElement('a');
...
async function vt(s, d = []) {
  const l = await je(() => import('./index-BmpJy8SR.js'), []),
    ...
    { header: z, footer: N } = js(l, 'monitoreo'),
    b = ea(d),
    L = (a, m) =>
      new C({
        children: [
  ...
  const _ = new c({
      sections: [{ headers: { default: z }, footers: { default: N }, children: R }]
    }),
    o = await E.toBlob(_);
  jt(o, `${s.numero || 'Informe_Monitoreo'}.docx`);
}
...
const sa = { OK: 'Conforme', NO: 'No conforme', NA: 'N/A' },
  Ct = { IMPORTACION: 'Importación', NACIONAL: 'Nacional' };
function Pe(s, d = {}) {
...
async function ra(s, d = [], l = {}) {
    ...
    o = (D, V) =>
      new p({
        children: [
          new O({
            width: { size: 35, type: x.PERCENTAGE },
            children: [new t({ children: [new h({ text: D, bold: !0 })] })]
          }),
          new O({ width: { size: 65, type: x.PERCENTAGE }, children: [new t(String(V ?? '—'))] })
        ]
      }),
    a = (D) => new O({ children: [new t({ children: [new h({ text: D, bold: !0, size: 18 })] })] }),
    m = (D) =>
      new O({ children: [new t({ children: [new h({ text: String(D ?? '—'), size: 18 })] })] }),
    n = [];
  (n.push(new t({ text: aa(s, l), heading: u.TITLE, alignment: z.CENTER })),
    l.soloNoSanitario &&
      n.push(
        new t({
          alignment: z.CENTER,
  ...
  if (
    ...
    (Array.isArray(D.clasificacion) &&
      ...
      cs.forEach((Y) => {
        n.push(new t(`${D.clasificacion.includes(Y.id) ? '☑' : '☐'} ${Y.label}`));
      }),
      n.push(new t(''))),
      D.embalaje &&
        ...
        n.push(
          new C({
            width: { size: 100, type: x.PERCENTAGE },
            rows: ds.map((Y) => o(Y.label, D.embalaje[Y.id] || '—'))
          })
        ),
        n.push(new t(''))));
  ...
  if (M) {
    ...
    (((A = D.pesos) != null && A.esperado) || ((Q = D.pesos) != null && Q.registrado)) &&
      ...
      n.push(
        new C({
          ...
          rows: [
            o(
              'Peso esperado',
              (se = D.pesos) != null && se.esperado ? `${D.pesos.esperado} kg` : '—'
            ),
            o(
              'Peso registrado',
              (X = D.pesos) != null && X.registrado ? `${D.pesos.registrado} kg` : '—'
            ),
            o('Resultado', V || '—')
          ]
        })
      ...
      n.push(new t('')));
    const ee = Number(D.bultosTotal ?? s.bultos) || 0;
    if (ee > 0) {
      const Y = Array.isArray(D.bultosEtiquetas) ? D.bultosEtiquetas : [];
    ...
    (Array.isArray(D.riesgos) &&
      ...
      ps.forEach((Y) => {
        n.push(new t(`${D.riesgos.includes(Y.id) ? '☑' : '☐'} ${Y.label}`));
      }),
      n.push(new t(''))),
      Array.isArray(D.evidencias) &&
        ...
        ['PALLET', 'EMBALAJE', 'CAMION'].forEach((Y) => {
          const w = D.evidencias.filter((G) => G.tipo === Y).length;
  ...
  if (!M) {
    ...
    Array.isArray(D.evidencias) &&
      ...
      [...new Set(D.evidencias.map((V) => V.tipo))].forEach((V) => {
        const ee = D.evidencias.filter((Y) => Y.tipo === V).length;
...
async function na(s, d = [], l = {}) {
  ...
  const z = u && Array.isArray((b = s.contexto) == null ? void 0 : b.skus) ? s.contexto.skus : [];
  if (
    (z.length &&
            ...
            body: [
              ...
              ...a.params.map((m) => {
                ...
                return [
                  ...
                  { text: ((I = h[m.id]) == null ? void 0 : I.nota) || '', fontSize: 9 }
                ];
              })
            ]
          },
        ...
        x.push({
          table: {
            ...
            body: ds.map((v) => {
              ...
              return [
                { text: v.label, bold: !0 },
                { text: g, bold: !0, color: g === '—' ? '#64748b' : I ? '#be123c' : '#047857' }
              ];
            })
          },
          layout: 'lightHorizontalLines',
      ...
      (x.push({ text: 'Verificación de bultos', style: 'h2' }),
        x.push({
          table: {
            ...
            widths: ['auto', '*'],
            body: [
              ['Bulto', 'Etiqueta'].map((I) => ({ text: I, bold: !0, fontSize: 9 })),
              ...Array.from({ length: Math.min(n, 60) }, (I, Z) => [
                { text: `Bulto ${Z + 1}/${n}`, fontSize: 9 },
                {
                  text: g[Z] ? 'Etiqueta OK' : 'Pendiente',
                  fontSize: 9,
                  bold: !0,
                  color: g[Z] ? '#047857' : '#b45309'
                }
              ])
            ]
          },
      ...
      x.push({
        columns: [0, 1].map((g) => ({
          stack: ps
            .filter((I, Z) => Z % 2 === g)
            .map((I) => ({
              text: `${a.riesgos.includes(I.id) ? '☑' : '☐'} ${I.label}`,
              fontSize: 9,
              margin: [0, 1, 0, 1]
            }))
        })),
    ...
    if (v.length || (Array.isArray(a.evidencias) && a.evidencias.length))
      if ((x.push({ text: 'Evidencia fotográfica', style: 'h2' }), v.length))
        for (let g = 0; g < v.length; g += 2)
          x.push({
            columns: v.slice(g, g + 2).map((I) => ({
              width: '50%',
              stack: [
                { image: I.dataUrl, fit: [230, 160] },
                { text: Ke[I.tipo] || I.tipo, fontSize: 8, color: '#64748b', margin: [0, 2, 0, 0] }
              ]
            })),
            columnGap: 12,
            margin: [0, 0, 0, 8]
...
const kt = (s) => ({
  ...
  Et = ({ tarea: s, onBack: d, canManage: l, onGenerarDanos: c }) => {
    var ie, i, $, U;
    const { user: E } = ve(),
      f = Vs(),
      t = Ks(),
      ...
      [x, z] = j.useState(() => O(s.checklist).resp),
    ...
    j.useEffect(() => {
      ...
      (z(r), b(k), P(s.observaciones || ''), R(s.disposicion || ''));
    }, [s.id]);
    const _ = (r, k) => z((B) => ({ ...B, [r]: { ...B[r], estado: k } })),
      o = (r, k) => z((B) => ({ ...B, [r]: { ...B[r], nota: k } })),
      a = (r, k) => z((B) => ({ ...B, [r]: { ...B[r], evidencia: k } })),
      m = (r, k) => b((B) => ({ ...B, [r]: k })),
      n = (r = N) => ({ ...x, _extras: r }),
      v = (r) =>
        b((k) => {
      ...
      I = !!(h != null && h.solo_no_sanitario),
      Z = (h == null ? void 0 : h.sin_clasificar) || 0,
      J = j.useMemo(() => {
        const r = g.filter((k) => (k.params || []).length > 0).map(kt);
        return [...Ea, ...r];
      }, [g]),
      ...
      X = async (r) => {
        try {
          const k = { categorias: g, soloNoSanitario: I };
          if (r === 'pdf') {
      ...
      V = async () => {
        ...
        if (!W) {
          S.error(`Faltan ${Q} ítem(s) por responder`);
          return;
        }
    ...
    const te = (r, k = 'galeria') => {
        var B;
        (we(r), k === 'camara' ? _e(!0) : (B = ae.current) == null || B.click());
      },
      oe = async (r) => {
        var B;
            ...
            !p &&
              e.jsxs('div', {
                ...
                children: [
                  ...
                  e.jsxs('button', {
                    type: 'button',
                    onClick: () => m('embalaje', { ...re, ...ks.conforme }),
                    className:
                  ...
                  e.jsxs('button', {
                    type: 'button',
                    onClick: () => m('embalaje', { ...re, ...ks.sinPallet }),
                    className:
                ...
                children:
                  Q > 0
                    ? e.jsxs('span', {
                        ...
                        children: [Q, ' ítem(s) por responder']
                      })
                    : A
                      ? e.jsx('span', {
  ...
  At = ({ onGenerarDanos: s }) => {
    ...
    return R
      ? e.jsx(Et, { tarea: R, onBack: () => O(null), canManage: c, onGenerarDanos: s })
      : e.jsxs('div', {
          children: [
            e.jsxs('div', {
              className:
  ...
  St = ({ canAssign: s, canManageQuality: d, onGenerarInforme: l }) => {
    const { user: c } = ve(),
      ...
      z = f.filter((N) => N.estado === 'PENDIENTE' || N.estado === 'EN_PROCESO').length;
    return e.jsxs('div', {
      className: 'mb-6',
      children: [
        e.jsxs('div', {
        ...
        C && e.jsx(Ot, { onClose: () => p(!1) })
      ]
    });
  },
  Rt = ({ onClose: s, onCreated: d }) => {
    const l = Ua(),
      [c, E] = j.useState(''),
      [f, t] = j.useState(''),
      [h, u] = j.useState(''),
      ...
      g = (A) => {
        ...
        return (
          (A || []).forEach((se) => {
            const X = `${se.codigo_producto}|${se.partida || ''}`,
              D = Q.get(X);
            D
              ? (D.disponible = Number(D.disponible || 0) + (Number(se.disponible) || 0))
              : Q.set(X, { ...se, ubicacion: '', disponible: Number(se.disponible) || 0 });
          }),
          [...Q.values()]
        );
      },
      I = j.useCallback(async () => {
        L(!0);
        try {
          M(g(await Ba(z)));
        } catch (A) {
      ...
      Z = (A) => `${A.codigo_producto}|${A.partida || ''}`,
      J = (A) => {
        const Q = Z(A);
        if (R.some((se) => se._key === Q)) {
        ...
        _((se) => [
          ...se,
          {
            ...
            ubicacion: '',
            partida: A.partida || '',
            cantidad: Number(A.disponible) > 0 ? Number(A.disponible) : 1,
            unidad_medida: A.unidad_medida || 'UN'
          }
        ]);
      },
      F = (A) => _((Q) => Q.filter((se) => se._key !== A)),
      W = async () => {
        if (!c.trim()) {
                                ...
                                e.jsxs('label', {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('input', {
                                      ...
                                      value: A.cantidad,
                                      onChange: (Q) => {
                                        const se = Math.max(1, Number(Q.target.value) || 1);
                                        _((X) =>
                                          X.map((D) =>
                                            D._key === A._key ? { ...D, cantidad: se } : D
                                          )
                                        );
                                      },
                                      className:
  ...
  Dt = ({ tarea: s, onBack: d, canManage: l }) => {
    const c = Vs(),
      E = Ks(),
      ...
      [z, N] = j.useState(s.observaciones || ''),
    ...
    const P = (y, T) => p((H) => ({ ...H, [y]: { ...H[y], estado: T } })),
      ...
      _ = (y, T) => x((H) => ({ ...H, [y]: T })),
      {
        ...
        let y = 0,
          T = !1;
        for (const te of Qe) {
          const oe = (H = C[te.id]) == null ? void 0 : H.estado;
          (oe && y++, oe === 'NO' && (T = !0));
        }
          ...
          if (y === 'pdf') {
            ...
            for (const oe of H)
              try {
                ...
                te.push({ tipo: oe.tipo, dataUrl: i });
              } catch {}
            ((T.evidenciasImg = te), await na(s, Ze, T));
    ...
    const w = (y, T = 'galeria') => {
        var H;
        (se(y), T === 'camara' ? W(!0) : (H = J.current) == null || H.click());
      },
      G = async (y) => {
        var H;
        const T = Array.from(y.target.files || []);
        if (((y.target.value = ''), !(!T.length || !Q))) {
          D(!0);
          try {
            const te = [];
            for (const oe of T) {
              if (!oe.type.startsWith('image/')) continue;
              const xe = await vs(oe),
                ie = await Ga({ tareaId: s.id, tipo: Q, blob: xe });
              te.push({ tipo: Q, path: ie, subido_en: new Date().toISOString() });
            }
            if (te.length) {
              const oe = { ...O, evidencias: [...Y, ...te] };
              (x(oe),
                await c.mutateAsync({
                  tareaId: s.id,
                  checklist: g(oe),
                ...
                S.success(
                  te.length > 1 ? 'Fotos agregadas al certificado' : 'Foto agregada al certificado'
                ));
            }
          } catch (te) {
            S.error(
              (H = te == null ? void 0 : te.message) != null && H.includes('row-level security')
                ? 'No tienes permiso para subir fotos'
                : `Error al subir: ${te.message}`
            );
          } finally {
            (D(!1), se(null));
          }
      ...
      _e = (y) => {
        const T = Array.from({ length: ae }, (H, te) => !!de[te]);
      ...
      we = f
        ...
        : o
          ? a
            ...
            : { ...Ue.VERDE }
          : { ...Ue.PENDIENTE },
      he = ({ pid: y, val: T, icon: H, activeCls: te }) => {
        var xe;
        ...
        return e.jsx('button', {
          ...
          onClick: () => P(y, T),
          className: `w-9 h-9 rounded-lg border flex items-center justify-center transition-colors shrink-0
          ${oe ? te : 'bg-white border-slate-200 text-slate-300 hover:border-slate-300'} ${t ? 'opacity-60 cursor-default' : ''}`,
          children: H
        });
      },
      ye = De[s.estado] || {};
                                  ...
                                  ((H = C[T.id]) == null ? void 0 : H.estado) &&
                                    e.jsxs('div', {
                                      ...
                                      children: [
                                        ...
                                        e.jsxs('select', {
                                          value:
                                            ((te = C[T.id]) == null ? void 0 : te.evidencia) || '',
                                          disabled: t,
                ...
                ae > 0
                  ? e.jsxs(e.Fragment, {
                      children: [
                        e.jsx('div', {
                          className: 'flex flex-wrap gap-2',
                          children: Array.from({ length: Math.min(ae, 60) }, (y, T) =>
                            e.jsxs(
                              'button',
                              {
                                type: 'button',
                        ...
                        e.jsxs('p', {
                          ...
                          children: [
                            de.slice(0, ae).filter(Boolean).length,
                            '/',
                            ae,
  ...
  It = () => {
    const { hasPermission: s, user: d } = ve(),
      ...
      R = j.useMemo(() => {
        const o = z.trim().toLocaleLowerCase('es-CL');
        return E.filter((a) => {
          const m = a.contexto || {};
          return (
            (!o ||
    ...
    return _
      ? e.jsx(Dt, { tarea: _, onBack: () => p(null), canManage: l })
      : e.jsxs('div', {
          children: [
            e.jsxs('div', {
              className:
  ...
  Tt = ({ codigo: s, value: d, onSelect: l }) => {
    ...
    (j.useEffect(() => {
      ...
      j.useEffect(() => {
        ...
        return (
          c && document.addEventListener('mousedown', z),
          () => document.removeEventListener('mousedown', z)
        );
      }, [c]));
    const x = (z) => {
      (l(z.valor, z.ubicacion || ''), E(!1), t(''));
    };
    return e.jsxs('div', {
      className: 'relative',
      ref: O,
                    ...
                    : h.map((z, N) =>
                        e.jsxs(
                          'button',
                          {
                            ...
                            children: [
                              e.jsx('span', {
                                className: `text-[9px] font-black px-1.5 py-0.5 rounded ${z.tipo === 'P' ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'}`,
                                children: z.tipo === 'P' ? 'LOTE' : 'SERIE'
                              }),
                              e.jsx('span', {
                                className:
                              ...
                              z.ubicacion &&
                                e.jsx('span', {
                                  ...
                                  children: z.ubicacion
                                }),
                              e.jsx('span', {
                                className: `text-xs font-bold shrink-0 ${Number(z.disponible) > 0 ? 'text-emerald-600' : 'text-slate-300'}`,
                                children: Number(z.disponible) || 0
                              })
                            ]
                          },
                          N
  ...
  Lt = ({ item: s, onChange: d }) => {
    const l = s.batch_source || (s.partida ? 'system' : 'none'),
      ...
      E = (t) => {
        ...
        (t === 'not_found' &&
          ...
          (h.observaciones = [(u = s.observaciones) == null ? void 0 : u.trim(), Ss]
            .filter(Boolean)
            .join(' · ')),
          d(h));
      },
    ...
    return e.jsxs('div', {
      ...
      children: [
        ...
        l === 'system' && e.jsx(Tt, { codigo: s.codigo_producto, value: c, onSelect: f }),
        l === 'manual' &&
          e.jsx('input', {
            value: c,
  ...
  Rs = ({
    ...
    const { user: t } = ve(),
      ...
      [z, N] = j.useState((s == null ? void 0 : s.bodega) || ''),
      ...
      [W, A] = j.useState([]),
      [Q, se] = j.useState(!x),
      [X, D] = j.useState({ status: 'idle', savedAt: null, error: '' }),
      [V, ee] = j.useState(
        x
          ? {
              name:
    ...
    const G = j.useCallback(async () => {
      ...
      ae = (i, $, U) => {
        Z((r) => r.map((k) => (k._key === i ? { ...k, [$]: U } : k)));
      },
      de = (i, $) => {
        Z((U) => U.map((r) => (r._key === i ? { ...r, ...$ } : r)));
      },
      _e = (i, $) =>
        Z((U) =>
          U.map((r) =>
      ...
      be = (i) => {
        (Z(($) => $.filter((U) => U._key !== i)), A(($) => $.filter((U) => U !== i)));
      },
      le = (i) => A(($) => ($.includes(i) ? $.filter((U) => U !== i) : [...$, i])),
      we = () => A((i) => (i.length === I.length ? [] : I.map(($) => $._key))),
      he = (i) => {
        if (W.length === 0) {
      ...
      ye = j.useMemo(
        () => ({
          ...
          header: { bodega: z, periodicidad: b, observaciones: P },
          items: I,
          selected_sku_ids: W
        }),
        [z, I, P, b, W]
    ...
    j.useEffect(() => {
      if (!x || !Q || X.status === 'conflict') return;
      D(($) => ({ ...$, status: 'pending', error: '' }));
      const i = window.setTimeout(async () => {
        D(($) => ({ ...$, status: 'saving', error: '' }));
        try {
          const $ = await Za(x, ye);
          (D({
            status: 'saved',
    ...
    const y = async () => {
      ...
      T = async (i) => {
        ...
        if (i === 'ENVIADO_CALIDAD') {
          const U = I.filter((B) => !(B.ubicacion || '').trim());
          if (U.length > 0) {
          ...
          const k = I.filter((B) => B.revision_estado === 'PENDIENTE');
          if (x && k.length > 0) {
            S.error(`Aún faltan ${k.length} SKU(s) por aprobar o rechazar.`);
            return;
          }
        }
        const $ = I.map(({ _key: U, ...r }) => r);
        try {
          if (x) {
            const r = await Zs(x);
            ee({
          ...
          let U = u ? s.id : null;
          if (u) {
            const r = { bodega: z || null, periodicidad: b, estado: i, observaciones: P || null };
      ...
      H = I.filter((i) => !(i.ubicacion || '').trim()).length,
      te = I.filter((i) => i.revision_estado !== 'PENDIENTE').length,
      oe = I.length > 0 ? Math.round((te / I.length) * 100) : 0,
      xe = (i, $) =>
        $
          ? i === 'OK'
                ...
                e.jsxs('div', {
                  ...
                  children: [
                    e.jsxs('h3', {
                      ...
                      children: ['Ítems del informe (', I.length, ')']
                    }),
                    e.jsxs('div', {
                      className: 'flex items-center gap-2',
                      children: [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx('div', {
                                    ...
                                    children: e.jsx(Lt, { item: i, onChange: (r) => de(i._key, r) })
                                  }),
                                  e.jsxs('div', {
                                    className: 'col-span-2',
                                    children: [
  ...
  Is = ({ informe: s, prefill: d, onCancel: l, onSaved: c }) => {
    ...
    const { user: E } = ve(),
      ...
      [x, z] = j.useState((s == null ? void 0 : s.bodega) || ''),
    ...
    const m = (w, G) => P((q) => ({ ...q, [w]: G })),
      ...
      v = (w, G, q) => R((re) => re.map((ae) => (ae._key === w ? { ...ae, [G]: q } : ae))),
      ...
      Z = (w, G, q) =>
        P((re) => ({
          ...re,
          cuadro_resumen: re.cuadro_resumen.map((ae, de) => (de === w ? { ...ae, [G]: q } : ae))
        })),
      ...
      W = (w, G) =>
        P((q) => ({
          ...q,
          acciones_recomendadas: q.acciones_recomendadas.map((re, ae) => (ae === w ? G : re))
        })),
      A = (w) =>
        P((G) => ({
          ...G,
      ...
      Q = async (w) => {
        ...
        try {
          const q = u
            ...
            ae = await f.mutateAsync({ informeId: u, cabecera: q, reporte: L, hallazgos: re });
          (C(ae.id),
            ae.numero && O(ae.numero),
            b(G),
            R(ae.hallazgos.map((de) => ({ ...de, _key: de.id }))),
            o(),
      ...
      X = async (w) => {
        ...
        try {
          w === 'word' ? await ft(se, M, _) : await Nt(se, M, _);
        } catch (G) {
  ...
  Pt = ({ informe: s, onBack: d, onEdit: l, onDelete: c }) => {
    var _;
    const { hasPermission: E } = ve(),
      f = E('manage_quality'),
      { data: t = [], isLoading: h } = bs(s.id),
      u = st(),
      C = at(),
      { data: p = [] } = tt(),
      { data: O = [] } = ot(),
      ...
      L = async (o) => {
        ...
        try {
          if (
            ...
            const v = Be.find((I) => I.id === a.tipoAccion),
            ...
            try {
              ...
              S.success(
                `Acción promulgada ${(I == null ? void 0 : I.folio) || ''} → ${((n = p.find((Z) => Z.codigo === g)) == null ? void 0 : n.label) || g}`
              );
            } catch (I) {
              S.error(`Dictamen OK, pero no se pudo crear la acción: ${I.message}`);
            }
          }
        } catch (v) {
        ...
        const o = t.map((g) => ({
          ...
          v = [
            ...
            ...['ROJO', 'NARANJA', 'VERDE', 'NA'].map((g) => ({
              Campo: `Semáforo ${g}`,
              Valor: a((I) => I.semaforo === g)
            })),
            { Campo: '— Por dictamen —', Valor: '' },
            ...m.map((g) => ({ Campo: g, Valor: a((I) => I.dictamen === g) })),
            { Campo: '— Por condición —', Valor: '' },
            ...n.map((g) => ({ Campo: g, Valor: a((I) => I.condicion_observada === g) }))
          ];
        _a({
...
const Xt = () => {
  const { hasPermission: s, user: d } = ve(),
    ...
    { data: f = [], isLoading: t } = Ha(),
    h = Va(),
    [u, C] = j.useState('list'),
    [p, O] = j.useState(null),
    [x, z] = j.useState('hito1'),
    [N, b] = j.useState(null),
    [L, P] = j.useState(null),
    [M, R] = j.useState(''),
    _ = Ka(),
  ...
  return e.jsxs('div', {
    ...
    children: [
      ...
      u === 'list' && x === 'hito1' && e.jsx(At, { onGenerarDanos: Z }),
      u === 'list' && x === 'hito3' && e.jsx(It, {}),
      u === 'new' &&
        e.jsx(Rs, {
      ...
      u === 'edit' && p && e.jsx(Rs, { informe: p, onCancel: I, onSaved: I }),
      u === 'new-danos' && e.jsx(Is, { prefill: N, onCancel: I, onSaved: I }),
      u === 'edit-danos' && p && e.jsx(Is, { informe: p, onCancel: I, onSaved: I }),
      u === 'detail' &&
        p &&
        e.jsx(Pt, { informe: p, onBack: I, onEdit: l ? v : null, onDelete: l ? g : null }),
      u === 'list' &&
        x === 'hito2' &&
        e.jsx(St, { canAssign: E, canManageQuality: l, onGenerarInforme: J }),
      u === 'list' &&
        x === 'hito2' &&
        e.jsxs(e.Fragment, {
          children: [
