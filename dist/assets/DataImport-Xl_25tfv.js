...
import { u as Ft, s as V } from './index-BGSkqVb2.js';
import {
  n as pt,
  q as Ve,
  ak as Ot,
...
import { u as es } from './useBarcodeScanner-DTxRt-wM.js';
...
function ts(l, C = 0) {
  ...
  const B = be(l.accepted ?? l.inserted),
    L = be(l.skipped ?? l.errors),
    z = be(l.total) || B + L || be(C);
  return { accepted: B, skipped: L, total: z, error: l.error || null };
}
const ge = [
    {
      ...
      G = (c) => {
        F((f) =>
          f.map((D) => {
            if (D.id !== c) return D;
            const R =
              (Array.isArray(D.import_tabs) ? D.import_tabs : []).length === Ue.length
                ? []
                : [...Ue];
  ...
  us = () => {
    ...
    const { user: l } = Ft(),
      [C, F] = i.useState(null),
      [Z, B] = i.useState(!1),
      L = wt.includes(l == null ? void 0 : l.rol);
    i.useEffect(() => {
      if (l != null && l.rol) {
        if (L) {
          F('*');
...
`
          ...
          if ((Ge(S.length - v.length), R(v), o.smartDedup && o.uniqueKey && v.length > 0))
            try {
              ...
              const x = r.map((h) => V.from(o.table).select(Q).in(j, h).limit(h.length)),
                q =
...
¿Continuar?`)
            ...
            try {
              ...
              let Q = 0;
              (n.forEach((r, x) => {
                (w[x] === 'new' || w[x] === 'update') && ((K[x] = Q < d ? 'loaded' : 'error'), Q++);
              }),
                H(K));
      ...
      Ie = Oe.find((t) => t.id === J),
      Ut = jt[(Ie == null ? void 0 : Ie.color) || 'slate'];
    return C === null
      ? e.jsx('div', {
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            e.jsxs('div', {
                              ...
                              children: [
                                e.jsx('div', {
                                  className: `w-8 h-8 rounded-lg ${Ut.active} flex items-center justify-center shrink-0`,
                              ...
                              e.jsxs('label', {
                                ...
                                children: [
                                  e.jsx('input', {
                                    ...
                                    checked: ze,
                                    onChange: (t) => {
                                      (Ye(t.target.checked), f && setTimeout(() => ke(f), 50));
                                    },
                                    className:
                                  ...
                                  _t &&
                                    e.jsx('button', {
                                      ...
                                      children: tt
                                        ...
                                        : e.jsxs(e.Fragment, {
                                            children: [e.jsx(Yt, { size: 20 }), ' Abrir Cámara']
                                          })
                                    }),
                                  e.jsxs('div', {
                                    className: 'flex items-center gap-2',
                      ...
                      children: [
                        ...
                        I &&
                          e.jsxs('div', {
                            ...
                            children: [
                              ...
                              xe.count > 0 &&
                                e.jsxs('div', {
                                  className: `flex items-start gap-2 rounded-xl px-4 py-3 text-sm ${U ? 'bg-red-100 border-2 border-red-400 text-red-900' : 'bg-amber-50 border border-amber-200 text-amber-900'}`,
                                  children: [
                                    e.jsx(X, {
                                      size: 18,
                                      className: `shrink-0 mt-0.5 ${U ? 'text-red-600' : 'text-amber-500'}`
                                    }),
                                    e.jsxs('span', {
                                      children: [
                                        U
                        ...
                        e.jsxs('div', {
                          ...
                          children: [
                            ...
                            e.jsxs('button', {
                              onClick: Mt,
                              disabled: ne || U || (A.new === 0 && A.update === 0 && !(I && se)),
                              title: U
                      ...
                      children: e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('div', {
                            ...
                            children: $.success ? e.jsx(Le, { size: 32 }) : e.jsx(X, { size: 32 })
                          }),
                          e.jsx('h2', {
                            className: 'text-lg font-extrabold text-slate-900 mb-2',
  ...
  le = ({ icon: l, label: C, value: F, color: Z }) => {
    const B = {
    ...
    return e.jsxs('div', {
      className: `flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-bold ${B[Z]}`,
      children: [
        e.jsx(l, { size: 13 }),
