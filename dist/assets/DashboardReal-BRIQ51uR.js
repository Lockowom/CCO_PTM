...
`),
  ...
  ((d.href = o), (d.download = `NVs_${h}_${x}.csv`), d.click(), URL.revokeObjectURL(o));
}
const u = 'bg-white',
  w = 'bg-blue-50/60',
  N = 'bg-amber-50/60';
                                ...
                                'tr',
                                {
                                  ...
                                  children: [
                                    ...
                                    e.jsx('td', {
                                      ...
                                      children: T(a.fecha_registro_nv)
                                    }),
                                    e.jsx('td', {
                                      className: `${w} px-3 py-2 whitespace-nowrap`,
                                      children: T(a.fecha_aprobacion)
                                    }),
                                    e.jsx('td', {
                                      className: `${w} px-3 py-2 whitespace-nowrap`,
                                      children: T(a.fecha_aprobacion_real)
                                    }),
                                    e.jsx('td', {
                                      className: `${w} px-3 py-2 text-center`,
                                      children:
                                      ...
                                      children:
                                        a.dias_atraso_ingreso > 0
                                          ? e.jsx('span', {
                                              ...
                                              children: T(a.fecha_promesa_efectiva)
                                            })
                                          : T(a.fecha_promesa_efectiva)
                                    }),
                                    e.jsx('td', {
                                      className: `${N} px-3 py-2 text-center`,
                                      children:
      ...
      const g = performance.now(),
        A = (S) => {
          const E = S - g,
            _ = Math.min(E / t, 1),
            L = x + i * js(_);
          (o(L.toFixed(n)), _ < 1 ? (h.current = requestAnimationFrame(A)) : (d.current = s));
        };
...
function gs({ children: s, glowColor: t = '245,124,0', className: n = '', onClick: r }) {
  const a = l.useRef(null),
    c = (f) => {
      ...
      (o.style.setProperty('--mx', `${f.clientX - d.left}px`),
        o.style.setProperty('--my', `${f.clientY - d.top}px`));
    };
  return e.jsxs('div', {
    ref: a,
    onMouseMove: c,
...
function Ns({ title: s, value: t, subtitle: n, color: r = '#f57c00', icon: a, onClick: c }) {
  const f = typeof t == 'number',
    o = typeof t == 'string' && /^\d+([.,]\d+)?%$/.test(t),
    d = f ? t : o ? parseFloat(t.replace(',', '.')) : null;
  return e.jsxs(gs, {
    glowColor: Ke(r),
    onClick: c,
    ...
    children: [
      ...
      e.jsx('div', {
        ...
        style: { color: r },
        children: d !== null ? e.jsx(bs, { end: d, decimals: o ? 1 : 0, suffix: o ? '%' : '' }) : t
      }),
...
const P = l.memo(Ns);
function ys({ kpis: s, onDetalle: t }) {
  return e.jsxs('div', {
...
function As({
    ...
    S = l.useCallback(
      (y) => {
        ...
        const V = R.getBoundingClientRect(),
          C = (y - V.left) / V.width,
          z = Math.max(0, Math.min(1, C));
        C < 0 ? g(Math.max(-1, C * 2)) : C > 1 ? g(Math.min(1, (C - 1) * 2)) : g(0);
        const U = s + z * (t - s),
          B = Math.round(U / n) * n;
        return Math.max(s, Math.min(t, B));
      },
      [s, t, n, r]
    ),
    E = (y) => {
      (x(!0), y.target.setPointerCapture(y.pointerId), a(S(y.clientX)));
    },
    _ = (y) => {
      h && a(S(y.clientX));
    },
  ...
  const F = i !== 0 ? `scaleX(${1 + Math.abs(i) * 0.04}) translateX(${i * 6}px)` : 'scaleX(1)';
  return e.jsxs('div', {
...
function Is() {
  const [s, t] = l.useState(null),
    ...
    I = l.useCallback(
      async (m) => {
        (re(m), ce(!0));
        try {
          const b = await Ge(m, j.from, j.to);
          le(b);
        } catch (b) {
    ...
    Pe = l.useCallback(async () => {
      (de(!0), xe(!0));
      try {
        const m = await Xe(j.from, j.to);
        oe(m);
      } catch (m) {
        (console.error('Error cargando incidencias:', m), oe([]));
      }
      xe(!1);
    }, [j]),
    v = l.useCallback(async (m, b) => {
      (se(!0), ae(null), $e({ from: m, to: b }));
      try {
        const p = await He(m, b);
        (t(p.kpis),
          r(p.estadoTable),
          c(p.divisions),
          o(p.transportistas),
          ...
          E(p.tiemposCiclo),
          L(p.otif),
          y(p.rankingTransportistas),
          V(p.rankingVendedores),
          z(p.incidenciasPorVendedor || []),
          B(p.alertasOperacionales),
          Ie(p.alertas),
          Oe(p.calidad),
  ...
  (l.useEffect(() => {
    ...
    l.useEffect(() => {
      ...
      let m = null;
      const b = () => {
          (m && clearTimeout(m), (m = setTimeout(() => v(G.current.from, G.current.to), 2500)));
        },
        p = X.channel('tms-oper-changes')
          ...
          .subscribe();
      return () => {
        (m && clearTimeout(m), X.removeChannel(p));
      };
    }, [v]));
  const [ue, O] = l.useState(120),
    k = l.useRef(120);
  return (
    l.useEffect(() => {
      ((k.current = 120), O(120));
      const m = setInterval(() => {
        ((k.current -= 1),
          O(k.current),
          k.current <= 0 && ((k.current = 120), O(120), v(j.from, j.to)));
      }, 1e3);
            ...
            children: [
                ...
                children: e.jsxs('div', {
                  ...
                  children: [
                    ...
                    e.jsxs('div', {
                      className: 'flex items-center gap-4',
                      children: [
                        e.jsx(ls, { onFilter: v, defaultFrom: Z, defaultTo: ee }),
                        e.jsxs('button', {
                          onClick: () => {
                            ((k.current = 120), O(120), v(j.from, j.to));
                          },
                          disabled: D,
                          className:
              ...
              e.jsxs('main', {
                ...
                children: [
                  ...
                  e.jsx(us, { kpis: s, onSelect: I }),
                  e.jsx(ys, { kpis: s, onDetalle: I }),
                  ...
                  e.jsxs('div', {
                    ...
                    children: [
                      e.jsxs('div', {
                        className: 'space-y-4',
                        children: [
                          e.jsx(Qe, { data: n, onSelectEstado: I }),
                          e.jsx('div', {
                            className: 'table-container',
                            children: e.jsxs('table', {
                              children: [
                                    ...
                                    e.jsxs(
                                      'tr',
                                      {
                                        ...
                                        children: [
                                          ...
                                          e.jsx('td', { className: 'font-bold', children: m.count })
                                        ]
                                      },
                                      m.estado
                                    )
                  ...
                  e.jsx(ws, { tiemposCiclo: S }),
                  e.jsx(Cs, { alertasOp: U }),
                  e.jsx(Ss, { data: C, onOpenIncidencias: Pe }),
                  e.jsx(Ts, { rankTransp: F, rankVend: R }),
                  e.jsx(ks, { auditKpis: Ae }),
                  e.jsx($s, { divisions: a }),
                  e.jsx(Es, { tendencia: Te }),
                  e.jsxs('div', {
              ...
              ne && e.jsx(is, { estado: ne, data: Ee, loading: _e, onClose: () => re(null) }),
