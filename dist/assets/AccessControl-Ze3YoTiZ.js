import { u as Ss, d as Ee, c as Re, j as e } from './query-vendor-BNjBrM5A.js';
import { s as F, f as zs, A as ss, g as is, u as Ke } from './index-CyF0yQ6M.js';
import { r as n, R as Q, e as Gs, u as Bs } from './react-vendor-6aw4XXjH.js';
import { u as Vs, g as Ks } from './animation-vendor-JfdD7EdN.js';
import {
  I as H,
  R as re,
  b9 as Js,
    ...
    const Y = Q.useCallback(
      ...
      Se = (a) => {
        switch (a == null ? void 0 : a.toUpperCase()) {
          ...
          case 'SUPERVISOR':
            return e.jsx(We, { size: 14 });
          case 'OPERADOR':
            return e.jsx(Zs, { size: 14 });
          default:
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsxs('button', {
                  ...
                  children: [e.jsx(Js, { size: 20 }), ' Nuevo Usuario']
                })
              ]
            })
          ]
                                    ...
                                    children: [
                                      ...
                                      e.jsx('td', {
                                        ...
                                        children: e.jsxs('span', {
                                          ...
                                          children: [
                                            e.jsx(Be, { size: 12, className: 'text-slate-300' }),
                                            js(a.last_seen)
                                          ]
                                        })
                                      }),
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Ve, { size: 16 }), ' Editar']
                                      }),
                                      e.jsx('button', {
                                        onClick: () => $e(a.id),
                                        className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('button', {
                                  ...
                                  children: C ? e.jsx(Ys, { size: 20 }) : e.jsx(Xs, { size: 20 })
                                })
                              ]
                            })
                          ]
                                ...
                                e.jsxs('div', {
                                  ...
                                  children: [
                                    ...
                                    e.jsxs('span', {
                                      ...
                                      children: ['Editar ', e.jsx(Ve, { size: 16 })]
                                    })
                                  ]
                                })
                              ]
                                ...
                                : e.jsxs(e.Fragment, {
                                    children: [
                                      ...
                                      e.jsxs('button', {
                                        ...
                                        children: [e.jsx(Ve, { size: 20 }), ' Editar Permisos']
                                      })
                                    ]
                                  })
                            })
                          ...
                          children: [
                            ...
                            Ns(t.expires_at) &&
                              e.jsxs('span', {
                                ...
                                children: [e.jsx(Be, { size: 10 }), ' expira ', Ns(t.expires_at)]
                              }),
                            l &&
                              e.jsx('button', {
                                onClick: () => D(t.id),
                  ...
                  children: [
                    m.tipo === 'add'
                      ...
                      : m.tipo === 'del'
                        ...
                        : e.jsx(Os, { size: 11, className: 'text-amber-500 mt-0.5 shrink-0' }),
                    e.jsx('span', {
          ...
          e.jsxs('div', {
            ...
            children: [
              e.jsxs('div', {
                className: 'flex items-center gap-2',
                children: [
                  e.jsx(Ts, { size: 16, className: 'text-orange-500' }),
                  e.jsx('h3', {
                    className: 'text-[12px] font-black text-slate-600 uppercase tracking-wide',
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('button', {
                ...
                children: [e.jsx(ls, { size: 15 }), ' ', T ? 'Evaluando…' : 'Evaluar']
              })
            ]
          }),
          y &&
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          p.ultimo &&
            e.jsxs('span', {
              className: 'ml-auto text-[11px] text-slate-400 inline-flex items-center gap-1.5',
              children: [e.jsx(Be, { size: 12 }), ' último ingreso ', ys(p.ultimo)]
            })
        ]
      }),
      e.jsx('div', {
...
function kt() {
  ...
  const { hasPermission: r, user: c } = Ke(),
    ...
    [A, P] = n.useState(''),
    [R, we] = n.useState(''),
    [W, Qe] = n.useState({ role: '', scopeType: 'global', scopeCode: '' }),
    ...
    $ = n.useCallback(async () => {
      (_e(!0), Pe(null));
      try {
        const [s, o, g] = await Promise.all([Oa(), Ta(), qa()]);
    ...
    J = n.useCallback(async (s) => {
      ...
      if (s)
        try {
          const [O, he] = await Promise.all([Ua(s.id), ms('group', s.id)]);
          (E(O),
            t(he),
            v({
              id: s.id,
  ...
  const $e = n.useMemo(() => {
    ...
    He = async () => {
      ...
      const s = await Va(d.id);
      if (!(s != null && s.ok))
        return b.error((s == null ? void 0 : s.error) || 'No se pudo eliminar el equipo');
      (b.success('Equipo eliminado'), _(null), C(Ze), T([]), D([]), await $());
    },
    X = async () => {
      const s = await Ka(f);
      if (!(s != null && s.ok))
    ...
    ke = async () => {
      ...
      (P(''), b.success('Miembro agregado al equipo'), await B(d), await $());
    },
    De = async () => {
      if (!(x != null && x.id) || !R) return;
      const s = await Ha(x.id, R);
      if (!(s != null && s.ok))
        return b.error((s == null ? void 0 : s.error) || 'No se pudo agregar el miembro');
    ...
    Ce = async () => {
      const s = await Wa((x == null ? void 0 : x.tipo) === 'dynamic' ? x.id : null);
      if (!(s != null && s.ok))
        return b.error(
...
const Ct = [
  ...
  { id: 'escala', label: 'Escala', icon: Ts, path: '/admin/roles?vista=escala', soloAdmin: !0 },
  {
    id: 'politicas',
    label: 'Políticas',
    icon: ls,
