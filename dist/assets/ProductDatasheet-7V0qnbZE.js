...
import { u as se, s as c } from './index-BGSkqVb2.js';
import { s as ae } from './storageUrl-BzrwhIwH.js';
import {
  t as p,
  v as re,
  x as $,
    ...
    W = async (t) => {
      ...
      if (((t.target.value = ''), !(!s || !o))) {
        ...
        try {
          ...
          (console.error(f),
            p.error(
              (I = f == null ? void 0 : f.message) != null && I.includes('row-level security')
