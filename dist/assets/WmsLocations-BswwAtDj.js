import { d as P, j as a } from './query-vendor-AW4268wa.js';
import { r as _, b as B, R as q } from './react-vendor-CczoB5o5.js';
import { u as H } from './warehouseStore-selABiHS.js';
import { u as J, s as G } from './index-Cm-QZeNi.js';
import { C as X } from './CalidadBadge-B9goYA8f.js';
import {
  m as Q,
  x as W,
  X as Z,
    ...
    ((this.unsubs = []),
      ...
      (this._willUpdate = () => {
        ...
        if (((this.pendingScrollAnchor = null), n && this.scrollElement && this.options.enabled)) {
          ...
          (t !== null &&
            !i &&
            (F() && (this.isScrolling || this._iosTouching || this._iosJustTouchEnded)
        ...
        (
          ...
          if (
            ...
            if (!x || x.length < g) {
              ...
              (x && u > 0 && C.set(x.subarray(0, u * 2)), (x = C), (this._flatMeasurements = x));
            }
            let I;
            if (u === 0) I = s + n;
            else {
            ...
            for (let C = u; C < e; C++) {
              const m = t(C),
                p = f.get(m),
                y = typeof p == 'number' ? p : this.options.estimateSize(C);
              ((x[C * 2] = I), (x[C * 2 + 1] = y), (I += y + c));
            }
            const j = le(e, x, t);
          ...
          for (let g = u; g < e; g++) {
            ...
            if (I !== void 0 && this.options.lanes > 1) {
              ...
              for (let A = 1; A < i; A++) {
                const R = b[A];
                (R < O || (R === O && w[A] < M)) && ((E = A), (O = R), (M = w[A]));
              }
              ((j = E), (C = O + c), m && this.laneAssignments.set(g, j));
            } else ((j = g % this.options.lanes), (C = s + n), m && this.laneAssignments.set(g, j));
            const p = f.get(x),
              y = typeof p == 'number' ? p : this.options.estimateSize(g),
              z = C + y;
            ((S[g] = { index: g, start: C, size: y, end: z, key: x, lane: j }),
              w[j] === void 0 && v++,
              (w[j] = g),
              (b[j] = z));
          }
...
const L = typeof document < 'u' ? _.useLayoutEffect : _.useEffect;
function ye({
  useFlushSync: l = !0,
  ...
  const n = _.useReducer((d) => d + 1, 0)[1],
    t = _.useRef({
      enabled: h,
      mode: e,
      container: null,
...
function Ie() {
  const l = Ee(),
    ...
    { byCodigo: s, byCodigoUbic: n } = _.useMemo(() => {
      const o = new Map(),
        i = new Map();
      for (const r of h) {
