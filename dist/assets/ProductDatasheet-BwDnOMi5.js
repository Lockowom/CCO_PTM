...
import { u as se, s as n } from './index-DpKQy1E-.js';
import { s as ae } from './storageUrl-DXi8LLxG.js';
import {
  t as p,
  x as re,
  z as $,
...
const ye = () => {
  ...
  i.useEffect(() => {
    ...
    const s = setTimeout(async () => {
      const { data: g, error: _ } = await n.rpc('search_productos', { p_query: t, p_limit: 30 });
      (_ ? (p.error('Error buscando productos'), N([])) : N(g || []), h(!1));
    }, 400);
    return () => clearTimeout(s);
  }, [l]);
  const w = i.useCallback(async (t) => {
      U(!0);
      const { data: s, error: g } = await n.rpc('get_ficha_producto', { p_codigo: t });
      ...
      if (((t.target.value = ''), !(!s || !o))) {
        ...
        try {
          const f = await ue(s),
            ...
            { error: A } = await n.storage
              .from(j)
              .upload(z, f, { contentType: 'image/jpeg', upsert: !1 });
          if (A) throw A;
          const { data: ee } = n.storage.from(j).getPublicUrl(z),
          ...
          if (D) throw (await n.storage.from(j).remove([z]), D);
          (p.success('Foto agregada'), await w(o));
        } catch (f) {
          (console.error(f),
            p.error(
    ...
    W = async (t) => {
      if (confirm('¿Eliminar esta foto?'))
        try {
          await n.storage.from(j).remove([t.storage_path]);
          const { error: s } = await n.from('tms_fichas_imagenes').delete().eq('id', t.id);
          if (s) throw s;
          (p.success('Foto eliminada'), await w(o));
        } catch {
    ...
    H = async (t) => {
      try {
        await n.from('tms_fichas_imagenes').update({ es_principal: !1 }).eq('codigo_producto', o);
        const { error: s } = await n
          .from('tms_fichas_imagenes')
    ...
    v = (r == null ? void 0 : r.imagenes) || [],
    y = v.find((t) => t.es_principal) || v[0] || null,
    [J, Y] = i.useState({});
  i.useEffect(() => {
    let t = !0;
    return (
  ...
  const u = (t) => (t && J[t.storage_path]) || '',
    ...
    c = (r == null ? void 0 : r.header) || (o ? { codigo_producto: o } : null),
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx('input', {
                  ...
                  className: `w-full pl-12 pr-10 py-3.5 rounded-2xl border border-slate-200 bg-white font-mono uppercase text-sm\r
              ...
              children: [
                ...
                l.trim().length >= 2 &&
                  ...
                  e.jsxs('div', {
                    className: 'text-center py-20 text-slate-400',
                    children: [
                      e.jsx($, { size: 40, className: 'mx-auto mb-4 text-slate-200' }),
                      e.jsxs('p', {
                        className: 'font-bold',
            ...
            e.jsxs('div', {
              children: [
                e.jsxs('button', {
                  ...
                  children: [e.jsx(K, { size: 18 }), ' Volver a la búsqueda']
                }),
                V
                  ? e.jsxs('div', {
                      className: 'flex flex-col items-center justify-center py-24 gap-3',
                      children: [
                        e.jsx(O, { className: 'animate-spin text-orange-500', size: 28 }),
                        e.jsx('p', {
                            ...
                            children: [
                              e.jsx('div', {
                                ...
                                children: y
                                  ? e.jsx('img', {
                                      src: u(y),
                                      alt: (c == null ? void 0 : c.producto) || o,
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  e.jsx('span', {
                                    ...
                                    children: (c == null ? void 0 : c.codigo_producto) || o
                                  }),
                                  e.jsx('h2', {
                                    className:
                                      'text-xl sm:text-2xl font-black text-slate-900 leading-tight mb-4',
                                    children: (c == null ? void 0 : c.producto) || '—'
                                  }),
                                  e.jsxs('div', {
                              ...
                              children: [
                                ...
                                d &&
                                  e.jsxs('button', {
                                    ...
                                    children: [
                                      E
                                        ? e.jsx(O, { size: 16, className: 'animate-spin' })
                                        : e.jsx(ce, { size: 16 }),
                                        ...
                                        children: [
                                          ...
                                          t.es_principal &&
                                            e.jsxs('span', {
                                              ...
                                              children: [e.jsx(ne, { size: 10 }), ' Principal']
                                            }),
                                          d &&
                                            e.jsxs('div', {
                                              className:
