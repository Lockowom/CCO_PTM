import { a3 as a } from './index-BncYchmL.js';
import { I as i, N as r } from './WarehousePDA-BhoKUYSj.js';
...
import './useBarcodeScanner-D4jdgJao.js';
import './conteoService-BzhR-XRI.js';
...
class m extends a {
  ...
  async impact(t) {
    const e = this.patternForImpact(t == null ? void 0 : t.style);
    this.vibrateWithPattern(e);
  }
  async notification(t) {
    const e = this.patternForNotification(t == null ? void 0 : t.type);
    this.vibrateWithPattern(e);
  }
  async vibrate(t) {
    const e = (t == null ? void 0 : t.duration) || 300;
    this.vibrateWithPattern([e]);
  }
