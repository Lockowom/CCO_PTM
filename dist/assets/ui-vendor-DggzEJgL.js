import { R as s, a as We, r as Me } from './react-vendor-CByR7_Pi.js';
function Ye(i) {
    ...
    ((this.subscribe = (n) => (
      ...
      (this.create = (n) => {
        ...
        const { message: o, ...S } = n,
          ...
          z = n.dismissible === void 0 ? !0 : n.dismissible;
        return (
            ...
            ? (this.toasts = this.toasts.map((k) =>
                k.id === d
                  ? (this.publish({ ...k, ...n, id: d, title: o }),
                    { ...k, ...n, id: d, dismissible: z, title: o })
                  : k
              ))
            : this.addToast({ title: o, ...S, dismissible: z, id: d }),
          d
        );
      }),
      (this.dismiss = (n) => (
      ...
      (this.promise = (n, a) => {
        ...
        const z = S.then(async (l) => {
              ...
              const t =
                ...
                v =
                  typeof a.description == 'function'
                    ...
                    : a.description,
                C = typeof t == 'object' && !s.isValidElement(t) ? t : { message: t };
              this.create({ id: o, type: 'error', description: v, ...C });
            } else if (l instanceof Error) {
              d = !1;
              const t = typeof a.error == 'function' ? await a.error(l) : a.error,
                v = typeof a.description == 'function' ? await a.description(l) : a.description,
                C = typeof t == 'object' && !s.isValidElement(t) ? t : { message: t };
              this.create({ id: o, type: 'error', description: v, ...C });
            } else if (a.success !== void 0) {
              d = !1;
              const t = typeof a.success == 'function' ? await a.success(l) : a.success,
                v = typeof a.description == 'function' ? await a.description(l) : a.description,
                C = typeof t == 'object' && !s.isValidElement(t) ? t : { message: t };
            ...
            .catch(async (l) => {
              if (((f = ['reject', l]), a.error !== void 0)) {
                ...
                const M = typeof a.error == 'function' ? await a.error(l) : a.error,
                  t = typeof a.description == 'function' ? await a.description(l) : a.description,
                  D = typeof M == 'object' && !s.isValidElement(M) ? M : { message: M };
                this.create({ id: o, type: 'error', description: t, ...D });
              }
            })
            .finally(() => {
          ...
          k = () =>
            new Promise((l, M) => z.then(() => (f[0] === 'reject' ? M(f[1]) : l(f[1]))).catch(M));
        return typeof o != 'string' && typeof o != 'number'
          ? { unwrap: k }
          : Object.assign(o, { unwrap: k });
      }),
      (this.custom = (n, a) => {
        const o = (a == null ? void 0 : a.id) || we++;
...
const L = new nt(),
  ot = (i, n) => {
    const a = (n == null ? void 0 : n.id) || we++;
    return (L.addToast({ title: i, ...n, id: a }), a);
  },
  rt = (i) =>
    i &&
    typeof i == 'object' &&
...
const gt = (i) => {
  ...
  const {
    ...
    ye = s.useMemo(() => $.findIndex((r) => r.toastId === t.id) || 0, [$, t.id]),
    _e = s.useMemo(() => {
      var r;
      return (r = t.closeButton) != null ? r : N;
    }, [t.closeButton, N]),
    ze = s.useMemo(() => t.duration || te || Ae, [t.duration, te]),
    xe = s.useRef(0),
    Q = s.useRef(0),
    Le = s.useRef(0),
    J = s.useRef(null),
    [Oe, Fe] = R.split('-'),
    qe = s.useMemo(() => $.reduce((r, g, w) => (w >= ye ? r : r + g.height), 0), [$, ye]),
    He = st(),
    Ue = t.invert || M,
    be = q === 'loading';
  ((Q.current = s.useMemo(() => ye * ie + qe, [ye, qe])),
    s.useEffect(() => {
      se.current = ze;
    }, [ze]),
    s.useEffect(() => {
    ...
    s.useEffect(() => {
      ...
      if (r) {
        ...
        return (
          Ce(g),
          C((w) => [{ toastId: t.id, height: g, position: t.position }, ...w]),
          () => C((w) => w.filter((H) => H.toastId !== t.id))
        );
      }
    }, [C, t.id]),
    s.useLayoutEffect(() => {
      ...
      ((r.style.height = g),
        Ce(w),
        C((H) =>
          H.find((b) => b.toastId === t.id)
            ? H.map((b) => (b.toastId === t.id ? { ...b, height: w } : b))
            : [{ toastId: t.id, height: w, position: t.position }, ...H]
        ));
    }, [c, t.title, t.description, C, t.id, t.jsx, t.action, t.cancel]));
  const _ = s.useCallback(() => {
    (E(!0),
      ve(Q.current),
      C((r) => r.filter((g) => g.toastId !== t.id)),
      setTimeout(() => {
        oe(t);
      }, mt));
  }, [t, oe, C, Q]);
  (s.useEffect(() => {
    if ((t.promise && q === 'loading') || t.duration === 1 / 0 || t.type === 'loading') return;
    let r;
    return (
      W || D || He
        ? (() => {
            if (Le.current < xe.current) {
              const H = new Date().getTime() - xe.current;
              se.current = se.current - H;
            }
        ...
        : (() => {
            se.current !== 1 / 0 &&
              ...
              (r = setTimeout(() => {
                (t.onAutoClose == null || t.onAutoClose.call(t, t), _());
              }, se.current)));
          })(),
      () => clearTimeout(r)
    );
    ...
    s.useEffect(() => {
      t.delete && (_(), t.onDismiss == null || t.onDismiss.call(t, t));
    }, [_, t.delete]));
  function Ze() {
    var r;
    if (x != null && x.loading) {
      ...
      return s.createElement(
        'div',
        {
          className: B(
            ...
            t == null || (g = t.classNames) == null ? void 0 : g.loader,
            'sonner-loader'
          ),
    ...
    return s.createElement(Ke, {
      className: B(
        h == null ? void 0 : h.loader,
        t == null || (r = t.classNames) == null ? void 0 : r.loader
      ),
      visible: q === 'loading'
    });
  }
  const $e = t.icon || (x == null ? void 0 : x[q]) || Xe(q);
  var Ee, Te;
  return s.createElement(
    'li',
    {
      ...
      className: B(
        ...
        t == null || (n = t.classNames) == null ? void 0 : n.toast,
        h == null ? void 0 : h.default,
        h == null ? void 0 : h[q],
        t == null || (a = t.classNames) == null ? void 0 : a[q]
      ),
      'data-sonner-toast': '',
      'data-rich-colors': (Ee = t.richColors) != null ? Ee : me,
      'data-styled': !(t.jsx || t.unstyled || v),
      'data-mounted': c,
      ...
      'data-expanded': !!(W || (ae && c)),
      'data-testid': t.testId,
      style: {
        '--index': y,
        '--toasts-before': y,
        '--z-index': ne.length - y,
        '--offset': `${u ? Re : Q.current}px`,
        '--initial-height': ae ? 'auto' : `${Be}px`,
        ...ee,
        ...t.style
      },
      onDragEnd: () => {
        (p(!1), j(null), (J.current = null));
      },
      onPointerDown: (r) => {
        r.button !== 2 &&
          (be ||
      ...
      onPointerUp: () => {
        ...
        const H = Number(
          ...
          b = new Date().getTime() - ((w = Se.current) == null ? void 0 : w.getTime()),
          T = F === 'x' ? H : he,
          pe = Math.abs(T) / b;
        if (Math.abs(T) >= kt || pe > 0.11) {
          (ve(Q.current),
            t.onDismiss == null || t.onDismiss.call(t, t),
            le(F === 'x' ? (H > 0 ? 'right' : 'left') : he > 0 ? 'down' : 'up'),
            _(),
            ce(!0));
          return;
        } else {
          var A, V;
          ((A = P.current) == null || A.style.setProperty('--swipe-amount-x', '0px'),
      ...
      onPointerMove: (r) => {
        ...
        const b = r.clientY - J.current.y,
          T = r.clientX - J.current.x;
        var pe;
        const A = (pe = i.swipeDirections) != null ? pe : ft(R);
        !F && (Math.abs(T) > 1 || Math.abs(b) > 1) && j(Math.abs(T) > Math.abs(b) ? 'x' : 'y');
        let V = { x: 0, y: 0 };
        const je = (Z) => 1 / (1.5 + Math.abs(Z) / 20);
        if (F === 'y') {
          if (A.includes('top') || A.includes('bottom'))
            if ((A.includes('top') && b < 0) || (A.includes('bottom') && b > 0)) V.y = b;
            else {
              const Z = b * je(b);
              V.y = Math.abs(Z) < Math.abs(b) ? Z : b;
            }
        } else if (F === 'x' && (A.includes('left') || A.includes('right')))
          if ((A.includes('left') && T < 0) || (A.includes('right') && T > 0)) V.x = T;
          else {
            const Z = T * je(T);
            V.x = Math.abs(Z) < Math.abs(T) ? Z : T;
          }
          ...
          'button',
          {
            ...
            onClick:
              be || !K
                ? () => {}
                : () => {
                    (_(), t.onDismiss == null || t.onDismiss.call(t, t));
                  },
            className: B(
              h == null ? void 0 : h.closeButton,
              t == null || (o = t.classNames) == null ? void 0 : o.closeButton
            )
          },
          (Te = x == null ? void 0 : x.close) != null ? Te : at
        )
      : null,
    (q || t.icon || t.promise) &&
      t.icon !== null &&
      ((x == null ? void 0 : x[q]) !== null || t.icon)
      ? s.createElement(
          'div',
          {
            'data-icon': '',
            className: B(
              ...
              t == null || (S = t.classNames) == null ? void 0 : S.icon
            )
          },
          t.promise || (t.type === 'loading' && !t.icon) ? t.icon || Ze() : null,
          t.type !== 'loading' ? $e : null
        )
      : null,
    s.createElement(
      'div',
      {
        ...
        className: B(
          ...
          t == null || (d = t.classNames) == null ? void 0 : d.content
        )
      },
      s.createElement(
        'div',
        {
          ...
          className: B(
            ...
            t == null || (f = t.classNames) == null ? void 0 : f.title
          )
        },
        ...
        ? s.createElement(
            'div',
            {
              ...
              className: B(
                ...
                t == null || (z = t.classNames) == null ? void 0 : z.description
              )
            },
    ...
    s.isValidElement(t.cancel)
      ? t.cancel
      : t.cancel && ue(t.cancel)
        ? s.createElement(
            'button',
            {
              'data-button': !0,
              'data-cancel': !0,
              style: t.cancelButtonStyle || O,
              onClick: (r) => {
                ue(t.cancel) &&
                  K &&
                  (t.cancel.onClick == null || t.cancel.onClick.call(t.cancel, r), _());
              },
              className: B(
                h == null ? void 0 : h.cancelButton,
                t == null || (k = t.classNames) == null ? void 0 : k.cancelButton
              )
            },
            t.cancel.label
          )
        : null,
    s.isValidElement(t.action)
      ? t.action
      : t.action && ue(t.action)
        ? s.createElement(
            'button',
            {
              'data-button': !0,
              'data-action': !0,
              style: t.actionButtonStyle || fe,
              onClick: (r) => {
                ue(t.action) &&
                  (t.action.onClick == null || t.action.onClick.call(t.action, r),
                  !r.defaultPrevented && _());
              },
              className: B(
                h == null ? void 0 : h.actionButton,
                t == null || (l = t.classNames) == null ? void 0 : l.actionButton
              )
            },
            t.action.label
          )
...
const St = s.forwardRef(function (n, a) {
  const {
      id: o,
      invert: S,
      ...
      gap: W = ut,
      icons: oe,
      containerAriaLabel: me = 'Notifications'
    } = n,
    [N, ee] = s.useState([]),
    O = s.useMemo(
    ...
    le = s.useCallback((c) => {
      ee((m) => {
        var u;
        return (
          ((u = m.find((E) => E.id === c.id)) != null && u.delete) || L.dismiss(c.id),
          m.filter(({ id: E }) => E !== c.id)
        );
      });
    }, []);
  return (
        ...
        L.subscribe((c) => {
          if (c.dismiss) {
            requestAnimationFrame(() => {
              ee((m) => m.map((u) => (u.id === c.id ? { ...u, delete: !0 } : u)));
            });
            return;
          }
          setTimeout(() => {
            We.flushSync(() => {
              ee((m) => {
                const u = m.findIndex((E) => E.id === c.id);
                return u !== -1
    ...
    s.useEffect(() => {
      if (I.current)
        return () => {
          j.current &&
            (j.current.focus({ preventScroll: !0 }), (j.current = null), (U.current = !1));
        };
    }, [I.current]),
    s.createElement(
      'section',
        ...
        return O.length
          ? s.createElement(
              'ol',
              {
                ...
                'data-x-position': Y,
                style: {
                  '--front-toast-height': `${((u = re[0]) == null ? void 0 : u.height) || 0}px`,
                  '--width': `${pt}px`,
                  '--gap': `${W}px`,
                  ...ke,
                  ...vt(M, t)
                ...
                onBlur: (p) => {
                  U.current &&
                    ...
                    ((U.current = !1),
                    j.current && (j.current.focus({ preventScroll: !0 }), (j.current = null)));
                },
                onFocus: (p) => {
                  (p.target instanceof HTMLElement && p.target.dataset.dismissible === 'false') ||
                    U.current ||
                    ((U.current = !0), (j.current = p.relatedTarget));
                },
                onMouseEnter: () => R(!0),
                onMouseMove: () => R(!0),
                onMouseLeave: () => {
              ...
              O.filter((p) => (!p.position && m === 0) || p.position === c).map((p, X) => {
                ...
                return s.createElement(gt, {
                  ...
                  toast: p,
                  defaultRichColors: D,
                  duration: (ce = y == null ? void 0 : y.duration) != null ? ce : C,
                  className: y == null ? void 0 : y.className,
                  descriptionClassName: y == null ? void 0 : y.descriptionClassName,
                  invert: S,
                  visibleToasts: $,
                  closeButton: (de = y == null ? void 0 : y.closeButton) != null ? de : k,
                  interacting: ie,
                  position: c,
                  ...
                  heights: re.filter((G) => G.position == p.position),
                  setHeights: ge,
                  expandByDefault: z,
                  gap: W,
                  expanded: te,
      ...
      (
        ...
        Me.createElement(
          'svg',
          {
            ...
            className: ['lucide', `lucide-${bt(i)}`, z].join(' '),
            ...l
          },
          [...n.map(([t, v]) => Me.createElement(t, v)), ...(Array.isArray(k) ? k : [k])]
        )
    );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const g1 = e('Loader2', [['path', { d: 'M21 12a9 9 0 1 1-6.219-8.56', key: '13zald' }]]);
/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const v1 = e('LockKeyhole', [
