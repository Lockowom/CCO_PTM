import { d as D, j as e } from './query-vendor-CojWQiBV.js';
import { r as m } from './react-vendor-CA7EHQ1X.js';
import {
  u as q,
  b4 as F,
  R as Q,
...
import { s as w } from './index-CXl7fTg4.js';
import { Q as W } from './QueryErrorState-DNrU4WXZ.js';
...
async function Z({ lookback: a, level: l, kind: i, moduleFilter: n, search: c }) {
  const o = X(a);
  let x = w
    .from('system_logs')
    .select(
  ...
  const g = w
    ...
    C = w
      ...
      .order('created_at', { ascending: !1 })
      .limit(20),
    [{ data: r, error: v, count: t }, p, b, h, f] = await Promise.all([x, g, S, j, C]);
  if (v) throw v;
  ...
  return {
    ...
    totals: {
      ...
      warns: h.count || 0,
      slow: b.count || 0,
      openAlerts: N.filter((s) => s.status === 'open').length,
      usersAffected: A,
      avgDuration: _
    },
    alerts: N,
    topFingerprints: L(k, (s) => s.fingerprint || s.message, 6),
    topModules: L(d, (s) => s.module, 6),
    topActions: L(
...
function oe() {
  ...
  const {
      ...
      queryFn: () => Z({ lookback: l, level: n, kind: o, moduleFilter: g, search: j }),
      refetchInterval: 15e3
    }),
    d = (t == null ? void 0 : t.logs) || [],
    N = (t == null ? void 0 : t.alerts) || [],
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('button', {
            ...
            children: [e.jsx(Q, { size: 16, className: b ? 'animate-spin' : '' }), 'Actualizar']
          })
        ]
      }),
      e.jsxs('div', {
              ...
              e.jsxs('div', {
                children: [
                  ...
                  e.jsxs('div', {
                    className: 'relative',
                    children: [
                      e.jsx(P, { size: 16, className: 'absolute left-3 top-3 text-slate-400' }),
                      e.jsx('input', {
                        value: j,
                        onChange: (s) => C(s.target.value),
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx(y, {
                  ...
                  helper: `Promedio: ${z(t == null ? void 0 : t.totals.avgDuration)}`
                })
              ]
            }),
            e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      e.jsxs('span', {
                                        children: [
                                          e.jsx(J, { size: 12, className: 'inline mr-1' }),
                                          z(s.duration_ms)
                                        ]
                                      })
                                    ]
