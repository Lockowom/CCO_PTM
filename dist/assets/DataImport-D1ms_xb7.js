...
import { r as n } from './react-vendor-CczoB5o5.js';
import { u as Vt, s as M } from './index-Cm-QZeNi.js';
import {
  n as ut,
  q as Ue,
  ah as Ft,
...
import { u as Jt } from './useBarcodeScanner-DBKrXJxf.js';
...
const be = [
                              ...
                              e.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  e.jsxs('button', {
                                    onClick: () => fe(u),
                                    disabled: O === u.id,
                                    className: `flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${Q === u.id ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-800 text-white hover:bg-slate-700'} disabled:opacity-50`,
                                    children: [
                                      O === u.id
  ...
  ds = () => {
    ...
    const D = n.useMemo(
      ...
      ge = ((rt = Q[0]) == null ? void 0 : rt.id) || 'ventas',
    ...
    n.useEffect(() => {
      ...
      if (D.length > 0 && !D.find((a) => a.id === K)) {
        const a = (t = Q[0]) == null ? void 0 : t.id,
...
¿Continuar?`)
                          ...
                          e.jsxs(e.Fragment, {
                            children: [
                              e.jsxs('div', {
                                ...
                                onClick: () => {
                                  var t;
                                  return (t = Ze.current) == null ? void 0 : t.focus();
                                },
                                children: [
                                  !f &&
                                    e.jsxs('div', {
                      ...
                      children: [
                        Ke > 0 &&
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx(Y, { size: 18, className: 'shrink-0 mt-0.5' }),
                              e.jsxs('span', {
                                children: [
                      ...
                      children: e.jsxs('div', {
                        ...
                        children: [
                          e.jsx('div', {
                            ...
                            children: T.success ? e.jsx(Me, { size: 32 }) : e.jsx(Y, { size: 32 })
                          }),
                          e.jsx('h2', {
                            className: 'text-lg font-extrabold text-slate-900 mb-2',
  ...
  re = ({ icon: d, label: L, value: F, color: oe }) => {
    ...
    return e.jsxs('div', {
      className: `flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-bold ${Z[oe]}`,
      children: [
        e.jsx(d, { size: 13 }),
