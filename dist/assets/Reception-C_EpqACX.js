import { u as bt, d as ft, c as gt, j as e } from './query-vendor-AW4268wa.js';
import { r as x } from './react-vendor-CczoB5o5.js';
import { u as jt, s as M } from './index-Cm-QZeNi.js';
import { u as Nt } from './useRealtimeTable-B0el-txd.js';
import { u as vt } from './useBarcodeScanner-DBKrXJxf.js';
import { u as wt, g as yt } from './animation-vendor-Bm2mNA5x.js';
import { l as Ct } from './logUpload-BiODRl_2.js';
import {
  f as fe,
  am as _t,
  P as qe,
...
¿Agregarla de todos modos? Quedará marcada como duplicada.`)
        ...
        (P((r) => [
          ...
          A({ reff: '', cantidad: 1, serie: '', lote: '', box: '', fecha_vencimiento: '' }),
          z(!0),
...
¿Quieres agregarlas de todos modos? Quedarán marcadas como duplicadas.`)
      ...
      Pe = (t) => {
        j({
          onScan: (s) => {
            const a = s.trim();
            (A((r) => ({ ...r, [t]: a })), h.success(`${t.toUpperCase()} escaneado: ${a}`));
          },
          onError: (s) => h.error(s)
        });
      },
      ...
      pt = (t, s) => {
        ...
        (Ne(r, N), h.success(`Archivo descargado: ${N}`));
      },
      mt = () => {
        if (T.length === 0) {
                          ...
                          children: at
                            ? e.jsx('tr', {
                                children: e.jsxs('td', {
                                  ...
                                  children: [
                                    e.jsx(Ke, { size: 20, className: 'animate-spin mx-auto mb-2' }),
                                    'Cargando...'
                                  ]
                                })
                              })
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  onChange: (t) =>
                                    O((s) => ({ ...s, fecha_recepcion: t.target.value })),
                                  className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: p.proveedor,
                                  onChange: (t) =>
                                    O((s) => ({ ...s, proveedor: t.target.value.toUpperCase() })),
                                  className:
                            ...
                            e.jsxs('div', {
                              ...
                              children: [
                                ...
                                e.jsx('input', {
                                  type: 'text',
                                  value: p.oc,
                                  onChange: (t) => O((s) => ({ ...s, oc: t.target.value })),
                                  className:
                                    'w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                                  placeholder: '21073...'
                                })
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  value: p.cant_bultos,
                                  onChange: (t) =>
                                    O((s) => ({ ...s, cant_bultos: t.target.value })),
                                  className:
                            ...
                            e.jsxs('div', {
                              children: [
                                ...
                                e.jsx('input', {
                                  ...
                                  onChange: (t) =>
                                    O((s) => ({ ...s, pallets_usados: t.target.value })),
                                  className:
                                    'w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                                  placeholder: '0',
                                  min: '0'
                        ...
                        e.jsxs('div', {
                          children: [
                            ...
                            e.jsx('select', {
                              ...
                              onChange: (t) =>
                                O((s) => ({ ...s, tipo_contenedor: t.target.value })),
                              className:
                                'w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-emerald-400',
                        ...
                        e.jsxs('div', {
                          children: [
                            ...
                            e.jsx('textarea', {
                              rows: 2,
                              value: p.notas,
                              onChange: (t) => O((s) => ({ ...s, notas: t.target.value })),
                              className:
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            value: m.reff,
                            onChange: (t) =>
                              A((s) => ({ ...s, reff: t.target.value.toUpperCase() })),
                            className:
                          ...
                          e.jsxs('div', {
                            children: [
                              ...
                              e.jsx('input', {
                                type: 'number',
                                value: m.cantidad,
                                onChange: (t) => A((s) => ({ ...s, cantidad: t.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            children: [
                              ...
                              e.jsx('input', {
                                type: 'text',
                                value: m.box,
                                onChange: (t) => A((s) => ({ ...s, box: t.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('input', {
                                type: 'text',
                                value: m.serie,
                                onChange: (t) => A((s) => ({ ...s, serie: t.target.value })),
                                className:
                          ...
                          e.jsxs('div', {
                            ...
                            children: [
                              e.jsx('input', {
                                type: 'text',
                                value: m.lote,
                                onChange: (t) => A((s) => ({ ...s, lote: t.target.value })),
                                className:
                                  'flex-1 p-4 bg-slate-50 border-2 border-slate-200 rounded-2xl text-base font-mono outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all',
                      ...
                      e.jsxs('div', {
                        ...
                        children: [
                          ...
                          e.jsx('input', {
                            ...
                            onChange: (t) =>
                              A((s) => ({ ...s, fecha_vencimiento: t.target.value })),
                            className:
                              'w-full p-4 bg-slate-50 border-2 border-slate-200 rounded-2xl text-base font-bold outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all'
                          })
                        ]
                          ...
                          e.jsxs('button', {
                            ...
                            children: [
                              ...
                              e.jsx('div', {
                                ...
                                children: _e ? e.jsx(Dt, { size: 18 }) : e.jsx(Tt, { size: 18 })
                              })
                            ]
                          }),
                          _e &&
                                              ...
                                              children: [
                                                ...
                                                a &&
                                                  e.jsxs('span', {
                                                    ...
                                                    children: [e.jsx(Xe, { size: 9 }), ' DUPLICADA']
                                                  })
                                              ]
                                            }),
                                            e.jsx('td', {
                        ...
                        e.jsx('div', {
                          ...
                          children: e.jsx('button', {
                            ...
                            children: me.isPending
                              ? e.jsxs(e.Fragment, {
                                  children: [
                                    e.jsx(Ke, { size: 22, className: 'animate-spin' }),
                                    ' GUARDANDO...'
                                  ]
                                })
                              : e.jsxs(e.Fragment, {
