...
> **Versión:** 1.4.31 | **Última actualización:** 2026-06-10
...
|---|---|---|
| 1.4.31 | 2026-06-10 | **DEPLOY del módulo Costos de Transporte**: bundle móvil `com.cco.wms@1.4.31` a Capgo OTA (canal `production`) + web a Render. El script `deploy:mobile` auto-incrementa el patch (1.4.30→1.4.31). |
